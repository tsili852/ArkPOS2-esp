# 1 "C:/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c"
# 1 "C:\\esp\\esp32-ArkPOS2\\ArkPOS2-esp\\build\\bootloader\\bootloader_support//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c"
# 14 "C:/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c"
...
# 15 "C:/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c" 2
...
# 17 "C:/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c" 2
...
# 18 "C:/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c" 2
...
# 20 "C:/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c" 2
# 77 "C:/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c"
...
# 78 "C:/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c" 2
...
# 79 "C:/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c" 2
...
# 80 "C:/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c" 2

static const char *TAG = "bootloader_flash";
# 91 "C:/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c"
static 
# 91 "C:/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c" 3 4
      _Bool 
# 91 "C:/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c"
           mapped;
...
const void *bootloader_mmap(uint32_t src_addr, uint32_t size)
{
    if (mapped) {
        ...
        return 
# 100 "C:/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c" 3 4
              ((void *)0)
# 100 "C:/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c"
                  ;
    }
    if (size > 0x320000) {
        ...
        return 
# 105 "C:/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c" 3 4
              ((void *)0)
# 105 "C:/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c"
                  ;
    }
    ...
    if (e != 0) {
        ...
        Cache_Read_Enable(0);
        return 
# 117 "C:/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c" 3 4
              ((void *)0)
# 117 "C:/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c"
                  ;
    }
    Cache_Read_Enable(0);

    mapped = 
# 121 "C:/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c" 3 4
            1
# 121 "C:/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c"
                ;
...
void bootloader_munmap(const void *mapping)
{
    if (mapped) {
        ...
        mmu_init(0);
        mapped = 
# 133 "C:/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c" 3 4
                0
# 133 "C:/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c"
                     ;
...
esp_err_t bootloader_flash_read(size_t src_addr, void *dest, size_t size, 
# 193 "C:/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c" 3 4
                                                                         _Bool 
# 193 "C:/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c"
                                                                              allow_decrypt)
{
    if (src_addr & 3) {
...
esp_err_t bootloader_flash_write(size_t dest_addr, void *src, size_t size, 
# 215 "C:/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c" 3 4
                                                                          _Bool 
# 215 "C:/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c"
                                                                               write_encrypted)
{
    esp_err_t err;
