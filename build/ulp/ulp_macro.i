# 1 "C:/esp/esp-idf/components/ulp/ulp_macro.c"
# 1 "C:\\esp\\ArkPOS2-esp\\build\\ulp//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/ulp/ulp_macro.c"
# 15 "C:/esp/esp-idf/components/ulp/ulp_macro.c"
...
# 16 "C:/esp/esp-idf/components/ulp/ulp_macro.c" 2
...
# 17 "C:/esp/esp-idf/components/ulp/ulp_macro.c" 2
...
# 18 "C:/esp/esp-idf/components/ulp/ulp_macro.c" 2

# 1 "C:/esp/esp-idf/components/esp32/include/esp_attr.h" 1
# 20 "C:/esp/esp-idf/components/ulp/ulp_macro.c" 2
...
# 21 "C:/esp/esp-idf/components/ulp/ulp_macro.c" 2
...
# 22 "C:/esp/esp-idf/components/ulp/ulp_macro.c" 2
...
# 23 "C:/esp/esp-idf/components/ulp/ulp_macro.c" 2
...
# 26 "C:/esp/esp-idf/components/ulp/ulp_macro.c" 2
# 1 "C:/esp/esp-idf/components/soc/esp32/include/soc/sens_reg.h" 1
# 27 "C:/esp/esp-idf/components/ulp/ulp_macro.c" 2

# 1 "C:/esp/ArkPOS2-esp/build/include/sdkconfig.h" 1
# 29 "C:/esp/esp-idf/components/ulp/ulp_macro.c" 2
...
# 100 "C:/esp/esp-idf/components/ulp/ulp_macro.c"
...
# 107 "C:/esp/esp-idf/components/ulp/ulp_macro.c"
    ,
                                                                     108
# 107 "C:/esp/esp-idf/components/ulp/ulp_macro.c"
    ...
    switch (insn->b.sub_opcode) {
        ...
        case 0: {
            ((insn->bx.reg == 0 && "relocation applied to a jump with offset in register") ? (void)0 : __assert_func (
                                                                          "C:/esp/esp-idf/components/ulp/ulp_macro.c"
# 124 "C:/esp/esp-idf/components/ulp/ulp_macro.c"
            ,
                                                                          125
# 124 "C:/esp/esp-idf/components/ulp/ulp_macro.c"
        ...
        default:
            ((
# 130 "C:/esp/esp-idf/components/ulp/ulp_macro.c" 3 4
           0 
# 130 "C:/esp/esp-idf/components/ulp/ulp_macro.c"
           && "unexpected sub-opcode") ? (void)0 : __assert_func ("C:/esp/esp-idf/components/ulp/ulp_macro.c", 130, __func__, "false && \"unexpected sub-opcode\""));
    }
    return 0;
}
...
esp_err_t ulp_process_macros_and_load(uint32_t load_addr, const ulp_insn_t* program, size_t* psize)
{
    ...
    if (reloc_info == 
# 167 "C:/esp/esp-idf/components/ulp/ulp_macro.c" 3 4
                     ((void *)0)
# 167 "C:/esp/esp-idf/components/ulp/ulp_macro.c"
                         ) {
        return 0x101;
    }
            ...
            switch(r_insn.macro.sub_opcode) {
                ...
                case 1:
                    *cur_reloc = (reloc_info_t) { .label = r_insn.macro.label, .addr = cur_insn_addr, .unused = 0, .type = 1 }
                    ...
                    break;
                default:
                    ((0 && "invalid sub_opcode for macro insn") ? (void)0 : __assert_func ("C:/esp/esp-idf/components/ulp/ulp_macro.c", 191, __func__, "0 && \"invalid sub_opcode for macro insn\""));
            }
            ++read_ptr;
            ((read_ptr != end && "program can not end with macro insn") ? (void)0 : __assert_func ("C:/esp/esp-idf/components/ulp/ulp_macro.c", 194, __func__, "read_ptr != end && \"program can not end with macro insn\""));
            ++cur_reloc;
        } else {
    ...
    while(cur_reloc < reloc_end) {
        ...
        ((label_info.type == 0) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/ulp/ulp_macro.c", 232, __func__, "label_info.type == RELOC_TYPE_LABEL"));
        ++cur_reloc;
        while (cur_reloc < reloc_end) {
            if (cur_reloc->type == 0) {
