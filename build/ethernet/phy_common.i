...
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/ethernet/eth_phy/phy_common.c"
# 15 "C:/esp/esp-idf/components/ethernet/eth_phy/phy_common.c"
# 1 "C:/esp/esp-idf/components/ethernet/include/eth_phy/phy.h" 1
# 15 "C:/esp/esp-idf/components/ethernet/include/eth_phy/phy.h"
...
# 18 "C:/esp/esp-idf/components/ethernet/include/esp_eth.h"
# 1 "c:\\msys32\\opt\\xtensa-esp32-elf\\lib\\gcc\\xtensa-esp32-elf\\5.2.0\\include\\stdbool.h" 1 3 4
# 19 "C:/esp/esp-idf/components/ethernet/include/esp_eth.h" 2
...
# 20 "C:/esp/esp-idf/components/ethernet/include/esp_eth.h" 2
...
# 21 "C:/esp/esp-idf/components/ethernet/include/esp_eth.h" 2
...
# 22 "C:/esp/esp-idf/components/ethernet/include/eth_phy/phy.h" 2
# 39 "C:/esp/esp-idf/components/ethernet/include/eth_phy/phy.h"
...
# 53 "C:/esp/esp-idf/components/ethernet/include/eth_phy/phy.h" 3 4
_Bool 
# 53 "C:/esp/esp-idf/components/ethernet/include/eth_phy/phy.h"
    phy_mii_check_link_status(void);


# 55 "C:/esp/esp-idf/components/ethernet/include/eth_phy/phy.h" 3 4
_Bool 
# 55 "C:/esp/esp-idf/components/ethernet/include/eth_phy/phy.h"
    phy_mii_get_partner_pause_enable(void);
# 16 "C:/esp/esp-idf/components/ethernet/eth_phy/phy_common.c" 2
# 1 "C:/esp/esp-idf/components/ethernet/include/eth_phy/phy_reg.h" 1
# 15 "C:/esp/esp-idf/components/ethernet/include/eth_phy/phy_reg.h"
       
# 17 "C:/esp/esp-idf/components/ethernet/eth_phy/phy_common.c" 2
...
# 18 "C:/esp/esp-idf/components/ethernet/eth_phy/phy_common.c" 2
...
# 19 "C:/esp/esp-idf/components/ethernet/eth_phy/phy_common.c" 2
...
void phy_rmii_configure_data_interface_pins(void)
{
    ...
    ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff49000 +0x2c)))) = (((({ ; (*(volatile uint32_t *)((0x3ff49000 +0x2c))); }) & ~((0x7) << (12)))|(((5) & (0x7))<<(12)))); })); });


    ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff49000 +0x74)))) = (((({ ; (*(volatile uint32_t *)((0x3ff49000 +0x74))); }) & ~((0x7) << (12)))|(((5) & (0x7))<<(12)))); })); });

    ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff49000 +0x7c)))) = (((({ ; (*(volatile uint32_t *)((0x3ff49000 +0x7c))); }) & ~((0x7) << (12)))|(((5) & (0x7))<<(12)))); })); });

    ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff49000 +0x80)))) = (((({ ; (*(volatile uint32_t *)((0x3ff49000 +0x80))); }) & ~((0x7) << (12)))|(((5) & (0x7))<<(12)))); })); });
...
# 55 "C:/esp/esp-idf/components/ethernet/eth_phy/phy_common.c" 3 4
_Bool 
# 55 "C:/esp/esp-idf/components/ethernet/eth_phy/phy_common.c"
    phy_mii_check_link_status(void)
{
    if ((esp_eth_smi_read((0x1)) & (1UL << (2)))) {
        ...
        return 
# 59 "C:/esp/esp-idf/components/ethernet/eth_phy/phy_common.c" 3 4
              1
# 59 "C:/esp/esp-idf/components/ethernet/eth_phy/phy_common.c"
                  ;
    } else {
        if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "phy_mii_check_link_status(DOWN)" "\033[0m" "\n", esp_log_timestamp(), TAG); };
        return 
# 62 "C:/esp/esp-idf/components/ethernet/eth_phy/phy_common.c" 3 4
              0
# 62 "C:/esp/esp-idf/components/ethernet/eth_phy/phy_common.c"
                   ;
    }
}


# 66 "C:/esp/esp-idf/components/ethernet/eth_phy/phy_common.c" 3 4
_Bool 
# 66 "C:/esp/esp-idf/components/ethernet/eth_phy/phy_common.c"
    phy_mii_get_partner_pause_enable(void)
{
    if((esp_eth_smi_read((0x5)) & (1UL << (10)))) {
        ...
        return 
# 70 "C:/esp/esp-idf/components/ethernet/eth_phy/phy_common.c" 3 4
              1
# 70 "C:/esp/esp-idf/components/ethernet/eth_phy/phy_common.c"
                  ;
    } else {
        if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "phy_mii_get_partner_pause_enable(FALSE)" "\033[0m" "\n", esp_log_timestamp(), TAG); };
        return 
# 73 "C:/esp/esp-idf/components/ethernet/eth_phy/phy_common.c" 3 4
              0
# 73 "C:/esp/esp-idf/components/ethernet/eth_phy/phy_common.c"
                   ;
    }
}
