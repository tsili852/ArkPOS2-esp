# 1 "C:/esp/esp-idf/components/driver/gpio.c"
# 1 "C:\\esp\\esp32-ArkPOS2\\ArkPOS2-esp\\build\\driver//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/driver/gpio.c"
# 14 "C:/esp/esp-idf/components/driver/gpio.c"
...
# 15 "C:/esp/esp-idf/components/driver/gpio.c" 2
...
# 16 "C:/esp/esp-idf/components/driver/gpio.c" 2
...
# 17 "C:/esp/esp-idf/components/driver/gpio.c" 2
...
# 18 "C:/esp/esp-idf/components/driver/gpio.c" 2
...
# 19 "C:/esp/esp-idf/components/driver/gpio.c" 2
...
# 22 "C:/esp/esp-idf/components/driver/gpio.c" 2
...
# 24 "C:/esp/esp-idf/components/driver/gpio.c" 2
...
# 80 "C:/esp/esp-idf/components/driver/gpio.c" 3 4
                                       ((void *)0)
# 80 "C:/esp/esp-idf/components/driver/gpio.c"
                                           ;
...
# 183 "C:/esp/esp-idf/components/driver/gpio.c" 3 4
                                               0
# 183 "C:/esp/esp-idf/components/driver/gpio.c"
                                                    , 
# 183 "C:/esp/esp-idf/components/driver/gpio.c" 3 4
                                                      0
# 183 "C:/esp/esp-idf/components/driver/gpio.c"
...
void __attribute__((section(".iram1"))) gpio_intr_service(void* arg)
{
    ...
    if (gpio_isr_func == 
# 353 "C:/esp/esp-idf/components/driver/gpio.c" 3 4
                        ((void *)0)
# 353 "C:/esp/esp-idf/components/driver/gpio.c"
                            ) {
        return;
    }
    do {
...
# 359 "C:/esp/esp-idf/components/driver/gpio.c" 3 4
                                                 ((void *)0)
# 359 "C:/esp/esp-idf/components/driver/gpio.c"
                                                     ) {
            ...
            if (gpio_intr_status_h & (1UL << (gpio_num - 32))) {
                if (gpio_isr_func[gpio_num].fn != 
# 366 "C:/esp/esp-idf/components/driver/gpio.c" 3 4
                                                 ((void *)0)
# 366 "C:/esp/esp-idf/components/driver/gpio.c"
                                                     ) {
                    gpio_isr_func[gpio_num].fn(gpio_isr_func[gpio_num].args);
                }
...
{
    if (!(gpio_isr_func != 
# 377 "C:/esp/esp-idf/components/driver/gpio.c" 3 4
   ((void *)0)
# 377 "C:/esp/esp-idf/components/driver/gpio.c"
...
{
    if (!(gpio_isr_func != 
# 392 "C:/esp/esp-idf/components/driver/gpio.c" 3 4
   ((void *)0)
# 392 "C:/esp/esp-idf/components/driver/gpio.c"
...
# 397 "C:/esp/esp-idf/components/driver/gpio.c" 3 4
                                    ((void *)0)
# 397 "C:/esp/esp-idf/components/driver/gpio.c"
                                        ;
        gpio_isr_func[gpio_num].args = 
# 398 "C:/esp/esp-idf/components/driver/gpio.c" 3 4
                                      ((void *)0)
# 398 "C:/esp/esp-idf/components/driver/gpio.c"
                                          ;
    }
    vTaskExitCritical(&gpio_spinlock);
    return 0;
...
{
    if (!(gpio_isr_func == 
# 406 "C:/esp/esp-idf/components/driver/gpio.c" 3 4
   ((void *)0)
# 406 "C:/esp/esp-idf/components/driver/gpio.c"
    ...
    if (gpio_isr_func == 
# 410 "C:/esp/esp-idf/components/driver/gpio.c" 3 4
                        ((void *)0)
# 410 "C:/esp/esp-idf/components/driver/gpio.c"
                            ) {
        ret = 0x101;
    } else {
        ret = gpio_isr_register(gpio_intr_service, 
# 413 "C:/esp/esp-idf/components/driver/gpio.c" 3 4
                                                  ((void *)0)
# 413 "C:/esp/esp-idf/components/driver/gpio.c"
...
{
    if (gpio_isr_func == 
# 421 "C:/esp/esp-idf/components/driver/gpio.c" 3 4
                        ((void *)0)
# 421 "C:/esp/esp-idf/components/driver/gpio.c"
                            ) {
        return;
    }
    vTaskEnterCritical(&gpio_spinlock);
    ...
    free(gpio_isr_func);
    gpio_isr_func = 
# 427 "C:/esp/esp-idf/components/driver/gpio.c" 3 4
                   ((void *)0)
# 427 "C:/esp/esp-idf/components/driver/gpio.c"
                       ;
    vTaskExitCritical(&gpio_spinlock);
    return;
}
...
esp_err_t gpio_get_drive_capability(gpio_num_t gpio_num, gpio_drive_cap_t* strength)
{
    ...
    if (!(strength != 
# 476 "C:/esp/esp-idf/components/driver/gpio.c" 3 4
   ((void *)0)
# 476 "C:/esp/esp-idf/components/driver/gpio.c"
