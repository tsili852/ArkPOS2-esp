# 1 "C:/esp/esp-idf/components/driver/spi_slave.c"
# 1 "C:\\esp\\ArkPOS2-esp\\build\\driver//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/driver/spi_slave.c"
# 15 "C:/esp/esp-idf/components/driver/spi_slave.c"
...
# 16 "C:/esp/esp-idf/components/driver/spi_slave.c" 2
...
# 17 "C:/esp/esp-idf/components/driver/spi_slave.c" 2
# 1 "C:/esp/esp-idf/components/driver/include/driver/spi_slave.h" 1
# 20 "C:/esp/esp-idf/components/driver/include/driver/spi_slave.h"
...
# 21 "C:/esp/esp-idf/components/driver/include/driver/spi_slave.h" 2
...
# 22 "C:/esp/esp-idf/components/driver/include/driver/spi_slave.h" 2
# 36 "C:/esp/esp-idf/components/driver/include/driver/spi_slave.h"
...
# 82 "C:/esp/esp-idf/components/driver/include/driver/spi_slave.h"
...
# 93 "C:/esp/esp-idf/components/driver/include/driver/spi_slave.h"
esp_err_t spi_slave_free(spi_host_device_t host);
# 116 "C:/esp/esp-idf/components/driver/include/driver/spi_slave.h"
esp_err_t spi_slave_queue_trans(spi_host_device_t host, const spi_slave_transaction_t *trans_desc, TickType_t ticks_to_wait);
# 138 "C:/esp/esp-idf/components/driver/include/driver/spi_slave.h"
esp_err_t spi_slave_get_trans_result(spi_host_device_t host, spi_slave_transaction_t **trans_desc, TickType_t ticks_to_wait);
# 158 "C:/esp/esp-idf/components/driver/include/driver/spi_slave.h"
esp_err_t spi_slave_transmit(spi_host_device_t host, spi_slave_transaction_t *trans_desc, TickType_t ticks_to_wait);
# 18 "C:/esp/esp-idf/components/driver/spi_slave.c" 2

# 1 "C:/esp/esp-idf/components/soc/esp32/include/soc/spi_reg.h" 1
# 20 "C:/esp/esp-idf/components/driver/spi_slave.c" 2
...
# 21 "C:/esp/esp-idf/components/driver/spi_slave.c" 2
...
# 28 "C:/esp/esp-idf/components/driver/spi_slave.c" 2
...
# 33 "C:/esp/esp-idf/components/driver/spi_slave.c" 2
...
# 34 "C:/esp/esp-idf/components/driver/spi_slave.c" 2
...
# 36 "C:/esp/esp-idf/components/driver/spi_slave.c" 2
...
# 40 "C:/esp/esp-idf/components/driver/spi_slave.c" 2
...
# 174 "C:/esp/esp-idf/components/heap/include/esp_heap_caps.h"
                                                  print_errors);
# 41 "C:/esp/esp-idf/components/driver/spi_slave.c" 2

static const char *SPI_TAG = "spi_slave";
# 51 "C:/esp/esp-idf/components/driver/spi_slave.c"
typedef struct {
...
# 58 "C:/esp/esp-idf/components/driver/spi_slave.c" 3 4
   _Bool 
# 58 "C:/esp/esp-idf/components/driver/spi_slave.c"
        no_gpio_matrix;
    int max_transfer_sz;
...
# 71 "C:/esp/esp-idf/components/driver/spi_slave.c" 3 4
   _Bool 
# 71 "C:/esp/esp-idf/components/driver/spi_slave.c"
        native, claimed;
    ...
    if (spihost[host] == 
# 79 "C:/esp/esp-idf/components/driver/spi_slave.c" 3 4
                        ((void *)0)
# 79 "C:/esp/esp-idf/components/driver/spi_slave.c"
                            ) goto nomem;
...
# 85 "C:/esp/esp-idf/components/driver/spi_slave.c" 3 4
                                                                          0
# 85 "C:/esp/esp-idf/components/driver/spi_slave.c"
                                                                               );
...
# 126 "C:/esp/esp-idf/components/driver/spi_slave.c" 3 4
   _Bool 
# 126 "C:/esp/esp-idf/components/driver/spi_slave.c"
        nodelay = 
# 126 "C:/esp/esp-idf/components/driver/spi_slave.c" 3 4
                  1
# 126 "C:/esp/esp-idf/components/driver/spi_slave.c"
...
nomem:
    ...
    free(spihost[host]);
    spihost[host] = 
# 180 "C:/esp/esp-idf/components/driver/spi_slave.c" 3 4
                   ((void *)0)
# 180 "C:/esp/esp-idf/components/driver/spi_slave.c"
                       ;
...
esp_err_t spi_slave_free(spi_host_device_t host)
{
    ...
    free(spihost[host]);
    spihost[host] = 
# 194 "C:/esp/esp-idf/components/driver/spi_slave.c" 3 4
                   ((void *)0)
# 194 "C:/esp/esp-idf/components/driver/spi_slave.c"
                       ;
    spicommon_periph_free(host);
    spihost[host] = 
# 196 "C:/esp/esp-idf/components/driver/spi_slave.c" 3 4
                   ((void *)0)
# 196 "C:/esp/esp-idf/components/driver/spi_slave.c"
                       ;
    return 0;
}
...
# 206 "C:/esp/esp-idf/components/driver/spi_slave.c" 3 4
   ((void *)0) 
# 206 "C:/esp/esp-idf/components/driver/spi_slave.c"
...
# 208 "C:/esp/esp-idf/components/driver/spi_slave.c" 3 4
   ((void *)0) 
# 208 "C:/esp/esp-idf/components/driver/spi_slave.c"
...
esp_err_t spi_slave_transmit(spi_host_device_t host, spi_slave_transaction_t *trans_desc, TickType_t ticks_to_wait)
{
    ...
    if (ret != 0) return ret;
    ((ret_trans == trans_desc) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/driver/spi_slave.c", 239, __func__, "ret_trans == trans_desc"));
    return 0;
}
# 267 "C:/esp/esp-idf/components/driver/spi_slave.c"
...
# 280 "C:/esp/esp-idf/components/driver/spi_slave.c" 3 4
                                    ((void *)0)
# 280 "C:/esp/esp-idf/components/driver/spi_slave.c"
                                        ;
    spi_slave_t *host = (spi_slave_t *)arg;
    ...
    if (host->cur_trans) {
        ...
        host->cur_trans = 
# 316 "C:/esp/esp-idf/components/driver/spi_slave.c" 3 4
                         ((void *)0)
# 316 "C:/esp/esp-idf/components/driver/spi_slave.c"
                             ;
    }
    if (host->dma_chan != 0) {
...
# 351 "C:/esp/esp-idf/components/driver/spi_slave.c" 3 4
                                                                                                             1
# 351 "C:/esp/esp-idf/components/driver/spi_slave.c"
                                                                                                                 );
...
# 357 "C:/esp/esp-idf/components/driver/spi_slave.c" 3 4
                                                                                                           0
# 357 "C:/esp/esp-idf/components/driver/spi_slave.c"
                                                                                                                );
...
# 389 "C:/esp/esp-idf/components/driver/spi_slave.c" 3 4
                                                      ((void *)0)
# 389 "C:/esp/esp-idf/components/driver/spi_slave.c"
                                                          ) ? 0 : 1;
        host->hw->user.usr_miso = (trans->rx_buffer == 
# 390 "C:/esp/esp-idf/components/driver/spi_slave.c" 3 4
                                                      ((void *)0)
# 390 "C:/esp/esp-idf/components/driver/spi_slave.c"
                                                          ) ? 0 : 1;
