# 1 "C:/esp/esp-idf/components/driver/mcpwm.c"
# 1 "C:\\esp\\ArkPOS2-esp\\build\\driver//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/driver/mcpwm.c"
# 15 "C:/esp/esp-idf/components/driver/mcpwm.c"
...
# 16 "C:/esp/esp-idf/components/driver/mcpwm.c" 2
...
# 17 "C:/esp/esp-idf/components/driver/mcpwm.c" 2
...
# 18 "C:/esp/esp-idf/components/driver/mcpwm.c" 2
...
# 19 "C:/esp/esp-idf/components/driver/mcpwm.c" 2
...
# 20 "C:/esp/esp-idf/components/driver/mcpwm.c" 2
...
# 21 "C:/esp/esp-idf/components/driver/mcpwm.c" 2
...
# 22 "C:/esp/esp-idf/components/driver/mcpwm.c" 2
...
# 24 "C:/esp/esp-idf/components/driver/mcpwm.c" 2
# 1 "C:/esp/esp-idf/components/soc/esp32/include/soc/mcpwm_reg.h" 1
# 25 "C:/esp/esp-idf/components/driver/mcpwm.c" 2
# 1 "C:/esp/esp-idf/components/soc/esp32/include/soc/mcpwm_struct.h" 1
# 21 "C:/esp/esp-idf/components/soc/esp32/include/soc/mcpwm_struct.h"
typedef volatile struct {
    union {
        struct {
            uint32_t prescale: 8;
...
# 26 "C:/esp/esp-idf/components/driver/mcpwm.c" 2


# 1 "C:/esp/esp-idf/components/driver/include/driver/mcpwm.h" 1
# 21 "C:/esp/esp-idf/components/driver/include/driver/mcpwm.h"
# 1 "C:/esp/esp-idf/components/driver/include/driver/periph_ctrl.h" 1
# 19 "C:/esp/esp-idf/components/driver/include/driver/periph_ctrl.h"
...
# 20 "C:/esp/esp-idf/components/driver/include/driver/periph_ctrl.h" 2
...
# 22 "C:/esp/esp-idf/components/driver/include/driver/mcpwm.h" 2
# 36 "C:/esp/esp-idf/components/driver/include/driver/mcpwm.h"
typedef enum {
    MCPWM0A = 0,
    MCPWM0B,
    MCPWM1A,
...
# 67 "C:/esp/esp-idf/components/driver/mcpwm.c"
    ...
    if (mcpwm_num == MCPWM_UNIT_0) {
        ...
        if (mcpwm_gpio_sig) {
            if (!((((((gpio_num < 40 && GPIO_PIN_MUX_REG[gpio_num] != 0))) && (gpio_num < 34))))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 79, __FUNCTION__, "MCPWM GPIO NUM ERROR"); }; return (0x102); };
            gpio_set_direction(gpio_num, GPIO_MODE_OUTPUT);
...
esp_err_t mcpwm_set_pin(mcpwm_unit_t mcpwm_num, const mcpwm_pin_config_t *mcpwm_pin)
{
    if (!(mcpwm_num < MCPWM_UNIT_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 95, __FUNCTION__, "MCPWM UNIT NUM ERROR"); }; return (0x102); };
...
esp_err_t mcpwm_start(mcpwm_unit_t mcpwm_num, mcpwm_timer_t timer_num)
{
    if (!(mcpwm_num < MCPWM_UNIT_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 117, __FUNCTION__, "MCPWM UNIT NUM ERROR"); }; return (0x102); };
    if (!(timer_num < MCPWM_TIMER_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 118, __FUNCTION__, "MCPWM TIMER NUM ERROR"); }; return (0x102); };
...
esp_err_t mcpwm_stop(mcpwm_unit_t mcpwm_num, mcpwm_timer_t timer_num)
{
    if (!(mcpwm_num < MCPWM_UNIT_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 127, __FUNCTION__, "MCPWM UNIT NUM ERROR"); }; return (0x102); };
    if (!(timer_num < MCPWM_TIMER_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 128, __FUNCTION__, "MCPWM TIMER NUM ERROR"); }; return (0x102); };
    vTaskEnterCritical(&mcpwm_spinlock);
...
esp_err_t mcpwm_set_frequency(mcpwm_unit_t mcpwm_num, mcpwm_timer_t timer_num, uint32_t frequency)
{
    ...
    if (!(mcpwm_num < MCPWM_UNIT_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 140, __FUNCTION__, "MCPWM UNIT NUM ERROR"); }; return (0x102); };
    if (!(timer_num < MCPWM_TIMER_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 141, __FUNCTION__, "MCPWM TIMER NUM ERROR"); }; return (0x102); };
    vTaskEnterCritical(&mcpwm_spinlock);
...
{
    uint32_t set_duty;
    if (!(mcpwm_num < MCPWM_UNIT_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 161, __FUNCTION__, "MCPWM UNIT NUM ERROR"); }; return (0x102); };
    if (!(timer_num < MCPWM_TIMER_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 162, __FUNCTION__, "MCPWM TIMER NUM ERROR"); }; return (0x102); };
    if (!(op_num < MCPWM_OPR_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 163, __FUNCTION__, "MCPWM OPERATOR ERROR"); }; return (0x102); };
    vTaskEnterCritical(&mcpwm_spinlock);
...
esp_err_t mcpwm_set_duty_in_us(mcpwm_unit_t mcpwm_num, mcpwm_timer_t timer_num, mcpwm_operator_t op_num, uint32_t duty)
{
    if (!(mcpwm_num < MCPWM_UNIT_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 174, __FUNCTION__, "MCPWM UNIT NUM ERROR"); }; return (0x102); };
    if (!(timer_num < MCPWM_TIMER_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 175, __FUNCTION__, "MCPWM TIMER NUM ERROR"); }; return (0x102); };
    if (!(op_num < MCPWM_OPR_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 176, __FUNCTION__, "MCPWM OPERATOR ERROR"); }; return (0x102); };
    vTaskEnterCritical(&mcpwm_spinlock);
...
{
    if (!(mcpwm_num < MCPWM_UNIT_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 187, __FUNCTION__, "MCPWM UNIT NUM ERROR"); }; return (0x102); };
    if (!(timer_num < MCPWM_TIMER_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 188, __FUNCTION__, "MCPWM TIMER NUM ERROR"); }; return (0x102); };
    if (!(op_num < MCPWM_OPR_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 189, __FUNCTION__, "MCPWM OPERATOR ERROR"); }; return (0x102); };
    if (!(duty_num < MCPWM_DUTY_MODE_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 190, __FUNCTION__, "MCPWM DUTY TYPE ERROR"); }; return (0x102); };
    vTaskEnterCritical(&mcpwm_spinlock);
...
esp_err_t mcpwm_init(mcpwm_unit_t mcpwm_num, mcpwm_timer_t timer_num, const mcpwm_config_t *mcpwm_conf)
{
    if (!(mcpwm_num < MCPWM_UNIT_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 264, __FUNCTION__, "MCPWM UNIT NUM ERROR"); }; return (0x102); };
    if (!(timer_num < MCPWM_TIMER_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 265, __FUNCTION__, "MCPWM TIMER NUM ERROR"); }; return (0x102); };
    periph_module_enable(PERIPH_PWM0_MODULE + mcpwm_num);
    vTaskEnterCritical(&mcpwm_spinlock);
...
{
    uint32_t frequency;
    if (!(mcpwm_num < MCPWM_UNIT_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 289, __FUNCTION__, "MCPWM UNIT NUM ERROR"); }; return (0x102); };
    if (!(timer_num < MCPWM_TIMER_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 290, __FUNCTION__, "MCPWM TIMER NUM ERROR"); }; return (0x102); };
...
{
    float duty;
    if (!(mcpwm_num < MCPWM_UNIT_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 298, __FUNCTION__, "MCPWM UNIT NUM ERROR"); }; return (0x102); };
    if (!(timer_num < MCPWM_TIMER_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 299, __FUNCTION__, "MCPWM TIMER NUM ERROR"); }; return (0x102); };
    if (!(op_num < MCPWM_OPR_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 300, __FUNCTION__, "MCPWM OPERATOR ERROR"); }; return (0x102); };
    vTaskEnterCritical(&mcpwm_spinlock);
...
esp_err_t mcpwm_set_signal_high(mcpwm_unit_t mcpwm_num, mcpwm_timer_t timer_num, mcpwm_operator_t op_num)
{
    if (!(mcpwm_num < MCPWM_UNIT_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 309, __FUNCTION__, "MCPWM UNIT NUM ERROR"); }; return (0x102); };
    if (!(timer_num < MCPWM_TIMER_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 310, __FUNCTION__, "MCPWM TIMER NUM ERROR"); }; return (0x102); };
    if (!(op_num < MCPWM_OPR_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 311, __FUNCTION__, "MCPWM OPERATOR ERROR"); }; return (0x102); };
    vTaskEnterCritical(&mcpwm_spinlock);
    if (op_num == MCPWM_OPR_A) {
        MCPWM[mcpwm_num]->channel[timer_num].generator[op_num].utez = 2;
        MCPWM[mcpwm_num]->channel[timer_num].generator[op_num].utea = 2;
...
esp_err_t mcpwm_set_signal_low(mcpwm_unit_t mcpwm_num, mcpwm_timer_t timer_num, mcpwm_operator_t op_num)
{
    if (!(mcpwm_num < MCPWM_UNIT_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 335, __FUNCTION__, "MCPWM UNIT NUM ERROR"); }; return (0x102); };
    if (!(timer_num < MCPWM_TIMER_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 336, __FUNCTION__, "MCPWM TIMER NUM ERROR"); }; return (0x102); };
    if (!(op_num < MCPWM_OPR_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 337, __FUNCTION__, "MCPWM OPERATOR ERROR"); }; return (0x102); };
    vTaskEnterCritical(&mcpwm_spinlock);
    if (op_num == 0) {
        MCPWM[mcpwm_num]->channel[timer_num].generator[op_num].utez = 1;
        MCPWM[mcpwm_num]->channel[timer_num].generator[op_num].utea = 1;
...
esp_err_t mcpwm_carrier_enable(mcpwm_unit_t mcpwm_num, mcpwm_timer_t timer_num)
{
    if (!(mcpwm_num < MCPWM_UNIT_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 360, __FUNCTION__, "MCPWM UNIT NUM ERROR"); }; return (0x102); };
    if (!(timer_num < MCPWM_TIMER_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 361, __FUNCTION__, "MCPWM TIMER NUM ERROR"); }; return (0x102); };
    vTaskEnterCritical(&mcpwm_spinlock);
...
esp_err_t mcpwm_carrier_disable(mcpwm_unit_t mcpwm_num, mcpwm_timer_t timer_num)
{
    if (!(mcpwm_num < MCPWM_UNIT_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 370, __FUNCTION__, "MCPWM UNIT NUM ERROR"); }; return (0x102); };
    if (!(timer_num < MCPWM_TIMER_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 371, __FUNCTION__, "MCPWM TIMER NUM ERROR"); }; return (0x102); };
    vTaskEnterCritical(&mcpwm_spinlock);
...
esp_err_t mcpwm_carrier_set_period(mcpwm_unit_t mcpwm_num, mcpwm_timer_t timer_num, uint8_t carrier_period)
{
    if (!(mcpwm_num < MCPWM_UNIT_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 380, __FUNCTION__, "MCPWM UNIT NUM ERROR"); }; return (0x102); };
    if (!(timer_num < MCPWM_TIMER_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 381, __FUNCTION__, "MCPWM TIMER NUM ERROR"); }; return (0x102); };
    vTaskEnterCritical(&mcpwm_spinlock);
...
esp_err_t mcpwm_carrier_set_duty_cycle(mcpwm_unit_t mcpwm_num, mcpwm_timer_t timer_num, uint8_t carrier_duty)
{
    if (!(mcpwm_num < MCPWM_UNIT_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 389, __FUNCTION__, "MCPWM UNIT NUM ERROR"); }; return (0x102); };
    if (!(timer_num < MCPWM_TIMER_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 390, __FUNCTION__, "MCPWM TIMER NUM ERROR"); }; return (0x102); };
    vTaskEnterCritical(&mcpwm_spinlock);
...
{
    if (!(mcpwm_num < MCPWM_UNIT_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 399, __FUNCTION__, "MCPWM UNIT NUM ERROR"); }; return (0x102); };
    if (!(timer_num < MCPWM_TIMER_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 400, __FUNCTION__, "MCPWM TIMER NUM ERROR"); }; return (0x102); };
    vTaskEnterCritical(&mcpwm_spinlock);
...
{
    if (!(mcpwm_num < MCPWM_UNIT_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 409, __FUNCTION__, "MCPWM UNIT NUM ERROR"); }; return (0x102); };
    if (!(timer_num < MCPWM_TIMER_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 410, __FUNCTION__, "MCPWM TIMER NUM ERROR"); }; return (0x102); };
    vTaskEnterCritical(&mcpwm_spinlock);
...
esp_err_t mcpwm_carrier_output_invert(mcpwm_unit_t mcpwm_num, mcpwm_timer_t timer_num,
                                      mcpwm_carrier_out_ivt_t carrier_ivt_mode)
{
    if (!(mcpwm_num < MCPWM_UNIT_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 420, __FUNCTION__, "MCPWM UNIT NUM ERROR"); }; return (0x102); };
    if (!(timer_num < MCPWM_TIMER_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 421, __FUNCTION__, "MCPWM TIMER NUM ERROR"); }; return (0x102); };
    vTaskEnterCritical(&mcpwm_spinlock);
...
esp_err_t mcpwm_carrier_init(mcpwm_unit_t mcpwm_num, mcpwm_timer_t timer_num, const mcpwm_carrier_config_t *carrier_conf)
{
    if (!(mcpwm_num < MCPWM_UNIT_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 430, __FUNCTION__, "MCPWM UNIT NUM ERROR"); }; return (0x102); };
    if (!(timer_num < MCPWM_TIMER_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 431, __FUNCTION__, "MCPWM TIMER NUM ERROR"); }; return (0x102); };
    vTaskEnterCritical(&mcpwm_spinlock);
...
esp_err_t mcpwm_deadtime_enable(mcpwm_unit_t mcpwm_num, mcpwm_timer_t timer_num, mcpwm_deadtime_type_t dt_mode,
                                uint32_t red, uint32_t fed)
{
    if (!(mcpwm_num < MCPWM_UNIT_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 450, __FUNCTION__, "MCPWM UNIT NUM ERROR"); }; return (0x102); };
    if (!(timer_num < MCPWM_TIMER_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 451, __FUNCTION__, "MCPWM TIMER NUM ERROR"); }; return (0x102); };
    if (!(dt_mode < MCPWM_DEADTIME_TYPE_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 452, __FUNCTION__, "MCPWM DEADTIME TYPE ERROR"); }; return (0x102); };
    vTaskEnterCritical(&mcpwm_spinlock);
...
esp_err_t mcpwm_deadtime_disable(mcpwm_unit_t mcpwm_num, mcpwm_timer_t timer_num)
{
    if (!(mcpwm_num < MCPWM_UNIT_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 533, __FUNCTION__, "MCPWM UNIT NUM ERROR"); }; return (0x102); };
    if (!(timer_num < MCPWM_TIMER_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 534, __FUNCTION__, "MCPWM TIMER NUM ERROR"); }; return (0x102); };
    vTaskEnterCritical(&mcpwm_spinlock);
    MCPWM[mcpwm_num]->channel[timer_num].db_cfg.b_outbypass = 1;
    MCPWM[mcpwm_num]->channel[timer_num].db_cfg.a_outbypass = 1;
    MCPWM[mcpwm_num]->channel[timer_num].db_cfg.red_outinvert = 0;
...
esp_err_t mcpwm_fault_init(mcpwm_unit_t mcpwm_num, mcpwm_fault_input_level_t intput_level, mcpwm_fault_signal_t fault_sig)
{
    if (!(mcpwm_num < MCPWM_UNIT_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 551, __FUNCTION__, "MCPWM UNIT NUM ERROR"); }; return (0x102); };
    vTaskEnterCritical(&mcpwm_spinlock);
    switch (fault_sig) {
...
esp_err_t mcpwm_fault_deinit(mcpwm_unit_t mcpwm_num, mcpwm_fault_signal_t fault_sig)
{
    if (!(mcpwm_num < MCPWM_UNIT_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 576, __FUNCTION__, "MCPWM UNIT NUM ERROR"); }; return (0x102); };
    vTaskEnterCritical(&mcpwm_spinlock);
...
esp_err_t mcpwm_fault_set_cyc_mode(mcpwm_unit_t mcpwm_num, mcpwm_timer_t timer_num, mcpwm_fault_signal_t fault_sig,
                                   mcpwm_action_on_pwmxa_t action_on_pwmxa, mcpwm_action_on_pwmxb_t action_on_pwmxb)
{
    if (!(mcpwm_num < MCPWM_UNIT_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 592, __FUNCTION__, "MCPWM UNIT NUM ERROR"); }; return (0x102); };
    if (!(timer_num < MCPWM_TIMER_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 593, __FUNCTION__, "MCPWM TIMER NUM ERROR"); }; return (0x102); };
    vTaskEnterCritical(&mcpwm_spinlock);
...
esp_err_t mcpwm_fault_set_oneshot_mode(mcpwm_unit_t mcpwm_num, mcpwm_timer_t timer_num, mcpwm_fault_signal_t fault_sig,
                                       mcpwm_action_on_pwmxa_t action_on_pwmxa, mcpwm_action_on_pwmxb_t action_on_pwmxb)
{
    if (!(mcpwm_num < MCPWM_UNIT_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 625, __FUNCTION__, "MCPWM UNIT NUM ERROR"); }; return (0x102); };
    if (!(timer_num < MCPWM_TIMER_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 626, __FUNCTION__, "MCPWM TIMER NUM ERROR"); }; return (0x102); };
    vTaskEnterCritical(&mcpwm_spinlock);
    if (fault_sig == MCPWM_SELECT_F0) {
...
esp_err_t mcpwm_capture_enable(mcpwm_unit_t mcpwm_num, mcpwm_capture_signal_t cap_sig, mcpwm_capture_on_edge_t cap_edge,
                               uint32_t num_of_pulse)
{
    if (!(mcpwm_num < MCPWM_UNIT_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 657, __FUNCTION__, "MCPWM UNIT NUM ERROR"); }; return (0x102); };
    vTaskEnterCritical(&mcpwm_spinlock);
...
esp_err_t mcpwm_capture_disable(mcpwm_unit_t mcpwm_num, mcpwm_capture_signal_t cap_sig)
{
    if (!(mcpwm_num < MCPWM_UNIT_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 669, __FUNCTION__, "MCPWM UNIT NUM ERROR"); }; return (0x102); };
    vTaskEnterCritical(&mcpwm_spinlock);
...
uint32_t mcpwm_capture_signal_get_value(mcpwm_unit_t mcpwm_num, mcpwm_capture_signal_t cap_sig)
{
    if (!(mcpwm_num < MCPWM_UNIT_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 678, __FUNCTION__, "MCPWM UNIT NUM ERROR"); }; return (0x102); };
    return MCPWM[mcpwm_num]->cap_val_ch[cap_sig];
}

uint32_t mcpwm_capture_signal_get_edge(mcpwm_unit_t mcpwm_num, mcpwm_capture_signal_t cap_sig)
{
    if (!(mcpwm_num < MCPWM_UNIT_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 684, __FUNCTION__, "MCPWM UNIT NUM ERROR"); }; return (0x102); };
...
{
    uint32_t set_phase;
    if (!(mcpwm_num < MCPWM_UNIT_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 699, __FUNCTION__, "MCPWM UNIT NUM ERROR"); }; return (0x102); };
    if (!(timer_num < MCPWM_TIMER_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 700, __FUNCTION__, "MCPWM TIMER NUM ERROR"); }; return (0x102); };
    vTaskEnterCritical(&mcpwm_spinlock);
...
esp_err_t mcpwm_sync_disable(mcpwm_unit_t mcpwm_num, mcpwm_timer_t timer_num)
{
    if (!(mcpwm_num < MCPWM_UNIT_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 719, __FUNCTION__, "MCPWM UNIT NUM ERROR"); }; return (0x102); };
    if (!(timer_num < MCPWM_TIMER_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 720, __FUNCTION__, "MCPWM TIMER NUM ERROR"); }; return (0x102); };
    vTaskEnterCritical(&mcpwm_spinlock);
...
{
    esp_err_t ret;
    if (!(mcpwm_num < MCPWM_UNIT_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 729, __FUNCTION__, "MCPWM UNIT NUM ERROR"); }; return (0x102); };
    if (!(fn != 
# 730 "C:/esp/esp-idf/components/driver/mcpwm.c" 3 4
   ((void *)0)
# 730 "C:/esp/esp-idf/components/driver/mcpwm.c"
   )) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, MCPWM_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), MCPWM_TAG, "C:/esp/esp-idf/components/driver/mcpwm.c", 730, __FUNCTION__, "MCPWM PARAM ADDR ERROR"); }; return (0x102); };
