# 1 "C:/esp/esp-idf/components/driver/sdmmc_host.c"
# 1 "C:\\esp\\ArkPOS2-esp\\build\\driver//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/driver/sdmmc_host.c"
# 15 "C:/esp/esp-idf/components/driver/sdmmc_host.c"
# 1 "c:\\msys32\\opt\\xtensa-esp32-elf\\lib\\gcc\\xtensa-esp32-elf\\5.2.0\\include\\stdbool.h" 1 3 4
# 16 "C:/esp/esp-idf/components/driver/sdmmc_host.c" 2
...
# 17 "C:/esp/esp-idf/components/driver/sdmmc_host.c" 2
...
# 18 "C:/esp/esp-idf/components/driver/sdmmc_host.c" 2
...
# 19 "C:/esp/esp-idf/components/driver/sdmmc_host.c" 2
...
# 20 "C:/esp/esp-idf/components/driver/sdmmc_host.c" 2
...
# 21 "C:/esp/esp-idf/components/driver/sdmmc_host.c" 2
# 1 "C:/esp/esp-idf/components/soc/esp32/include/soc/sdmmc_reg.h" 1
# 16 "C:/esp/esp-idf/components/soc/esp32/include/soc/sdmmc_reg.h"
# 1 "C:/esp/esp-idf/components/soc/esp32/include/soc/soc.h" 1
# 17 "C:/esp/esp-idf/components/soc/esp32/include/soc/sdmmc_reg.h" 2
# 22 "C:/esp/esp-idf/components/driver/sdmmc_host.c" 2
...
# 23 "C:/esp/esp-idf/components/driver/sdmmc_host.c" 2
# 1 "C:/esp/esp-idf/components/soc/esp32/include/soc/gpio_sig_map.h" 1
# 24 "C:/esp/esp-idf/components/driver/sdmmc_host.c" 2
...
# 25 "C:/esp/esp-idf/components/driver/sdmmc_host.c" 2
...
# 26 "C:/esp/esp-idf/components/driver/sdmmc_host.c" 2
...
# 27 "C:/esp/esp-idf/components/driver/sdmmc_host.c" 2
...
# 28 "C:/esp/esp-idf/components/driver/sdmmc_host.c" 2
...
# 21 "C:/esp/esp-idf/components/driver/sdmmc_private.h" 2
...
# 22 "C:/esp/esp-idf/components/driver/sdmmc_private.h" 2
...
# 29 "C:/esp/esp-idf/components/driver/sdmmc_host.c" 2
...
# 121 "C:/esp/esp-idf/components/driver/sdmmc_host.c"
...
# 148 "C:/esp/esp-idf/components/driver/sdmmc_host.c" 3 4
   _Bool 
# 148 "C:/esp/esp-idf/components/driver/sdmmc_host.c"
        repeat = 
# 148 "C:/esp/esp-idf/components/driver/sdmmc_host.c" 3 4
                 1
# 148 "C:/esp/esp-idf/components/driver/sdmmc_host.c"
    ...
    while(repeat) {
        ...
        while (
# 151 "C:/esp/esp-idf/components/driver/sdmmc_host.c" 3 4
              1
# 151 "C:/esp/esp-idf/components/driver/sdmmc_host.c"
                  ) {
            ...
            if (SDMMC.rintsts.hle) {
                SDMMC.rintsts.hle = 1;
                repeat = 
# 156 "C:/esp/esp-idf/components/driver/sdmmc_host.c" 3 4
                        1
# 156 "C:/esp/esp-idf/components/driver/sdmmc_host.c"
                            ;
                break;
            }
            ...
            if (SDMMC.cmd.start_command == 0) {
                repeat = 
# 162 "C:/esp/esp-idf/components/driver/sdmmc_host.c" 3 4
                        0
# 162 "C:/esp/esp-idf/components/driver/sdmmc_host.c"
                             ;
                break;
            }
        }
...
esp_err_t sdmmc_host_init()
{
    ...
    if (ret != 0) {
        ...
        s_event_queue = 
# 263 "C:/esp/esp-idf/components/driver/sdmmc_host.c" 3 4
                       ((void *)0)
# 263 "C:/esp/esp-idf/components/driver/sdmmc_host.c"
                           ;
        return ret;
    }
    ...
    if (ret != 0) {
        vQueueDelete(s_event_queue);
        s_event_queue = 
# 284 "C:/esp/esp-idf/components/driver/sdmmc_host.c" 3 4
                       ((void *)0)
# 284 "C:/esp/esp-idf/components/driver/sdmmc_host.c"
                           ;
        esp_intr_free(s_intr_handle);
        s_intr_handle = 
# 286 "C:/esp/esp-idf/components/driver/sdmmc_host.c" 3 4
                       ((void *)0)
# 286 "C:/esp/esp-idf/components/driver/sdmmc_host.c"
                           ;
        return ret;
    }
...
static inline void configure_pin(uint32_t io_mux_reg)
{
    ...
    ({ ; ({ ; (*((volatile uint32_t *)((io_mux_reg)))) = (uint32_t)((({ ; (*((volatile uint32_t *)(io_mux_reg))); })|(((1UL << (9)))))); }); });
    ({ ; (({ ; (*(volatile uint32_t *)((io_mux_reg))) = (((({ ; (*(volatile uint32_t *)(io_mux_reg)); }) & ~((0x7) << (12)))|(((sdmmc_func) & (0x7))<<(12)))); })); });
    ({ ; (({ ; (*(volatile uint32_t *)((io_mux_reg))) = (((({ ; (*(volatile uint32_t *)(io_mux_reg)); }) & ~((0x3) << (10)))|((((drive_strength)) & (0x3))<<(10)))); })); });;
}
...
esp_err_t sdmmc_host_init_slot(int slot, const sdmmc_slot_config_t* slot_config)
{
    ...
    if (slot_config == 
# 311 "C:/esp/esp-idf/components/driver/sdmmc_host.c" 3 4
                      ((void *)0)
# 311 "C:/esp/esp-idf/components/driver/sdmmc_host.c"
                          ) {
        return 0x102;
    }
...
esp_err_t sdmmc_host_deinit()
{
    ...
    esp_intr_free(s_intr_handle);
    s_intr_handle = 
# 368 "C:/esp/esp-idf/components/driver/sdmmc_host.c" 3 4
                   ((void *)0)
# 368 "C:/esp/esp-idf/components/driver/sdmmc_host.c"
                       ;
    vQueueDelete(s_event_queue);
    s_event_queue = 
# 370 "C:/esp/esp-idf/components/driver/sdmmc_host.c" 3 4
                   ((void *)0)
# 370 "C:/esp/esp-idf/components/driver/sdmmc_host.c"
                       ;
...
# 469 "C:/esp/esp-idf/components/driver/sdmmc_host.c"
static void sdmmc_isr(void* arg) {
