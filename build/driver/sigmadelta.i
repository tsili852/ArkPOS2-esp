...
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/driver/sigmadelta.c"
# 14 "C:/esp/esp-idf/components/driver/sigmadelta.c"
...
# 15 "C:/esp/esp-idf/components/driver/sigmadelta.c" 2

# 1 "C:/esp/esp-idf/components/driver/include/driver/periph_ctrl.h" 1
# 17 "C:/esp/esp-idf/components/driver/include/driver/periph_ctrl.h"
...
# 18 "C:/esp/esp-idf/components/driver/include/driver/periph_ctrl.h" 2
...
# 17 "C:/esp/esp-idf/components/driver/sigmadelta.c" 2
# 1 "C:/esp/esp-idf/components/driver/include/driver/sigmadelta.h" 1
# 17 "C:/esp/esp-idf/components/driver/include/driver/sigmadelta.h"
...
# 18 "C:/esp/esp-idf/components/driver/include/driver/sigmadelta.h" 2
# 1 "C:/esp/esp-idf/components/soc/esp32/include/soc/gpio_sd_struct.h" 1
# 21 "C:/esp/esp-idf/components/soc/esp32/include/soc/gpio_sd_struct.h"
...
# 19 "C:/esp/esp-idf/components/driver/include/driver/sigmadelta.h" 2
# 1 "C:/esp/esp-idf/components/soc/esp32/include/soc/gpio_sd_reg.h" 1
# 20 "C:/esp/esp-idf/components/driver/include/driver/sigmadelta.h" 2
...
# 21 "C:/esp/esp-idf/components/driver/include/driver/sigmadelta.h" 2
# 29 "C:/esp/esp-idf/components/driver/include/driver/sigmadelta.h"
typedef enum{
...
esp_err_t sigmadelta_set_prescale(sigmadelta_channel_t channel, uint8_t prescale)
{
    if(!(channel < SIGMADELTA_CHANNEL_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, SIGMADELTA_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), SIGMADELTA_TAG, "C:/esp/esp-idf/components/driver/sigmadelta.c", 47, __FUNCTION__, "SIGMADELTA CHANNEL ERROR"); }; return (0x102); };
...
esp_err_t sigmadelta_set_pin(sigmadelta_channel_t channel, gpio_num_t gpio_num)
{
    if(!(channel < SIGMADELTA_CHANNEL_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, SIGMADELTA_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), SIGMADELTA_TAG, "C:/esp/esp-idf/components/driver/sigmadelta.c", 54, __FUNCTION__, "SIGMADELTA CHANNEL ERROR"); }; return (0x102); };
    if(!(((((gpio_num < 40 && GPIO_PIN_MUX_REG[gpio_num] != 0))) && (gpio_num < 34)))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, SIGMADELTA_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), SIGMADELTA_TAG, "C:/esp/esp-idf/components/driver/sigmadelta.c", 55, __FUNCTION__, "SIGMADELTA GPIO NUM ERROR"); }; return (0x102); };
