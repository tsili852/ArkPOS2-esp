# 1 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c"
# 1 "C:\\esp\\ArkPOS2-esp\\build\\sdmmc//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c"
# 18 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c"
...
# 19 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c" 2
...
# 20 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c" 2
...
# 174 "C:/esp/esp-idf/components/heap/include/esp_heap_caps.h"
                                                  print_errors);
# 21 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c" 2
...
# 22 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c" 2
...
# 23 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c" 2
...
# 24 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c" 2
...
# 25 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c" 2
...
esp_err_t sdmmc_read_sectors(sdmmc_card_t* card, void* dst,
        size_t start_sector, size_t sector_count);
# 26 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c" 2
...
# 27 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c" 2
...
# 28 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c" 2
...
# 56 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c" 3 4
                                                              _Bool 
# 56 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c"
                                                                   crc_enable);
...
static 
# 65 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c" 3 4
      _Bool 
# 65 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c"
...
esp_err_t sdmmc_card_init(const sdmmc_host_t* config, sdmmc_card_t* card)
{
    ...
    const 
# 75 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c" 3 4
         _Bool 
# 75 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c"
...
# 111 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c"
    if (is_spi) {
        err = sdmmc_send_cmd_crc_on_off(card, 
# 112 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c" 3 4
                                             1
# 112 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c"
                                                 );
        if (err != 0) {
...
# 251 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c" 3 4
   _Bool 
# 251 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c"
        freq_switched = 
# 251 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c" 3 4
                        0
# 251 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c"
    ...
    if (config->max_freq_khz >= 40000 &&
        ...
        if (err == 0x106) {
            ...
            if (card->csd.tr_speed != 50000000) {
                ...
                freq_switched = 
# 297 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c" 3 4
                               1
# 297 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c"
                                   ;
            }
        }
    }
    ...
    if (!freq_switched &&
        ...
        freq_switched = 
# 312 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c" 3 4
                       1
# 312 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c"
                           ;
    }
...
static esp_err_t sdmmc_send_cmd_read_ocr(sdmmc_card_t *card, uint32_t *ocrp)
{
    ((ocrp) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c", 454, __func__, "ocrp"));
    sdmmc_command_t cmd = {
        .opcode = 58,
...
static esp_err_t sddmc_send_cmd_all_send_cid(sdmmc_card_t* card, sdmmc_cid_t* out_cid)
{
    ((out_cid) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c", 480, __func__, "out_cid"));
    sdmmc_command_t cmd = {
            .opcode = 2,
            .flags = 0x0030 | (0x1000|0x0400|0x0200)
    };
...
static esp_err_t sdmmc_send_cmd_send_cid(sdmmc_card_t *card, sdmmc_cid_t *out_cid)
{
    ((out_cid) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c", 494, __func__, "out_cid"));
    ((host_is_spi(card) && "SEND_CID should only be used in SPI mode") ? (void)0 : __assert_func ("C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c", 495, __func__, "host_is_spi(card) && \"SEND_CID should only be used in SPI mode\""));
...
static esp_err_t sdmmc_send_cmd_set_relative_addr(sdmmc_card_t* card, uint16_t* out_rca)
{
    ((out_rca) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c", 515, __func__, "out_rca"));
    sdmmc_command_t cmd = {
            .opcode = 3,
            .flags = 0x0030 | (0x1000|0x0400|0x0800)
    };
...
static esp_err_t sdmmc_send_cmd_send_csd(sdmmc_card_t* card, sdmmc_csd_t* out_csd)
{
    ...
    const 
# 577 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c" 3 4
         _Bool 
# 577 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c"
              is_spi = host_is_spi(card);
    sdmmc_command_t cmd = {
            .opcode = 9,
...
static esp_err_t sdmmc_send_cmd_send_scr(sdmmc_card_t* card, sdmmc_scr_t *out_scr)
{
    ...
    if (buf == 
# 628 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c" 3 4
              ((void *)0)
# 628 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c"
                  ) {
        return 0x101;
    }
    sdmmc_command_t cmd = {
...
static esp_err_t sdmmc_send_cmd_crc_on_off(sdmmc_card_t* card, 
# 671 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c" 3 4
                                                              _Bool 
# 671 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c"
                                                                   crc_enable)
{
    ((host_is_spi(card) && "CRC_ON_OFF can only be used in SPI mode") ? (void)0 : __assert_func ("C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c", 673, __func__, "host_is_spi(card) && \"CRC_ON_OFF can only be used in SPI mode\""));
    sdmmc_command_t cmd = {
            .opcode = 59,
            .arg = crc_enable ? 1 : 0,
            .flags = 0x0000 | (0x1000|0x0400|0x0800)
...
static void flip_byte_order(uint32_t* response, size_t size)
{
    ((size % (2 * sizeof(uint32_t)) == 0) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c", 692, __func__, "size % (2 * sizeof(uint32_t)) == 0"));
        ...
        size_t start_block, size_t block_count)
{
    ...
    if (esp_ptr_dma_capable(src) && (intptr_t)src % 4 == 0) {
        ...
        if (tmp_buf == 
# 731 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c" 3 4
                      ((void *)0)
# 731 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c"
                          ) {
            return 0x101;
        }
        ...
        size_t start_block, size_t block_count)
{
    ...
    if (esp_ptr_dma_capable(dst) && (intptr_t)dst % 4 == 0) {
        ...
        void* tmp_buf = heap_caps_malloc(block_size, (1<<3));
        if (tmp_buf == 
# 805 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c" 3 4
                      ((void *)0)
# 805 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c"
                          ) {
            return 0x101;
        }
...
static esp_err_t sdmmc_enable_hs_mode(sdmmc_card_t* card)
{
    ...
    if (response == 
# 931 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c" 3 4
                   ((void *)0)
# 931 "C:/esp/esp-idf/components/sdmmc/sdmmc_cmd.c"
                       ) {
        return 0x101;
    }
