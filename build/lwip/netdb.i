# 1 "C:/esp/esp-idf/components/lwip/api/netdb.c"
# 1 "C:\\esp\\esp32-ArkPOS2\\ArkPOS2-esp\\build\\lwip//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/lwip/api/netdb.c"
# 36 "C:/esp/esp-idf/components/lwip/api/netdb.c"
# 1 "C:/esp/esp-idf/components/lwip/include/lwip/lwip/netdb.h" 1
# 32 "C:/esp/esp-idf/components/lwip/include/lwip/lwip/netdb.h"
...
# 33 "C:/esp/esp-idf/components/lwip/include/lwip/lwip/netdb.h" 2
...
# 44 "C:/esp/esp-idf/components/lwip/include/lwip/lwip/inet.h"
...
# 39 "C:/esp/esp-idf/components/lwip/include/lwip/lwip/netdb.h" 2
...
# 40 "C:/esp/esp-idf/components/lwip/include/lwip/lwip/netdb.h" 2
...
int lwip_getaddrinfo(const char *nodename,
       ...
       struct addrinfo **res);
# 37 "C:/esp/esp-idf/components/lwip/api/netdb.c" 2
...
# 42 "C:/esp/esp-idf/components/lwip/api/netdb.c" 2
...
# 43 "C:/esp/esp-idf/components/lwip/api/netdb.c" 2
...
# 45 "C:/esp/esp-idf/components/lwip/api/netdb.c" 2
...
err_t dns_gethostbyname_addrtype(const char *hostname, ip_addr_t *addr,
                                 dns_found_callback found, void *callback_arg,
                                 u8_t dns_addrtype);
# 46 "C:/esp/esp-idf/components/lwip/api/netdb.c" 2
...
# 48 "C:/esp/esp-idf/components/lwip/api/netdb.c" 2
...
int h_errno;
# 84 "C:/esp/esp-idf/components/lwip/api/netdb.c"
struct hostent*
lwip_gethostbyname(const char *name)
{
  ...
  if (err != 0) {
    ...
    h_errno = 210;
    return 
# 102 "C:/esp/esp-idf/components/lwip/api/netdb.c" 3 4
          ((void *)0)
# 102 "C:/esp/esp-idf/components/lwip/api/netdb.c"
              ;
  }
  ...
  s_phostent_addr[1] = 
# 108 "C:/esp/esp-idf/components/lwip/api/netdb.c" 3 4
                      ((void *)0)
# 108 "C:/esp/esp-idf/components/lwip/api/netdb.c"
                          ;
  strncpy(s_hostname, name, 256);
  s_hostname[256] = 0;
  s_hostent.h_name = s_hostname;
  s_aliases = 
# 112 "C:/esp/esp-idf/components/lwip/api/netdb.c" 3 4
             ((void *)0)
# 112 "C:/esp/esp-idf/components/lwip/api/netdb.c"
                 ;
  s_hostent.h_aliases = &s_aliases;
  s_hostent.h_addrtype = 2;
  s_hostent.h_length = sizeof(ip_addr_t);
  s_hostent.h_addr_list = (char**)&s_phostent_addr;
# 139 "C:/esp/esp-idf/components/lwip/api/netdb.c"
  return &s_hostent;

}
# 159 "C:/esp/esp-idf/components/lwip/api/netdb.c"
int
                ...
                size_t buflen, struct hostent **result, int *h_errnop)
{
  ...
  if (h_errnop == 
# 169 "C:/esp/esp-idf/components/lwip/api/netdb.c" 3 4
                 ((void *)0)
# 169 "C:/esp/esp-idf/components/lwip/api/netdb.c"
                     ) {
  ...
  if (result == 
# 174 "C:/esp/esp-idf/components/lwip/api/netdb.c" 3 4
               ((void *)0)
# 174 "C:/esp/esp-idf/components/lwip/api/netdb.c"
                   ) {
  ...
  *result = 
# 180 "C:/esp/esp-idf/components/lwip/api/netdb.c" 3 4
           ((void *)0)
# 180 "C:/esp/esp-idf/components/lwip/api/netdb.c"
               ;
  if ((name == 
# 181 "C:/esp/esp-idf/components/lwip/api/netdb.c" 3 4
              ((void *)0)
# 181 "C:/esp/esp-idf/components/lwip/api/netdb.c"
                  ) || (ret == 
# 181 "C:/esp/esp-idf/components/lwip/api/netdb.c" 3 4
                               ((void *)0)
# 181 "C:/esp/esp-idf/components/lwip/api/netdb.c"
...
# 181 "C:/esp/esp-idf/components/lwip/api/netdb.c"
  ...
  h->addr_list[1] = 
# 211 "C:/esp/esp-idf/components/lwip/api/netdb.c" 3 4
                   ((void *)0)
# 211 "C:/esp/esp-idf/components/lwip/api/netdb.c"
                       ;
  h->aliases = 
# 212 "C:/esp/esp-idf/components/lwip/api/netdb.c" 3 4
              ((void *)0)
# 212 "C:/esp/esp-idf/components/lwip/api/netdb.c"
                  ;
  ret->h_name = hostname;
...
# 233 "C:/esp/esp-idf/components/lwip/api/netdb.c"
void
lwip_freeaddrinfo(struct addrinfo *ai)
{
  ...
  while (ai != 
# 238 "C:/esp/esp-idf/components/lwip/api/netdb.c" 3 4
              ((void *)0)
# 238 "C:/esp/esp-idf/components/lwip/api/netdb.c"
                  ) {
    next = ai->ai_next;
    free(ai);
    ai = next;
...
# 266 "C:/esp/esp-idf/components/lwip/api/netdb.c"
int
...
# 273 "C:/esp/esp-idf/components/lwip/api/netdb.c" 3 4
                               ((void *)0)
# 273 "C:/esp/esp-idf/components/lwip/api/netdb.c"
                                   ;
  int port_nr = 0;
  size_t total_size;
  size_t namelen = 0;
  ...
  if (res == 
# 279 "C:/esp/esp-idf/components/lwip/api/netdb.c" 3 4
            ((void *)0)
# 279 "C:/esp/esp-idf/components/lwip/api/netdb.c"
                ) {
    return 202;
  }
  *res = 
# 282 "C:/esp/esp-idf/components/lwip/api/netdb.c" 3 4
        ((void *)0)
# 282 "C:/esp/esp-idf/components/lwip/api/netdb.c"
            ;
  if ((nodename == 
# 283 "C:/esp/esp-idf/components/lwip/api/netdb.c" 3 4
                  ((void *)0)
# 283 "C:/esp/esp-idf/components/lwip/api/netdb.c"
                      ) && (servname == 
# 283 "C:/esp/esp-idf/components/lwip/api/netdb.c" 3 4
                                        ((void *)0)
# 283 "C:/esp/esp-idf/components/lwip/api/netdb.c"
  ...
  if (hints != 
# 287 "C:/esp/esp-idf/components/lwip/api/netdb.c" 3 4
              ((void *)0)
# 287 "C:/esp/esp-idf/components/lwip/api/netdb.c"
                  ) {
  ...
  if (servname != 
# 303 "C:/esp/esp-idf/components/lwip/api/netdb.c" 3 4
                 ((void *)0)
# 303 "C:/esp/esp-idf/components/lwip/api/netdb.c"
                     ) {
  ...
  if (nodename != 
# 312 "C:/esp/esp-idf/components/lwip/api/netdb.c" 3 4
                 ((void *)0)
# 312 "C:/esp/esp-idf/components/lwip/api/netdb.c"
                     ) {

    if ((hints != 
# 314 "C:/esp/esp-idf/components/lwip/api/netdb.c" 3 4
                 ((void *)0)
# 314 "C:/esp/esp-idf/components/lwip/api/netdb.c"
                     ) && (hints->ai_flags & 0x04)) {
    ...
    if ((hints != 
# 342 "C:/esp/esp-idf/components/lwip/api/netdb.c" 3 4
                 ((void *)0)
# 342 "C:/esp/esp-idf/components/lwip/api/netdb.c"
                     ) && (hints->ai_flags & 0x01)) {
...
# 343 "C:/esp/esp-idf/components/lwip/api/netdb.c" 3 4
     ((void *)0)
# 343 "C:/esp/esp-idf/components/lwip/api/netdb.c"
...
# 345 "C:/esp/esp-idf/components/lwip/api/netdb.c" 3 4
     ((void *)0)
# 345 "C:/esp/esp-idf/components/lwip/api/netdb.c"
...
# 345 "C:/esp/esp-idf/components/lwip/api/netdb.c"
  ...
  if (nodename != 
# 350 "C:/esp/esp-idf/components/lwip/api/netdb.c" 3 4
                 ((void *)0)
# 350 "C:/esp/esp-idf/components/lwip/api/netdb.c"
                     ) {
    ...
    do { if(!(total_size + namelen + 1 > total_size)) __assert_func("C:/esp/esp-idf/components/lwip/api/netdb.c", 356, __func__, "namelen is too long"); } while(0);
...
# 360 "C:/esp/esp-idf/components/lwip/api/netdb.c"
  ,
                                 361
# 360 "C:/esp/esp-idf/components/lwip/api/netdb.c"
  ...
  if (ai == 
# 363 "C:/esp/esp-idf/components/lwip/api/netdb.c" 3 4
           ((void *)0)
# 363 "C:/esp/esp-idf/components/lwip/api/netdb.c"
               ) {
    return 203;
  }
  ...
  if (hints != 
# 391 "C:/esp/esp-idf/components/lwip/api/netdb.c" 3 4
              ((void *)0)
# 391 "C:/esp/esp-idf/components/lwip/api/netdb.c"
                  ) {
  ...
  if (nodename != 
# 396 "C:/esp/esp-idf/components/lwip/api/netdb.c" 3 4
                 ((void *)0)
# 396 "C:/esp/esp-idf/components/lwip/api/netdb.c"
                     ) {
