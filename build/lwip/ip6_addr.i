# 1 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_addr.c"
# 1 "C:\\esp\\esp32-ArkPOS2\\ArkPOS2-esp\\build\\lwip//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_addr.c"
# 43 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_addr.c"
...
# 44 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_addr.c" 2
...
# 48 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_addr.c" 2



const ip_addr_t ip6_addr_any = { { { { 0ul, 0ul, 0ul, 0ul } } }, 6U };
# 72 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_addr.c"
int
...
# 174 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_addr.c"
char *
...
# 190 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_addr.c"
char *
  ...
  for (current_block_index = 0; current_block_index < 8; current_block_index++) {
    ...
    if (current_block_value == 0) {
      if (current_block_index == 7) {
        ...
        if (i >= buflen) {
          return 
# 214 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_addr.c" 3 4
                ((void *)0)
# 214 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_addr.c"
                    ;
        }
        break;
      }
      if (empty_block_flag == 0) {
        ...
        if (next_block_value == 0) {
          ...
          if (i >= buflen) {
            return 
# 230 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_addr.c" 3 4
                  ((void *)0)
# 230 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_addr.c"
                      ;
          }
          continue;
        }
    ...
    if (current_block_index > 0) {
      ...
      if (i >= buflen) {
        return 
# 246 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_addr.c" 3 4
              ((void *)0)
# 246 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_addr.c"
                  ;
      }
    }
    ...
    if ((current_block_value & 0xf000) == 0) {
      ...
      if (i >= buflen) {
        return 
# 256 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_addr.c" 3 4
              ((void *)0)
# 256 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_addr.c"
                  ;
      }
    }
    ...
    if (((current_block_value & 0xf00) == 0) && (zero_flag)) {
      ...
      if (i >= buflen) {
        return 
# 266 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_addr.c" 3 4
              ((void *)0)
# 266 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_addr.c"
                  ;
      }
    }
    ...
    if (((current_block_value & 0xf0) == 0) && (zero_flag)) {
      ...
      if (i >= buflen) {
        return 
# 277 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_addr.c" 3 4
              ((void *)0)
# 277 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_addr.c"
                  ;
      }
    }
    ...
    if (i >= buflen) {
      return 
# 283 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_addr.c" 3 4
            ((void *)0)
# 283 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_addr.c"
                ;
    }
  }
