# 1 "C:/esp/esp-idf/components/lwip/core/dns.c"
# 1 "C:\\esp\\esp32-ArkPOS2\\ArkPOS2-esp\\build\\lwip//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/lwip/core/dns.c"
# 77 "C:/esp/esp-idf/components/lwip/core/dns.c"
...
# 78 "C:/esp/esp-idf/components/lwip/core/dns.c" 2
...
# 82 "C:/esp/esp-idf/components/lwip/core/dns.c" 2
...
err_t dns_gethostbyname_addrtype(const char *hostname, ip_addr_t *addr,
                                 dns_found_callback found, void *callback_arg,
                                 u8_t dns_addrtype);
# 85 "C:/esp/esp-idf/components/lwip/core/dns.c" 2
...
# 87 "C:/esp/esp-idf/components/lwip/core/dns.c" 2
# 210 "C:/esp/esp-idf/components/lwip/core/dns.c"
...
# 313 "C:/esp/esp-idf/components/lwip/core/dns.c"
...
# 379 "C:/esp/esp-idf/components/lwip/core/dns.c"
  ,
                                                380
# 379 "C:/esp/esp-idf/components/lwip/core/dns.c"
  ...
  do { if(!(sizeof(struct dns_answer) <= 12)) __assert_func(
                                                         "C:/esp/esp-idf/components/lwip/core/dns.c"
# 381 "C:/esp/esp-idf/components/lwip/core/dns.c"
  ,
                                                         382
# 381 "C:/esp/esp-idf/components/lwip/core/dns.c"
...
# 406 "C:/esp/esp-idf/components/lwip/core/dns.c"
}
...
dns_setserver(u8_t numdns, const ip_addr_t *dnsserver)
{
  if (numdns < 2) {
    if (dnsserver != 
# 418 "C:/esp/esp-idf/components/lwip/core/dns.c" 3 4
                    ((void *)0)
# 418 "C:/esp/esp-idf/components/lwip/core/dns.c"
                        ) {
...
# 433 "C:/esp/esp-idf/components/lwip/core/dns.c"
ip_addr_t
...
# 605 "C:/esp/esp-idf/components/lwip/core/dns.c"
static err_t
dns_lookup(const char *name, ip_addr_t *addr , u8_t dns_addrtype)
{
  u8_t i;
# 623 "C:/esp/esp-idf/components/lwip/core/dns.c"
  for (i = 0; i < 4; ++i) {
...
# 628 "C:/esp/esp-idf/components/lwip/core/dns.c" 3 4
     ((void *)0)
# 628 "C:/esp/esp-idf/components/lwip/core/dns.c"
...
# 651 "C:/esp/esp-idf/components/lwip/core/dns.c"
static u16_t
...
# 687 "C:/esp/esp-idf/components/lwip/core/dns.c"
static u16_t
...
dns_send(u8_t idx)
{
  ...
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {printf ("dns_send: dns_servers[%""d""] \"%s\": request\n", (u16_t)(entry->server_idx), entry->name);} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0)
                                                       ;
  do { if(!(entry->server_idx < 2)) __assert_func("C:/esp/esp-idf/components/lwip/core/dns.c", 731, __func__, "dns server out of array"); } while(0);
  if ((((((&dns_servers[entry->server_idx])->type) == 6U)) ? (((*(&((&(dns_servers[entry->server_idx]))->u_addr.ip6))).addr[0] == 0) && ((*(&((&(dns_servers[entry->server_idx]))->u_addr.ip6))).addr[1] == 0) && ((*(&((&(dns_servers[entry->server_idx]))->u_addr.ip6))).addr[2] == 0) && ((*(&((&(dns_servers[entry->server_idx]))->u_addr.ip6))).addr[3] == 0)) : ((*(&((&(dns_servers[entry->server_idx]))->u_addr.ip4))).addr == ((u32_t)0x00000000UL)))) {
    ...
    dns_call_found(idx, 
# 735 "C:/esp/esp-idf/components/lwip/core/dns.c" 3 4
                       ((void *)0)
# 735 "C:/esp/esp-idf/components/lwip/core/dns.c"
                           );
  ...
  p = pbuf_alloc(PBUF_TRANSPORT, (u16_t)(12 + strlen(entry->name) + 2 +
                 4), PBUF_RAM);
  if (p != 
# 744 "C:/esp/esp-idf/components/lwip/core/dns.c" 3 4
          ((void *)0)
# 744 "C:/esp/esp-idf/components/lwip/core/dns.c"
              ) {
...
dns_alloc_random_port(void)
{
  ...
  if (ret == 
# 806 "C:/esp/esp-idf/components/lwip/core/dns.c" 3 4
            ((void *)0)
# 806 "C:/esp/esp-idf/components/lwip/core/dns.c"
                ) {

    return 
# 808 "C:/esp/esp-idf/components/lwip/core/dns.c" 3 4
          ((void *)0)
# 808 "C:/esp/esp-idf/components/lwip/core/dns.c"
              ;
  }
  do {
  ...
  if (err != 0) {
    udp_remove(ret);
    return 
# 821 "C:/esp/esp-idf/components/lwip/core/dns.c" 3 4
          ((void *)0)
# 821 "C:/esp/esp-idf/components/lwip/core/dns.c"
              ;
  }
  udp_recv(ret, dns_recv, 
# 823 "C:/esp/esp-idf/components/lwip/core/dns.c" 3 4
                         ((void *)0)
# 823 "C:/esp/esp-idf/components/lwip/core/dns.c"
                             );
  return ret;
}
...
dns_alloc_pcb(void)
{
  ...
  for (i = 0; i < 4; i++) {
    if (dns_pcbs[i] == 
# 840 "C:/esp/esp-idf/components/lwip/core/dns.c" 3 4
                      ((void *)0)
# 840 "C:/esp/esp-idf/components/lwip/core/dns.c"
                          ) {
      break;
    }
  }
  if (i < 4) {
    ...
    if (dns_pcbs[i] != 
# 846 "C:/esp/esp-idf/components/lwip/core/dns.c" 3 4
                      ((void *)0)
# 846 "C:/esp/esp-idf/components/lwip/core/dns.c"
                          ) {
  ...
  for (i = 0, idx = dns_last_pcb_idx + 1; i < 4; i++, idx++) {
    ...
    if (dns_pcbs[idx] != 
# 858 "C:/esp/esp-idf/components/lwip/core/dns.c" 3 4
                        ((void *)0)
# 858 "C:/esp/esp-idf/components/lwip/core/dns.c"
                            ) {
...
# 875 "C:/esp/esp-idf/components/lwip/core/dns.c"
static void
dns_call_found(u8_t idx, ip_addr_t* addr)
{
  ...
  if (addr != 
# 883 "C:/esp/esp-idf/components/lwip/core/dns.c" 3 4
             ((void *)0)
# 883 "C:/esp/esp-idf/components/lwip/core/dns.c"
                 ) {

    if ((((&*addr)->type) == 6U)) {
      do { if(!((((dns_table[idx].reqaddrtype) == 3) || ((dns_table[idx].reqaddrtype) == 1)))) __assert_func("C:/esp/esp-idf/components/lwip/core/dns.c", 886, __func__, "invalid response"); } while(0);
      dns_table[idx].reqaddrtype = 1;
    } else {
      do { if(!(!(((dns_table[idx].reqaddrtype) == 3) || ((dns_table[idx].reqaddrtype) == 1)))) __assert_func("C:/esp/esp-idf/components/lwip/core/dns.c", 889, __func__, "invalid response"); } while(0);
...
# 900 "C:/esp/esp-idf/components/lwip/core/dns.c" 3 4
                             ((void *)0)
# 900 "C:/esp/esp-idf/components/lwip/core/dns.c"
                                 ;
    }
  }
# 911 "C:/esp/esp-idf/components/lwip/core/dns.c"
  for (i = 0; i < 4; i++) {
    if (i == idx) {
      continue;
    }
...
# 926 "C:/esp/esp-idf/components/lwip/core/dns.c" 3 4
                                      ((void *)0)
# 926 "C:/esp/esp-idf/components/lwip/core/dns.c"
                                          ;
    dns_table[idx].pcb_idx = 4;
  }
...
# 963 "C:/esp/esp-idf/components/lwip/core/dns.c"
static void
dns_check_entry(u8_t i)
{
  ...
  do { if(!(i < 4)) __assert_func("C:/esp/esp-idf/components/lwip/core/dns.c", 969, __func__, "array index out of bounds"); } while(0);
      ...
      if (--entry->tmr == 0) {
        if (++entry->retries == 4) {
          if ((entry->server_idx + 1 < 2) && !(((((&dns_servers[entry->server_idx + 1])->type) == 6U)) ? (((*(&((&(dns_servers[entry->server_idx + 1]))->u_addr.ip6))).addr[0] == 0) && ((*(&((&(dns_servers[entry->server_idx + 1]))->u_addr.ip6))).addr[1] == 0) && ((*(&((&(dns_servers[entry->server_idx + 1]))->u_addr.ip6))).addr[2] == 0) && ((*(&((&(dns_servers[entry->server_idx + 1]))->u_addr.ip6))).addr[3] == 0)) : ((*(&((&(dns_servers[entry->server_idx + 1]))->u_addr.ip4))).addr == ((u32_t)0x00000000UL)))) {
            ...
            dns_call_found(i, 
# 1003 "C:/esp/esp-idf/components/lwip/core/dns.c" 3 4
                             ((void *)0)
# 1003 "C:/esp/esp-idf/components/lwip/core/dns.c"
                                 );
    ...
    case 0:
      ...
      break;
    default:
      do { if(!(0)) __assert_func("C:/esp/esp-idf/components/lwip/core/dns.c", 1033, __func__, "unknown dns_table entry state:"); } while(0);
      break;
  }
}
          ...
          if (ans.cls == ((((1) & 0xff) << 8) | (((1) & 0xff00) >> 8))) {
            ...
            if ((ans.type == ((((1) & 0xff) << 8) | (((1) & 0xff00) >> 8))) && (ans.len == ((((sizeof(ip4_addr_t)) & 0xff) << 8) | (((sizeof(ip4_addr_t)) & 0xff00) >> 8)))) {
...

              {
                ...
                do { if(((((&(entry->ipaddr))) != 
# 1166 "C:/esp/esp-idf/components/lwip/core/dns.c" 3 4
               ((void *)0)
# 1166 "C:/esp/esp-idf/components/lwip/core/dns.c"
...
# 1166 "C:/esp/esp-idf/components/lwip/core/dns.c"
            ...
            if ((ans.type == ((((28) & 0xff) << 8) | (((28) & 0xff00) >> 8))) && (ans.len == ((((sizeof(ip6_addr_t)) & 0xff) << 8) | (((sizeof(ip6_addr_t)) & 0xff00) >> 8)))) {
...

              {
                ...
                do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {printf ("dns_recv: \"%s\": response = ", entry->name);} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
                do { if(((((&(entry->ipaddr))) != 
# 1199 "C:/esp/esp-idf/components/lwip/core/dns.c" 3 4
               ((void *)0)
# 1199 "C:/esp/esp-idf/components/lwip/core/dns.c"
               ) && (((&*((&(entry->ipaddr))))->type) == 6U))) { do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {printf ("%" "x" ":%" "x" ":%" "x" ":%" "x" ":%" "x" ":%" "x" ":%" "x" ":%" "x", ((&(((&(entry->ipaddr)))->u_addr.ip6))) != 
# 1199 "C:/esp/esp-idf/components/lwip/core/dns.c" 3 4
               ((void *)0) 
# 1199 "C:/esp/esp-idf/components/lwip/core/dns.c"
...
# 1248 "C:/esp/esp-idf/components/lwip/core/dns.c" 3 4
                           ((void *)0)
# 1248 "C:/esp/esp-idf/components/lwip/core/dns.c"
                               );
flushentry:
...
# 1268 "C:/esp/esp-idf/components/lwip/core/dns.c"
static err_t
...
# 1274 "C:/esp/esp-idf/components/lwip/core/dns.c" 3 4
                                 ((void *)0)
# 1274 "C:/esp/esp-idf/components/lwip/core/dns.c"
                                     ;
  size_t namelen;
  ...
  req = 
# 1341 "C:/esp/esp-idf/components/lwip/core/dns.c" 3 4
       ((void *)0)
# 1341 "C:/esp/esp-idf/components/lwip/core/dns.c"
           ;
  for (r = 0; r < 4; r++) {
    if (dns_requests[r].found == 
# 1343 "C:/esp/esp-idf/components/lwip/core/dns.c" 3 4
                                ((void *)0)
# 1343 "C:/esp/esp-idf/components/lwip/core/dns.c"
                                    ) {
      req = &dns_requests[r];
      break;
    }
  ...
  if (req == 
# 1348 "C:/esp/esp-idf/components/lwip/core/dns.c" 3 4
            ((void *)0)
# 1348 "C:/esp/esp-idf/components/lwip/core/dns.c"
                ) {
  ...
  if (entry->pcb_idx >= 4) {
    ...
    entry->state = 0;
    req->found = 
# 1379 "C:/esp/esp-idf/components/lwip/core/dns.c" 3 4
                ((void *)0)
# 1379 "C:/esp/esp-idf/components/lwip/core/dns.c"
                    ;
    return -1;
  }
...
# 1413 "C:/esp/esp-idf/components/lwip/core/dns.c"
err_t
                           ...
                           void *callback_arg, u8_t dns_addrtype)
{
  ...
  if ((addr == 
# 1433 "C:/esp/esp-idf/components/lwip/core/dns.c" 3 4
              ((void *)0)
# 1433 "C:/esp/esp-idf/components/lwip/core/dns.c"
                  ) ||
      (!hostname) || (!hostname[0])) {
    return -15;
  }
...
# 1457 "C:/esp/esp-idf/components/lwip/core/dns.c"
  if (ipaddr_aton(hostname, addr)) {

    if (((((addr) != 
# 1459 "C:/esp/esp-idf/components/lwip/core/dns.c" 3 4
        ((void *)0)
# 1459 "C:/esp/esp-idf/components/lwip/core/dns.c"
        ) && (((&*(addr))->type) == 6U)) && (dns_addrtype != 0)) ||
        (!(((addr) != 
# 1460 "C:/esp/esp-idf/components/lwip/core/dns.c" 3 4
         ((void *)0)
# 1460 "C:/esp/esp-idf/components/lwip/core/dns.c"
