# 1 "C:/esp/esp-idf/components/lwip/core/ipv4/icmp.c"
# 1 "C:\\esp\\esp32-ArkPOS2\\ArkPOS2-esp\\build\\lwip//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/lwip/core/ipv4/icmp.c"
# 42 "C:/esp/esp-idf/components/lwip/core/ipv4/icmp.c"
...
# 43 "C:/esp/esp-idf/components/lwip/core/ipv4/icmp.c" 2



# 1 "C:/esp/esp-idf/components/lwip/include/lwip/lwip/icmp.h" 1
# 36 "C:/esp/esp-idf/components/lwip/include/lwip/lwip/icmp.h"
...
# 37 "C:/esp/esp-idf/components/lwip/include/lwip/lwip/icmp.h" 2
...
# 38 "C:/esp/esp-idf/components/lwip/include/lwip/lwip/icmp.h" 2
...
# 39 "C:/esp/esp-idf/components/lwip/include/lwip/lwip/icmp.h" 2
...
# 47 "C:/esp/esp-idf/components/lwip/core/ipv4/icmp.c" 2
...
# 48 "C:/esp/esp-idf/components/lwip/core/ipv4/icmp.c" 2
...
# 49 "C:/esp/esp-idf/components/lwip/core/ipv4/icmp.c" 2
...
# 53 "C:/esp/esp-idf/components/lwip/core/ipv4/icmp.c" 2
# 64 "C:/esp/esp-idf/components/lwip/core/ipv4/icmp.c"
static void icmp_send_response(struct pbuf *p, u8_t type, u8_t code);
# 75 "C:/esp/esp-idf/components/lwip/core/ipv4/icmp.c"
void
icmp_input(struct pbuf *p, struct netif *inp)
{
  ...
  case 8:
    ...
    if (pbuf_header(p, (40 + (14 + 0) + 0))) {
      ...
      if (r == 
# 154 "C:/esp/esp-idf/components/lwip/core/ipv4/icmp.c" 3 4
              ((void *)0)
# 154 "C:/esp/esp-idf/components/lwip/core/ipv4/icmp.c"
                  ) {
...
# 158 "C:/esp/esp-idf/components/lwip/core/ipv4/icmp.c"
      ,
                                                                 159
# 158 "C:/esp/esp-idf/components/lwip/core/ipv4/icmp.c"
      ...
      if (pbuf_header(r, -hlen)) {
        do { if(!(0)) __assert_func("C:/esp/esp-idf/components/lwip/core/ipv4/icmp.c", 164, __func__, "icmp_input: moving r->payload to icmp header failed\n"); } while(0);
        pbuf_free(r);
        goto icmperr;
      }

      if (pbuf_copy(r, p) != 0) {
        do { if(!(0)) __assert_func("C:/esp/esp-idf/components/lwip/core/ipv4/icmp.c", 170, __func__, "icmp_input: copying to new pbuf failed\n"); } while(0);
        pbuf_free(r);
        goto icmperr;
      }
      ...
      if (pbuf_header(p, -(s16_t)(40 + (14 + 0) + 0))) {
        do { if(!(0)) __assert_func("C:/esp/esp-idf/components/lwip/core/ipv4/icmp.c", 181, __func__, "icmp_input: restoring original p->payload failed\n"); } while(0);
        goto icmperr;
      }
    }
    ...
    if (pbuf_header(p, hlen)) {
      do { if(!(0)) __assert_func("C:/esp/esp-idf/components/lwip/core/ipv4/icmp.c", 191, __func__, "Can't move over header in packet"); } while(0);
    } else {
      err_t ret;
...
# 217 "C:/esp/esp-idf/components/lwip/core/ipv4/icmp.c"
      (iphdr)->_ttl = (u8_t)((255));
      (iphdr)->_chksum = (0);
...
# 232 "C:/esp/esp-idf/components/lwip/core/ipv4/icmp.c" 3 4
                                 ((void *)0)
# 232 "C:/esp/esp-idf/components/lwip/core/ipv4/icmp.c"
                                           ,
                   (255), 0, 1, inp);
      if (ret != 0) {
...
# 289 "C:/esp/esp-idf/components/lwip/core/ipv4/icmp.c"
void
...
# 321 "C:/esp/esp-idf/components/lwip/core/ipv4/icmp.c"
static void
icmp_send_response(struct pbuf *p, u8_t type, u8_t code)
{
  ...
  q = pbuf_alloc(PBUF_IP, sizeof(struct icmp_echo_hdr) + 20 + 8,
                 PBUF_RAM);
  if (q == 
# 337 "C:/esp/esp-idf/components/lwip/core/ipv4/icmp.c" 3 4
          ((void *)0)
# 337 "C:/esp/esp-idf/components/lwip/core/ipv4/icmp.c"
              ) {
  ...
  do { if(!((q->len >= (sizeof(struct icmp_echo_hdr) + 20 + 8)))) __assert_func(
                                                                                              "C:/esp/esp-idf/components/lwip/core/ipv4/icmp.c"
# 342 "C:/esp/esp-idf/components/lwip/core/ipv4/icmp.c"
  ,
                                                                                              343
# 342 "C:/esp/esp-idf/components/lwip/core/ipv4/icmp.c"
  ...
  if (netif != 
# 372 "C:/esp/esp-idf/components/lwip/core/ipv4/icmp.c" 3 4
              ((void *)0)
# 372 "C:/esp/esp-idf/components/lwip/core/ipv4/icmp.c"
                  ) {
    ...
    ;
    ip4_output_if(q, 
# 381 "C:/esp/esp-idf/components/lwip/core/ipv4/icmp.c" 3 4
                    ((void *)0)
# 381 "C:/esp/esp-idf/components/lwip/core/ipv4/icmp.c"
