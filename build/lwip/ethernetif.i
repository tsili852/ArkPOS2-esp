# 1 "C:/esp/esp-idf/components/lwip/port/netif/ethernetif.c"
# 1 "C:\\esp\\esp32-ArkPOS2\\ArkPOS2-esp\\build\\lwip//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/lwip/port/netif/ethernetif.c"
# 39 "C:/esp/esp-idf/components/lwip/port/netif/ethernetif.c"
...
# 40 "C:/esp/esp-idf/components/lwip/port/netif/ethernetif.c" 2
...
# 42 "C:/esp/esp-idf/components/lwip/port/netif/ethernetif.c" 2
...
# 43 "C:/esp/esp-idf/components/lwip/port/netif/ethernetif.c" 2
...
# 44 "C:/esp/esp-idf/components/lwip/port/netif/ethernetif.c" 2
...
# 45 "C:/esp/esp-idf/components/lwip/port/netif/ethernetif.c" 2
...
struct udp_pcb;
struct netif;
# 46 "C:/esp/esp-idf/components/lwip/port/netif/ethernetif.c" 2
...
# 47 "C:/esp/esp-idf/components/lwip/port/netif/ethernetif.c" 2
...
# 48 "C:/esp/esp-idf/components/lwip/port/netif/ethernetif.c" 2
...
# 50 "C:/esp/esp-idf/components/lwip/port/netif/ethernetif.c" 2
...
# 52 "C:/esp/esp-idf/components/lwip/port/netif/ethernetif.c" 2
...
# 53 "C:/esp/esp-idf/components/lwip/port/netif/ethernetif.c" 2
# 65 "C:/esp/esp-idf/components/lwip/port/netif/ethernetif.c"
static void
...
# 106 "C:/esp/esp-idf/components/lwip/port/netif/ethernetif.c"
static err_t
ethernet_low_level_output(struct netif *netif, struct pbuf *p)
{
  ...
  pbuf_x_len = q->len;
  if(q->next !=
# 122 "C:/esp/esp-idf/components/lwip/port/netif/ethernetif.c" 3 4
              ((void *)0)
# 122 "C:/esp/esp-idf/components/lwip/port/netif/ethernetif.c"
                  ) {

    struct pbuf *tmp = q->next;
    while(tmp != 
# 125 "C:/esp/esp-idf/components/lwip/port/netif/ethernetif.c" 3 4
                ((void *)0)
# 125 "C:/esp/esp-idf/components/lwip/port/netif/ethernetif.c"
                    ) {
...
# 158 "C:/esp/esp-idf/components/lwip/port/netif/ethernetif.c"
void
ethernetif_input(struct netif *netif, void *buffer, uint16_t len)
{
  ...
  if(buffer== 
# 163 "C:/esp/esp-idf/components/lwip/port/netif/ethernetif.c" 3 4
             ((void *)0) 
# 163 "C:/esp/esp-idf/components/lwip/port/netif/ethernetif.c"
...
# 187 "C:/esp/esp-idf/components/lwip/port/netif/ethernetif.c"
  p = pbuf_alloc(PBUF_RAW, len, PBUF_REF);
  if (p == 
# 188 "C:/esp/esp-idf/components/lwip/port/netif/ethernetif.c" 3 4
          ((void *)0)
# 188 "C:/esp/esp-idf/components/lwip/port/netif/ethernetif.c"
              ){
    esp_eth_free_rx_buf(buffer);
    return;
  }
...
if (netif->input(p, netif) != 0) {
  ...
  p->l2_owner = 
# 199 "C:/esp/esp-idf/components/lwip/port/netif/ethernetif.c" 3 4
               ((void *)0)
# 199 "C:/esp/esp-idf/components/lwip/port/netif/ethernetif.c"
                   ;
  pbuf_free(p);
}

}
# 217 "C:/esp/esp-idf/components/lwip/port/netif/ethernetif.c"
err_t
ethernetif_init(struct netif *netif)
{
  do { if(!((netif != 
# 220 "C:/esp/esp-idf/components/lwip/port/netif/ethernetif.c" 3 4
 ((void *)0)
# 220 "C:/esp/esp-idf/components/lwip/port/netif/ethernetif.c"
 ))) __assert_func("C:/esp/esp-idf/components/lwip/port/netif/ethernetif.c", 220, __func__, "netif != NULL"); } while(0);
...
# 238 "C:/esp/esp-idf/components/lwip/port/netif/ethernetif.c"
  ;
