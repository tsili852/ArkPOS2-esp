# 1 "C:/esp/esp-idf/components/lwip/api/tcpip.c"
# 1 "C:\\esp\\esp32-ArkPOS2\\ArkPOS2-esp\\build\\lwip//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/lwip/api/tcpip.c"
# 39 "C:/esp/esp-idf/components/lwip/api/tcpip.c"
...
# 40 "C:/esp/esp-idf/components/lwip/api/tcpip.c" 2
...
# 44 "C:/esp/esp-idf/components/lwip/api/tcpip.c" 2
...
# 45 "C:/esp/esp-idf/components/lwip/api/tcpip.c" 2



# 1 "C:/esp/esp-idf/components/lwip/include/lwip/lwip/init.h" 1
# 66 "C:/esp/esp-idf/components/lwip/include/lwip/lwip/init.h"
void lwip_init(void);
# 49 "C:/esp/esp-idf/components/lwip/api/tcpip.c" 2
...
# 50 "C:/esp/esp-idf/components/lwip/api/tcpip.c" 2
...
# 52 "C:/esp/esp-idf/components/lwip/api/tcpip.c" 2
...
# 62 "C:/esp/esp-idf/components/lwip/api/tcpip.c" 3 4
                          ((void *)0)
# 62 "C:/esp/esp-idf/components/lwip/api/tcpip.c"
                              ;
# 80 "C:/esp/esp-idf/components/lwip/api/tcpip.c"
static void
tcpip_thread(void *arg)
{
  ...
  if (tcpip_init_done != 
# 88 "C:/esp/esp-idf/components/lwip/api/tcpip.c" 3 4
                        ((void *)0)
# 88 "C:/esp/esp-idf/components/lwip/api/tcpip.c"
                            ) {
  ...
  while (1) {
    ...
    if (msg == 
# 107 "C:/esp/esp-idf/components/lwip/api/tcpip.c" 3 4
              ((void *)0)
# 107 "C:/esp/esp-idf/components/lwip/api/tcpip.c"
                  ) {
      ...
      do { if(!(0)) __assert_func("C:/esp/esp-idf/components/lwip/api/tcpip.c", 109, __func__, "tcpip_thread: invalid message"); } while(0);
    ...
    case TCPIP_MSG_INPKT:
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {printf ("tcpip_thread: PACKET %p\n", (void *)msg);} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
        ...
        if(msg->msg.inp.p != 
# 141 "C:/esp/esp-idf/components/lwip/api/tcpip.c" 3 4
                            ((void *)0) 
# 141 "C:/esp/esp-idf/components/lwip/api/tcpip.c"
                                 && msg->msg.inp.netif != 
# 141 "C:/esp/esp-idf/components/lwip/api/tcpip.c" 3 4
                                                          ((void *)0)
# 141 "C:/esp/esp-idf/components/lwip/api/tcpip.c"
      ...
      break;
# 168 "C:/esp/esp-idf/components/lwip/api/tcpip.c"
    ...
    default:
      ...
      do { if(!(0)) __assert_func("C:/esp/esp-idf/components/lwip/api/tcpip.c", 184, __func__, "tcpip_thread: invalid message"); } while(0);
      break;
    }

  }
}
# 198 "C:/esp/esp-idf/components/lwip/api/tcpip.c"
err_t
tcpip_inpkt(struct pbuf *p, struct netif *inp, netif_input_fn input_fn)
{
# 209 "C:/esp/esp-idf/components/lwip/api/tcpip.c"
  struct tcpip_msg *msg;

  if (!( ( ( *&(mbox) ) == 
# 211 "C:/esp/esp-idf/components/lwip/api/tcpip.c" 3 4
      ((void *)0)
# 211 "C:/esp/esp-idf/components/lwip/api/tcpip.c"
      ) ? ( ( BaseType_t ) 0 ) : ( ( BaseType_t ) 1 ) )) {
    return -6;
  }
  msg = (struct tcpip_msg *)malloc(memp_pools[MEMP_TCPIP_MSG_INPKT]->size);
  if (msg == 
# 215 "C:/esp/esp-idf/components/lwip/api/tcpip.c" 3 4
            ((void *)0)
# 215 "C:/esp/esp-idf/components/lwip/api/tcpip.c"
                ) {
    return -1;
  }
...
# 247 "C:/esp/esp-idf/components/lwip/api/tcpip.c"
err_t
...
# 269 "C:/esp/esp-idf/components/lwip/api/tcpip.c"
err_t
tcpip_callback_with_block(tcpip_callback_fn function, void *ctx, u8_t block)
{
  ...
  if (( ( ( *&(mbox) ) == 
# 274 "C:/esp/esp-idf/components/lwip/api/tcpip.c" 3 4
     ((void *)0)
# 274 "C:/esp/esp-idf/components/lwip/api/tcpip.c"
     ) ? ( ( BaseType_t ) 0 ) : ( ( BaseType_t ) 1 ) )) {
    msg = (struct tcpip_msg *)malloc(memp_pools[MEMP_TCPIP_MSG_API]->size);
    if (msg == 
# 276 "C:/esp/esp-idf/components/lwip/api/tcpip.c" 3 4
              ((void *)0)
# 276 "C:/esp/esp-idf/components/lwip/api/tcpip.c"
                  ) {
      return -1;
    }
...
# 366 "C:/esp/esp-idf/components/lwip/api/tcpip.c"
err_t
tcpip_send_api_msg(tcpip_callback_fn fn, void *apimsg, sys_sem_t* sem)
{
  do { if(!(( ( ( *sem ) == 
# 369 "C:/esp/esp-idf/components/lwip/api/tcpip.c" 3 4
 ((void *)0)
# 369 "C:/esp/esp-idf/components/lwip/api/tcpip.c"
 ) ? ( ( BaseType_t ) 0 ) : ( ( BaseType_t ) 1 ) ))) __assert_func("C:/esp/esp-idf/components/lwip/api/tcpip.c", 369, __func__, "semaphore not initialized"); } while(0);

  if (( ( ( *&(mbox) ) == 
# 371 "C:/esp/esp-idf/components/lwip/api/tcpip.c" 3 4
     ((void *)0)
# 371 "C:/esp/esp-idf/components/lwip/api/tcpip.c"
     ) ? ( ( BaseType_t ) 0 ) : ( ( BaseType_t ) 1 ) )) {
    struct tcpip_msg msg;
...
err_t tcpip_api_call(tcpip_api_call_fn fn, struct tcpip_api_call *call)
{
  ...
  if (( ( ( *&(mbox) ) == 
# 397 "C:/esp/esp-idf/components/lwip/api/tcpip.c" 3 4
     ((void *)0)
# 397 "C:/esp/esp-idf/components/lwip/api/tcpip.c"
     ) ? ( ( BaseType_t ) 0 ) : ( ( BaseType_t ) 1 ) )) {
    struct tcpip_msg msg;
    err_t err;
...
# 436 "C:/esp/esp-idf/components/lwip/api/tcpip.c"
struct tcpip_callback_msg*
tcpip_callbackmsg_new(tcpip_callback_fn function, void *ctx)
{
  struct tcpip_msg *msg = (struct tcpip_msg *)malloc(memp_pools[MEMP_TCPIP_MSG_API]->size);
  if (msg == 
# 440 "C:/esp/esp-idf/components/lwip/api/tcpip.c" 3 4
            ((void *)0)
# 440 "C:/esp/esp-idf/components/lwip/api/tcpip.c"
                ) {
    return 
# 441 "C:/esp/esp-idf/components/lwip/api/tcpip.c" 3 4
          ((void *)0)
# 441 "C:/esp/esp-idf/components/lwip/api/tcpip.c"
              ;
  }
...
# 467 "C:/esp/esp-idf/components/lwip/api/tcpip.c"
err_t
tcpip_trycallback(struct tcpip_callback_msg* msg)
{
  if (!( ( ( *&(mbox) ) == 
# 470 "C:/esp/esp-idf/components/lwip/api/tcpip.c" 3 4
      ((void *)0)
# 470 "C:/esp/esp-idf/components/lwip/api/tcpip.c"
      ) ? ( ( BaseType_t ) 0 ) : ( ( BaseType_t ) 1 ) )) {
    return -6;
  }
  return sys_mbox_trypost(&mbox, msg);
}
# 484 "C:/esp/esp-idf/components/lwip/api/tcpip.c"
void
tcpip_init(tcpip_init_done_fn initfunc, void *arg)
{
  ...
  if (sys_mbox_new(&mbox, 32) != 0) {
    do { if(!(0)) __assert_func("C:/esp/esp-idf/components/lwip/api/tcpip.c", 493, __func__, "failed to create tcpip_thread mbox"); } while(0);
  }
  ...
  g_lwip_task = sys_thread_new("tiT"
                , tcpip_thread, 
# 503 "C:/esp/esp-idf/components/lwip/api/tcpip.c" 3 4
                               ((void *)0)
# 503 "C:/esp/esp-idf/components/lwip/api/tcpip.c"
                                   , 2560, ((( 25 )) - 7));
...
# 544 "C:/esp/esp-idf/components/lwip/api/tcpip.c"
