# 1 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
# 1 "C:\\esp\\esp32-ArkPOS2\\ArkPOS2-esp\\build\\lwip//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
# 42 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
...
# 43 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c" 2
# 1 "C:/esp/esp-idf/components/lwip/include/lwip/lwip/ip6_frag.h" 1
# 45 "C:/esp/esp-idf/components/lwip/include/lwip/lwip/ip6_frag.h"
...
# 46 "C:/esp/esp-idf/components/lwip/include/lwip/lwip/ip6_frag.h" 2
...
# 47 "C:/esp/esp-idf/components/lwip/include/lwip/lwip/ip6_frag.h" 2
# 1 "C:/esp/esp-idf/components/lwip/include/lwip/lwip/ip6.h" 1
# 49 "C:/esp/esp-idf/components/lwip/include/lwip/lwip/ip6.h"
...
# 48 "C:/esp/esp-idf/components/lwip/include/lwip/lwip/ip6_frag.h" 2
# 80 "C:/esp/esp-idf/components/lwip/include/lwip/lwip/ip6_frag.h"
...
# 44 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c" 2
...
# 46 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c" 2
...
# 47 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c" 2
...
# 48 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c" 2
...
# 54 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c" 2
# 89 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
...
# 116 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
  ,
                                                    117
# 116 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
  ...
  r = reassdatagrams;
  while (r != 
# 121 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c" 3 4
             ((void *)0)
# 121 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
                 ) {
...
# 145 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
static void
ip6_reass_free_complete_datagram(struct ip6_reassdata *ipr)
{
  ...
  if (iprh->start == 0) {
    ...
    if (pbuf_header_force(p, (s16_t)((u8_t*)p->payload - (u8_t*)(ipr->iphdr)))) {
      do { if(!(0)) __assert_func("C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c", 164, __func__, "ip6_reass_free: moving p->payload to ip6 header failed\n"); } while(0);
    }
    else {
      icmp6_time_exceeded(p, ICMP6_TE_FRAG);
    }
    clen = pbuf_clen(p);
    do { if(!(pbufs_freed + clen <= 0xffff)) __assert_func("C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c", 170, __func__, "pbufs_freed + clen <= 0xffff"); } while(0);
    pbufs_freed += clen;
    pbuf_free(p);
  }
  ...
  p = ipr->p;
  while (p != 
# 179 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c" 3 4
             ((void *)0)
# 179 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
                 ) {
    struct pbuf *pcur;
    ...
    p = iprh->next_pbuf;
    clen = pbuf_clen(pcur);
    do { if(!(pbufs_freed + clen <= 0xffff)) __assert_func("C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c", 186, __func__, "pbufs_freed + clen <= 0xffff"); } while(0);
    pbufs_freed += clen;
    pbuf_free(pcur);
  }
  ...
  if (ipr == reassdatagrams) {
    ...
    prev = reassdatagrams;
    while (prev != 
# 196 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c" 3 4
                  ((void *)0)
# 196 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
                      ) {
      if (prev->next == ipr) {
        break;
      }
    ...
    if (prev != 
# 202 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c" 3 4
               ((void *)0)
# 202 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
                   ) {
      prev->next = ipr->next;
    }
  }
  ...
  do { if(!(ip6_reass_pbufcount >= pbufs_freed)) __assert_func("C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c", 209, __func__, "ip_reass_pbufcount >= clen"); } while(0);
  ip6_reass_pbufcount -= pbufs_freed;
}
# 222 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
static void
ip6_reass_remove_oldest_datagram(struct ip6_reassdata *ipr, int pbufs_needed)
{
  ...
  do {
    ...
    while (r != 
# 231 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c" 3 4
               ((void *)0)
# 231 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
                   ) {
      if (r != ipr) {
    ...
    if (oldest != 
# 244 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c" 3 4
                 ((void *)0)
# 244 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
                     ) {
      ip6_reass_free_complete_datagram(oldest);
    }
  } while (((ip6_reass_pbufcount + pbufs_needed) > 10) && (reassdatagrams != 
# 247 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c" 3 4
                                                                                            ((void *)0)
# 247 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
                                                                                                ));
}
# 259 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
struct pbuf *
ip6_reass(struct pbuf *p)
{
  struct ip6_reassdata *ipr, *ipr_prev;
  struct ip6_reass_helper *iprh, *iprh_tmp, *iprh_prev=
# 263 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c" 3 4
                                                      ((void *)0)
# 263 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
                                                          ;
  ...
  do { if(!((const void*)((const struct ip6_hdr*)(ip_data.current_ip6_header)) == ((u8_t*)p->payload) - 40)) __assert_func(
                                                                        "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
# 271 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
  ,
                                                                        272
# 271 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
...
# 289 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c" 3 4
                                       ((void *)0)
# 289 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
                                           ; ipr != 
# 289 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c" 3 4
                                                    ((void *)0)
# 289 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
  ...
  if (ipr == 
# 302 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c" 3 4
            ((void *)0)
# 302 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
                ) {

    ipr = (struct ip6_reassdata *)malloc(memp_pools[MEMP_IP6_REASSDATA]->size);
    if (ipr == 
# 305 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c" 3 4
              ((void *)0)
# 305 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
                  ) {
      ...
      ipr = (struct ip6_reassdata *)malloc(memp_pools[MEMP_IP6_REASSDATA]->size);
      if (ipr != 
# 310 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c" 3 4
                ((void *)0)
# 310 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
                    ) {

        for (ipr_prev = reassdatagrams; ipr_prev != 
# 312 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c" 3 4
                                                   ((void *)0)
# 312 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
    ...
    reassdatagrams = ipr;
# 340 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
  ...
  if ((ip6_reass_pbufcount + clen) > 10) {
    ...
    if ((ip6_reass_pbufcount + clen) <= 10) {
      ...
      for (ipr_prev = reassdatagrams; ipr_prev != 
# 356 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c" 3 4
                                                 ((void *)0)
# 356 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
                                                     ; ipr_prev = ipr_prev->next) {
        if (ipr_prev->next == ipr) {
          break;
        }
...
# 381 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
  do { if(!(sizeof(struct ip6_reass_helper) <= 8)) __assert_func(
                                                    "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
# 381 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
  ,
...
# 381 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
  ...
  iprh = (struct ip6_reass_helper *)p->payload;
  iprh->next_pbuf = 
# 385 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c" 3 4
                   ((void *)0)
# 385 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
                       ;
  ...
  for (q = ipr->p; q != 
# 392 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c" 3 4
                       ((void *)0)
# 392 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
                           ;) {
    ...
    if (iprh->start < iprh_tmp->start) {
      ...
      if (iprh_prev != 
# 402 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c" 3 4
                      ((void *)0)
# 402 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
                          ) {
      ...
      iprh->next_pbuf = q;
      if (iprh_prev != 
# 413 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c" 3 4
                      ((void *)0)
# 413 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
                          ) {
      ...
      if (iprh_prev != 
# 434 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c" 3 4
                      ((void *)0)
# 434 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
                          ) {
  ...
  if (q == 
# 447 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c" 3 4
          ((void *)0)
# 447 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
              ) {
    if (iprh_prev != 
# 448 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c" 3 4
                    ((void *)0)
# 448 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
                        ) {



      do { if(!(iprh_prev->end <= iprh->start)) __assert_func("C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c", 452, __func__, "check fragments don't overlap"); } while(0);
      ...
      do { if(!(ipr->p == 
# 460 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c" 3 4
     ((void *)0)
# 460 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
     )) __assert_func(
                      "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
# 460 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
      ,
...
# 460 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
  ...
  q = iprh->next_pbuf;
  while ((q != 
# 501 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c" 3 4
              ((void *)0)
# 501 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
                  ) && valid) {
  ...
  if (valid) {
    ...
    iprh = (struct ip6_reass_helper*) ipr->p->payload;
    while (iprh != 
# 517 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c" 3 4
                  ((void *)0)
# 517 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
                      ) {
      struct pbuf* next_pbuf = iprh->next_pbuf;
      if (next_pbuf != 
# 519 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c" 3 4
                      ((void *)0)
# 519 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
                          ) {
        ...
        iprh_tmp = 
# 535 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c" 3 4
                  ((void *)0)
# 535 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
                      ;
      }

      iprh = iprh_tmp;
    }
# 550 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
    iphdr_ptr = ipr->iphdr;
    ...
    if (reassdatagrams == ipr) {
      ...
      do { if(!(ipr_prev != 
# 578 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c" 3 4
     ((void *)0)
# 578 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
     )) __assert_func("C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c", 578, __func__, "sanity check linked list"); } while(0);
    ...
    if (pbuf_header_force(p, (s16_t)((u8_t*)p->payload - (u8_t*)iphdr_ptr))) {
      do { if(!(0)) __assert_func("C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c", 589, __func__, "ip6_reass: moving p->payload to ip6 header failed\n"); } while(0);
      pbuf_free(p);
      return 
# 591 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c" 3 4
            ((void *)0)
# 591 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
                ;
    }
  ...
  return 
# 598 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c" 3 4
        ((void *)0)
# 598 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
            ;

nullreturn:
  pbuf_free(p);
  return 
# 602 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c" 3 4
        ((void *)0)
# 602 "C:/esp/esp-idf/components/lwip/core/ipv6/ip6_frag.c"
            ;
}
