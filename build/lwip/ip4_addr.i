# 1 "C:/esp/esp-idf/components/lwip/core/ipv4/ip4_addr.c"
# 1 "C:\\esp\\esp32-ArkPOS2\\ArkPOS2-esp\\build\\lwip//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/lwip/core/ipv4/ip4_addr.c"
# 39 "C:/esp/esp-idf/components/lwip/core/ipv4/ip4_addr.c"
...
# 40 "C:/esp/esp-idf/components/lwip/core/ipv4/ip4_addr.c" 2
...
# 44 "C:/esp/esp-idf/components/lwip/core/ipv4/ip4_addr.c" 2
...
# 45 "C:/esp/esp-idf/components/lwip/core/ipv4/ip4_addr.c" 2
...
# 58 "C:/esp/esp-idf/components/lwip/core/ipv4/ip4_addr.c"
u8_t
...
# 133 "C:/esp/esp-idf/components/lwip/core/ipv4/ip4_addr.c"
u32_t
...
# 155 "C:/esp/esp-idf/components/lwip/core/ipv4/ip4_addr.c"
int
...
# 226 "C:/esp/esp-idf/components/lwip/core/ipv4/ip4_addr.c"
    if (c == '.') {
  ...
  case 4:
    ...
    break;
  default:
    do { if(!(0)) __assert_func("C:/esp/esp-idf/components/lwip/core/ipv4/ip4_addr.c", 290, __func__, "unhandled"); } while(0);
    break;
  }
  if (addr) {
...
# 307 "C:/esp/esp-idf/components/lwip/core/ipv4/ip4_addr.c"
char*
...
# 323 "C:/esp/esp-idf/components/lwip/core/ipv4/ip4_addr.c"
char*
ip4addr_ntoa_r(const ip4_addr_t *addr, char *buf, int buflen)
{
  ...
  for (n = 0; n < 4; n++) {
    ...
    while (i--) {
      if (len++ >= buflen) {
        return 
# 348 "C:/esp/esp-idf/components/lwip/core/ipv4/ip4_addr.c" 3 4
              ((void *)0)
# 348 "C:/esp/esp-idf/components/lwip/core/ipv4/ip4_addr.c"
                  ;
      }
      *rp++ = inv[i];
    }
    if (len++ >= buflen) {
      return 
# 353 "C:/esp/esp-idf/components/lwip/core/ipv4/ip4_addr.c" 3 4
            ((void *)0)
# 353 "C:/esp/esp-idf/components/lwip/core/ipv4/ip4_addr.c"
                ;
    }
    *rp++ = '.';
    ap++;
