# 1 "C:/esp/esp-idf/components/lwip/apps/ping/ping.c"
# 1 "C:\\esp\\esp32-ArkPOS2\\ArkPOS2-esp\\build\\lwip//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/lwip/apps/ping/ping.c"
# 41 "C:/esp/esp-idf/components/lwip/apps/ping/ping.c"
...
# 42 "C:/esp/esp-idf/components/lwip/apps/ping/ping.c" 2



# 1 "C:/esp/esp-idf/components/lwip/apps/ping/ping.h" 1
# 46 "C:/esp/esp-idf/components/lwip/apps/ping/ping.h"
void ping_init(void);
# 46 "C:/esp/esp-idf/components/lwip/apps/ping/ping.c" 2
...
# 48 "C:/esp/esp-idf/components/lwip/apps/ping/ping.c" 2
# 1 "C:/esp/esp-idf/components/lwip/include/lwip/lwip/raw.h" 1
# 39 "C:/esp/esp-idf/components/lwip/include/lwip/lwip/raw.h"
...
# 40 "C:/esp/esp-idf/components/lwip/include/lwip/lwip/raw.h" 2
...
# 41 "C:/esp/esp-idf/components/lwip/include/lwip/lwip/raw.h" 2
...
# 49 "C:/esp/esp-idf/components/lwip/apps/ping/ping.c" 2
...
# 50 "C:/esp/esp-idf/components/lwip/apps/ping/ping.c" 2
...
# 52 "C:/esp/esp-idf/components/lwip/apps/ping/ping.c" 2
...
# 53 "C:/esp/esp-idf/components/lwip/apps/ping/ping.c" 2
...
# 54 "C:/esp/esp-idf/components/lwip/apps/ping/ping.c" 2
...
# 57 "C:/esp/esp-idf/components/lwip/apps/ping/ping.c" 2




# 1 "C:/esp/esp-idf/components/lwip/apps/ping/esp_ping.h" 1
# 31 "C:/esp/esp-idf/components/lwip/apps/ping/esp_ping.h"
...
# 62 "C:/esp/esp-idf/components/lwip/apps/ping/esp_ping.h"
esp_err_t esp_ping_set_target(ping_target_id_t opt_id, void *opt_val, uint32_t opt_len);
# 75 "C:/esp/esp-idf/components/lwip/apps/ping/esp_ping.h"
esp_err_t esp_ping_get_target(ping_target_id_t opt_id, void *opt_val, uint32_t opt_len);
# 88 "C:/esp/esp-idf/components/lwip/apps/ping/esp_ping.h"
esp_err_t esp_ping_result(uint8_t res_val, uint16_t res_len, uint32_t res_time);
# 62 "C:/esp/esp-idf/components/lwip/apps/ping/ping.c" 2
# 102 "C:/esp/esp-idf/components/lwip/apps/ping/ping.c"
...
ping_send(int s, ip_addr_t *addr)
{
  ...
  do { if(!(ping_size <= 0xffff)) __assert_func("C:/esp/esp-idf/components/lwip/apps/ping/ping.c", 139, __func__, "ping_size is too big"); } while(0);
  do { if(!(!(((addr) != 
# 140 "C:/esp/esp-idf/components/lwip/apps/ping/ping.c" 3 4
 ((void *)0)
# 140 "C:/esp/esp-idf/components/lwip/apps/ping/ping.c"
 ) && (((&*(addr))->type) == 6U)))) __assert_func("C:/esp/esp-idf/components/lwip/apps/ping/ping.c", 140, __func__, "ping: expect IPv4 address"); } while(0);
...
# 179 "C:/esp/esp-idf/components/lwip/apps/ping/ping.c" 3 4
       ((void *)0) 
# 179 "C:/esp/esp-idf/components/lwip/apps/ping/ping.c"
...
ping_thread(void *arg)
{
  ...
  do { if(!(ret == 0)) __assert_func("C:/esp/esp-idf/components/lwip/apps/ping/ping.c", 232, __func__, "setting receive timeout failed"); } while(0);
  (void)ret;
  ...
  while (1) {
    ...
    if (ping_send(s, &ping_target) == 0) {
      ...
      do { if((((&ping_target) != 
# 246 "C:/esp/esp-idf/components/lwip/apps/ping/ping.c" 3 4
     ((void *)0)
# 246 "C:/esp/esp-idf/components/lwip/apps/ping/ping.c"
...
# 246 "C:/esp/esp-idf/components/lwip/apps/ping/ping.c"
     ? ((u16_t)(((const u8_t*)(&((&((&ping_target)->u_addr.ip4)))->addr))[3])) : 0);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0); }}while(0);
      ...
      do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("ping: send ");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
      do { if((((&ping_target) != 
# 253 "C:/esp/esp-idf/components/lwip/apps/ping/ping.c" 3 4
     ((void *)0)
# 253 "C:/esp/esp-idf/components/lwip/apps/ping/ping.c"
     ) && (((&*(&ping_target))->type) == 6U))) { do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("%" "x" ":%" "x" ":%" "x" ":%" "x" ":%" "x" ":%" "x" ":%" "x" ":%" "x", ((&((&ping_target)->u_addr.ip6))) != 
# 253 "C:/esp/esp-idf/components/lwip/apps/ping/ping.c" 3 4
     ((void *)0) 
# 253 "C:/esp/esp-idf/components/lwip/apps/ping/ping.c"
...
# 356 "C:/esp/esp-idf/components/lwip/apps/ping/ping.c"
void
ping_init(void)
{

  sys_thread_new("ping_thread", ping_thread, 
# 360 "C:/esp/esp-idf/components/lwip/apps/ping/ping.c" 3 4
                                            ((void *)0)
# 360 "C:/esp/esp-idf/components/lwip/apps/ping/ping.c"
                                                , 2560, ((( 25 )) - 7));
