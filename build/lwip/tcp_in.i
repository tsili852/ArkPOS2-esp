# 1 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
# 1 "C:\\esp\\esp32-ArkPOS2\\ArkPOS2-esp\\build\\lwip//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
# 44 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
...
# 45 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 2
...
# 39 "C:/esp/esp-idf/components/lwip/include/lwip/lwip/tcp.h"
...
# 40 "C:/esp/esp-idf/components/lwip/include/lwip/lwip/tcp.h" 2
...
# 38 "C:/esp/esp-idf/components/lwip/include/lwip/lwip/stats.h"
...
# 49 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 2
...
# 55 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 2
...
# 61 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 2
# 71 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
...
# 103 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
void
...
# 137 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
     ((void *)0)
# 137 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
...
# 138 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
     ((void *)0)
# 138 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
  ...
  tcphdr_opt2 = 
# 162 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
               ((void *)0)
# 162 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                   ;
  if (p->len < hdrlen * 4) {
    if (p->len >= 20) {
      ...
      pbuf_header(p, -20);
      do { if(!(tcphdr_opt1len >= p->len)) __assert_func("C:/esp/esp-idf/components/lwip/core/tcp_in.c", 168, __func__, "tcphdr_opt1len >= p->len"); } while(0);
      do { if(!(p->next != 
# 169 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
     ((void *)0)
# 169 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
     )) __assert_func("C:/esp/esp-idf/components/lwip/core/tcp_in.c", 169, __func__, "p->next != NULL"); } while(0);
      ...
      if (optlen > tcphdr_opt1len) {
        ...
        do { if(!(phret == 0)) __assert_func("C:/esp/esp-idf/components/lwip/core/tcp_in.c", 176, __func__, "phret == 0"); } while(0);
        ...
        do { if(!(phret == 0)) __assert_func("C:/esp/esp-idf/components/lwip/core/tcp_in.c", 186, __func__, "phret == 0"); } while(0);


        p->tot_len -= opt2len;
      }
      do { if(!(p->len == 0)) __assert_func("C:/esp/esp-idf/components/lwip/core/tcp_in.c", 191, __func__, "p->len == 0"); } while(0);
    } else {
  ...
  prev = 
# 214 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
        ((void *)0)
# 214 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
            ;

  for (pcb = tcp_active_pcbs; pcb != 
# 216 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
                                    ((void *)0)
# 216 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                                        ; pcb = pcb->next) {
    do { if(!(pcb->state != CLOSED)) __assert_func("C:/esp/esp-idf/components/lwip/core/tcp_in.c", 217, __func__, "tcp_input: active pcb->state != CLOSED"); } while(0);
    do { if(!(pcb->state != TIME_WAIT)) __assert_func("C:/esp/esp-idf/components/lwip/core/tcp_in.c", 218, __func__, "tcp_input: active pcb->state != TIME-WAIT"); } while(0);
    do { if(!(pcb->state != LISTEN)) __assert_func("C:/esp/esp-idf/components/lwip/core/tcp_in.c", 219, __func__, "tcp_input: active pcb->state != LISTEN"); } while(0);
    if (pcb->remote_port == tcphdr->src &&
      ...
      do { if(!(pcb->next != pcb)) __assert_func("C:/esp/esp-idf/components/lwip/core/tcp_in.c", 227, __func__, "tcp_input: pcb->next != pcb (before cache)"); } while(0);
      if (prev != 
# 228 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
                 ((void *)0)
# 228 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                     ) {
        prev->next = pcb->next;
      ...
      do { if(!(pcb->next != pcb)) __assert_func("C:/esp/esp-idf/components/lwip/core/tcp_in.c", 235, __func__, "tcp_input: pcb->next != pcb (after cache)"); } while(0);
      break;
    }
    prev = pcb;
  }
  ...
  if (pcb == 
# 241 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
            ((void *)0)
# 241 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                ) {


    for (pcb = tcp_tw_pcbs; pcb != 
# 244 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
                                  ((void *)0)
# 244 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                                      ; pcb = pcb->next) {
      do { if(!(pcb->state == TIME_WAIT)) __assert_func("C:/esp/esp-idf/components/lwip/core/tcp_in.c", 245, __func__, "tcp_input: TIME-WAIT pcb->state == TIME-WAIT"); } while(0);
      if (pcb->remote_port == tcphdr->src &&
          pcb->local_port == tcphdr->dest &&
          ((((&pcb->remote_ip)->type) != (((&ip_data.current_iphdr_src))->type)) ? 0 : ((((&*(&pcb->remote_ip))->type) == 6U) ? ((((&((&pcb->remote_ip)->u_addr.ip6)))->addr[0] == ((&(((&ip_data.current_iphdr_src))->u_addr.ip6)))->addr[0]) && (((&((&pcb->remote_ip)->u_addr.ip6)))->addr[1] == ((&(((&ip_data.current_iphdr_src))->u_addr.ip6)))->addr[1]) && (((&((&pcb->remote_ip)->u_addr.ip6)))->addr[2] == ((&(((&ip_data.current_iphdr_src))->u_addr.ip6)))->addr[2]) && (((&((&pcb->remote_ip)->u_addr.ip6)))->addr[3] == ((&(((&ip_data.current_iphdr_src))->u_addr.ip6)))->addr[3])) : (((&((&pcb->remote_ip)->u_addr.ip4)))->addr == ((&(((&ip_data.current_iphdr_src))->u_addr.ip4)))->addr))) &&
          ((((&pcb->local_ip)->type) != (((&ip_data.current_iphdr_dest))->type)) ? 0 : ((((&*(&pcb->local_ip))->type) == 6U) ? ((((&((&pcb->local_ip)->u_addr.ip6)))->addr[0] == ((&(((&ip_data.current_iphdr_dest))->u_addr.ip6)))->addr[0]) && (((&((&pcb->local_ip)->u_addr.ip6)))->addr[1] == ((&(((&ip_data.current_iphdr_dest))->u_addr.ip6)))->addr[1]) && (((&((&pcb->local_ip)->u_addr.ip6)))->addr[2] == ((&(((&ip_data.current_iphdr_dest))->u_addr.ip6)))->addr[2]) && (((&((&pcb->local_ip)->u_addr.ip6)))->addr[3] == ((&(((&ip_data.current_iphdr_dest))->u_addr.ip6)))->addr[3])) : (((&((&pcb->local_ip)->u_addr.ip4)))->addr == ((&(((&ip_data.current_iphdr_dest))->u_addr.ip4)))->addr)))) {
    ...
    prev = 
# 262 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
          ((void *)0)
# 262 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
              ;
    for (lpcb = tcp_listen_pcbs.listen_pcbs; lpcb != 
# 263 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
                                                    ((void *)0)
# 263 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                                                        ; lpcb = lpcb->next) {
...
# 277 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
                    ((void *)0)
# 277 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
...
# 298 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
    if (lpcb != 
# 298 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
               ((void *)0)
# 298 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                   ) {
      ...
      if (prev != 
# 302 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
                 ((void *)0)
# 302 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                     ) {
...
# 326 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
  if (pcb != 
# 326 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
            ((void *)0)
# 326 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                ) {
    ...
    inseg.next = 
# 333 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
                ((void *)0)
# 333 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                    ;
    inseg.len = p->tot_len;
    inseg.p = p;
    inseg.tcphdr = tcphdr;
    ...
    recv_data = 
# 338 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
               ((void *)0)
# 338 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                   ;
    recv_flags = 0;
    ...
    if (pcb->refused_data != 
# 346 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
                            ((void *)0)
# 346 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                                ) {
      if ((tcp_process_refused_data(pcb) == -11) ||
        ((pcb->refused_data != 
# 348 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
                              ((void *)0)
# 348 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                                  ) && (tcplen > 0))) {
    ...
    if (err != -11) {
      if (recv_flags & (u8_t)0x08U) {
        ...
        do { if((pcb->errf) != 
# 366 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
       ((void *)0)
# 366 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
        ...
        if (pcb->acked > 0) {
          u16_t acked;
# 384 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
          {
            acked = pcb->acked;

            do { if((pcb)->sent != 
# 387 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
           ((void *)0)
# 387 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
        ...
        if (recv_flags & (u8_t)0x10U) {
          ...
          if (!(pcb->flags & 0x10U)) {
            ...
            do { if((pcb->errf) != 
# 400 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
           ((void *)0)
# 400 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
        ...
        if (recv_data != 
# 411 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
                        ((void *)0)
# 411 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                            ) {


          do { if(!(pcb->refused_data == 
# 414 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
         ((void *)0)
# 414 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
         )) __assert_func("C:/esp/esp-idf/components/lwip/core/tcp_in.c", 414, __func__, "pcb->refused_data == NULL"); } while(0);
          if (pcb->flags & 0x10U) {
          ...
          do { if((pcb)->recv != 
# 429 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
         ((void *)0)
# 429 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
...
# 429 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
        ...
        if (recv_flags & (u8_t)0x20U) {
          if (pcb->refused_data != 
# 460 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
                                  ((void *)0)
# 460 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                                      ) {
            ...
            do { if(((pcb)->recv != 
# 469 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
           ((void *)0)
# 469 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
...
# 469 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
        ...
        tcp_input_pcb = 
# 476 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
                       ((void *)0)
# 476 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                           ;
...
aborted:
    tcp_input_pcb = 
# 489 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
                   ((void *)0)
# 489 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                       ;
    recv_data = 
# 490 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
               ((void *)0)
# 490 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                   ;


    if (inseg.p != 
# 493 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
                  ((void *)0)
# 493 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                      )
    {
      pbuf_free(inseg.p);
      inseg.p = 
# 496 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
               ((void *)0)
# 496 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                   ;
    }
  } else {
  ...
  do { if(!(1)) __assert_func("C:/esp/esp-idf/components/lwip/core/tcp_in.c", 512, __func__, "tcp_input: tcp_pcbs_sane()"); } while(0);
  ;
  return;
dropped:
  ;
...
# 533 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
static err_t
tcp_listen_input(struct tcp_pcb_listen *pcb)
{
  ...
  if (flags & 0x10U) {
    ...
    if (npcb == 
# 564 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
               ((void *)0)
# 564 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                   ) {
...
# 623 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
static err_t
...
# 669 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
static err_t
tcp_process(struct tcp_pcb *pcb)
{
  ...
  if (flags & 0x04U) {
    ...
    if (acceptable) {
      ...
      do { if(!(pcb->state != CLOSED)) __assert_func("C:/esp/esp-idf/components/lwip/core/tcp_in.c", 694, __func__, "tcp_input: pcb->state != CLOSED"); } while(0);
  ...
  case SYN_SENT:
    ...
    if ((flags & 0x10U) && (flags & 0x02U)
      ...
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {printf ("tcp_process (SENT): cwnd %""d" " ssthresh %""d""\n", pcb->cwnd, pcb->ssthresh);} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0)
                                                             ...
                                                             ;
      do { if(!((pcb->snd_queuelen > 0))) __assert_func("C:/esp/esp-idf/components/lwip/core/tcp_in.c", 749, __func__, "pcb->snd_queuelen > 0"); } while(0);
      --pcb->snd_queuelen;
      ...
      if (pcb->unacked == 
# 758 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
                         ((void *)0)
# 758 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                             ) {
        pcb->rtime = -1;
      } else {
        pcb->rtime = 0;
      ...
      do { if((pcb)->connected != 
# 767 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
     ((void *)0)
# 767 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
  ...
  case SYN_RCVD:
    if (flags & 0x10U) {
      ...
      if ((((s32_t)((u32_t)(ackno) - (u32_t)(pcb->lastack+1)) >= 0) && ((s32_t)((u32_t)(ackno) - (u32_t)(pcb->snd_nxt)) <= 0))) {
        ...
        do { if(!(pcb->accept != 
# 787 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
       ((void *)0)
# 787 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
       )) __assert_func("C:/esp/esp-idf/components/lwip/core/tcp_in.c", 787, __func__, "pcb->accept != NULL"); } while(0);


        do { if((pcb)->accept != 
# 790 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
       ((void *)0)
# 790 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
...
# 850 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
       ((void *)0)
# 850 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
...
# 850 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
  ...
  case FIN_WAIT_2:
    ...
    if (recv_flags & (u8_t)0x20U) {
      ...
      tcp_pcb_purge(pcb);
      do { do { if(*(&tcp_active_pcbs) == (pcb)) { (*(&tcp_active_pcbs)) = (*&tcp_active_pcbs)->next; } else { struct tcp_pcb *tcp_tmp_pcb; for (tcp_tmp_pcb = *&tcp_active_pcbs; tcp_tmp_pcb != 
# 867 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
     ((void *)0)
# 867 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
     ; tcp_tmp_pcb = tcp_tmp_pcb->next) { if(tcp_tmp_pcb->next == (pcb)) { tcp_tmp_pcb->next = (pcb)->next; break; } } } (pcb)->next = 
# 867 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
     ((void *)0)
# 867 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
  ...
  case CLOSING:
    ...
    if (flags & 0x10U && ackno == pcb->snd_nxt) {
      ...
      tcp_pcb_purge(pcb);
      do { do { if(*(&tcp_active_pcbs) == (pcb)) { (*(&tcp_active_pcbs)) = (*&tcp_active_pcbs)->next; } else { struct tcp_pcb *tcp_tmp_pcb; for (tcp_tmp_pcb = *&tcp_active_pcbs; tcp_tmp_pcb != 
# 877 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
     ((void *)0)
# 877 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
     ; tcp_tmp_pcb = tcp_tmp_pcb->next) { if(tcp_tmp_pcb->next == (pcb)) { tcp_tmp_pcb->next = (pcb)->next; break; } } } (pcb)->next = 
# 877 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
     ((void *)0)
# 877 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
...
tcp_oos_insert_segment(struct tcp_seg *cseg, struct tcp_seg *next)
{
  ...
  if ((lwip_ntohs((cseg->tcphdr)->_hdrlen_rsvd_flags) & 0x3fU) & 0x01U) {
    ...
    tcp_segs_free(next);
    next = 
# 910 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
          ((void *)0)
# 910 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
              ;
  } else {
...
# 948 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
static void
tcp_receive(struct tcp_pcb *pcb)
{
  ...
  do { if(!(pcb->state >= ESTABLISHED)) __assert_func("C:/esp/esp-idf/components/lwip/core/tcp_in.c", 966, __func__, "tcp_receive: wrong state"); } while(0);
...
# 1003 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
    }
# 1026 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
...
# 1102 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
     ((void *)0)
# 1102 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
...
# 1102 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
     ? lwip_ntohl(pcb->unacked->tcphdr->seqno) + ((pcb->unacked)->len + ((((lwip_ntohs(((pcb->unacked)->tcphdr)->_hdrlen_rsvd_flags) & 0x3fU) & (0x01U | 0x02U)) != 0) ? 1U : 0U)): 0);} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0)
      ...
      while (pcb->unacked != 
# 1111 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
                            ((void *)0) 
# 1111 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                                 &&
        ...
        do { if(!((pcb->snd_queuelen >= pbuf_clen(next->p)))) __assert_func("C:/esp/esp-idf/components/lwip/core/tcp_in.c", 1123, __func__, "pcb->snd_queuelen >= pbuf_clen(next->p)"); } while(0);
        ...
        if (pcb->snd_queuelen != 0) {
          do { if(!(pcb->unacked != 
# 1134 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
         ((void *)0) 
# 1134 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
         || pcb->unsent != 
# 1134 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
         ((void *)0)
# 1134 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
...
# 1134 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
      ...
      if (pcb->unacked == 
# 1141 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
                         ((void *)0)
# 1141 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                             ) {
        pcb->rtime = -1;
      } else {
        pcb->rtime = 0;
...
# 1150 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
         ((void *)0)
# 1150 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
         )) {
    ...
    while (pcb->unsent != 
# 1167 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
                         ((void *)0) 
# 1167 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                              &&
      ...
      if (pcb->unsent == 
# 1177 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
                        ((void *)0)
# 1177 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                            ) {
        pcb->unsent_oversize = 0;
      }

      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {printf ("tcp_receive: queuelen %""d"" ... ", (tcpwnd_size_t)pcb->snd_queuelen);} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      do { if(!((pcb->snd_queuelen >= pbuf_clen(next->p)))) __assert_func("C:/esp/esp-idf/components/lwip/core/tcp_in.c", 1182, __func__, "pcb->snd_queuelen >= pbuf_clen(next->p)"); } while(0);
      ...
      if (pcb->snd_queuelen != 0) {
        do { if(!(pcb->unacked != 
# 1191 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
       ((void *)0) 
# 1191 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
       || pcb->unsent != 
# 1191 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
       ((void *)0)
# 1191 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
...
# 1263 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
    if ((((s32_t)((u32_t)(pcb->rcv_nxt) - (u32_t)(seqno + 1)) >= 0) && ((s32_t)((u32_t)(pcb->rcv_nxt) - (u32_t)(seqno + tcplen - 1)) <= 0))) {
# 1284 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
      off = pcb->rcv_nxt - seqno;
      p = inseg.p;
      do { if(!(inseg.p)) __assert_func("C:/esp/esp-idf/components/lwip/core/tcp_in.c", 1286, __func__, "inseg.p != NULL"); } while(0);
      do { if(!((off < 0x7fff))) __assert_func("C:/esp/esp-idf/components/lwip/core/tcp_in.c", 1287, __func__, "insane offset!"); } while(0);
      if (inseg.p->len < off) {
        do { if(!((((s32_t)inseg.p->tot_len) >= off))) __assert_func("C:/esp/esp-idf/components/lwip/core/tcp_in.c", 1289, __func__, "pbuf too short!"); } while(0);
        ...
        if (pbuf_header(p, (s16_t)-off)) {
          ...
          do { if(!(0)) __assert_func("C:/esp/esp-idf/components/lwip/core/tcp_in.c", 1302, __func__, "pbuf_header failed"); } while(0);
        }
      } else {
        if (pbuf_header(inseg.p, (s16_t)-off)) {

          do { if(!(0)) __assert_func("C:/esp/esp-idf/components/lwip/core/tcp_in.c", 1307, __func__, "pbuf_header failed"); } while(0);
        }
      }
      ...
      if (pcb->rcv_nxt == seqno) {
        ...
        if (tcplen > pcb->rcv_wnd) {
          ...
          do { if(!((seqno + tcplen) == (pcb->rcv_nxt + pcb->rcv_wnd))) __assert_func(
                                                                       "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
# 1352 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
          ,
                                                                       1353
# 1352 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
        ...
        if (pcb->ooseq != 
# 1359 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
                         ((void *)0)
# 1359 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                             ) {
          if ((lwip_ntohs((inseg.tcphdr)->_hdrlen_rsvd_flags) & 0x3fU) & 0x01U) {
            ...
            while (pcb->ooseq != 
# 1366 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
                                ((void *)0)
# 1366 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                                    ) {
            ...
            if (next &&
              ...
              do { if(!((seqno + tcplen) == next->tcphdr->seqno)) __assert_func(
                                                                 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
# 1400 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
              ,
                                                                 1401
# 1400 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
        ...
        do { if(!(pcb->rcv_wnd >= tcplen)) __assert_func("C:/esp/esp-idf/components/lwip/core/tcp_in.c", 1411, __func__, "tcp_receive: tcplen > rcv_wnd\n"); } while(0);
        pcb->rcv_wnd -= tcplen;

        tcp_update_rcv_ann_wnd(pcb);
# 1425 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
        if (inseg.p->tot_len > 0) {
          ...
          inseg.p = 
# 1430 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
                   ((void *)0)
# 1430 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                       ;
        }
        if ((lwip_ntohs((inseg.tcphdr)->_hdrlen_rsvd_flags) & 0x3fU) & 0x01U) {
        ...
        while (pcb->ooseq != 
# 1440 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
                            ((void *)0) 
# 1440 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                                 &&
          ...
          do { if(!(pcb->rcv_wnd >= ((cseg)->len + ((((lwip_ntohs(((cseg)->tcphdr)->_hdrlen_rsvd_flags) & 0x3fU) & (0x01U | 0x02U)) != 0) ? 1U : 0U)))) __assert_func(
                                                      "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
# 1447 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
          ,
                                                      1448
# 1447 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
          ...
          if (cseg->p->tot_len > 0) {
            ...
            cseg->p = 
# 1464 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
                     ((void *)0)
# 1464 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                         ;
          }
          if ((lwip_ntohs((cseg->tcphdr)->_hdrlen_rsvd_flags) & 0x3fU) & 0x01U) {
        ...
        if ((((const struct ip6_hdr*)(ip_data.current_ip6_header)) != 
# 1484 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
           ((void *)0)
# 1484 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
           )) {
        ...
        if (pcb->ooseq == 
# 1495 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
                         ((void *)0)
# 1495 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                             ) {
          pcb->ooseq = tcp_seg_copy(&inseg);
        } else {
# 1510 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
          prev = 
# 1510 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
                ((void *)0)
# 1510 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                    ;
          for (next = pcb->ooseq; next != 
# 1511 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
                                         ((void *)0)
# 1511 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                                             ; next = next->next) {
            if (seqno == next->tcphdr->seqno) {
              ...
              if (inseg.len > next->len) {
                ...
                if (cseg != 
# 1522 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
                           ((void *)0)
# 1522 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                               ) {
                  if (prev != 
# 1523 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
                             ((void *)0)
# 1523 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                                 ) {
                    prev->next = cseg;
                  } else {
                    pcb->ooseq = cseg;
              ...
              if (prev == 
# 1538 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
                         ((void *)0)
# 1538 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                             ) {
                if (((s32_t)((u32_t)(seqno) - (u32_t)(next->tcphdr->seqno)) < 0)) {
                  ...
                  cseg = tcp_seg_copy(&inseg);
                  if (cseg != 
# 1545 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
                             ((void *)0)
# 1545 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                                 ) {
                    pcb->ooseq = cseg;
                    tcp_oos_insert_segment(cseg, next);
                  }
                ...
                if ((((s32_t)((u32_t)(seqno) - (u32_t)(prev->tcphdr->seqno+1)) >= 0) && ((s32_t)((u32_t)(seqno) - (u32_t)(next->tcphdr->seqno-1)) <= 0))) {
                  ...
                  cseg = tcp_seg_copy(&inseg);
                  if (cseg != 
# 1561 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
                             ((void *)0)
# 1561 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                                 ) {
              ...
              if (next->next == 
# 1576 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
                               ((void *)0) 
# 1576 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                                    &&
                ...
                if (next->next != 
# 1583 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
                                 ((void *)0)
# 1583 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                                     ) {
                  ...
                  if (((s32_t)((u32_t)((u32_t)tcplen + seqno) - (u32_t)(pcb->rcv_nxt + (u32_t)pcb->rcv_wnd)) > 0)) {
                    ...
                    do { if(!((seqno + tcplen) == (pcb->rcv_nxt + pcb->rcv_wnd))) __assert_func(
                                                                                 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
# 1604 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                    ,
                                                                                 1605
# 1604 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
                    , __func__, "tcp_receive: segment not trimmed correctly to rcv_wnd\n"); } while(0)
...
# 1640 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
      }
    } else {
...
{
  if ((tcphdr_opt2 == 
# 1657 "C:/esp/esp-idf/components/lwip/core/tcp_in.c" 3 4
                     ((void *)0)
# 1657 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
...
# 1674 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
static void
  ...
  if (tcphdr_optlen != 0) {
    for (tcp_optidx = 0; tcp_optidx < tcphdr_optlen; ) {
      ...
      case 2:
        ...
        break;
# 1760 "C:/esp/esp-idf/components/lwip/core/tcp_in.c"
      default:
