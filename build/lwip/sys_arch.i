# 1 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c"
# 1 "C:\\esp\\esp32-ArkPOS2\\ArkPOS2-esp\\build\\lwip//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c"
# 35 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c"
...
# 37 "C:/esp/esp-idf/components/lwip/include/lwip/port/arch/cc.h"
...
# 38 "C:/esp/esp-idf/components/lwip/include/lwip/port/arch/cc.h" 2
...
# 40 "C:/esp/esp-idf/components/lwip/include/lwip/port/arch/cc.h" 2
...
# 41 "C:/esp/esp-idf/components/lwip/include/lwip/port/arch/cc.h" 2
...
# 36 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c" 2
...
# 37 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c" 2
# 1 "C:/esp/esp-idf/components/lwip/include/lwip/lwip/sys.h" 1
# 89 "C:/esp/esp-idf/components/lwip/include/lwip/lwip/sys.h"
...
# 90 "C:/esp/esp-idf/components/lwip/include/lwip/lwip/sys.h" 2
...
# 38 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c" 2
...
# 39 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c" 2
...
# 41 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c" 2
...
# 42 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c" 2
...
# 47 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c" 3 4
                                         ((void *)0)
# 47 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c"
                                             ;
...
sys_mutex_new(sys_mutex_t *pxMutex)
{
  ...
  *pxMutex = xQueueCreateMutex( ( ( uint8_t ) 1U ) );
  ...
  if (*pxMutex != 
# 60 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c" 3 4
                 ((void *)0)
# 60 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c"
                     ) {
    xReturn = 0;
  }
...
# 74 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c" 3 4
        ((void *)0)
# 74 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c"
...
# 80 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c" 3 4
     ((void *)0)
# 80 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c"
...
# 89 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c" 3 4
 ((void *)0)
# 89 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c"
...
# 109 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c" 3 4
 ((void *)0) 
# 109 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c"
...
# 109 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c"
 , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) ); } };
  ...
  if ((*sem) != 
# 111 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c" 3 4
               ((void *)0)
# 111 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c"
                   ) {
    if (count == 0) {
      xQueueGenericReceive( ( QueueHandle_t ) ( *sem ), 
# 113 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c" 3 4
     ((void *)0)
# 113 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c"
     , ( 1 ), ( ( BaseType_t ) 0 ) );
    }
...
# 129 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c" 3 4
   ((void *)0)
# 129 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c"
   , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
}
# 148 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c"
u32_t
...
# 157 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c" 3 4
       ((void *)0)
# 157 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c"
...
# 170 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c" 3 4
          ((void *)0)
# 170 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c"
          , ( ( TickType_t ) 0xffffffffUL ), ( ( BaseType_t ) 0 ) ) != ( ( BaseType_t ) 1 ));
...
sys_mbox_new(sys_mbox_t *mbox, int size)
{
  *mbox = malloc(sizeof(struct sys_mbox_s));
  if (*mbox == 
# 199 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c" 3 4
              ((void *)0)
# 199 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c"
                  ){
  ...
  if ((*mbox)->os_mbox == 
# 206 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c" 3 4
                         ((void *)0)
# 206 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c"
                             ) {
  ...
  (*mbox)->alive = 
# 219 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c" 3 4
                  1
# 219 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c"
                      ;
...
# 265 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c"
u32_t
sys_arch_mbox_fetch(sys_mbox_t *mbox, void **msg, u32_t timeout)
{
  ...
  StartTime = xTaskGetTickCount();
  if (msg == 
# 273 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c" 3 4
            ((void *)0)
# 273 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c"
                ) {
    msg = &dummyptr;
  }

  if (*mbox == 
# 277 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c" 3 4
              ((void *)0)
# 277 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c"
                  ){
    *msg = 
# 278 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c" 3 4
          ((void *)0)
# 278 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c"
              ;
  ...
  if (timeout != 0) {
    if (( ( BaseType_t ) 1 ) == xQueueGenericReceive( ( (*mbox)->os_mbox ), ( &(*msg) ), ( timeout / ( ( TickType_t ) 1000 / ( 100 ) ) ), ( ( BaseType_t ) 0 ) )) {
      ...
      *msg = 
# 296 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c" 3 4
            ((void *)0)
# 296 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c"
                ;
      ulReturn = 0xffffffffUL;
    }
  } else {
    ...
    while (1){
      ...
      if ((*mbox)->alive == 
# 308 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c" 3 4
                           0
# 308 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c"
                                ){
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {printf ("sys_arch_mbox_fetch:mbox not alive\n");} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
        *msg = 
# 310 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c" 3 4
              ((void *)0)
# 310 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c"
                  ;
        break;
      }
    }
...
sys_arch_mbox_tryfetch(sys_mbox_t *mbox, void **msg)
{
  ...
  if (msg == 
# 337 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c" 3 4
            ((void *)0)
# 337 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c"
                ) {
    msg = &pvDummy;
  }
...
# 362 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c" 3 4
 _Bool 
# 362 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c"
      post_null = 
# 362 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c" 3 4
                  1
# 362 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c"
  ...
  (*mbox)->alive = 
# 365 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c" 3 4
                  0
# 365 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c"
                       ;
...
# 377 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c" 3 4
                                 ((void *)0)
# 377 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c"
                                     ) != 0){
        ;
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {printf ("sys_mbox_free: post null mbox fail\n");} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      } else {
        post_null = 
# 381 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c" 3 4
                   0
# 381 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c"
                        ;
  ...
  free(*mbox);
  *mbox = 
# 403 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c" 3 4
         ((void *)0)
# 403 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c"
             ;
}
# 413 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c"
sys_thread_t
sys_thread_new(const char *name, lwip_thread_fn thread, void *arg, int stacksize, int prio)
{
  ...
  if (result == ( ( ( BaseType_t ) 1 ) )) {
    ...
    return 
# 424 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c" 3 4
          ((void *)0)
# 424 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c"
              ;
  }
}
...
# 465 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c"
sys_prot_t
...
# 479 "C:/esp/esp-idf/components/lwip/port/freertos/sys_arch.c"
void
