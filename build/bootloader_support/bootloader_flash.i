...
const void *bootloader_mmap(uint32_t src_addr, uint32_t size)
{
    if (map) {
        ...
        return 
# 32 "C:/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c" 3 4
              ((void *)0)
# 32 "C:/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c"
                  ;
    }
    const void *result = 
# 34 "C:/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c" 3 4
                        ((void *)0)
# 34 "C:/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c"
                            ;
    ...
    if (err != 0) {
        result = 
# 39 "C:/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c" 3 4
                ((void *)0)
# 39 "C:/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c"
                    ;
    }
...
# 52 "C:/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c" 3 4
                                                                    _Bool 
# 52 "C:/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c"
                                                                         allow_decrypt)
{
...
esp_err_t bootloader_flash_write(size_t dest_addr, void *src, size_t size, 
# 61 "C:/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c" 3 4
                                                                          _Bool 
# 61 "C:/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c"
                                                                               write_encrypted)
{
    if (write_encrypted) {
