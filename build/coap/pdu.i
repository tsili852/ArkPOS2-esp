# 1 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c"
# 1 "C:\\esp\\ArkPOS2-esp\\build\\coap//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c"
# 9 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c"
...
# 10 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c" 2
...
# 18 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c" 2

# 1 "C:/esp/esp-idf/components/lwip/include/lwip/port/arpa/inet.h" 1
# 20 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c" 2
...
# 23 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c" 2
# 1 "C:/esp/esp-idf/components/coap/libcoap/include/coap/pdu.h" 1
# 24 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c" 2
...
# 25 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c" 2
...
# 26 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c" 2
...
# 27 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c" 2

void
coap_pdu_clear(coap_pdu_t *pdu, size_t size) {
  ((pdu) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/coap/libcoap/src/pdu.c", 30, __func__, "pdu"));
  ...
  pdu->max_delta = 0;
  pdu->data = 
# 38 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c" 3 4
             ((void *)0)
# 38 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c"
                 ;
...
# 74 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c"
coap_pdu_t *
coap_pdu_init(unsigned char type, unsigned char code,
  ...
  ((size <= 1400) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/coap/libcoap/src/pdu.c", 82, __func__, "size <= COAP_MAX_PDU_SIZE"));

  if (size < sizeof(coap_hdr_t) || size > 1400)
    return 
# 85 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c" 3 4
          ((void *)0)
# 85 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c"
              ;
  ...
  if (!pdu) return 
# 90 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c" 3 4
                  ((void *)0)
# 90 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c"
                      ;
  pdu->hdr = coap_malloc_type(COAP_PDU_BUF, size);
  if (pdu->hdr == 
# 92 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c" 3 4
                 ((void *)0)
# 92 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c"
                     ) {
    coap_free_type(COAP_PDU, pdu);
    pdu = 
# 94 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c" 3 4
         ((void *)0)
# 94 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c"
             ;
  }
# 106 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c"
  if (pdu) {
...
coap_delete_pdu(coap_pdu_t *pdu) {
  ...
  if (pdu != 
# 138 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c" 3 4
            ((void *)0)
# 138 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c"
                ) {
    if (pdu->hdr != 
# 139 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c" 3 4
                   ((void *)0)
# 139 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c"
                       ) {
...
coap_add_token(coap_pdu_t *pdu, size_t len, const unsigned char *data) {
  ...
  pdu->data = 
# 164 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c" 3 4
             ((void *)0)
# 164 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c"
                 ;
...
coap_add_option(coap_pdu_t *pdu, unsigned short type, unsigned int len, const unsigned char *data) {
  ...
  ((pdu) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/coap/libcoap/src/pdu.c", 175, __func__, "pdu"));
  pdu->data = 
# 176 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c" 3 4
             ((void *)0)
# 176 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c"
                 ;
...
coap_add_option_later(coap_pdu_t *pdu, unsigned short type, unsigned int len) {
  ...
  ((pdu) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/coap/libcoap/src/pdu.c", 207, __func__, "pdu"));
  pdu->data = 
# 208 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c" 3 4
             ((void *)0)
# 208 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c"
                 ;

  if (type < pdu->max_delta) {
    coap_log_impl(LOG_WARNING, "coap_add_option: options are not in correct order\n");
    return 
# 212 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c" 3 4
          ((void *)0)
# 212 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c"
              ;
  }
  ...
  optsize = coap_opt_encode(opt, pdu->max_size - pdu->length,
       type - pdu->max_delta, 
# 219 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c" 3 4
                             ((void *)0)
# 219 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c"
                                 , len);
  ...
  if (!optsize) {
    ...
    return 
# 224 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c" 3 4
          ((void *)0)
# 224 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c"
              ;
  } else {
    pdu->max_delta = type;
    pdu->length += optsize;
...
coap_add_data(coap_pdu_t *pdu, unsigned int len, const unsigned char *data) {
  ((pdu) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/coap/libcoap/src/pdu.c", 235, __func__, "pdu"));
  ((pdu->data == 
# 236 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c" 3 4
 ((void *)0)
# 236 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c"
 ) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/coap/libcoap/src/pdu.c", 236, __func__, "pdu->data == NULL"));
  ...
  if (pdu->length + len + 1 > pdu->max_size) {
    ...
    ((pdu->data == 
# 243 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c" 3 4
   ((void *)0)
# 243 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c"
   ) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/coap/libcoap/src/pdu.c", 243, __func__, "pdu->data == NULL"));
    return 0;
  }
...
coap_get_data(coap_pdu_t *pdu, size_t *len, unsigned char **data) {
  ((pdu) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/coap/libcoap/src/pdu.c", 258, __func__, "pdu"));
  ((len) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/coap/libcoap/src/pdu.c", 259, __func__, "len"));
  ((data) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/coap/libcoap/src/pdu.c", 260, __func__, "data"));
  ...
  if (pdu->data) {
    ...
    *len = 0;
    *data = 
# 267 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c" 3 4
           ((void *)0)
# 267 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c"
               ;
  }

  return *data != 
# 270 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c" 3 4
                 ((void *)0)
# 270 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c"
                     ;
}
...
error_desc_t coap_error[] = {
  ...
  { 0, 
# 305 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c" 3 4
      ((void *)0) 
# 305 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c"
           }
};
...
coap_response_phrase(unsigned char code) {
  ...
  return 
# 315 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c" 3 4
        ((void *)0)
# 315 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c"
            ;
}
...
next_option_safe(coap_opt_t **optp, size_t *length) {
  ...
  ((optp) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/coap/libcoap/src/pdu.c", 329, __func__, "optp")); ((*optp) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/coap/libcoap/src/pdu.c", 329, __func__, "*optp"));
  ((length) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/coap/libcoap/src/pdu.c", 330, __func__, "length"));

  optsize = coap_opt_parse(*optp, *length, &option);
  if (optsize) {
    ((optsize <= *length) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/coap/libcoap/src/pdu.c", 334, __func__, "optsize <= *length"));
...
coap_pdu_parse(unsigned char *data, size_t length, coap_pdu_t *pdu) {
  ...
  ((data) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/coap/libcoap/src/pdu.c", 347, __func__, "data"));
  ((pdu) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/coap/libcoap/src/pdu.c", 348, __func__, "pdu"));
...
# 367 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c"
  ...
  pdu->data = 
# 372 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c" 3 4
             ((void *)0)
# 372 "C:/esp/esp-idf/components/coap/libcoap/src/pdu.c"
                 ;
  ...
  if (length) {
    ((*opt == 0xFF) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/coap/libcoap/src/pdu.c", 416, __func__, "*opt == COAP_PAYLOAD_START"));
    opt++; length--;
