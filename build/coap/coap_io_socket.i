# 1 "C:/esp/esp-idf/components/coap/port/coap_io_socket.c"
# 1 "C:\\esp\\ArkPOS2-esp\\build\\coap//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/coap/port/coap_io_socket.c"
# 17 "C:/esp/esp-idf/components/coap/port/coap_io_socket.c"
...
# 18 "C:/esp/esp-idf/components/coap/port/coap_io_socket.c" 2
# 27 "C:/esp/esp-idf/components/coap/port/coap_io_socket.c"
# 1 "C:/esp/esp-idf/components/lwip/include/lwip/posix/sys/socket.h" 1
# 28 "C:/esp/esp-idf/components/coap/port/coap_io_socket.c" 2
# 44 "C:/esp/esp-idf/components/coap/port/coap_io_socket.c"
...
int coap_get_data(coap_pdu_t *pdu,
                  size_t *len,
                  unsigned char **data);
# 45 "C:/esp/esp-idf/components/coap/port/coap_io_socket.c" 2
...
# 46 "C:/esp/esp-idf/components/coap/port/coap_io_socket.c" 2
...
# 47 "C:/esp/esp-idf/components/coap/port/coap_io_socket.c" 2
...
void coap_packet_get_memmapped(coap_packet_t *packet,
                               ...
                               size_t *length);
# 48 "C:/esp/esp-idf/components/coap/port/coap_io_socket.c" 2
# 68 "C:/esp/esp-idf/components/coap/port/coap_io_socket.c"
struct coap_packet_t {
...
# 136 "C:/esp/esp-idf/components/coap/port/coap_io_socket.c"
...
coap_new_endpoint(const coap_address_t *addr, int flags) {
  ...
  if (sockfd < 0) {
    ...
    return 
# 154 "C:/esp/esp-idf/components/coap/port/coap_io_socket.c" 3 4
          ((void *)0)
# 154 "C:/esp/esp-idf/components/coap/port/coap_io_socket.c"
              ;
  }
  ...
  if (lwip_bind_r(sockfd,&addr->addr.sa,addr->size) < 0) {
    ...
    lwip_close_r(sockfd);
    return 
# 163 "C:/esp/esp-idf/components/coap/port/coap_io_socket.c" 3 4
          ((void *)0)
# 163 "C:/esp/esp-idf/components/coap/port/coap_io_socket.c"
              ;
  }
  ...
  if (!ep) {
    ...
    lwip_close_r(sockfd);
    return 
# 170 "C:/esp/esp-idf/components/coap/port/coap_io_socket.c" 3 4
          ((void *)0)
# 170 "C:/esp/esp-idf/components/coap/port/coap_io_socket.c"
              ;
  }
  ...
  if (lwip_getsockname_r(sockfd,&ep->addr.addr.sa,&ep->addr.size) < 0) {
    ...
    lwip_close_r(sockfd);
    return 
# 181 "C:/esp/esp-idf/components/coap/port/coap_io_socket.c" 3 4
          ((void *)0)
# 181 "C:/esp/esp-idf/components/coap/port/coap_io_socket.c"
              ;
  }
...
# 220 "C:/esp/esp-idf/components/coap/port/coap_io_socket.c"
struct in6_pktinfo {
...
# 243 "C:/esp/esp-idf/components/coap/port/coap_io_socket.c"
ssize_t
...
# 271 "C:/esp/esp-idf/components/coap/port/coap_io_socket.c"
...
# 300 "C:/esp/esp-idf/components/coap/port/coap_io_socket.c"
...
coap_network_read(coap_endpoint_t *ep, coap_packet_t **packet) {
  ...
  char *soc_appdata = 
# 342 "C:/esp/esp-idf/components/coap/port/coap_io_socket.c" 3 4
                     ((void *)0)
# 342 "C:/esp/esp-idf/components/coap/port/coap_io_socket.c"
                         ;
  struct sockaddr_in soc_srcipaddr;
  socklen_t soc_srcsize = sizeof(struct sockaddr_in);


  ((ep) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/coap/port/coap_io_socket.c", 347, __func__, "ep"));
  ((packet) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/coap/port/coap_io_socket.c", 348, __func__, "packet"));
  ...
  *packet = coap_malloc_packet();
  ...
  if (soc_appdata){
   ...
   soc_appdata = 
# 398 "C:/esp/esp-idf/components/coap/port/coap_io_socket.c" 3 4
                ((void *)0)
# 398 "C:/esp/esp-idf/components/coap/port/coap_io_socket.c"
                    ;
  } else {
   goto error;
  }
# 452 "C:/esp/esp-idf/components/coap/port/coap_io_socket.c"
  (*packet)->interface = ep;
 ...
 error:
  ...
  if (soc_appdata)
   coap_free(soc_appdata);
  soc_appdata = 
# 459 "C:/esp/esp-idf/components/coap/port/coap_io_socket.c" 3 4
               ((void *)0)
# 459 "C:/esp/esp-idf/components/coap/port/coap_io_socket.c"
                   ;

  coap_free_packet(*packet);
  *packet = 
# 462 "C:/esp/esp-idf/components/coap/port/coap_io_socket.c" 3 4
           ((void *)0)
# 462 "C:/esp/esp-idf/components/coap/port/coap_io_socket.c"
               ;
  return -1;
}
