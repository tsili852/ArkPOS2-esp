# 1 "C:/esp/esp-idf/components/newlib/locks.c"
# 1 "C:\\esp\\ArkPOS2-esp\\build\\newlib//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/newlib/locks.c"
# 15 "C:/esp/esp-idf/components/newlib/locks.c"
...
# 16 "C:/esp/esp-idf/components/newlib/locks.c" 2
...
# 17 "C:/esp/esp-idf/components/newlib/locks.c" 2

# 1 "C:/esp/esp-idf/components/esp32/include/esp_attr.h" 1
# 19 "C:/esp/esp-idf/components/newlib/locks.c" 2
...
# 20 "C:/esp/esp-idf/components/newlib/locks.c" 2
...
# 21 "C:/esp/esp-idf/components/newlib/locks.c" 2
...
# 22 "C:/esp/esp-idf/components/newlib/locks.c" 2
# 1 "C:/esp/esp-idf/components/freertos/include/freertos/portmacro.h" 1
# 23 "C:/esp/esp-idf/components/newlib/locks.c" 2
...
# 24 "C:/esp/esp-idf/components/newlib/locks.c" 2
# 1 "C:/esp/esp-idf/components/freertos/include/freertos/portable.h" 1
# 25 "C:/esp/esp-idf/components/newlib/locks.c" 2
# 42 "C:/esp/esp-idf/components/newlib/locks.c"
...
static void __attribute__((section(".iram1"))) lock_init_generic(_lock_t *lock, uint8_t mutex_type) {
    ...
    {
# 79 "C:/esp/esp-idf/components/newlib/locks.c"
...
# 108 "C:/esp/esp-idf/components/newlib/locks.c"
...
# 113 "C:/esp/esp-idf/components/newlib/locks.c" 3 4
       ((void *)0)
# 113 "C:/esp/esp-idf/components/newlib/locks.c"
       )) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/newlib/locks.c", 113, __FUNCTION__); abort(); };
...
static int __attribute__((section(".iram1"))) lock_acquire_generic(_lock_t *lock, uint32_t delay, uint8_t mutex_type) {
    ...
    if (!h) {
        ...
        if (!(h != 
# 134 "C:/esp/esp-idf/components/newlib/locks.c" 3 4
       ((void *)0)
# 134 "C:/esp/esp-idf/components/newlib/locks.c"
       )) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/newlib/locks.c", 134, __FUNCTION__); abort(); };
    }
...
# 143 "C:/esp/esp-idf/components/newlib/locks.c" 3 4
                                      0
# 143 "C:/esp/esp-idf/components/newlib/locks.c"
                                           ;
        success = xQueueReceiveFromISR( ( QueueHandle_t ) ( h ), 
# 144 "C:/esp/esp-idf/components/newlib/locks.c" 3 4
                 ((void *)0)
# 144 "C:/esp/esp-idf/components/newlib/locks.c"
                 , ( &higher_task_woken ) );
        if (!success && delay > 0) {
            abort();
        }
...
# 157 "C:/esp/esp-idf/components/newlib/locks.c" 3 4
                     ((void *)0)
# 157 "C:/esp/esp-idf/components/newlib/locks.c"
                     , ( delay ), ( ( BaseType_t ) 0 ) );
        }
    }
...
static void __attribute__((section(".iram1"))) lock_release_generic(_lock_t *lock, uint8_t mutex_type) {
    SemaphoreHandle_t h = (SemaphoreHandle_t)(*lock);
    if (h == 
# 185 "C:/esp/esp-idf/components/newlib/locks.c" 3 4
            ((void *)0)
# 185 "C:/esp/esp-idf/components/newlib/locks.c"
                ) {
    ...
    if (xPortInIsrContext()) {
        ...
        BaseType_t higher_task_woken = 
# 196 "C:/esp/esp-idf/components/newlib/locks.c" 3 4
                                      0
# 196 "C:/esp/esp-idf/components/newlib/locks.c"
                                           ;
...
# 205 "C:/esp/esp-idf/components/newlib/locks.c" 3 4
           ((void *)0)
# 205 "C:/esp/esp-idf/components/newlib/locks.c"
