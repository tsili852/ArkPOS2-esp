...
lock_init_generic:
.LFB13:
	.file 1 "C:/esp/esp-idf/components/newlib/locks.c"
	.loc 1 50 0
.LVL0:
	entry	sp, 32
.LCFI0:
...
.LFE13:
	...
	.align	4
.LC2:
	.string	"C:/esp/esp-idf/components/newlib/locks.c"
	.align	4
.LC4:
	.string	"%s:%d (%s)- assert failed!\n"
	.section	.iram1
	.literal_position
	.literal .LC1, __FUNCTION__$4928
	.literal .LC3, .LC2
	.literal .LC5, .LC4
	.align	4
...
.LEFDE22:
	.text
.Letext0:
	.file 2 "C:/esp/esp-idf/components/newlib/include/sys/lock.h"
	...
	.file 11 "C:/esp/esp-idf/components/freertos/include/freertos/portable.h"
