# 1 "C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_queue.c"
# 1 "C:\\esp\\ArkPOS2-esp\\build\\nghttp//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_queue.c"
# 25 "C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_queue.c"
# 1 "C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_queue.h" 1
# 29 "C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_queue.h"
...
# 30 "C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_queue.h" 2
...
# 33 "C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_queue.h" 2
...
# 26 "C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_queue.c" 2
...
# 29 "C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_queue.c" 2

void nghttp2_queue_init(nghttp2_queue *queue) {
  queue->front = queue->back = 
# 31 "C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_queue.c" 3 4
                              ((void *)0)
# 31 "C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_queue.c"
                                  ;
}
...
int nghttp2_queue_push(nghttp2_queue *queue, void *data) {
  ...
  new_cell->data = data;
  new_cell->next = 
# 54 "C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_queue.c" 3 4
                  ((void *)0)
# 54 "C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_queue.c"
                      ;
  if (queue->back) {
...
void nghttp2_queue_pop(nghttp2_queue *queue) {
  ...
  ((front) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_queue.c", 67, __func__, "front"));
  queue->front = front->next;
  if (front == queue->back) {
    queue->back = 
# 70 "C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_queue.c" 3 4
                 ((void *)0)
# 70 "C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_queue.c"
                     ;
  }
  free(front);
}
...
void *nghttp2_queue_front(nghttp2_queue *queue) {
  ((queue->front) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_queue.c", 76, __func__, "queue->front"));
  return queue->front->data;
}

void *nghttp2_queue_back(nghttp2_queue *queue) {
  ((queue->back) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_queue.c", 81, __func__, "queue->back"));
  return queue->back->data;
}

int nghttp2_queue_empty(nghttp2_queue *queue) { return queue->front == 
# 85 "C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_queue.c" 3 4
                                                                      ((void *)0)
# 85 "C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_queue.c"
                                                                          ; }
