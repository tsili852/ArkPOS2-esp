# 1 "C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_outbound_item.c"
# 1 "C:\\esp\\ArkPOS2-esp\\build\\nghttp//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_outbound_item.c"
# 25 "C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_outbound_item.c"
# 1 "C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_outbound_item.h" 1
# 29 "C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_outbound_item.h"
...
# 30 "C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_outbound_item.h" 2
...
# 33 "C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_outbound_item.h" 2
...
# 26 "C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_outbound_item.c" 2
...
# 28 "C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_outbound_item.c" 2


void nghttp2_outbound_item_init(nghttp2_outbound_item *item) {
  item->cycle = 0;
  item->qnext = 
# 32 "C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_outbound_item.c" 3 4
               ((void *)0)
# 32 "C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_outbound_item.c"
                   ;
  item->queued = 0;
...
void nghttp2_outbound_item_free(nghttp2_outbound_item *item, nghttp2_mem *mem) {
  ...
  if (item == 
# 41 "C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_outbound_item.c" 3 4
             ((void *)0)
# 41 "C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_outbound_item.c"
                 ) {
    return;
  }
  ...
  default: {
    ...
    case NGHTTP2_ALTSVC:
      ...
      break;
    default:
      ((0) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_outbound_item.c", 90, __func__, "0"));
      break;
    }
  }
  }
...
void nghttp2_outbound_queue_init(nghttp2_outbound_queue *q) {
  q->head = q->tail = 
# 98 "C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_outbound_item.c" 3 4
                     ((void *)0)
# 98 "C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_outbound_item.c"
                         ;
  q->n = 0;
}
...
void nghttp2_outbound_queue_pop(nghttp2_outbound_queue *q) {
  ...
  q->head = q->head->qnext;
  item->qnext = 
# 119 "C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_outbound_item.c" 3 4
               ((void *)0)
# 119 "C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_outbound_item.c"
                   ;
  if (!q->head) {
    q->tail = 
# 121 "C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_outbound_item.c" 3 4
             ((void *)0)
# 121 "C:/esp/esp-idf/components/nghttp/nghttp2/lib/nghttp2_outbound_item.c"
                 ;
  }
  --q->n;
}
