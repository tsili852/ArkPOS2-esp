...
# 9 "C:/esp/esp-idf/components/expat/port/chardata.c" 2

# 1 "C:/esp/esp-idf/components/expat/port/include/minicheck.h" 1
# 41 "C:/esp/esp-idf/components/expat/port/include/minicheck.h"
...
# 11 "C:/esp/esp-idf/components/expat/port/chardata.c" 2
...
# 13 "C:/esp/esp-idf/components/expat/port/chardata.c" 2
...
# 14 "C:/esp/esp-idf/components/expat/port/chardata.c" 2
...
# 15 "C:/esp/esp-idf/components/expat/port/chardata.c" 2

# 1 "C:/esp/esp-idf/components/expat/port/include/chardata.h" 1
# 15 "C:/esp/esp-idf/components/expat/port/include/chardata.h"
...
# 16 "C:/esp/esp-idf/components/expat/port/include/chardata.h" 2
...
# 17 "C:/esp/esp-idf/components/expat/port/chardata.c" 2
...
xmlstrlen(const XML_Char *s)
{
    int len = 0;
    ((s != 
# 23 "C:/esp/esp-idf/components/expat/port/chardata.c" 3 4
   ((void *)0)
# 23 "C:/esp/esp-idf/components/expat/port/chardata.c"
   ) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/expat/port/chardata.c", 23, __func__, "s != NULL"));
    while (s[len] != 0)
        ++len;
    return len;
}
...
{
    ((storage != 
# 33 "C:/esp/esp-idf/components/expat/port/chardata.c" 3 4
   ((void *)0)
# 33 "C:/esp/esp-idf/components/expat/port/chardata.c"
   ) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/expat/port/chardata.c", 33, __func__, "storage != NULL"));
    storage->count = -1;
}
...
CharData_AppendString(CharData *storage, const char *s)
{
    ...
    ((s != 
# 43 "C:/esp/esp-idf/components/expat/port/chardata.c" 3 4
   ((void *)0)
# 43 "C:/esp/esp-idf/components/expat/port/chardata.c"
   ) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/expat/port/chardata.c", 43, __func__, "s != NULL"));
    len = strlen(s);
    if (storage->count < 0)
        storage->count = 0;
...
CharData_AppendXMLChars(CharData *storage, const XML_Char *s, int len)
{
    ...
    ((storage != 
# 61 "C:/esp/esp-idf/components/expat/port/chardata.c" 3 4
   ((void *)0)
# 61 "C:/esp/esp-idf/components/expat/port/chardata.c"
   ) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/expat/port/chardata.c", 61, __func__, "storage != NULL"));
    ((s != 
# 62 "C:/esp/esp-idf/components/expat/port/chardata.c" 3 4
   ((void *)0)
# 62 "C:/esp/esp-idf/components/expat/port/chardata.c"
   ) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/expat/port/chardata.c", 62, __func__, "s != NULL"));
...
CharData_CheckString(CharData *storage, const char *expected)
{
    ...
    ((storage != 
# 85 "C:/esp/esp-idf/components/expat/port/chardata.c" 3 4
   ((void *)0)
# 85 "C:/esp/esp-idf/components/expat/port/chardata.c"
   ) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/expat/port/chardata.c", 85, __func__, "storage != NULL"));
    ((expected != 
# 86 "C:/esp/esp-idf/components/expat/port/chardata.c" 3 4
   ((void *)0)
# 86 "C:/esp/esp-idf/components/expat/port/chardata.c"
   ) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/expat/port/chardata.c", 86, __func__, "expected != NULL"));
    ...
    if (len != count) {
        if (sizeof(XML_Char) == 1)
            ...
            sprintf(buffer,
                    ...
                    count, len);
        _fail_unless(0, "C:/esp/esp-idf/components/expat/port/chardata.c", 97, buffer);
        return 0;
    }
    if (memcmp(expected, storage->data, len) != 0) {
        _fail_unless(0, "C:/esp/esp-idf/components/expat/port/chardata.c", 101, "got bad data bytes");
        return 0;
    }
    return 1;
}
...
CharData_CheckXMLChars(CharData *storage, const XML_Char *expected)
{
    ...
    ((storage != 
# 114 "C:/esp/esp-idf/components/expat/port/chardata.c" 3 4
   ((void *)0)
# 114 "C:/esp/esp-idf/components/expat/port/chardata.c"
   ) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/expat/port/chardata.c", 114, __func__, "storage != NULL"));
    count = (storage->count < 0) ? 0 : storage->count;
    if (len != count) {
        sprintf(buffer, "wrong number of data characters: got %d, expected %d",
                count, len);
        _fail_unless(0, "C:/esp/esp-idf/components/expat/port/chardata.c", 119, buffer);
        return 0;
    }
    if (memcmp(expected, storage->data, len * sizeof(storage->data[0])) != 0) {
        _fail_unless(0, "C:/esp/esp-idf/components/expat/port/chardata.c", 123, "got bad data bytes");
        return 0;
    }
    return 1;
}
