# 1 "C:/esp/esp-idf/components/expat/port/minicheck.c"
...
# 9 "C:/esp/esp-idf/components/expat/port/minicheck.c" 2
...
# 10 "C:/esp/esp-idf/components/expat/port/minicheck.c" 2
...
# 11 "C:/esp/esp-idf/components/expat/port/minicheck.c" 2
...
# 12 "C:/esp/esp-idf/components/expat/port/minicheck.c" 2
...
# 14 "C:/esp/esp-idf/components/expat/port/minicheck.c" 2
...
# 15 "C:/esp/esp-idf/components/expat/port/minicheck.c" 2
...
suite_create(const char *name)
{
    ...
    if (suite != 
# 20 "C:/esp/esp-idf/components/expat/port/minicheck.c" 3 4
                ((void *)0)
# 20 "C:/esp/esp-idf/components/expat/port/minicheck.c"
                    ) {
        suite->name = name;
    }
    return suite;
...
tcase_create(const char *name)
{
    ...
    if (tc != 
# 30 "C:/esp/esp-idf/components/expat/port/minicheck.c" 3 4
             ((void *)0)
# 30 "C:/esp/esp-idf/components/expat/port/minicheck.c"
                 ) {
        tc->name = name;
    }
    return tc;
...
{
    ((suite != 
# 39 "C:/esp/esp-idf/components/expat/port/minicheck.c" 3 4
   ((void *)0)
# 39 "C:/esp/esp-idf/components/expat/port/minicheck.c"
   ) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/expat/port/minicheck.c", 39, __func__, "suite != NULL"));
    ((tc != 
# 40 "C:/esp/esp-idf/components/expat/port/minicheck.c" 3 4
   ((void *)0)
# 40 "C:/esp/esp-idf/components/expat/port/minicheck.c"
   ) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/expat/port/minicheck.c", 40, __func__, "tc != NULL"));
    ((tc->next_tcase == 
# 41 "C:/esp/esp-idf/components/expat/port/minicheck.c" 3 4
   ((void *)0)
# 41 "C:/esp/esp-idf/components/expat/port/minicheck.c"
   ) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/expat/port/minicheck.c", 41, __func__, "tc->next_tcase == NULL"));
...
{
    ((tc != 
# 52 "C:/esp/esp-idf/components/expat/port/minicheck.c" 3 4
   ((void *)0)
# 52 "C:/esp/esp-idf/components/expat/port/minicheck.c"
   ) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/expat/port/minicheck.c", 52, __func__, "tc != NULL"));
    tc->setup = setup;
...
{
    ((tc != 
# 60 "C:/esp/esp-idf/components/expat/port/minicheck.c" 3 4
   ((void *)0)
# 60 "C:/esp/esp-idf/components/expat/port/minicheck.c"
   ) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/expat/port/minicheck.c", 60, __func__, "tc != NULL"));
    if (tc->allocated == tc->ntests) {
        int nalloc = tc->allocated + 100;
        size_t new_size = sizeof(tcase_test_function) * nalloc;
        tcase_test_function *new_tests = realloc(tc->tests, new_size);
        ((new_tests != 
# 65 "C:/esp/esp-idf/components/expat/port/minicheck.c" 3 4
       ((void *)0)
# 65 "C:/esp/esp-idf/components/expat/port/minicheck.c"
       ) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/expat/port/minicheck.c", 65, __func__, "new_tests != NULL"));
...
srunner_create(Suite *suite)
{
    ...
    if (runner != 
# 80 "C:/esp/esp-idf/components/expat/port/minicheck.c" 3 4
                 ((void *)0)
# 80 "C:/esp/esp-idf/components/expat/port/minicheck.c"
                     ) {
        runner->suite = suite;
    }
    return runner;
...
# 88 "C:/esp/esp-idf/components/expat/port/minicheck.c" 3 4
                                            ((void *)0)
# 88 "C:/esp/esp-idf/components/expat/port/minicheck.c"
                                                ;
static int _check_current_lineno = -1;
static char const *_check_current_filename = 
# 90 "C:/esp/esp-idf/components/expat/port/minicheck.c" 3 4
                                            ((void *)0)
# 90 "C:/esp/esp-idf/components/expat/port/minicheck.c"
                                                ;
...
{
  if (tc->setup != 
# 113 "C:/esp/esp-idf/components/expat/port/minicheck.c" 3 4
                  ((void *)0)
# 113 "C:/esp/esp-idf/components/expat/port/minicheck.c"
                      ) {
  ...
  if (tc->teardown != 
# 129 "C:/esp/esp-idf/components/expat/port/minicheck.c" 3 4
                     ((void *)0)
# 129 "C:/esp/esp-idf/components/expat/port/minicheck.c"
                         ) {
    if (setjmp(env)) {
      add_failure(runner, verbosity);
      return;
...
{
    ((runner != 
# 141 "C:/esp/esp-idf/components/expat/port/minicheck.c" 3 4
   ((void *)0)
# 141 "C:/esp/esp-idf/components/expat/port/minicheck.c"
   ) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/expat/port/minicheck.c", 141, __func__, "runner != NULL"));
    ((runner->suite != 
# 142 "C:/esp/esp-idf/components/expat/port/minicheck.c" 3 4
   ((void *)0)
# 142 "C:/esp/esp-idf/components/expat/port/minicheck.c"
   ) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/expat/port/minicheck.c", 142, __func__, "runner->suite != NULL"));
    TCase *tc = runner->suite->tests;
    while (tc != 
# 144 "C:/esp/esp-idf/components/expat/port/minicheck.c" 3 4
                ((void *)0)
# 144 "C:/esp/esp-idf/components/expat/port/minicheck.c"
                    ) {
...
_fail_unless(int UNUSED_condition __attribute__((__unused__)), const char *UNUSED_file __attribute__((__unused__)), int UNUSED_line __attribute__((__unused__)), const char *msg)
{
    ...
    if (msg != 
# 167 "C:/esp/esp-idf/components/expat/port/minicheck.c" 3 4
              ((void *)0)
# 167 "C:/esp/esp-idf/components/expat/port/minicheck.c"
                  )
        printf("%s", msg);
    longjmp(env, 1);
}
...
{
    ((runner != 
# 175 "C:/esp/esp-idf/components/expat/port/minicheck.c" 3 4
   ((void *)0)
# 175 "C:/esp/esp-idf/components/expat/port/minicheck.c"
   ) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/expat/port/minicheck.c", 175, __func__, "runner != NULL"));
