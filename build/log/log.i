...
# 1 "C:\\esp\\esp32-ArkPOS2\\ArkPOS2-esp\\build\\log//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/log/log.c"
# 40 "C:/esp/esp-idf/components/log/log.c"
...
# 41 "C:/esp/esp-idf/components/log/log.c" 2
# 1 "C:/esp/esp-idf/components/freertos/include/freertos/FreeRTOSConfig.h" 1
# 42 "C:/esp/esp-idf/components/log/log.c" 2
...
# 43 "C:/esp/esp-idf/components/log/log.c" 2
...
# 44 "C:/esp/esp-idf/components/log/log.c" 2
...
# 77 "C:/esp/esp-idf/components/log/log.c"
typedef struct {
    const char* tag;
    uint32_t level : 3;
...
# 90 "C:/esp/esp-idf/components/log/log.c" 3 4
                                                                   ((void *)0) 
# 90 "C:/esp/esp-idf/components/log/log.c"
                                                                   };
...
# 95 "C:/esp/esp-idf/components/log/log.c" 3 4
                                      ((void *)0)
# 95 "C:/esp/esp-idf/components/log/log.c"
                                          ;
...
static inline 
# 101 "C:/esp/esp-idf/components/log/log.c" 3 4
             _Bool 
# 101 "C:/esp/esp-idf/components/log/log.c"
                  get_cached_log_level(const char* tag, esp_log_level_t* level);
static inline 
# 102 "C:/esp/esp-idf/components/log/log.c" 3 4
             _Bool 
# 102 "C:/esp/esp-idf/components/log/log.c"
...
static inline 
# 106 "C:/esp/esp-idf/components/log/log.c" 3 4
             _Bool 
# 106 "C:/esp/esp-idf/components/log/log.c"
...
# 119 "C:/esp/esp-idf/components/log/log.c" 3 4
   ((void *)0)
# 119 "C:/esp/esp-idf/components/log/log.c"
...
# 125 "C:/esp/esp-idf/components/log/log.c" 3 4
       ((void *)0)
# 125 "C:/esp/esp-idf/components/log/log.c"
...
# 130 "C:/esp/esp-idf/components/log/log.c" 3 4
                              ((void *)0)
# 130 "C:/esp/esp-idf/components/log/log.c"
                                  ;
    ...
    if ( it == 
# 140 "C:/esp/esp-idf/components/log/log.c" 3 4
              ((void *)0) 
# 140 "C:/esp/esp-idf/components/log/log.c"
                   ) {

        size_t entry_size = 
# 142 "C:/esp/esp-idf/components/log/log.c" 3 4
                           __builtin_offsetof (
# 142 "C:/esp/esp-idf/components/log/log.c"
                           uncached_tag_entry_t
# 142 "C:/esp/esp-idf/components/log/log.c" 3 4
                           , 
# 142 "C:/esp/esp-idf/components/log/log.c"
...
# 142 "C:/esp/esp-idf/components/log/log.c"
        ...
        if (!new_entry) {
            xQueueGenericSend( ( QueueHandle_t ) ( s_log_mutex ), 
# 145 "C:/esp/esp-idf/components/log/log.c" 3 4
           ((void *)0)
# 145 "C:/esp/esp-idf/components/log/log.c"
           , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
            return;
        }
    ...
    xQueueGenericSend( ( QueueHandle_t ) ( s_log_mutex ), 
# 163 "C:/esp/esp-idf/components/log/log.c" 3 4
   ((void *)0)
# 163 "C:/esp/esp-idf/components/log/log.c"
   , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
}
...
# 168 "C:/esp/esp-idf/components/log/log.c" 3 4
           ((void *)0)
# 168 "C:/esp/esp-idf/components/log/log.c"
           )) {
...
# 185 "C:/esp/esp-idf/components/log/log.c" 3 4
       ((void *)0)
# 185 "C:/esp/esp-idf/components/log/log.c"
    ...
    xQueueGenericSend( ( QueueHandle_t ) ( s_log_mutex ), 
# 199 "C:/esp/esp-idf/components/log/log.c" 3 4
   ((void *)0)
# 199 "C:/esp/esp-idf/components/log/log.c"
   , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
...
# 205 "C:/esp/esp-idf/components/log/log.c" 3 4
   __builtin_va_start(
# 205 "C:/esp/esp-idf/components/log/log.c"
   list
# 205 "C:/esp/esp-idf/components/log/log.c" 3 4
   ,
# 205 "C:/esp/esp-idf/components/log/log.c"
...
# 207 "C:/esp/esp-idf/components/log/log.c" 3 4
   __builtin_va_end(
# 207 "C:/esp/esp-idf/components/log/log.c"
   list
# 207 "C:/esp/esp-idf/components/log/log.c" 3 4
   )
# 207 "C:/esp/esp-idf/components/log/log.c"
...
static inline 
# 210 "C:/esp/esp-idf/components/log/log.c" 3 4
             _Bool 
# 210 "C:/esp/esp-idf/components/log/log.c"
                  get_cached_log_level(const char* tag, esp_log_level_t* level)
{
    ...
    if (i == s_log_cache_entry_count) {
        return 
# 223 "C:/esp/esp-idf/components/log/log.c" 3 4
              0
# 223 "C:/esp/esp-idf/components/log/log.c"
                   ;
    }
    ...
    *level = (esp_log_level_t) s_log_cache[i].level;
    ...
    return 
# 238 "C:/esp/esp-idf/components/log/log.c" 3 4
          1
# 238 "C:/esp/esp-idf/components/log/log.c"
              ;
}
...
static inline 
# 268 "C:/esp/esp-idf/components/log/log.c" 3 4
             _Bool 
# 268 "C:/esp/esp-idf/components/log/log.c"
                  get_uncached_log_level(const char* tag, esp_log_level_t* level)
{
    ...
    for ((it) = (((&s_log_tags))->slh_first); (it); (it) = (((it))->entries.sle_next)) {
        if (strcmp(tag, it->tag) == 0) {
            *level = it->level;
            return 
# 276 "C:/esp/esp-idf/components/log/log.c" 3 4
                  1
# 276 "C:/esp/esp-idf/components/log/log.c"
                      ;
        }
    }
    return 
# 279 "C:/esp/esp-idf/components/log/log.c" 3 4
          0
# 279 "C:/esp/esp-idf/components/log/log.c"
               ;
}

static inline 
# 282 "C:/esp/esp-idf/components/log/log.c" 3 4
             _Bool 
# 282 "C:/esp/esp-idf/components/log/log.c"
                  should_output(esp_log_level_t level_for_message, esp_log_level_t level_for_tag)
{
