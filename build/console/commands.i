# 1 "C:/esp/esp-idf/components/console/commands.c"
# 1 "C:\\esp\\esp32-ArkPOS2\\ArkPOS2-esp\\build\\console//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/console/commands.c"
# 15 "C:/esp/esp-idf/components/console/commands.c"
...
# 16 "C:/esp/esp-idf/components/console/commands.c" 2
...
# 17 "C:/esp/esp-idf/components/console/commands.c" 2
...
# 18 "C:/esp/esp-idf/components/console/commands.c" 2
...
# 19 "C:/esp/esp-idf/components/console/commands.c" 2
...
# 20 "C:/esp/esp-idf/components/console/commands.c" 2
# 1 "C:/esp/esp-idf/components/console/esp_console.h" 1
# 14 "C:/esp/esp-idf/components/console/esp_console.h"
       

# 1 "c:\\msys32\\opt\\xtensa-esp32-elf\\lib\\gcc\\xtensa-esp32-elf\\5.2.0\\include\\stddef.h" 1 3 4
# 17 "C:/esp/esp-idf/components/console/esp_console.h" 2
...
# 18 "C:/esp/esp-idf/components/console/esp_console.h" 2
...
# 40 "C:/esp/esp-idf/components/console/esp_console.h"
esp_err_t esp_console_init(const esp_console_config_t* config);
# 50 "C:/esp/esp-idf/components/console/esp_console.h"
esp_err_t esp_console_deinit();
# 59 "C:/esp/esp-idf/components/console/esp_console.h"
...
# 102 "C:/esp/esp-idf/components/console/esp_console.h"
esp_err_t esp_console_cmd_register(const esp_console_cmd_t *cmd);
# 113 "C:/esp/esp-idf/components/console/esp_console.h"
esp_err_t esp_console_run(const char* cmdline, int* cmd_ret);
# 139 "C:/esp/esp-idf/components/console/esp_console.h"
size_t esp_console_split_argv(char *line, char **argv, size_t argv_size);
# 152 "C:/esp/esp-idf/components/console/esp_console.h"
void esp_console_get_completion(const char *buf, linenoiseCompletions *lc);
# 171 "C:/esp/esp-idf/components/console/esp_console.h"
const char *esp_console_get_hint(const char *buf, int *color, int *bold);
# 181 "C:/esp/esp-idf/components/console/esp_console.h"
esp_err_t esp_console_register_help_command();
# 21 "C:/esp/esp-idf/components/console/commands.c" 2
...
# 22 "C:/esp/esp-idf/components/console/commands.c" 2
# 1 "C:/esp/esp-idf/components/console/argtable3/argtable3.h" 1
# 35 "C:/esp/esp-idf/components/console/argtable3/argtable3.h"
...
# 23 "C:/esp/esp-idf/components/console/commands.c" 2
# 1 "C:/esp/esp-idf/components/esp32/include/rom/queue.h" 1
# 24 "C:/esp/esp-idf/components/console/commands.c" 2
...
esp_err_t esp_console_init(const esp_console_config_t* config)
{
    ...
    if (s_tmp_line_buf == 
# 67 "C:/esp/esp-idf/components/console/commands.c" 3 4
                         ((void *)0)
# 67 "C:/esp/esp-idf/components/console/commands.c"
                             ) {
        return 0x101;
    }
    return 0;
...
esp_err_t esp_console_cmd_register(const esp_console_cmd_t *cmd)
{
    ...
    if (item == 
# 90 "C:/esp/esp-idf/components/console/commands.c" 3 4
               ((void *)0)
# 90 "C:/esp/esp-idf/components/console/commands.c"
                   ) {
        return 0x101;
    }
    if (cmd->command == 
# 93 "C:/esp/esp-idf/components/console/commands.c" 3 4
                       ((void *)0)
# 93 "C:/esp/esp-idf/components/console/commands.c"
                           ) {
        return 0x102;
    }
    if (strchr(cmd->command, ' ') != 
# 96 "C:/esp/esp-idf/components/console/commands.c" 3 4
                                    ((void *)0)
# 96 "C:/esp/esp-idf/components/console/commands.c"
                                        ) {
        return 0x102;
    }
    ...
    if (cmd->hint) {
        ...
        char* buf = 
# 108 "C:/esp/esp-idf/components/console/commands.c" 3 4
                   ((void *)0)
# 108 "C:/esp/esp-idf/components/console/commands.c"
                       ;
        size_t buf_size = 0;
        FILE* f = open_memstream(&buf, &buf_size);
        if (f != 
# 111 "C:/esp/esp-idf/components/console/commands.c" 3 4
                ((void *)0)
# 111 "C:/esp/esp-idf/components/console/commands.c"
                    ) {
            arg_print_syntax(f, cmd->argtable, 
# 112 "C:/esp/esp-idf/components/console/commands.c" 3 4
                                              ((void *)0)
# 112 "C:/esp/esp-idf/components/console/commands.c"
                                                  );
            fclose(f);
        }
        item->hint = buf;
    ...
    if (last == 
# 120 "C:/esp/esp-idf/components/console/commands.c" 3 4
               ((void *)0)
# 120 "C:/esp/esp-idf/components/console/commands.c"
                   ) {
        do { (((item))->next.sle_next) = (((&s_cmd_list))->slh_first); (((&s_cmd_list))->slh_first) = (item); } while (0);
    } else {
        cmd_item_t* it;
        while ((it = ((last)->next.sle_next)) != 
# 124 "C:/esp/esp-idf/components/console/commands.c" 3 4
                                               ((void *)0)
# 124 "C:/esp/esp-idf/components/console/commands.c"
                                                   ) {
            last = it;
        }
...
const char* esp_console_get_hint(const char *buf, int *color, int *bold)
{
    ...
    return 
# 159 "C:/esp/esp-idf/components/console/commands.c" 3 4
          ((void *)0)
# 159 "C:/esp/esp-idf/components/console/commands.c"
              ;
}
...
# 164 "C:/esp/esp-idf/components/console/commands.c" 3 4
                           ((void *)0)
# 164 "C:/esp/esp-idf/components/console/commands.c"
                               ;
    cmd_item_t* it;
    for ((it) = (((&s_cmd_list))->slh_first); (it); (it) = (((it))->next.sle_next)) {
...
{
    if (s_tmp_line_buf == 
# 177 "C:/esp/esp-idf/components/console/commands.c" 3 4
                         ((void *)0)
# 177 "C:/esp/esp-idf/components/console/commands.c"
                             ) {
        return 0x103;
    }
    char** argv = (char**) calloc(s_config.max_cmdline_args, sizeof(char*));
    if (argv == 
# 181 "C:/esp/esp-idf/components/console/commands.c" 3 4
               ((void *)0)
# 181 "C:/esp/esp-idf/components/console/commands.c"
                   ) {
        return 0x101;
    }
    ...
    if (cmd == 
# 190 "C:/esp/esp-idf/components/console/commands.c" 3 4
              ((void *)0)
# 190 "C:/esp/esp-idf/components/console/commands.c"
                  ) {
        return 0x105;
    }
...
static int help_command(int argc, char** argv)
{
    ...
    for ((it) = (((&s_cmd_list))->slh_first); (it); (it) = (((it))->next.sle_next)) {
        if (it->help == 
# 204 "C:/esp/esp-idf/components/console/commands.c" 3 4
                       ((void *)0)
# 204 "C:/esp/esp-idf/components/console/commands.c"
                           ) {
            continue;
        }
