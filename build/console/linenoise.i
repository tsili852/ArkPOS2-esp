# 1 "C:/esp/esp-idf/components/console/linenoise/linenoise.c"
# 1 "C:\\esp\\esp32-ArkPOS2\\ArkPOS2-esp\\build\\console//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/console/linenoise/linenoise.c"
# 106 "C:/esp/esp-idf/components/console/linenoise/linenoise.c"
...
# 9 "C:/esp/esp-idf/components/newlib/include/sys/unistd.h" 2
...
# 25 "C:/esp/esp-idf/components/newlib/include/sys/types.h"
...
# 107 "C:/esp/esp-idf/components/console/linenoise/linenoise.c" 2
...
# 108 "C:/esp/esp-idf/components/console/linenoise/linenoise.c" 2
...
# 109 "C:/esp/esp-idf/components/console/linenoise/linenoise.c" 2
...
# 110 "C:/esp/esp-idf/components/console/linenoise/linenoise.c" 2
...
# 111 "C:/esp/esp-idf/components/console/linenoise/linenoise.c" 2
...
# 113 "C:/esp/esp-idf/components/console/linenoise/linenoise.c" 2
...
# 114 "C:/esp/esp-idf/components/console/linenoise/linenoise.c" 2
...
# 116 "C:/esp/esp-idf/components/console/linenoise/linenoise.c" 2

# 1 "C:/esp/esp-idf/components/console/linenoise/linenoise.h" 1
# 46 "C:/esp/esp-idf/components/console/linenoise/linenoise.h"
...
# 118 "C:/esp/esp-idf/components/console/linenoise/linenoise.c" 2




static linenoiseCompletionCallback *completionCallback = 
# 122 "C:/esp/esp-idf/components/console/linenoise/linenoise.c" 3 4
                                                        ((void *)0)
# 122 "C:/esp/esp-idf/components/console/linenoise/linenoise.c"
                                                            ;
static linenoiseHintsCallback *hintsCallback = 
# 123 "C:/esp/esp-idf/components/console/linenoise/linenoise.c" 3 4
                                              ((void *)0)
# 123 "C:/esp/esp-idf/components/console/linenoise/linenoise.c"
                                                  ;
static linenoiseFreeHintsCallback *freeHintsCallback = 
# 124 "C:/esp/esp-idf/components/console/linenoise/linenoise.c" 3 4
                                                      ((void *)0)
# 124 "C:/esp/esp-idf/components/console/linenoise/linenoise.c"
                                                          ;
...
static char **history = 
# 130 "C:/esp/esp-idf/components/console/linenoise/linenoise.c" 3 4
                       ((void *)0)
# 130 "C:/esp/esp-idf/components/console/linenoise/linenoise.c"
                           ;
...
# 195 "C:/esp/esp-idf/components/console/linenoise/linenoise.c"
void linenoiseSetMultiLine(int ml) {
    mlmode = ml;
}
...
static void freeCompletions(linenoiseCompletions *lc) {
    ...
    for (i = 0; i < lc->len; i++)
        free(lc->cvec[i]);
    if (lc->cvec != 
# 274 "C:/esp/esp-idf/components/console/linenoise/linenoise.c" 3 4
                   ((void *)0)
# 274 "C:/esp/esp-idf/components/console/linenoise/linenoise.c"
                       )
        free(lc->cvec);
}
...
# 285 "C:/esp/esp-idf/components/console/linenoise/linenoise.c" 3 4
                                  ((void *)0) 
# 285 "C:/esp/esp-idf/components/console/linenoise/linenoise.c"
                                       };
    int nread, nwritten;
    char c = 0;
...
void linenoiseAddCompletion(linenoiseCompletions *lc, const char *str) {
    ...
    copy = malloc(len+1);
    if (copy == 
# 368 "C:/esp/esp-idf/components/console/linenoise/linenoise.c" 3 4
               ((void *)0)
# 368 "C:/esp/esp-idf/components/console/linenoise/linenoise.c"
                   ) return;
    memcpy(copy,str,len+1);
    cvec = realloc(lc->cvec,sizeof(char*)*(lc->len+1));
    if (cvec == 
# 371 "C:/esp/esp-idf/components/console/linenoise/linenoise.c" 3 4
               ((void *)0)
# 371 "C:/esp/esp-idf/components/console/linenoise/linenoise.c"
                   ) {
        free(copy);
        return;
    }
...
static void abInit(struct abuf *ab) {
    ab->b = 
# 391 "C:/esp/esp-idf/components/console/linenoise/linenoise.c" 3 4
           ((void *)0)
# 391 "C:/esp/esp-idf/components/console/linenoise/linenoise.c"
               ;
    ab->len = 0;
}
...
static void abAppend(struct abuf *ab, const char *s, int len) {
    ...
    if (new == 
# 398 "C:/esp/esp-idf/components/console/linenoise/linenoise.c" 3 4
              ((void *)0)
# 398 "C:/esp/esp-idf/components/console/linenoise/linenoise.c"
                  ) return;
...
# 701 "C:/esp/esp-idf/components/console/linenoise/linenoise.c"
...
# 742 "C:/esp/esp-idf/components/console/linenoise/linenoise.c" 3 4
                                           ((void *)0)
# 742 "C:/esp/esp-idf/components/console/linenoise/linenoise.c"
                                               ) {
        ...
        case ENTER:
            ...
            if (hintsCallback) {
                ...
                hintsCallback = 
# 760 "C:/esp/esp-idf/components/console/linenoise/linenoise.c" 3 4
                               ((void *)0)
# 760 "C:/esp/esp-idf/components/console/linenoise/linenoise.c"
                                   ;
                refreshLine(&l);
                hintsCallback = hc;
            }
...
char *linenoise(const char *prompt) {
    ...
    if (count <= 0) {
        free(buf);
        return 
# 984 "C:/esp/esp-idf/components/console/linenoise/linenoise.c" 3 4
              ((void *)0)
# 984 "C:/esp/esp-idf/components/console/linenoise/linenoise.c"
                  ;
    }
    return buf;
}
...
void linenoiseHistoryFree() {
    ...
    history = 
# 1006 "C:/esp/esp-idf/components/console/linenoise/linenoise.c" 3 4
             ((void *)0)
# 1006 "C:/esp/esp-idf/components/console/linenoise/linenoise.c"
                 ;
}
# 1016 "C:/esp/esp-idf/components/console/linenoise/linenoise.c"
int linenoiseHistoryAdd(const char *line) {
    char *linecopy;
    ...
    if (history == 
# 1022 "C:/esp/esp-idf/components/console/linenoise/linenoise.c" 3 4
                  ((void *)0)
# 1022 "C:/esp/esp-idf/components/console/linenoise/linenoise.c"
                      ) {
        history = malloc(sizeof(char*)*history_max_len);
        if (history == 
# 1024 "C:/esp/esp-idf/components/console/linenoise/linenoise.c" 3 4
                      ((void *)0)
# 1024 "C:/esp/esp-idf/components/console/linenoise/linenoise.c"
                          ) return 0;
...
int linenoiseHistorySetMaxLen(int len) {
    ...
    if (history) {
        ...
        if (new == 
# 1057 "C:/esp/esp-idf/components/console/linenoise/linenoise.c" 3 4
                  ((void *)0)
# 1057 "C:/esp/esp-idf/components/console/linenoise/linenoise.c"
                      ) return 0;
...
int linenoiseHistorySave(const char *filename) {
    ...
    fp = fopen(filename,"w");
    if (fp == 
# 1084 "C:/esp/esp-idf/components/console/linenoise/linenoise.c" 3 4
             ((void *)0)
# 1084 "C:/esp/esp-idf/components/console/linenoise/linenoise.c"
                 ) return -1;
...
int linenoiseHistoryLoad(const char *filename) {
    ...
    if (fp == 
# 1100 "C:/esp/esp-idf/components/console/linenoise/linenoise.c" 3 4
             ((void *)0)
# 1100 "C:/esp/esp-idf/components/console/linenoise/linenoise.c"
                 ) return -1;

    while (fgets(buf,4096,fp) != 
# 1102 "C:/esp/esp-idf/components/console/linenoise/linenoise.c" 3 4
                                              ((void *)0)
# 1102 "C:/esp/esp-idf/components/console/linenoise/linenoise.c"
                                                  ) {
        char *p;
