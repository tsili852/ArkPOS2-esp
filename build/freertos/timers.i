# 1 "C:/esp/esp-idf/components/freertos/timers.c"
# 1 "C:\\esp\\ArkPOS2-esp\\build\\freertos//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/freertos/timers.c"
# 71 "C:/esp/esp-idf/components/freertos/timers.c"
...
# 72 "C:/esp/esp-idf/components/freertos/timers.c" 2
...
# 79 "C:/esp/esp-idf/components/freertos/timers.c" 2
...
# 80 "C:/esp/esp-idf/components/freertos/timers.c" 2
...
# 81 "C:/esp/esp-idf/components/freertos/timers.c" 2
...
# 82 "C:/esp/esp-idf/components/freertos/timers.c" 2
# 1 "C:/esp/esp-idf/components/freertos/include/freertos/portmacro.h" 1
# 83 "C:/esp/esp-idf/components/freertos/timers.c" 2
# 105 "C:/esp/esp-idf/components/freertos/timers.c"
...
# 170 "C:/esp/esp-idf/components/freertos/timers.c" 3 4
                                                  ((void *)0)
# 170 "C:/esp/esp-idf/components/freertos/timers.c"
                                                      ;


 portMUX_TYPE xTimerMux = { .owner = 0xB33FFFFF, .count = 0, };
# 189 "C:/esp/esp-idf/components/freertos/timers.c"
...
# 256 "C:/esp/esp-idf/components/freertos/timers.c"
 prvCheckForValidListAndQueue();

 if( xTimerQueue != 
# 258 "C:/esp/esp-idf/components/freertos/timers.c" 3 4
                   ((void *)0) 
# 258 "C:/esp/esp-idf/components/freertos/timers.c"
                        )
 {
...
# 269 "C:/esp/esp-idf/components/freertos/timers.c" 3 4
                                                                                                         ((void *)0)
# 269 "C:/esp/esp-idf/components/freertos/timers.c"
...
# 269 "C:/esp/esp-idf/components/freertos/timers.c"
 ...
 if (!(xReturn)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/timers.c", 278, __FUNCTION__); abort(); };
 return xReturn;
}
...
Timer_t *pxNewTimer;
 ...
 {
  pxNewTimer = 
# 290 "C:/esp/esp-idf/components/freertos/timers.c" 3 4
              ((void *)0)
# 290 "C:/esp/esp-idf/components/freertos/timers.c"
                  ;
 }
 else
 {
  ...
  if( pxNewTimer != 
# 295 "C:/esp/esp-idf/components/freertos/timers.c" 3 4
                   ((void *)0) 
# 295 "C:/esp/esp-idf/components/freertos/timers.c"
                        )
  {
 ...
 if (!(( xTimerPeriodInTicks > 0 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/timers.c", 318, __FUNCTION__); abort(); };
...
DaemonTaskMessage_t xMessage;
 ...
 if( xTimerQueue != 
# 331 "C:/esp/esp-idf/components/freertos/timers.c" 3 4
                   ((void *)0) 
# 331 "C:/esp/esp-idf/components/freertos/timers.c"
                        )
 {
...
# 378 "C:/esp/esp-idf/components/freertos/timers.c"
const char * pcTimerGetTimerName( TimerHandle_t xTimer )
{
...
# 407 "C:/esp/esp-idf/components/freertos/timers.c" 3 4
                                                                                         ((void *)0)
# 407 "C:/esp/esp-idf/components/freertos/timers.c"
                                                                                             , ( TickType_t ) 0U );
   if (!(xResult)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/timers.c", 408, __FUNCTION__); abort(); };
   ( void ) xResult;
  }
  else
  {
...
{
TickType_t xNextExpireTime;
# 514 "C:/esp/esp-idf/components/freertos/timers.c"
 ...
 while( xQueueGenericReceive( ( xTimerQueue ), ( &xMessage ), ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) ) != ( ( ( BaseType_t ) 0 ) ) )
 {

  {
   ...
   if( xMessage.xMessageID < ( BaseType_t ) 0 )
   {
    ...
    if (!(pxCallback)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/timers.c", 612, __FUNCTION__); abort(); };
...
# 632 "C:/esp/esp-idf/components/freertos/timers.c" 3 4
      ((void *)0) 
# 632 "C:/esp/esp-idf/components/freertos/timers.c"
      ) ) ) == ( ( BaseType_t ) 0 ) )
   {
...
# 669 "C:/esp/esp-idf/components/freertos/timers.c" 3 4
                                                                                                                                                      ((void *)0)
# 669 "C:/esp/esp-idf/components/freertos/timers.c"
                                                                                                                                                          , ( TickType_t ) 0U );
       if (!(xResult)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/timers.c", 670, __FUNCTION__); abort(); };
       ( void ) xResult;
      }
      else
      {
    ...
    case ( ( BaseType_t ) 9 ) :
     ...
     if (!(( pxTimer->xTimerPeriodInTicks > 0 ))) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/timers.c", 693, __FUNCTION__); abort(); };
...
BaseType_t xResult;
 ...
 while( ( ( BaseType_t ) ( ( pxCurrentTimerList )->uxNumberOfItems == ( UBaseType_t ) 0 ) ) == ( ( BaseType_t ) 0 ) )
 {
  ...
  if( pxTimer->uxAutoReload == ( UBaseType_t ) ( ( BaseType_t ) 1 ) )
  {
   ...
   {
    xResult = xTimerGenericCommand( pxTimer, ( ( BaseType_t ) 0 ), xNextExpireTime, 
# 761 "C:/esp/esp-idf/components/freertos/timers.c" 3 4
                                                                                          ((void *)0)
# 761 "C:/esp/esp-idf/components/freertos/timers.c"
                                                                                              , ( TickType_t ) 0U );
    if (!(xResult)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/timers.c", 762, __FUNCTION__); abort(); };
    ( void ) xResult;
   }
  }
  else
...
static void prvCheckForValidListAndQueue( void )
{
# 788 "C:/esp/esp-idf/components/freertos/timers.c"
 if( xTimerQueue == 
# 788 "C:/esp/esp-idf/components/freertos/timers.c" 3 4
                   ((void *)0) 
# 788 "C:/esp/esp-idf/components/freertos/timers.c"
 ...
 {
  if( xTimerQueue == 
# 792 "C:/esp/esp-idf/components/freertos/timers.c" 3 4
                    ((void *)0) 
# 792 "C:/esp/esp-idf/components/freertos/timers.c"
                         )
  {
   ...
   if (!(xTimerQueue)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/timers.c", 799, __FUNCTION__); abort(); };
# 813 "C:/esp/esp-idf/components/freertos/timers.c"
  }
  else
  {
   ;
...
# 834 "C:/esp/esp-idf/components/freertos/timers.c" 3 4
                                          ((void *)0) 
# 834 "C:/esp/esp-idf/components/freertos/timers.c"
                                          ) ) ) );
 }
 vTaskExitCritical(&xTimerMux);
...
Timer_t * const pxTimer = ( Timer_t * ) xTimer;
 ...
 BaseType_t xReturn;
  ...
  if (!(xTimerQueue)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/timers.c", 884, __FUNCTION__); abort(); };
