# 1 "C:/esp/esp-idf/components/freertos/event_groups.c"
# 1 "C:\\esp\\esp32-ArkPOS2\\ArkPOS2-esp\\build\\freertos//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/freertos/event_groups.c"
# 71 "C:/esp/esp-idf/components/freertos/event_groups.c"
...
# 72 "C:/esp/esp-idf/components/freertos/event_groups.c" 2
...
# 80 "C:/esp/esp-idf/components/freertos/event_groups.c" 2
...
# 81 "C:/esp/esp-idf/components/freertos/event_groups.c" 2
...
# 82 "C:/esp/esp-idf/components/freertos/event_groups.c" 2
...
# 83 "C:/esp/esp-idf/components/freertos/event_groups.c" 2
# 113 "C:/esp/esp-idf/components/freertos/event_groups.c"
...
# 136 "C:/esp/esp-idf/components/freertos/event_groups.c"
...
EventGroup_t *pxEventBits;
 ...
 if( pxEventBits != 
# 145 "C:/esp/esp-idf/components/freertos/event_groups.c" 3 4
                   ((void *)0) 
# 145 "C:/esp/esp-idf/components/freertos/event_groups.c"
                        )
 {
...
BaseType_t xTimeoutOccurred = ( ( BaseType_t ) 0 );
 ...
 if (!(( uxBitsToWaitFor & 0xff000000UL ) == 0)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/event_groups.c", 169, __FUNCTION__); abort(); };
 if (!(uxBitsToWaitFor != 0)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/event_groups.c", 170, __FUNCTION__); abort(); };

 {
  if (!(!( ( xTaskGetSchedulerState() == ( ( BaseType_t ) 0 ) ) && ( xTicksToWait != 0 ) ))) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/event_groups.c", 173, __FUNCTION__); abort(); };
 }
...
BaseType_t xTimeoutOccurred = ( ( BaseType_t ) 0 );
 ...
 if (!(xEventGroup)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/event_groups.c", 289, __FUNCTION__); abort(); };
 if (!(( uxBitsToWaitFor & 0xff000000UL ) == 0)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/event_groups.c", 290, __FUNCTION__); abort(); };
 if (!(uxBitsToWaitFor != 0)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/event_groups.c", 291, __FUNCTION__); abort(); };

 {
  if (!(!( ( xTaskGetSchedulerState() == ( ( BaseType_t ) 0 ) ) && ( xTicksToWait != 0 ) ))) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/event_groups.c", 294, __FUNCTION__); abort(); };
 }
...
EventBits_t uxReturn;
 ...
 if (!(xEventGroup)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/event_groups.c", 437, __FUNCTION__); abort(); };
 if (!(( uxBitsToClear & 0xff000000UL ) == 0)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/event_groups.c", 438, __FUNCTION__); abort(); };
...
# 472 "C:/esp/esp-idf/components/freertos/event_groups.c"
EventBits_t xEventGroupGetBitsFromISR( EventGroupHandle_t xEventGroup )
{
...
BaseType_t xMatchFound = ( ( BaseType_t ) 0 );
 ...
 if (!(xEventGroup)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/event_groups.c", 499, __FUNCTION__); abort(); };
 if (!(( uxBitsToSet & 0xff000000UL ) == 0)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/event_groups.c", 500, __FUNCTION__); abort(); };
