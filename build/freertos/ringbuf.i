# 1 "C:/esp/esp-idf/components/freertos/ringbuf.c"
# 1 "C:\\esp\\esp32-ArkPOS2\\ArkPOS2-esp\\build\\freertos//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/freertos/ringbuf.c"
# 15 "C:/esp/esp-idf/components/freertos/ringbuf.c"
...
# 16 "C:/esp/esp-idf/components/freertos/ringbuf.c" 2
...
# 17 "C:/esp/esp-idf/components/freertos/ringbuf.c" 2
...
# 18 "C:/esp/esp-idf/components/freertos/ringbuf.c" 2
# 1 "C:/esp/esp-idf/components/freertos/include/freertos/queue.h" 1
# 19 "C:/esp/esp-idf/components/freertos/ringbuf.c" 2
...
# 21 "C:/esp/esp-idf/components/freertos/ringbuf.c" 2
...
# 24 "C:/esp/esp-idf/components/freertos/ringbuf.c" 2
...
# 69 "C:/esp/esp-idf/components/freertos/ringbuf.c"
typedef struct {
    size_t len;
    itemflag_t flags;
} buf_entry_hdr_t;
...
static BaseType_t copyItemToRingbufAllowSplit(ringbuf_t *rb, uint8_t *buffer, size_t buffer_size)
{
    size_t rbuffer_size;
    rbuffer_size=(buffer_size+3)&~3;
    if (!(((int)rb->write_ptr&3)==0)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/ringbuf.c", 160, __FUNCTION__); abort(); };
    if (!(rb->write_ptr-(rb->data+rb->size) >= sizeof(buf_entry_hdr_t))) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/ringbuf.c", 161, __FUNCTION__); abort(); };
    ...
    if (rem_len < rbuffer_size + sizeof(buf_entry_hdr_t)) {
        ...
        if (!(rem_len>=sizeof(buf_entry_hdr_t))) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/ringbuf.c", 180, __FUNCTION__); abort(); };
...
static uint8_t *getItemFromRingbufByteBuf(ringbuf_t *rb, size_t *length, int wanted_length)
{
    ...
    if (rb->read_ptr != rb->free_ptr) {
        ...
        return 
# 303 "C:/esp/esp-idf/components/freertos/ringbuf.c" 3 4
              ((void *)0)
# 303 "C:/esp/esp-idf/components/freertos/ringbuf.c"
                  ;
    }
    if (rb->read_ptr == rb->write_ptr) {

        return 
# 307 "C:/esp/esp-idf/components/freertos/ringbuf.c" 3 4
              ((void *)0)
# 307 "C:/esp/esp-idf/components/freertos/ringbuf.c"
                  ;
    }
    ret=rb->read_ptr;
    if (rb->read_ptr > rb->write_ptr) {
...
static void returnItemToRingbufDefault(ringbuf_t *rb, void *item) {
    ...
    if (!(((int)rb->free_ptr&3)==0)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/ringbuf.c", 338, __FUNCTION__); abort(); };
    if (!(data >= rb->data)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/ringbuf.c", 339, __FUNCTION__); abort(); };
    if (!(data <= rb->data+rb->size)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/ringbuf.c", 340, __FUNCTION__); abort(); };

    buf_entry_hdr_t *hdr=(buf_entry_hdr_t*)(data-sizeof(buf_entry_hdr_t));
    if (!(hdr->len < rb->size)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/ringbuf.c", 343, __FUNCTION__); abort(); };
    if (!((hdr->flags & iflag_dummydata)==0)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/ringbuf.c", 344, __FUNCTION__); abort(); };
    if (!((hdr->flags & iflag_free)==0)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/ringbuf.c", 345, __FUNCTION__); abort(); };
    ...
    while (((hdr->flags & iflag_free) || (hdr->flags & iflag_dummydata)) && rb->free_ptr != rb->write_ptr) {
        if (hdr->flags & iflag_dummydata) {
            ...
            if (!(rb->free_ptr<=rb->data+rb->size)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/ringbuf.c", 360, __FUNCTION__); abort(); };
        }
...
static void returnItemToRingbufBytebuf(ringbuf_t *rb, void *item) {
    uint8_t *data=(uint8_t*)item;
    if (!(data >= rb->data)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/ringbuf.c", 380, __FUNCTION__); abort(); };
    if (!(data < rb->data+rb->size)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/ringbuf.c", 381, __FUNCTION__); abort(); };
...
void xRingbufferPrintInfo(RingbufHandle_t ringbuf)
{
    ...
    if (!(rb)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/ringbuf.c", 389, __FUNCTION__); abort(); };
...
RingbufHandle_t xRingbufferCreate(size_t buf_length, ringbuf_type_t type)
{
    ...
    if (rb==
# 399 "C:/esp/esp-idf/components/freertos/ringbuf.c" 3 4
           ((void *)0)
# 399 "C:/esp/esp-idf/components/freertos/ringbuf.c"
               ) goto err;
    memset(rb, 0, sizeof(ringbuf_t));
    rb->data = malloc(buf_length);
    if (rb->data == 
# 402 "C:/esp/esp-idf/components/freertos/ringbuf.c" 3 4
                   ((void *)0)
# 402 "C:/esp/esp-idf/components/freertos/ringbuf.c"
                       ) goto err;
    rb->size = buf_length;
    rb->free_ptr = rb->data;
    rb->read_ptr = rb->data;
    ...
    if (type==RINGBUF_TYPE_ALLOWSPLIT) {
        ...
        if (!(0)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/ringbuf.c", 434, __FUNCTION__); abort(); };
    }
    if (rb->free_space_sem == 
# 436 "C:/esp/esp-idf/components/freertos/ringbuf.c" 3 4
                             ((void *)0) 
# 436 "C:/esp/esp-idf/components/freertos/ringbuf.c"
...
err:
    ...
    free(rb);
    return 
# 449 "C:/esp/esp-idf/components/freertos/ringbuf.c" 3 4
          ((void *)0)
# 449 "C:/esp/esp-idf/components/freertos/ringbuf.c"
              ;
}
...
{
    ringbuf_t *rb=(ringbuf_t *)ringbuf;
    if (!(rb)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/ringbuf.c", 465, __FUNCTION__); abort(); };
...
BaseType_t xRingbufferSend(RingbufHandle_t ringbuf, void *data, size_t dataSize, TickType_t ticks_to_wait)
{
    ...
    if (!(rb)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/ringbuf.c", 477, __FUNCTION__); abort(); };
...
# 490 "C:/esp/esp-idf/components/freertos/ringbuf.c" 3 4
                              ((void *)0)
# 490 "C:/esp/esp-idf/components/freertos/ringbuf.c"
...
# 517 "C:/esp/esp-idf/components/freertos/ringbuf.c" 3 4
   ((void *)0)
# 517 "C:/esp/esp-idf/components/freertos/ringbuf.c"
...
BaseType_t xRingbufferSendFromISR(RingbufHandle_t ringbuf, void *data, size_t dataSize, BaseType_t *higher_prio_task_awoken)
{
    ...
    if (!(rb)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/ringbuf.c", 526, __FUNCTION__); abort(); };
    size_t needed_size=dataSize+sizeof(buf_entry_hdr_t);
    vTaskEnterCritical(&rb->mux);
...
static void *xRingbufferReceiveGeneric(RingbufHandle_t ringbuf, size_t *item_size, TickType_t ticks_to_wait, size_t wanted_size)
{
    ...
    uint8_t *itemData;
    BaseType_t done=( ( BaseType_t ) 0 );
    if (!(rb)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/ringbuf.c", 548, __FUNCTION__); abort(); };
    while(!done) {

        while (rb->read_ptr == rb->write_ptr) {
            BaseType_t r=xQueueGenericReceive( ( QueueHandle_t ) ( rb->items_buffered_sem ), 
# 552 "C:/esp/esp-idf/components/freertos/ringbuf.c" 3 4
                        ((void *)0)
# 552 "C:/esp/esp-idf/components/freertos/ringbuf.c"
                        , ( ticks_to_wait ), ( ( BaseType_t ) 0 ) );
            if (r == ( ( BaseType_t ) 0 )) {

                return 
# 555 "C:/esp/esp-idf/components/freertos/ringbuf.c" 3 4
                      ((void *)0)
# 555 "C:/esp/esp-idf/components/freertos/ringbuf.c"
                          ;
            }
        }
...
void *xRingbufferReceiveFromISR(RingbufHandle_t ringbuf, size_t *item_size)
{
    ringbuf_t *rb=(ringbuf_t *)ringbuf;
    uint8_t *itemData;
    if (!(rb)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/ringbuf.c", 580, __FUNCTION__); abort(); };
    vTaskEnterCritical(&rb->mux);
...
# 589 "C:/esp/esp-idf/components/freertos/ringbuf.c" 3 4
                                ((void *)0)
# 589 "C:/esp/esp-idf/components/freertos/ringbuf.c"
                                    ;
    if (!(rb)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/ringbuf.c", 590, __FUNCTION__); abort(); };
    if (!(rb->flags & flag_bytebuf)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/ringbuf.c", 591, __FUNCTION__); abort(); };
...
void *xRingbufferReceiveUpToFromISR(RingbufHandle_t ringbuf, size_t *item_size, size_t wanted_size)
{
    ...
    uint8_t *itemData;
    if (wanted_size == 0) return 
# 599 "C:/esp/esp-idf/components/freertos/ringbuf.c" 3 4
                                ((void *)0)
# 599 "C:/esp/esp-idf/components/freertos/ringbuf.c"
                                    ;
    if (!(rb)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/ringbuf.c", 600, __FUNCTION__); abort(); };
    if (!(rb->flags & flag_bytebuf)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/ringbuf.c", 601, __FUNCTION__); abort(); };
    vTaskEnterCritical(&rb->mux);
    itemData=rb->getItemFromRingbufImpl(rb, item_size, wanted_size);
    vTaskExitCritical(&rb->mux);
    return (void*)itemData;
...
# 615 "C:/esp/esp-idf/components/freertos/ringbuf.c" 3 4
   ((void *)0)
# 615 "C:/esp/esp-idf/components/freertos/ringbuf.c"
   , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
}
...
{
    ringbuf_t *rb=(ringbuf_t *)ringbuf;
    if (!(rb)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/ringbuf.c", 632, __FUNCTION__); abort(); };
...
{
    ringbuf_t *rb=(ringbuf_t *)ringbuf;
    if (!(rb)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/ringbuf.c", 640, __FUNCTION__); abort(); };
...
{
    ringbuf_t *rb=(ringbuf_t *)ringbuf;
    if (!(rb)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/ringbuf.c", 648, __FUNCTION__); abort(); };
...
{
    ringbuf_t *rb=(ringbuf_t *)ringbuf;
    if (!(rb)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/ringbuf.c", 655, __FUNCTION__); abort(); };
