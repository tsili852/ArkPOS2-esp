# 1 "C:/esp/esp-idf/components/freertos/queue.c"
# 1 "C:\\esp\\esp32-ArkPOS2\\ArkPOS2-esp\\build\\freertos//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/freertos/queue.c"
# 79 "C:/esp/esp-idf/components/freertos/queue.c"
...
# 80 "C:/esp/esp-idf/components/freertos/queue.c" 2
...
# 81 "C:/esp/esp-idf/components/freertos/queue.c" 2
...
# 83 "C:/esp/esp-idf/components/freertos/queue.c" 2
...
# 90 "C:/esp/esp-idf/components/freertos/queue.c" 2
...
# 91 "C:/esp/esp-idf/components/freertos/queue.c" 2
...
# 92 "C:/esp/esp-idf/components/freertos/queue.c" 2
# 136 "C:/esp/esp-idf/components/freertos/queue.c"
...
# 216 "C:/esp/esp-idf/components/freertos/queue.c"
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
 ...
 if (!(pxQueue)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/queue.c", 263, __FUNCTION__); abort(); };
...
# 368 "C:/esp/esp-idf/components/freertos/queue.c"
 QueueHandle_t xQueueGenericCreate( const UBaseType_t uxQueueLength, const UBaseType_t uxItemSize, const uint8_t ucQueueType )
 {
 Queue_t *pxNewQueue;
 ...
 uint8_t *pucQueueStorage;
  ...
  if (!(uxQueueLength > ( UBaseType_t ) 0)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/queue.c", 374, __FUNCTION__); abort(); };
  ...
  if( pxNewQueue != 
# 390 "C:/esp/esp-idf/components/freertos/queue.c" 3 4
                   ((void *)0) 
# 390 "C:/esp/esp-idf/components/freertos/queue.c"
                        )
  {


   pucQueueStorage = ( ( uint8_t * ) pxNewQueue ) + sizeof( Queue_t );
# 405 "C:/esp/esp-idf/components/freertos/queue.c"
...
# 447 "C:/esp/esp-idf/components/freertos/queue.c"
 {
  pxNewQueue->pxQueueSetContainer = 
# 448 "C:/esp/esp-idf/components/freertos/queue.c" 3 4
                                   ((void *)0)
# 448 "C:/esp/esp-idf/components/freertos/queue.c"
                                       ;
 }
 ...
 {
  if( pxNewQueue != 
# 460 "C:/esp/esp-idf/components/freertos/queue.c" 3 4
                   ((void *)0) 
# 460 "C:/esp/esp-idf/components/freertos/queue.c"
                        )
  {
   ...
   pxNewQueue->pcTail = 
# 466 "C:/esp/esp-idf/components/freertos/queue.c" 3 4
                              ((void *)0)
# 466 "C:/esp/esp-idf/components/freertos/queue.c"
                                  ;
   pxNewQueue->pcHead = 
# 467 "C:/esp/esp-idf/components/freertos/queue.c" 3 4
                            ((void *)0)
# 467 "C:/esp/esp-idf/components/freertos/queue.c"
                                               ;
...
# 477 "C:/esp/esp-idf/components/freertos/queue.c" 3 4
                                          ((void *)0)
# 477 "C:/esp/esp-idf/components/freertos/queue.c"
...
# 526 "C:/esp/esp-idf/components/freertos/queue.c"
 void* xQueueGetMutexHolder( QueueHandle_t xSemaphore )
 {
...
# 538 "C:/esp/esp-idf/components/freertos/queue.c" 3 4
                                                   ((void *)0) 
# 538 "C:/esp/esp-idf/components/freertos/queue.c"
                                                                       )
   {
   ...
   {
    pxReturn = 
# 544 "C:/esp/esp-idf/components/freertos/queue.c" 3 4
              ((void *)0)
# 544 "C:/esp/esp-idf/components/freertos/queue.c"
                  ;
   }
  }
  vTaskExitCritical(&pxQueue->mux);
 ...
 Queue_t * const pxMutex = ( Queue_t * ) xMutex;
  ...
  if (!(pxMutex)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/queue.c", 562, __FUNCTION__); abort(); };
...
# 586 "C:/esp/esp-idf/components/freertos/queue.c" 3 4
                                        ((void *)0)
# 586 "C:/esp/esp-idf/components/freertos/queue.c"
                                            , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
   }
   else
   {
 ...
 Queue_t * const pxMutex = ( Queue_t * ) xMutex;
  ...
  if (!(pxMutex)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/queue.c", 617, __FUNCTION__); abort(); };
...
# 631 "C:/esp/esp-idf/components/freertos/queue.c" 3 4
                                           ((void *)0)
# 631 "C:/esp/esp-idf/components/freertos/queue.c"
...
# 682 "C:/esp/esp-idf/components/freertos/queue.c"
 QueueHandle_t xQueueCreateCountingSemaphore( const UBaseType_t uxMaxCount, const UBaseType_t uxInitialCount )
 {
 QueueHandle_t xHandle;

  if (!(uxMaxCount != 0)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/queue.c", 686, __FUNCTION__); abort(); };
  if (!(uxInitialCount <= uxMaxCount)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/queue.c", 687, __FUNCTION__); abort(); };

  xHandle = xQueueGenericCreate( uxMaxCount, ( ( UBaseType_t ) 0 ), ( ( uint8_t ) 2U ) );

  if( xHandle != 
# 691 "C:/esp/esp-idf/components/freertos/queue.c" 3 4
                ((void *)0) 
# 691 "C:/esp/esp-idf/components/freertos/queue.c"
                     )
  {
  ...
  if (!(xHandle)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/queue.c", 702, __FUNCTION__); abort(); };
  return xHandle;
 }
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
 ...
 if (!(pxQueue)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/queue.c", 715, __FUNCTION__); abort(); };
 if (!(!( ( pvItemToQueue == 
# 716 "C:/esp/esp-idf/components/freertos/queue.c" 3 4
((void *)0) 
# 716 "C:/esp/esp-idf/components/freertos/queue.c"
) && ( pxQueue->uxItemSize != ( UBaseType_t ) 0U ) ))) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/queue.c", 716, __FUNCTION__); abort(); };
 if (!(!( ( xCopyPosition == ( ( BaseType_t ) 2 ) ) && ( pxQueue->uxLength != 1 ) ))) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/queue.c", 717, __FUNCTION__); abort(); };

 {
  if (!(!( ( xTaskGetSchedulerState() == ( ( BaseType_t ) 0 ) ) && ( xTicksToWait != 0 ) ))) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/queue.c", 720, __FUNCTION__); abort(); };
 }
...
# 743 "C:/esp/esp-idf/components/freertos/queue.c" 3 4
                                        ((void *)0) 
# 743 "C:/esp/esp-idf/components/freertos/queue.c"
                                             )
     {
...
# 824 "C:/esp/esp-idf/components/freertos/queue.c"
    vTaskExitCritical(&pxQueue->mux);
    return ( ( ( BaseType_t ) 1 ) );
   }
   else
...
# 1147 "C:/esp/esp-idf/components/freertos/queue.c"
BaseType_t xQueueGenericSendFromISR( QueueHandle_t xQueue, const void * const pvItemToQueue, BaseType_t * const pxHigherPriorityTaskWoken, const BaseType_t xCopyPosition )
{
BaseType_t xReturn;
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
 ...
 if (!(pxQueue)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/queue.c", 1153, __FUNCTION__); abort(); };
 if (!(!( ( pvItemToQueue == 
# 1154 "C:/esp/esp-idf/components/freertos/queue.c" 3 4
((void *)0) 
# 1154 "C:/esp/esp-idf/components/freertos/queue.c"
) && ( pxQueue->uxItemSize != ( UBaseType_t ) 0U ) ))) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/queue.c", 1154, __FUNCTION__); abort(); };
 if (!(!( ( xCopyPosition == ( ( BaseType_t ) 2 ) ) && ( pxQueue->uxLength != 1 ) ))) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/queue.c", 1155, __FUNCTION__); abort(); };
# 1171 "C:/esp/esp-idf/components/freertos/queue.c"
 ;
 ...
 uxSavedInterruptStatus = portENTER_CRITICAL_NESTED();
 {
  ...
  if( ( pxQueue->uxMessagesWaiting < pxQueue->uxLength ) || ( xCopyPosition == ( ( BaseType_t ) 2 ) ) )
  {
   ...
   {
    if( pxQueue->pxQueueSetContainer != 
# 1194 "C:/esp/esp-idf/components/freertos/queue.c" 3 4
                                       ((void *)0) 
# 1194 "C:/esp/esp-idf/components/freertos/queue.c"
                                            )
    {
     if( prvNotifyQueueSetContainer( pxQueue, xCopyPosition ) == ( ( BaseType_t ) 1 ) )
     {
...
# 1201 "C:/esp/esp-idf/components/freertos/queue.c" 3 4
                                      ((void *)0) 
# 1201 "C:/esp/esp-idf/components/freertos/queue.c"
                                           )
      {
    ...
    else
    {
     if( ( ( BaseType_t ) ( ( &( pxQueue->xTasksWaitingToReceive ) )->uxNumberOfItems == ( UBaseType_t ) 0 ) ) == ( ( BaseType_t ) 0 ) )
     {
      if( xTaskRemoveFromEventList( &( pxQueue->xTasksWaitingToReceive ) ) != ( ( BaseType_t ) 0 ) )
      {
       ...
       if( pxHigherPriorityTaskWoken != 
# 1223 "C:/esp/esp-idf/components/freertos/queue.c" 3 4
                                       ((void *)0) 
# 1223 "C:/esp/esp-idf/components/freertos/queue.c"
                                            )
       {
        *pxHigherPriorityTaskWoken = ( ( BaseType_t ) 1 );
       }
...
# 1271 "C:/esp/esp-idf/components/freertos/queue.c"
   xReturn = ( ( ( BaseType_t ) 1 ) );
  }
  else
  {
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
 ...
 if (!(pxQueue)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/queue.c", 1292, __FUNCTION__); abort(); };


 if (!(pxQueue->uxItemSize == 0)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/queue.c", 1295, __FUNCTION__); abort(); };
# 1311 "C:/esp/esp-idf/components/freertos/queue.c"
 ;
 ...
 uxSavedInterruptStatus = portENTER_CRITICAL_NESTED();
 {
  ...
  if( pxQueue->uxMessagesWaiting < pxQueue->uxLength )
  {
   ...
   {
    if( pxQueue->pxQueueSetContainer != 
# 1338 "C:/esp/esp-idf/components/freertos/queue.c" 3 4
                                       ((void *)0) 
# 1338 "C:/esp/esp-idf/components/freertos/queue.c"
                                            )
    {
     if( prvNotifyQueueSetContainer( pxQueue, ( ( BaseType_t ) 0 ) ) == ( ( BaseType_t ) 1 ) )
     {
      ...
      if( pxHigherPriorityTaskWoken != 
# 1345 "C:/esp/esp-idf/components/freertos/queue.c" 3 4
                                      ((void *)0) 
# 1345 "C:/esp/esp-idf/components/freertos/queue.c"
                                           )
      {
       *pxHigherPriorityTaskWoken = ( ( BaseType_t ) 1 );
      }
    ...
    else
    {
     if( ( ( BaseType_t ) ( ( &( pxQueue->xTasksWaitingToReceive ) )->uxNumberOfItems == ( UBaseType_t ) 0 ) ) == ( ( BaseType_t ) 0 ) )
     {
      if( xTaskRemoveFromEventList( &( pxQueue->xTasksWaitingToReceive ) ) != ( ( BaseType_t ) 0 ) )
      {
       ...
       if( pxHigherPriorityTaskWoken != 
# 1367 "C:/esp/esp-idf/components/freertos/queue.c" 3 4
                                       ((void *)0) 
# 1367 "C:/esp/esp-idf/components/freertos/queue.c"
                                            )
       {
        *pxHigherPriorityTaskWoken = ( ( BaseType_t ) 1 );
       }
...
# 1416 "C:/esp/esp-idf/components/freertos/queue.c"
   xReturn = ( ( ( BaseType_t ) 1 ) );
  }
  else
  {
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
 ...
 if (!(pxQueue)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/queue.c", 1438, __FUNCTION__); abort(); };
 if (!(!( ( pvBuffer == 
# 1439 "C:/esp/esp-idf/components/freertos/queue.c" 3 4
((void *)0) 
# 1439 "C:/esp/esp-idf/components/freertos/queue.c"
) && ( pxQueue->uxItemSize != ( UBaseType_t ) 0U ) ))) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/queue.c", 1439, __FUNCTION__); abort(); };

 {
  if (!(!( ( xTaskGetSchedulerState() == ( ( BaseType_t ) 0 ) ) && ( xTicksToWait != 0 ) ))) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/queue.c", 1442, __FUNCTION__); abort(); };
 }
  ...
  vTaskEnterCritical(&pxQueue->mux);
  {
   ...
   if( pxQueue->uxMessagesWaiting > ( UBaseType_t ) 0 )
   {
    ...
    if( xJustPeeking == ( ( BaseType_t ) 0 ) )
    {
     ...
     {
      if( pxQueue->pcHead == 
# 1473 "C:/esp/esp-idf/components/freertos/queue.c" 3 4
                                 ((void *)0) 
# 1473 "C:/esp/esp-idf/components/freertos/queue.c"
                                                     )
      {
  ...
  if( xTaskCheckForTimeOut( &xTimeOut, &xTicksToWait ) == ( ( BaseType_t ) 0 ) )
  {
   if( prvIsQueueEmpty( pxQueue ) != ( ( BaseType_t ) 0 ) )
   {
    ...
    {
     if( pxQueue->pcHead == 
# 1575 "C:/esp/esp-idf/components/freertos/queue.c" 3 4
                                ((void *)0) 
# 1575 "C:/esp/esp-idf/components/freertos/queue.c"
                                                    )
     {
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
 ...
 if (!(pxQueue)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/queue.c", 1612, __FUNCTION__); abort(); };
 if (!(!( ( pvBuffer == 
# 1613 "C:/esp/esp-idf/components/freertos/queue.c" 3 4
((void *)0) 
# 1613 "C:/esp/esp-idf/components/freertos/queue.c"
) && ( pxQueue->uxItemSize != ( UBaseType_t ) 0U ) ))) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/queue.c", 1613, __FUNCTION__); abort(); };
# 1629 "C:/esp/esp-idf/components/freertos/queue.c"
 ;
  ...
  if( pxQueue->uxMessagesWaiting > ( UBaseType_t ) 0 )
  {
   ...
   if( ( ( BaseType_t ) ( ( &( pxQueue->xTasksWaitingToSend ) )->uxNumberOfItems == ( UBaseType_t ) 0 ) ) == ( ( BaseType_t ) 0 ) )
   {
    if( xTaskRemoveFromEventList( &( pxQueue->xTasksWaitingToSend ) ) != ( ( BaseType_t ) 0 ) )
    {
     ...
     if( pxHigherPriorityTaskWoken != 
# 1648 "C:/esp/esp-idf/components/freertos/queue.c" 3 4
                                     ((void *)0) 
# 1648 "C:/esp/esp-idf/components/freertos/queue.c"
                                          )
     {
      *pxHigherPriorityTaskWoken = ( ( BaseType_t ) 1 );
     }
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
 ...
 if (!(pxQueue)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/queue.c", 1689, __FUNCTION__); abort(); };
 if (!(!( ( pvBuffer == 
# 1690 "C:/esp/esp-idf/components/freertos/queue.c" 3 4
((void *)0) 
# 1690 "C:/esp/esp-idf/components/freertos/queue.c"
) && ( pxQueue->uxItemSize != ( UBaseType_t ) 0U ) ))) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/queue.c", 1690, __FUNCTION__); abort(); };
 if (!(pxQueue->uxItemSize != 0)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/queue.c", 1691, __FUNCTION__); abort(); };
# 1707 "C:/esp/esp-idf/components/freertos/queue.c"
 ;
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
 ...
 if (!(xQueue)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/queue.c", 1743, __FUNCTION__); abort(); };
...
Queue_t *pxQueue;
 ...
 if (!(pxQueue)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/queue.c", 1761, __FUNCTION__); abort(); };
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
 ...
 if (!(xQueue)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/queue.c", 1778, __FUNCTION__); abort(); };
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
 ...
 if (!(pxQueue)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/queue.c", 1792, __FUNCTION__); abort(); };
...
# 1827 "C:/esp/esp-idf/components/freertos/queue.c"
}
# 1861 "C:/esp/esp-idf/components/freertos/queue.c"
static BaseType_t prvCopyDataToQueue( Queue_t * const pxQueue, const void *pvItemToQueue, const BaseType_t xPosition )
{
BaseType_t xReturn = ( ( BaseType_t ) 0 );
 ...
 if( pxQueue->uxItemSize == ( UBaseType_t ) 0 )
 {
  ...
  {
   if( pxQueue->pcHead == 
# 1869 "C:/esp/esp-idf/components/freertos/queue.c" 3 4
                              ((void *)0) 
# 1869 "C:/esp/esp-idf/components/freertos/queue.c"
                                                  )
   {

    xReturn = xTaskPriorityDisinherit( ( void * ) pxQueue->pcTail );
    pxQueue->pcTail = 
# 1873 "C:/esp/esp-idf/components/freertos/queue.c" 3 4
                            ((void *)0)
# 1873 "C:/esp/esp-idf/components/freertos/queue.c"
                                ;
   }
   else
   {
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
 ...
 if (!(xQueue)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/queue.c", 1979, __FUNCTION__); abort(); };
 vTaskEnterCritical(&pxQueue->mux);
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
 ...
 if (!(xQueue)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/esp/esp-idf/components/freertos/queue.c", 2021, __FUNCTION__); abort(); };
 vTaskEnterCritical(&pxQueue->mux);
...
# 2372 "C:/esp/esp-idf/components/freertos/queue.c"
 void vQueueWaitForMessageRestricted( QueueHandle_t xQueue, TickType_t xTicksToWait )
 {
 Queue_t * const pxQueue = ( Queue_t * ) xQueue;
# 2388 "C:/esp/esp-idf/components/freertos/queue.c"
  vTaskEnterCritical(&pxQueue->mux);
...
# 2427 "C:/esp/esp-idf/components/freertos/queue.c" 3 4
                                                                  ((void *)0) 
# 2427 "C:/esp/esp-idf/components/freertos/queue.c"
                                                                       )
   {
...
# 2476 "C:/esp/esp-idf/components/freertos/queue.c" 3 4
                                             ((void *)0)
# 2476 "C:/esp/esp-idf/components/freertos/queue.c"
                                                 ;
   }
...
# 2492 "C:/esp/esp-idf/components/freertos/queue.c" 3 4
                                 ((void *)0)
# 2492 "C:/esp/esp-idf/components/freertos/queue.c"
                                     ;
 ...
 {
 QueueSetMemberHandle_t xReturn = 
# 2505 "C:/esp/esp-idf/components/freertos/queue.c" 3 4
                                 ((void *)0)
# 2505 "C:/esp/esp-idf/components/freertos/queue.c"
                                     ;

  ( void ) xQueueReceiveFromISR( ( QueueHandle_t ) xQueueSet, &xReturn, 
# 2507 "C:/esp/esp-idf/components/freertos/queue.c" 3 4
                                                                       ((void *)0) 
# 2507 "C:/esp/esp-idf/components/freertos/queue.c"
                                                                            );
  return xReturn;
 }
