# 1 "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c"
# 1 "C:\\esp\\ArkPOS2-esp\\build\\freertos//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c"
# 126 "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c"
...
# 19 "C:/Users/nickt/git/esp-idf/components/newlib/include/stdlib.h" 2
...
# 127 "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c" 2
...
# 134 "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c" 2
...
# 135 "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c" 2
...
# 136 "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c" 2



# 1 "C:/Users/nickt/git/esp-idf/components/freertos/include/freertos/heap_regions.h" 1
# 17 "C:/Users/nickt/git/esp-idf/components/freertos/include/freertos/heap_regions.h"
# 1 "C:/Users/nickt/git/esp-idf/components/freertos/include/freertos/FreeRTOS.h" 1
# 18 "C:/Users/nickt/git/esp-idf/components/freertos/include/freertos/heap_regions.h" 2
...
# 43 "C:/Users/nickt/git/esp-idf/components/freertos/include/freertos/heap_regions.h"
void vPortDefineHeapRegionsTagged( const HeapRegionTagged_t * const pxHeapRegions );
# 59 "C:/Users/nickt/git/esp-idf/components/freertos/include/freertos/heap_regions.h"
void *pvPortMallocTagged( size_t xWantedSize, BaseType_t tag );
# 68 "C:/Users/nickt/git/esp-idf/components/freertos/include/freertos/heap_regions.h"
void vPortFreeTagged( void *pv );
# 81 "C:/Users/nickt/git/esp-idf/components/freertos/include/freertos/heap_regions.h"
size_t xPortGetMinimumEverFreeHeapSizeTagged( BaseType_t tag );
# 93 "C:/Users/nickt/git/esp-idf/components/freertos/include/freertos/heap_regions.h"
size_t xPortGetFreeHeapSizeTagged( BaseType_t tag );
# 140 "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c" 2
# 153 "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c"
...
static portMUX_TYPE xMallocMutex = { .mux = 0xB33F0000|0xB33FFFFF };
# 172 "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c"
...
static const uint32_t uxHeapStructSize = ( ( sizeof ( BlockLink_t ) + 0 + 0 + ( 4 - 1 ) ) & ~( 0x0003 ) );


static BlockLink_t xStart, *pxEnd = 
# 181 "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c" 3 4
                                   ((void *)0)
# 181 "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c"
                                       ;



static size_t xFreeBytesRemaining[16] = {0};
static size_t xMinimumEverFreeBytesRemaining[16] = {0};
...
void *pvReturn = 
# 194 "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c" 3 4
                ((void *)0)
# 194 "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c"
                    ;



    if (!(pxEnd)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c", 198, __FUNCTION__); abort(); };

    vTaskEnterCritical(&xMallocMutex);
    {
        ...
        if( xWantedSize > 0 )
        {
            ...
            if( ( xWantedSize & ( 0x0003 ) ) != 0x00 )
            {

               xWantedSize += ( 4 - ( xWantedSize & ( 0x0003 ) ) );
            }
            else
            {
               ;
        ...
        if( ( xWantedSize > 0 ) && ( xWantedSize <= xFreeBytesRemaining[ tag ] ) )
        {
            ...
            while( ( ( pxBlock->xTag != tag ) || ( pxBlock->xBlockSize < xWantedSize ) ) && ( pxBlock->pxNextFreeBlock != 
# 231 "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c" 3 4
                                                                                                                          ((void *)0) 
# 231 "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c"
                                                                                                                               ) )
            {
# 241 "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c"
            ...
            if( pxBlock != pxEnd )
            {
                ...
                pvReturn = ( void * ) ( ( ( uint8_t * ) pxPreviousBlock->pxNextFreeBlock ) + uxHeapStructSize - 0 - 0);
...
# 282 "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c"
...
# 303 "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c" 3 4
                                          ((void *)0)
# 303 "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c"
                                              ;
    ...
    vTaskExitCritical(&xMallocMutex);
# 340 "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c"
    return pvReturn;
}
...
BlockLink_t *pxLink;
    ...
    if( pv != 
# 349 "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c" 3 4
             ((void *)0) 
# 349 "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c"
                  )
    {


        puc -= (uxHeapStructSize - 0 - 0) ;


        pxLink = ( void * ) puc;
# 368 "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c"
        if (!(( pxLink->xAllocated ) != 0)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c", 368, __FUNCTION__); abort(); };
        if (!(pxLink->pxNextFreeBlock == 
# 369 "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c" 3 4
       ((void *)0)
# 369 "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c"
       )) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c", 369, __FUNCTION__); abort(); };

        if( pxLink->xAllocated != 0 )
        {
            if( pxLink->pxNextFreeBlock == 
# 373 "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c" 3 4
                                          ((void *)0) 
# 373 "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c"
                                               )
            {
...
# 476 "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c" 3 4
                                       ((void *)0)
# 476 "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c"
                                           , *pxPreviousFreeBlock;
...
const HeapRegionTagged_t *pxHeapRegion;
    ...
    if (!(pxEnd == 
# 484 "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c" 3 4
   ((void *)0)
# 484 "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c"
   )) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c", 484, __FUNCTION__); abort(); };
    ...
    while( pxHeapRegion->xSizeInBytes > 0 )
    {
        ...
        if (!(pxHeapRegion->xTag < 16)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c", 499, __FUNCTION__); abort(); };
        if (!(pxHeapRegion->xSizeInBytes < (16*1024*1024))) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c", 500, __FUNCTION__); abort(); };
        xTotalRegionSize = pxHeapRegion->xSizeInBytes;


        ulAddress = ( uint32_t ) pxHeapRegion->pucStartAddress;
        if( ( ulAddress & ( 0x0003 ) ) != 0 )
        {
            ulAddress += ( 4 - 1 );
            ulAddress &= ~( 0x0003 );
        ...
        if( xDefinedRegions == 0 )
        {
            ...
            xStart.pxNextFreeBlock = ( BlockLink_t * ) (pucAlignedHeap + 0);
        ...
        else
        {
            ...
            if (!(pxEnd != 
# 528 "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c" 3 4
           ((void *)0)
# 528 "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c"
           )) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c", 528, __FUNCTION__); abort(); };


            if (!(ulAddress > ( uint32_t ) pxEnd)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c", 531, __FUNCTION__); abort(); };
        }
        ...
        ulAddress &= ~( 0x0003 );
        pxEnd = ( BlockLink_t * ) (ulAddress + 0);
        pxEnd->xBlockSize = 0;
        pxEnd->pxNextFreeBlock = 
# 545 "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c" 3 4
                                ((void *)0)
# 545 "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c"
                                    ;
        pxEnd->xTag = -1;
        ...
        pxFirstFreeBlockInRegion = ( BlockLink_t * ) (pucAlignedHeap + 0);
        pxFirstFreeBlockInRegion->xBlockSize = ulAddress - ( uint32_t ) pxFirstFreeBlockInRegion + 0;
...
# 558 "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c" 3 4
                                  ((void *)0) 
# 558 "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c"
                                       )
        {
    ...
    if (!(xTotalHeapSize)) { ets_printf("%s:%d (%s)- assert failed!\n", "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c", 581, __FUNCTION__); abort(); };
# 590 "C:/Users/nickt/git/esp-idf/components/freertos/heap_regions.c"
}
