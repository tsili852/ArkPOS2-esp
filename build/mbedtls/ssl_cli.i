# 1 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
# 1 "C:\\esp\\ArkPOS2-esp\\build\\mbedtls//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
# 25 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
...
# 26 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c" 2
...
# 32 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c" 2
...
# 39 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c" 2
# 1 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/ssl.h" 1
# 40 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c" 2
...
# 41 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c" 2
...
# 43 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c" 2
# 52 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
                                    ...
                                    size_t *olen )
{
    ...
    *olen = 0;
    ...
    if( ssl->hostname == 
# 68 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c" 3 4
                        ((void *)0) 
# 68 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
                             )
        return;
...
# 100 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
...
# 230 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
                                                     ...
                                                     size_t *olen )
{
    ...
    *olen = 0;
...

    {
        ...
        if( info == 
# 274 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c" 3 4
                   ((void *)0) 
# 274 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
                        )
        {
            do { } while( 0 );
            return;
...
# 429 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
...
# 593 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c" 3 4
                                         ((void *)0) 
# 593 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
                                              || tlen == 0 )
    {
        return;
    }
...
# 617 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c" 3 4
                               ((void *)0) 
# 617 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
                                    )
    {
        return;
    }
...
# 624 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c" 3 4
                                            ((void *)0)
# 624 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
                                                ; cur++ )
...
# 645 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
    p += 4;

    for( cur = ssl->conf->alpn_list; *cur != 
# 647 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c" 3 4
                                            ((void *)0)
# 647 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
                                                ; cur++ )
    {
...
static int ssl_generate_random( mbedtls_ssl_context *ssl )
{
    ...
    mbedtls_time_t t;
# 689 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
    t = time( 
# 689 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c" 3 4
                     ((void *)0) 
# 689 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
                          );
...
static int ssl_write_client_hello( mbedtls_ssl_context *ssl )
{
    ...
    if( ssl->conf->f_rng == 
# 721 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c" 3 4
                           ((void *)0) 
# 721 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
                                )
    {
        do { } while( 0 );
        return( -0x7400 );
...
# 749 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
    buf = ssl->out_msg;
    p = buf + 4;
    ...
    do { } while( 0 );
    p += 32;
# 781 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
    ...
    {
        if( ssl->session_negotiate->ticket != 
# 801 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c" 3 4
                                             ((void *)0) 
# 801 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
                                                  &&
    ...
    *p++ = (unsigned char) n;
    ...
    do { } while( 0 );
    do { } while( 0 );
# 850 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
    ...
    for( i = 0; ciphersuites[i] != 0; i++ )
    {
        ...
        if( ciphersuite_info == 
# 861 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c" 3 4
                               ((void *)0) 
# 861 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
                                    )
            continue;
        ...
        if( ciphersuite_info->min_minor_ver > ssl->conf->max_minor_ver ||
            ...
            continue;
# 886 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
        do { } while( 0 )
                                                       ;
    ...
    *q++ = (unsigned char)( n << 1 );
    ...
    offer_compress = 0;
# 939 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
    if( offer_compress )
    {
        do { } while( 0 );
        do { } while( 0 )
    ...
    ext_len += olen;
# 992 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
...
# 1286 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
                               ...
                               const unsigned char *buf, size_t len )
{
    ...
    if( ssl->conf->alpn_list == 
# 1293 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c" 3 4
                               ((void *)0) 
# 1293 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
                                    )
    {
        do { } while( 0 );
        mbedtls_ssl_send_alert_message( ssl, 2,
...
# 1312 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
    if( len < 4 )
    {
        mbedtls_ssl_send_alert_message( ssl, 2,
                                        50 );
...
# 1336 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c" 3 4
                                        ((void *)0)
# 1336 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
                                            ; p++ )
    {
...
# 1428 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
...
# 1505 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
...
# 1525 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
...
# 1556 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
    ...
    comp = buf[37 + n];
# 1616 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
    if( comp != 0 )
...
# 1630 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c" 3 4
                                                     ((void *)0) 
# 1630 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
                                                          )
    {
        do { } while( 0 );
        mbedtls_ssl_send_alert_message( ssl, 2,
...
# 1658 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c" 3 4
                                                     ((void *)0) 
# 1658 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
                                                          );
    ...
    if( suite_info == 
# 1685 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c" 3 4
                     ((void *)0)
...
# 1690 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
       )
    {
        do { } while( 0 );
        mbedtls_ssl_send_alert_message( ssl, 2,
    ...
    while( ext_len )
    {
        ...
        case 11:
            ...
            break;
# 1858 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
        case 16:
            do { } while( 0 );
...
{
    int ret = -0x7080;
# 1943 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
...
# 1971 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
static int ssl_check_server_ecdh_params( const mbedtls_ssl_context *ssl )
{
    ...
    if( curve_info == 
# 1976 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c" 3 4
                     ((void *)0) 
# 1976 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
                          )
    {
        do { } while( 0 );
        return( -0x6C00 );
...
# 2005 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
static int ssl_parse_server_ecdh_params( mbedtls_ssl_context *ssl,
                                         unsigned char **p,
                                         unsigned char *end )
{
    int ret = -0x7080;
# 2019 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
...
# 2079 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
...
# 2100 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
    mbedtls_ssl_write_version( ssl->conf->max_major_ver, ssl->conf->max_minor_ver,
                       ssl->conf->transport, p );
...
# 2111 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c" 3 4
                                            ((void *)0) 
# 2111 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
                                                 )
    {
        do { } while( 0 );
        return( -0x7700 );
...
static int ssl_get_ecdh_params_from_cert( mbedtls_ssl_context *ssl )
{
    ...
    if( ssl->session_negotiate->peer_cert == 
# 2223 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c" 3 4
                                            ((void *)0) 
# 2223 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
                                                 )
    {
        do { } while( 0 );
        return( -0x7700 );
...
static int ssl_parse_server_key_exchange( mbedtls_ssl_context *ssl )
{
    ...
    do { } while( 0 );
# 2365 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
...
# 2413 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
    {
        do { } while( 0 );
        return( -0x6C00 );
    }
    ...
    if( mbedtls_ssl_ciphersuite_uses_server_signature( ciphersuite_info ) )
    {
        ...
        if( md_alg == MBEDTLS_MD_NONE )
        {
            ...
            hashlen = 36;
# 2514 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
        ...
        if( md_alg != MBEDTLS_MD_NONE )
        {
            ...
            hashlen = 0;
# 2548 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
        ...
        if( ssl->session_negotiate->peer_cert == 
# 2574 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c" 3 4
                                                ((void *)0) 
# 2574 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
                                                     )
        {
            do { } while( 0 );
            mbedtls_ssl_send_alert_message( ssl, 2,
...
# 2631 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
...
# 2700 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
    buf = ssl->in_msg;
...
# 2731 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
        n += 2 + sig_alg_len;
...
# 3000 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
    if( ciphersuite_info->key_exchange == MBEDTLS_KEY_EXCHANGE_RSA )
    {
        i = 4;
...
# 3033 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
    {
...
# 3091 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
...
# 3121 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c" 3 4
                                                               ((void *)0) 
# 3121 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
                                                                    )
    {
        do { } while( 0 );
        ssl->state++;
...
# 3128 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c" 3 4
                                     ((void *)0) 
# 3128 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
                                          )
    {
        do { } while( 0 );
        return( -0x7600 );
    ...
    if( ssl->minor_ver != 3 )
    {
# 3155 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
        hashlen = 36;
        md_alg = MBEDTLS_MD_NONE;
    ...
    if( ssl->minor_ver == 3 )
    {
# 3189 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
...
# 3248 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
...
# 3282 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
    if( ssl->in_msg[0] != 4 ||
...
# 3322 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c" 3 4
                                    ((void *)0)
# 3322 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
                                        ;
    ssl->session_negotiate->ticket_len = 0;

    if( ( ticket = calloc( 1, ticket_len ) ) == 
# 3325 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c" 3 4
                                                       ((void *)0) 
# 3325 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
                                                            )
    {
        do { } while( 0 );
        mbedtls_ssl_send_alert_message( ssl, 2,
...
# 3360 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c" 3 4
                                                                     ((void *)0) 
# 3360 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
                                                                          )
        return( -0x7100 );
    ...
    if( ( ret = mbedtls_ssl_flush_output( ssl ) ) != 0 )
        return( ret );
# 3380 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
    ...
    switch( ssl->state )
    {
       ...
       case MBEDTLS_SSL_CLIENT_HELLO:
           ...
           break;
# 3407 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
       ...
       case MBEDTLS_SSL_SERVER_HELLO_DONE:
           ...
           break;
# 3434 "C:/esp/esp-idf/components/mbedtls/library/ssl_cli.c"
