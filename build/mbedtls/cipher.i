# 1 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
# 1 "C:\\esp\\ArkPOS2-esp\\build\\mbedtls//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
# 29 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
...
# 30 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 2
...
int mbedtls_cipher_auth_decrypt( mbedtls_cipher_context_t *ctx,
                         ...
                         unsigned char *output, size_t *olen,
                         const unsigned char *tag, size_t tag_len );
# 35 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 2
# 1 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/cipher_internal.h" 1
# 34 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/cipher_internal.h"
# 1 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/cipher.h" 1
# 35 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/cipher_internal.h" 2
# 43 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/cipher_internal.h"
struct mbedtls_cipher_base_t
{
    ...
    int (*ctr_func)( void *ctx, size_t length, size_t *nc_off,
                     ...
                     const unsigned char *input, unsigned char *output );
# 80 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/cipher_internal.h"
...
# 36 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 2
...
# 38 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 2
...
# 39 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 2


# 1 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/gcm.h" 1
# 28 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/gcm.h"
...
# 29 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/gcm.h" 2
...
# 42 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 2
...
# 46 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 2
...
# 54 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 2
# 64 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
...
# 95 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
                                                       ((void *)0)
# 95 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
                                                           ; def++ )
        if( def->type == cipher_type )
            return( def->info );

    return( 
# 99 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
           ((void *)0) 
# 99 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
                );
}
...
const mbedtls_cipher_info_t *mbedtls_cipher_info_from_string( const char *cipher_name )
{
    ...
    if( 
# 106 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
       ((void *)0) 
# 106 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
            == cipher_name )
        return( 
# 107 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
               ((void *)0) 
# 107 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
                    );

    for( def = mbedtls_cipher_definitions; def->info != 
# 109 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
                                                       ((void *)0)
# 109 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
                                                           ; def++ )
        if( ! strcmp( def->info->name, cipher_name ) )
            return( def->info );

    return( 
# 113 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
           ((void *)0) 
# 113 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
                );
}
                                              ...
                                              const mbedtls_cipher_mode_t mode )
{
    ...
    for( def = mbedtls_cipher_definitions; def->info != 
# 122 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
                                                       ((void *)0)
# 122 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
                                                           ; def++ )
    ...
    return( 
# 128 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
           ((void *)0) 
# 128 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
                );
}
...
{
    if( ctx == 
# 138 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
              ((void *)0) 
# 138 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
                   )
        return;
# 149 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
    if( ctx->cipher_ctx )
...
{
    if( 
# 157 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
       ((void *)0) 
# 157 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
            == cipher_info || 
# 157 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
                              ((void *)0) 
# 157 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
    ...
    if( 
# 162 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
       ((void *)0) 
# 162 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
...
{
    if( 
# 184 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
       ((void *)0) 
# 184 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
            == ctx || 
# 184 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
                      ((void *)0) 
# 184 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
                   ...
                   const unsigned char *iv, size_t iv_len )
{
    ...
    if( 
# 219 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
       ((void *)0) 
# 219 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
            == ctx || 
# 219 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
                      ((void *)0) 
# 219 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
...
{
    if( 
# 245 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
       ((void *)0) 
# 245 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
            == ctx || 
# 245 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
                      ((void *)0) 
# 245 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
...
{
    if( 
# 257 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
       ((void *)0) 
# 257 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
            == ctx || 
# 257 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
                      ((void *)0) 
# 257 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
                   ...
                   size_t ilen, unsigned char *output, size_t *olen )
{
    ...
    if( 
# 276 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
       ((void *)0) 
# 276 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
            == ctx || 
# 276 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
                      ((void *)0) 
# 276 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
...
# 451 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
    return( -0x6080 );
}
        ...
        size_t *data_len )
{
    ...
    if( 
# 475 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
       ((void *)0) 
# 475 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
            == input || 
# 475 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
                        ((void *)0) 
# 475 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
                                      ...
                                      size_t *data_len )
{
    ...
    if( 
# 516 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
       ((void *)0) 
# 516 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
            == input || 
# 516 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
                        ((void *)0) 
# 516 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
                                      ...
                                      size_t *data_len )
{
    ...
    if( 
# 555 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
       ((void *)0) 
# 555 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
            == input || 
# 555 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
                        ((void *)0) 
# 555 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
                              ...
                              size_t *data_len )
{
    ...
    if( 
# 593 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
       ((void *)0) 
# 593 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
            == input || 
# 593 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
                        ((void *)0) 
# 593 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
...
# 614 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
static int get_no_padding( unsigned char *input, size_t input_len,
                              size_t *data_len )
{
    if( 
# 617 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
       ((void *)0) 
# 617 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
            == input || 
# 617 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
                        ((void *)0) 
# 617 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
...
{
    if( 
# 629 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
       ((void *)0) 
# 629 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
            == ctx || 
# 629 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
                      ((void *)0) 
# 629 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
    ...
    *olen = 0;
    ...
    if( MBEDTLS_MODE_CBC == ctx->cipher_info->mode )
    {
        ...
        if( MBEDTLS_ENCRYPT == ctx->operation )
        {
            ...
            if( 
# 658 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
               ((void *)0) 
# 658 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
                    == ctx->add_padding )
            {
                if( 0 != ctx->unprocessed_len )
                    return( -0x6280 );
        ...
        else if( mbedtls_cipher_get_block_size( ctx ) != ctx->unprocessed_len )
        {
            ...
            if( 
# 675 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
               ((void *)0) 
# 675 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
...
{
    if( 
# 708 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
       ((void *)0) 
# 708 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
            == ctx ||
    ...
    case MBEDTLS_PADDING_NONE:
        ctx->add_padding = 
# 741 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
                          ((void *)0)
# 741 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
                              ;
...
{
    if( 
# 757 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
       ((void *)0) 
# 757 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
            == ctx || 
# 757 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
                      ((void *)0) 
# 757 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
                      ...
                      const unsigned char *tag, size_t tag_len )
{
    ...
    if( 
# 774 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
       ((void *)0) 
# 774 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
            == ctx || 
# 774 "C:/esp/esp-idf/components/mbedtls/library/cipher.c" 3 4
                      ((void *)0) 
# 774 "C:/esp/esp-idf/components/mbedtls/library/cipher.c"
