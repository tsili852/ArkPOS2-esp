# 1 "C:/esp/esp-idf/components/mbedtls/library/dhm.c"
# 1 "C:\\esp\\ArkPOS2-esp\\build\\mbedtls//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/mbedtls/library/dhm.c"
# 33 "C:/esp/esp-idf/components/mbedtls/library/dhm.c"
...
# 34 "C:/esp/esp-idf/components/mbedtls/library/dhm.c" 2
...
# 39 "C:/esp/esp-idf/components/mbedtls/library/dhm.c" 2
...
# 41 "C:/esp/esp-idf/components/mbedtls/library/dhm.c" 2
...
# 44 "C:/esp/esp-idf/components/mbedtls/library/dhm.c" 2
...
# 48 "C:/esp/esp-idf/components/mbedtls/library/dhm.c" 2
...
# 52 "C:/esp/esp-idf/components/mbedtls/library/dhm.c" 2
# 61 "C:/esp/esp-idf/components/mbedtls/library/dhm.c"
...
# 100 "C:/esp/esp-idf/components/mbedtls/library/dhm.c"
                     ...
                     void *p_rng )
{
    ...
    if( ( ret = dhm_check_range( &ctx->GX, &ctx->P ) ) != 0 )
        return( ret );
# 195 "C:/esp/esp-idf/components/mbedtls/library/dhm.c"
                     ...
                     const unsigned char *input, size_t ilen )
{
    ...
    if( ctx == 
# 224 "C:/esp/esp-idf/components/mbedtls/library/dhm.c" 3 4
              ((void *)0) 
# 224 "C:/esp/esp-idf/components/mbedtls/library/dhm.c"
                   || ilen < 1 || ilen > ctx->len )
        return( -0x3080 );
                     ...
                     void *p_rng )
{
    ...
    if( ctx == 
# 243 "C:/esp/esp-idf/components/mbedtls/library/dhm.c" 3 4
              ((void *)0) 
# 243 "C:/esp/esp-idf/components/mbedtls/library/dhm.c"
                   || olen < 1 || olen > ctx->len )
        return( -0x3080 );
                     ...
                     void *p_rng )
{
    ...
    if( ctx == 
# 356 "C:/esp/esp-idf/components/mbedtls/library/dhm.c" 3 4
              ((void *)0) 
# 356 "C:/esp/esp-idf/components/mbedtls/library/dhm.c"
                   || output_size < ctx->len )
        return( -0x3080 );
    ...
    if( f_rng != 
# 365 "C:/esp/esp-idf/components/mbedtls/library/dhm.c" 3 4
                ((void *)0) 
# 365 "C:/esp/esp-idf/components/mbedtls/library/dhm.c"
                     )
    {
    ...
    if( f_rng != 
# 379 "C:/esp/esp-idf/components/mbedtls/library/dhm.c" 3 4
                ((void *)0) 
# 379 "C:/esp/esp-idf/components/mbedtls/library/dhm.c"
                     )
    {
                   ...
                   size_t dhminlen )
{
    ...
    if( dhminlen == 0 || dhmin[dhminlen - 1] != '\0' )
        ...
        ret = mbedtls_pem_read_buffer( &pem,
                               ...
                               "-----END DH PARAMETERS-----",
                               dhmin, 
# 433 "C:/esp/esp-idf/components/mbedtls/library/dhm.c" 3 4
                                     ((void *)0)
# 433 "C:/esp/esp-idf/components/mbedtls/library/dhm.c"
                                         , 0, &dhminlen );
...
# 458 "C:/esp/esp-idf/components/mbedtls/library/dhm.c"
...
# 517 "C:/esp/esp-idf/components/mbedtls/library/dhm.c"
static int load_file( const char *path, unsigned char **buf, size_t *n )
{
    ...
    if( ( f = fopen( path, "rb" ) ) == 
# 522 "C:/esp/esp-idf/components/mbedtls/library/dhm.c" 3 4
                                      ((void *)0) 
# 522 "C:/esp/esp-idf/components/mbedtls/library/dhm.c"
                                           )
        return( -0x3480 );
    ...
    *n = (size_t) size;
    ...
    if( *n + 1 == 0 ||
        ( *buf = calloc( 1, *n + 1 ) ) == 
# 536 "C:/esp/esp-idf/components/mbedtls/library/dhm.c" 3 4
                                                 ((void *)0) 
# 536 "C:/esp/esp-idf/components/mbedtls/library/dhm.c"
                                                      )
    {
        fclose( f );
        return( -0x3400 );
...
# 553 "C:/esp/esp-idf/components/mbedtls/library/dhm.c" 3 4
                                                       ((void *)0) 
# 553 "C:/esp/esp-idf/components/mbedtls/library/dhm.c"
                                                            )
        ++*n;
