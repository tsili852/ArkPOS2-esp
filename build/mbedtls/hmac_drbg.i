# 1 "C:/esp/esp-idf/components/mbedtls/library/hmac_drbg.c"
# 1 "C:\\esp\\ArkPOS2-esp\\build\\mbedtls//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/mbedtls/library/hmac_drbg.c"
# 31 "C:/esp/esp-idf/components/mbedtls/library/hmac_drbg.c"
...
# 32 "C:/esp/esp-idf/components/mbedtls/library/hmac_drbg.c" 2
...
# 37 "C:/esp/esp-idf/components/mbedtls/library/hmac_drbg.c" 2
...
# 39 "C:/esp/esp-idf/components/mbedtls/library/hmac_drbg.c" 2
...
# 42 "C:/esp/esp-idf/components/mbedtls/library/hmac_drbg.c" 2
...
# 47 "C:/esp/esp-idf/components/mbedtls/library/hmac_drbg.c" 2
...
# 77 "C:/esp/esp-idf/components/mbedtls/library/hmac_drbg.c" 3 4
                                          ((void *)0) 
# 77 "C:/esp/esp-idf/components/mbedtls/library/hmac_drbg.c"
                                               && add_len != 0 ) ? 2 : 1;
    unsigned char sep[1];
    unsigned char K[64];
                      ...
                      const unsigned char *additional, size_t len )
{
    ...
    if( additional != 
# 148 "C:/esp/esp-idf/components/mbedtls/library/hmac_drbg.c" 3 4
                     ((void *)0) 
# 148 "C:/esp/esp-idf/components/mbedtls/library/hmac_drbg.c"
                          && len != 0 )
    {
...
# 202 "C:/esp/esp-idf/components/mbedtls/library/hmac_drbg.c"
                               ...
                               const unsigned char *additional, size_t add_len )
{
    ...
    if( ctx->f_entropy != 
# 268 "C:/esp/esp-idf/components/mbedtls/library/hmac_drbg.c" 3 4
                         ((void *)0) 
# 268 "C:/esp/esp-idf/components/mbedtls/library/hmac_drbg.c"
                              &&
    ...
    if( additional != 
# 279 "C:/esp/esp-idf/components/mbedtls/library/hmac_drbg.c" 3 4
                     ((void *)0) 
# 279 "C:/esp/esp-idf/components/mbedtls/library/hmac_drbg.c"
                          && add_len != 0 )
...
# 319 "C:/esp/esp-idf/components/mbedtls/library/hmac_drbg.c" 3 4
                                                                  ((void *)0)
# 319 "C:/esp/esp-idf/components/mbedtls/library/hmac_drbg.c"
                                                                      , 0 );
...
{
    if( ctx == 
# 334 "C:/esp/esp-idf/components/mbedtls/library/hmac_drbg.c" 3 4
              ((void *)0) 
# 334 "C:/esp/esp-idf/components/mbedtls/library/hmac_drbg.c"
                   )
        return;
...
int mbedtls_hmac_drbg_write_seed_file( mbedtls_hmac_drbg_context *ctx, const char *path )
{
    ...
    if( ( f = fopen( path, "wb" ) ) == 
# 351 "C:/esp/esp-idf/components/mbedtls/library/hmac_drbg.c" 3 4
                                      ((void *)0) 
# 351 "C:/esp/esp-idf/components/mbedtls/library/hmac_drbg.c"
                                           )
        return( -0x0007 );
...
int mbedtls_hmac_drbg_update_seed_file( mbedtls_hmac_drbg_context *ctx, const char *path )
{
    ...
    if( ( f = fopen( path, "rb" ) ) == 
# 376 "C:/esp/esp-idf/components/mbedtls/library/hmac_drbg.c" 3 4
                                      ((void *)0) 
# 376 "C:/esp/esp-idf/components/mbedtls/library/hmac_drbg.c"
                                           )
        return( -0x0007 );
...
# 418 "C:/esp/esp-idf/components/mbedtls/library/hmac_drbg.c"
...
# 469 "C:/esp/esp-idf/components/mbedtls/library/hmac_drbg.c"
int mbedtls_hmac_drbg_self_test( int verbose )
{
...
# 484 "C:/esp/esp-idf/components/mbedtls/library/hmac_drbg.c" 3 4
   ((void *)0)
# 484 "C:/esp/esp-idf/components/mbedtls/library/hmac_drbg.c"
...
# 507 "C:/esp/esp-idf/components/mbedtls/library/hmac_drbg.c" 3 4
   ((void *)0)
# 507 "C:/esp/esp-idf/components/mbedtls/library/hmac_drbg.c"
   , 0 )) != 0 ) { if( verbose != 0 ) printf( "failed\n" ); return( 1 ); }

                                    ;
    if( (mbedtls_hmac_drbg_reseed( &ctx, 
# 510 "C:/esp/esp-idf/components/mbedtls/library/hmac_drbg.c" 3 4
   ((void *)0)
# 510 "C:/esp/esp-idf/components/mbedtls/library/hmac_drbg.c"
   , 0 )) != 0 ) { if( verbose != 0 ) printf( "failed\n" ); return( 1 ); };
    if( (mbedtls_hmac_drbg_random( &ctx, buf, 80 )) != 0 ) { if( verbose != 0 ) printf( "failed\n" ); return( 1 ); };
    if( (mbedtls_hmac_drbg_random( &ctx, buf, 80 )) != 0 ) { if( verbose != 0 ) printf( "failed\n" ); return( 1 ); };
