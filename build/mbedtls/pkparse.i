# 1 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c"
# 1 "C:\\esp\\ArkPOS2-esp\\build\\mbedtls//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c"
# 25 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c"
...
# 26 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c" 2
...
# 31 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c" 2
...
# 32 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c" 2
...
# 33 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c" 2
...
# 35 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c" 2


# 1 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/rsa.h" 1
# 38 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c" 2


# 1 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/ecp.h" 1
# 41 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c" 2


# 1 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/ecdsa.h" 1
# 44 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c" 2
...
# 47 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c" 2
...
# 50 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c" 2
...
# 53 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c" 2
...
# 57 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c" 2
# 65 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c"
static void mbedtls_zeroize( void *v, size_t n ) {
    volatile unsigned char *p = v; while( n-- ) *p++ = 0;
}
# 76 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c"
int mbedtls_pk_load_file( const char *path, unsigned char **buf, size_t *n )
{
    FILE *f;
    long size;
    ...
    if( ( f = fopen( path, "rb" ) ) == 
# 81 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c" 3 4
                                      ((void *)0) 
# 81 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c"
                                           )
        return( -0x3E00 );
    ...
    *n = (size_t) size;
    ...
    if( *n + 1 == 0 ||
        ( *buf = calloc( 1, *n + 1 ) ) == 
# 95 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c" 3 4
                                                 ((void *)0) 
# 95 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c"
                                                      )
    {
        fclose( f );
        return( -0x3F80 );
...
# 112 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c" 3 4
                                                       ((void *)0) 
# 112 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c"
                                                            )
        ++*n;
                      ...
                      const char *path, const char *pwd )
{
    ...
    if( pwd == 
# 131 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c" 3 4
              ((void *)0) 
# 131 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c"
                   )
        ret = mbedtls_pk_parse_key( ctx, buf, n, 
# 132 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c" 3 4
                                                ((void *)0)
# 132 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c"
                                                    , 0 );
    else
        ret = mbedtls_pk_parse_key( ctx, buf, n,
...
# 173 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c"
...
# 225 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c"
static int pk_group_from_specified( const mbedtls_asn1_buf *params, mbedtls_ecp_group *grp )
{
    ...
    end_field = p + len;
# 261 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c"
    ...
    if( p != end_field )
        return( -0x3D00 +
                -0x0066 );
# 291 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c"
    if( ( ret = mbedtls_asn1_get_tag( &p, end, &len,
            0x20 | 0x10 ) ) != 0 )
        return( ret );
...
# 442 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c"
...
# 481 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c"
...
# 508 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c"
...
# 546 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c"
...
# 606 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c" 3 4
                                                            ((void *)0) 
# 606 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c"
                                                                 )
        return( -0x3C80 );
...
# 669 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c"
    if( ( ret = mbedtls_asn1_get_tag( &p, end, &len,
            0x20 | 0x10 ) ) != 0 )
    {
        return( -0x3D00 + ret );
                                  ...
                                  size_t keylen )
{
    ...
    unsigned char *end2;
# 745 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c"
    if( ( ret = mbedtls_asn1_get_tag( &p, end, &len,
            0x20 | 0x10 ) ) != 0 )
    {
        return( -0x3D00 + ret );
...
# 829 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c" 3 4
                                                     ((void *)0)
# 829 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c"
                                                         , 
# 829 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c" 3 4
                                                           ((void *)0) 
# 829 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c"
                                    ...
                                    size_t keylen )
{
    ...
    mbedtls_pk_type_t pk_alg = MBEDTLS_PK_NONE;
    const mbedtls_pk_info_t *pk_info;
# 877 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c"
    if( ( ret = mbedtls_asn1_get_tag( &p, end, &len,
            0x20 | 0x10 ) ) != 0 )
    {
        return( -0x3D00 + ret );
    ...
    if( ( pk_info = mbedtls_pk_info_from_type( pk_alg ) ) == 
# 901 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c" 3 4
                                                            ((void *)0) 
# 901 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c"
                                                                 )
        return( -0x3C80 );
                                    ...
                                    const unsigned char *pwd, size_t pwdlen )
{
    ...
    if( pwdlen == 0 )
        return( -0x3C00 );
# 974 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c"
    if( ( ret = mbedtls_asn1_get_tag( &p, end, &len,
            0x20 | 0x10 ) ) != 0 )
    {
        return( -0x3D00 + ret );
...
# 1084 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c" 3 4
                                                                        ((void *)0) 
# 1084 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c"
                                                                             )
            return( -0x3C80 );
...
# 1116 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c" 3 4
                                                                          ((void *)0) 
# 1116 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c"
                                                                               )
            return( -0x3C80 );
    ...
    if( keylen == 0 || key[keylen - 1] != '\0' )
        ...
        ret = mbedtls_pem_read_buffer( &pem,
                               ...
                               "-----END PRIVATE KEY-----",
                               key, 
# 1144 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c" 3 4
                                   ((void *)0)
# 1144 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c"
                                       , 0, &len );
    if( ret == 0 )
    {
    ...
    if( keylen == 0 || key[keylen - 1] != '\0' )
        ...
        ret = mbedtls_pem_read_buffer( &pem,
                               ...
                               key, 
# 1167 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c" 3 4
                                   ((void *)0)
# 1167 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c"
                                       , 0, &len );
    if( ret == 0 )
    {
        ...
        return( ret );
# 1197 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c"
    ...
    if( ( pk_info = mbedtls_pk_info_from_type( MBEDTLS_PK_RSA ) ) == 
# 1217 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c" 3 4
                                                                    ((void *)0) 
# 1217 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c"
                                                                         )
        return( -0x3C80 );
    ...
    if( ( pk_info = mbedtls_pk_info_from_type( MBEDTLS_PK_ECKEY ) ) == 
# 1230 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c" 3 4
                                                                      ((void *)0) 
# 1230 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c"
                                                                           )
        return( -0x3C80 );
                         ...
                         const unsigned char *key, size_t keylen )
{
    ...
    if( keylen == 0 || key[keylen - 1] != '\0' )
        ...
        ret = mbedtls_pem_read_buffer( &pem,
                ...
                "-----END PUBLIC KEY-----",
                key, 
# 1266 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c" 3 4
                    ((void *)0)
# 1266 "C:/esp/esp-idf/components/mbedtls/library/pkparse.c"
                        , 0, &len );
