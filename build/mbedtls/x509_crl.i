# 1 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c"
# 1 "C:\\esp\\ArkPOS2-esp\\build\\mbedtls//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c"
# 35 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c"
...
# 36 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c" 2




# 1 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/x509_crl.h" 1
# 32 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/x509_crl.h"
...
# 33 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/x509_crl.h" 2
...
# 41 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c" 2
...
# 42 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c" 2
...
# 44 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c" 2
...
# 47 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c" 2
...
# 51 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c" 2
# 70 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c"
                             ...
                             mbedtls_x509_buf *ext )
{
            ...
            0x20 | 0x10 ) ) != 0 )
    {
        ...
        {
            ext->p = 
# 158 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c" 3 4
                    ((void *)0)
# 158 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c"
                        ;
            return( 0 );
        }
        return( -0x2500 + ret );
                             ...
                             mbedtls_x509_crl_entry *entry )
{
    ...
    while( *p < end )
    {
        ...
        if( *p < end )
        {
            ...
            if( cur_entry->next == 
# 242 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c" 3 4
                                  ((void *)0) 
# 242 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c"
                                       )
                return( -0x2880 );
                        ...
                        const unsigned char *buf, size_t buflen )
{
    ...
    if( crl == 
# 267 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c" 3 4
              ((void *)0) 
# 267 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c"
                   || buf == 
# 267 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c" 3 4
                             ((void *)0) 
# 267 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c"
...
# 277 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c" 3 4
                                            ((void *)0) 
# 277 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c"
                                                 )
        crl = crl->next;

    if( crl->version != 0 && crl->next == 
# 280 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c" 3 4
                                         ((void *)0) 
# 280 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c"
                                              )
    {
        crl->next = calloc( 1, sizeof( mbedtls_x509_crl ) );

        if( crl->next == 
# 284 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c" 3 4
                        ((void *)0) 
# 284 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c"
                             )
        {
...
# 297 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c" 3 4
                                              ((void *)0) 
# 297 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c"
                                                   )
        return( -0x2880 );
...
# 421 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c"
...
int mbedtls_x509_crl_parse( mbedtls_x509_crl *chain, const unsigned char *buf, size_t buflen )
{
    ...
    if( chain == 
# 498 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c" 3 4
                ((void *)0) 
# 498 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c"
                     || buf == 
# 498 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c" 3 4
                               ((void *)0) 
# 498 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c"
    ...
    do
    {
        ...
        if( buflen == 0 || buf[buflen - 1] != '\0' )
            ...
            ret = mbedtls_pem_read_buffer( &pem,
                                           ...
                                           "-----END X509 CRL-----",
                                            buf, 
# 513 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c" 3 4
                                                ((void *)0)
# 513 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c"
                                                    , 0, &use_len );
...
# 581 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c"
int mbedtls_x509_crl_info( char *buf, size_t size, const char *prefix,
                   const mbedtls_x509_crl *crl )
{
    int ret;
    ...
    while( entry != 
# 621 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c" 3 4
                   ((void *)0) 
# 621 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c"
                        && entry->raw.len != 0 )
    {
        ret = snprintf( p, n, "\n%sserial number: ",
                               prefix );
...
void mbedtls_x509_crl_free( mbedtls_x509_crl *crl )
{
    ...
    if( crl == 
# 673 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c" 3 4
              ((void *)0) 
# 673 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c"
                   )
        return;
    ...
    do
    {
        ...
        while( name_cur != 
# 683 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c" 3 4
                          ((void *)0) 
# 683 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c"
                               )
        {
            name_prv = name_cur;
        ...
        while( entry_cur != 
# 692 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c" 3 4
                           ((void *)0) 
# 692 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c"
                                )
        {
            entry_prv = entry_cur;
        ...
        if( crl_cur->raw.p != 
# 700 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c" 3 4
                             ((void *)0) 
# 700 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c"
                                  )
        {
    ...
    while( crl_cur != 
# 708 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c" 3 4
                     ((void *)0) 
# 708 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c"
                          );
    ...
    while( crl_cur != 
# 720 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c" 3 4
                     ((void *)0) 
# 720 "C:/esp/esp-idf/components/mbedtls/library/x509_crl.c"
                          );
}
