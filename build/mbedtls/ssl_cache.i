# 1 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c"
# 1 "C:\\esp\\ArkPOS2-esp\\build\\mbedtls//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c"
# 29 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c"
...
# 30 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c" 2
...
# 36 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c" 2
...
# 1 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/ssl_cache.h" 1
# 26 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/ssl_cache.h"
...
# 27 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/ssl_cache.h" 2
# 54 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/ssl_cache.h"
...
# 99 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/ssl_cache.h"
int mbedtls_ssl_cache_get( void *data, mbedtls_ssl_session *session );
# 108 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/ssl_cache.h"
int mbedtls_ssl_cache_set( void *data, const mbedtls_ssl_session *session );
# 120 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/ssl_cache.h"
void mbedtls_ssl_cache_set_timeout( mbedtls_ssl_cache_context *cache, int timeout );
# 130 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/ssl_cache.h"
...
# 43 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c" 2
...
# 45 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c" 2
...
# 62 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c" 3 4
                                    ((void *)0) 
# 62 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c"
                                         );
    ...
    cur = cache->chain;
    entry = 
# 73 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c" 3 4
           ((void *)0)
# 73 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c"
               ;

    while( cur != 
# 75 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c" 3 4
                 ((void *)0) 
# 75 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c"
                      )
    {
        entry = cur;
        cur = cur->next;
...
# 103 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c" 3 4
                                 ((void *)0) 
# 103 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c"
                                      )
        {
            if( ( session->peer_cert = calloc( 1,
                                 sizeof(mbedtls_x509_crt) ) ) == 
# 106 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c" 3 4
                                                                ((void *)0) 
# 106 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c"
                                                                     )
            {
                ret = 1;
                goto exit;
                                ...
                                entry->peer_cert.len ) != 0 )
            {
                ...
                session->peer_cert = 
# 117 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c" 3 4
                                    ((void *)0)
# 117 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c"
                                        ;
                ret = 1;
                goto exit;
            }
...
int mbedtls_ssl_cache_set( void *data, const mbedtls_ssl_session *session )
{
    ...
    mbedtls_time_t t = time( 
# 141 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c" 3 4
                                    ((void *)0) 
# 141 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c"
                                         ), oldest = 0;
    mbedtls_ssl_cache_entry *old = 
# 142 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c" 3 4
                                  ((void *)0)
# 142 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c"
                                      ;
    ...
    cur = cache->chain;
    prv = 
# 154 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c" 3 4
         ((void *)0)
# 154 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c"
             ;

    while( cur != 
# 156 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c" 3 4
                 ((void *)0) 
# 156 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c"
                      )
    {
        count++;
    ...
    if( cur == 
# 184 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c" 3 4
              ((void *)0) 
# 184 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c"
                   )
    {
        ...
        {
            if( old == 
# 192 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c" 3 4
                      ((void *)0) 
# 192 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c"
                           )
            {
                ret = 1;
                goto exit;
...
# 219 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c"
        else
        {
            ...
            if( cur == 
# 225 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c" 3 4
                      ((void *)0) 
# 225 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c"
                           )
            {
                ret = 1;
                goto exit;
            ...
            if( prv == 
# 231 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c" 3 4
                      ((void *)0) 
# 231 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c"
                           )
                cache->chain = cur;
            else
                prv->next = cur;
    ...
    if( cur->peer_cert.p != 
# 248 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c" 3 4
                           ((void *)0) 
# 248 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c"
                                )
    {
...
# 257 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c" 3 4
                             ((void *)0) 
# 257 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c"
                                  )
    {
        cur->peer_cert.p = calloc( 1, session->peer_cert->raw.len );
        if( cur->peer_cert.p == 
# 260 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c" 3 4
                               ((void *)0) 
# 260 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c"
                                    )
        {
            ret = 1;
            goto exit;
...
# 270 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c" 3 4
                                ((void *)0)
# 270 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c"
                                    ;
    }
...
void mbedtls_ssl_cache_free( mbedtls_ssl_cache_context *cache )
{
    ...
    while( cur != 
# 307 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c" 3 4
                 ((void *)0) 
# 307 "C:/esp/esp-idf/components/mbedtls/library/ssl_cache.c"
                      )
    {
        prv = cur;
        cur = cur->next;
