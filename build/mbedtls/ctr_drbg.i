# 1 "C:/esp/esp-idf/components/mbedtls/library/ctr_drbg.c"
# 1 "C:\\esp\\ArkPOS2-esp\\build\\mbedtls//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/mbedtls/library/ctr_drbg.c"
# 30 "C:/esp/esp-idf/components/mbedtls/library/ctr_drbg.c"
...
# 31 "C:/esp/esp-idf/components/mbedtls/library/ctr_drbg.c" 2
...
# 36 "C:/esp/esp-idf/components/mbedtls/library/ctr_drbg.c" 2
...
# 38 "C:/esp/esp-idf/components/mbedtls/library/ctr_drbg.c" 2
...
# 41 "C:/esp/esp-idf/components/mbedtls/library/ctr_drbg.c" 2
...
# 46 "C:/esp/esp-idf/components/mbedtls/library/ctr_drbg.c" 2
...
{
    if( ctx == 
# 117 "C:/esp/esp-idf/components/mbedtls/library/ctr_drbg.c" 3 4
              ((void *)0) 
# 117 "C:/esp/esp-idf/components/mbedtls/library/ctr_drbg.c"
                   )
        return;
...
# 168 "C:/esp/esp-idf/components/mbedtls/library/ctr_drbg.c"
    p = buf + 16;
    *p++ = ( data_len >> 24 ) & 0xff;
    *p++ = ( data_len >> 16 ) & 0xff;
    *p++ = ( data_len >> 8 ) & 0xff;
...
# 409 "C:/esp/esp-idf/components/mbedtls/library/ctr_drbg.c" 3 4
                                                                    ((void *)0)
# 409 "C:/esp/esp-idf/components/mbedtls/library/ctr_drbg.c"
                                                                        , 0 );
...
int mbedtls_ctr_drbg_write_seed_file( mbedtls_ctr_drbg_context *ctx, const char *path )
{
    ...
    if( ( f = fopen( path, "wb" ) ) == 
# 426 "C:/esp/esp-idf/components/mbedtls/library/ctr_drbg.c" 3 4
                                      ((void *)0) 
# 426 "C:/esp/esp-idf/components/mbedtls/library/ctr_drbg.c"
                                           )
        return( -0x003A );
...
int mbedtls_ctr_drbg_update_seed_file( mbedtls_ctr_drbg_context *ctx, const char *path )
{
    ...
    if( ( f = fopen( path, "rb" ) ) == 
# 451 "C:/esp/esp-idf/components/mbedtls/library/ctr_drbg.c" 3 4
                                      ((void *)0) 
# 451 "C:/esp/esp-idf/components/mbedtls/library/ctr_drbg.c"
                                           )
        return( -0x003A );
...
# 540 "C:/esp/esp-idf/components/mbedtls/library/ctr_drbg.c"
int mbedtls_ctr_drbg_self_test( int verbose )
{
    mbedtls_ctr_drbg_context ctx;
...
# 578 "C:/esp/esp-idf/components/mbedtls/library/ctr_drbg.c" 3 4
   ((void *)0)
# 578 "C:/esp/esp-idf/components/mbedtls/library/ctr_drbg.c"
