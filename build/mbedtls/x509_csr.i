# 1 "C:/esp/esp-idf/components/mbedtls/library/x509_csr.c"
# 1 "C:\\esp\\ArkPOS2-esp\\build\\mbedtls//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/mbedtls/library/x509_csr.c"
# 35 "C:/esp/esp-idf/components/mbedtls/library/x509_csr.c"
...
# 36 "C:/esp/esp-idf/components/mbedtls/library/x509_csr.c" 2
...
int mbedtls_x509write_csr_pem( mbedtls_x509write_csr *ctx, unsigned char *buf, size_t size,
                       int (*f_rng)(void *, unsigned char *, size_t),
                       void *p_rng );
# 41 "C:/esp/esp-idf/components/mbedtls/library/x509_csr.c" 2
...
# 42 "C:/esp/esp-idf/components/mbedtls/library/x509_csr.c" 2
...
# 44 "C:/esp/esp-idf/components/mbedtls/library/x509_csr.c" 2
...
# 47 "C:/esp/esp-idf/components/mbedtls/library/x509_csr.c" 2
...
# 51 "C:/esp/esp-idf/components/mbedtls/library/x509_csr.c" 2
# 64 "C:/esp/esp-idf/components/mbedtls/library/x509_csr.c"
                        ...
                        const unsigned char *buf, size_t buflen )
{
    ...
    if( csr == 
# 107 "C:/esp/esp-idf/components/mbedtls/library/x509_csr.c" 3 4
              ((void *)0) 
# 107 "C:/esp/esp-idf/components/mbedtls/library/x509_csr.c"
                   || buf == 
# 107 "C:/esp/esp-idf/components/mbedtls/library/x509_csr.c" 3 4
                             ((void *)0) 
# 107 "C:/esp/esp-idf/components/mbedtls/library/x509_csr.c"
    ...
    if( p == 
# 117 "C:/esp/esp-idf/components/mbedtls/library/x509_csr.c" 3 4
            ((void *)0) 
# 117 "C:/esp/esp-idf/components/mbedtls/library/x509_csr.c"
                 )
        return( -0x2880 );
...
# 133 "C:/esp/esp-idf/components/mbedtls/library/x509_csr.c"
...
# 218 "C:/esp/esp-idf/components/mbedtls/library/x509_csr.c"
    if( ( ret = mbedtls_asn1_get_tag( &p, end, &len,
            0x20 | 0x80 ) ) != 0 )
    {
        mbedtls_x509_csr_free( csr );
...
int mbedtls_x509_csr_parse( mbedtls_x509_csr *csr, const unsigned char *buf, size_t buflen )
{
    ...
    if( csr == 
# 277 "C:/esp/esp-idf/components/mbedtls/library/x509_csr.c" 3 4
              ((void *)0) 
# 277 "C:/esp/esp-idf/components/mbedtls/library/x509_csr.c"
                   || buf == 
# 277 "C:/esp/esp-idf/components/mbedtls/library/x509_csr.c" 3 4
                             ((void *)0) 
# 277 "C:/esp/esp-idf/components/mbedtls/library/x509_csr.c"
    ...
    if( buf[buflen - 1] != '\0' )
        ...
        ret = mbedtls_pem_read_buffer( &pem,
                               ...
                               buf, 
# 290 "C:/esp/esp-idf/components/mbedtls/library/x509_csr.c" 3 4
                                   ((void *)0)
# 290 "C:/esp/esp-idf/components/mbedtls/library/x509_csr.c"
                                       , 0, &use_len );
...
void mbedtls_x509_csr_free( mbedtls_x509_csr *csr )
{
    ...
    if( csr == 
# 396 "C:/esp/esp-idf/components/mbedtls/library/x509_csr.c" 3 4
              ((void *)0) 
# 396 "C:/esp/esp-idf/components/mbedtls/library/x509_csr.c"
                   )
        return;
    ...
    while( name_cur != 
# 406 "C:/esp/esp-idf/components/mbedtls/library/x509_csr.c" 3 4
                      ((void *)0) 
# 406 "C:/esp/esp-idf/components/mbedtls/library/x509_csr.c"
                           )
    {
        name_prv = name_cur;
    ...
    if( csr->raw.p != 
# 414 "C:/esp/esp-idf/components/mbedtls/library/x509_csr.c" 3 4
                     ((void *)0) 
# 414 "C:/esp/esp-idf/components/mbedtls/library/x509_csr.c"
                          )
    {
