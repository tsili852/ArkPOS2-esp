# 1 "C:/esp/esp-idf/components/mbedtls/library/ecdh.c"
# 1 "C:\\esp\\ArkPOS2-esp\\build\\mbedtls//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/mbedtls/library/ecdh.c"
# 32 "C:/esp/esp-idf/components/mbedtls/library/ecdh.c"
...
# 33 "C:/esp/esp-idf/components/mbedtls/library/ecdh.c" 2




# 1 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/ecdh.h" 1
# 26 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/ecdh.h"
...
# 27 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/ecdh.h" 2
...
int mbedtls_ecdh_calc_secret( mbedtls_ecdh_context *ctx, size_t *olen,
                      ...
                      int (*f_rng)(void *, unsigned char *, size_t),
                      void *p_rng );
# 38 "C:/esp/esp-idf/components/mbedtls/library/ecdh.c" 2
...
# 40 "C:/esp/esp-idf/components/mbedtls/library/ecdh.c" 2
...
{
    if( ctx == 
# 98 "C:/esp/esp-idf/components/mbedtls/library/ecdh.c" 3 4
              ((void *)0) 
# 98 "C:/esp/esp-idf/components/mbedtls/library/ecdh.c"
                   )
        return;
...
# 118 "C:/esp/esp-idf/components/mbedtls/library/ecdh.c"
int mbedtls_ecdh_make_params( mbedtls_ecdh_context *ctx, size_t *olen,
                      unsigned char *buf, size_t blen,
                      int (*f_rng)(void *, unsigned char *, size_t),
                      void *p_rng )
{
    ...
    if( ctx == 
# 126 "C:/esp/esp-idf/components/mbedtls/library/ecdh.c" 3 4
              ((void *)0) 
# 126 "C:/esp/esp-idf/components/mbedtls/library/ecdh.c"
                   || ctx->grp.pbits == 0 )
        return( -0x4F80 );
...
# 155 "C:/esp/esp-idf/components/mbedtls/library/ecdh.c"
int mbedtls_ecdh_read_params( mbedtls_ecdh_context *ctx,
                      const unsigned char **buf, const unsigned char *end )
{
    int ret;
                      ...
                      void *p_rng )
{
    ...
    if( ctx == 
# 206 "C:/esp/esp-idf/components/mbedtls/library/ecdh.c" 3 4
              ((void *)0) 
# 206 "C:/esp/esp-idf/components/mbedtls/library/ecdh.c"
                   || ctx->grp.pbits == 0 )
        return( -0x4F80 );
                      ...
                      const unsigned char *buf, size_t blen )
{
    ...
    if( ctx == 
# 226 "C:/esp/esp-idf/components/mbedtls/library/ecdh.c" 3 4
              ((void *)0) 
# 226 "C:/esp/esp-idf/components/mbedtls/library/ecdh.c"
                   )
        return( -0x4F80 );
                      ...
                      void *p_rng )
{
    ...
    if( ctx == 
# 248 "C:/esp/esp-idf/components/mbedtls/library/ecdh.c" 3 4
              ((void *)0) 
# 248 "C:/esp/esp-idf/components/mbedtls/library/ecdh.c"
                   )
        return( -0x4F80 );
