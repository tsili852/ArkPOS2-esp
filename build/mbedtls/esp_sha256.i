# 1 "C:/esp/esp-idf/components/mbedtls/port/esp_sha256.c"
# 1 "C:\\esp\\ArkPOS2-esp\\build\\mbedtls//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/mbedtls/port/esp_sha256.c"
# 33 "C:/esp/esp-idf/components/mbedtls/port/esp_sha256.c"
...
# 34 "C:/esp/esp-idf/components/mbedtls/port/esp_sha256.c" 2
...
# 34 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/sha256.h" 2
...
# 39 "C:/esp/esp-idf/components/mbedtls/port/esp_sha256.c" 2
...
# 41 "C:/esp/esp-idf/components/mbedtls/port/esp_sha256.c" 2
...
# 45 "C:/esp/esp-idf/components/mbedtls/port/esp_sha256.c" 2
...
# 26 "C:/esp/esp-idf/components/esp32/include/rom/sha.h"
...
# 52 "C:/esp/esp-idf/components/mbedtls/port/esp_sha256.c" 2


static void mbedtls_zeroize( void *v, size_t n ) {
    volatile unsigned char *p = v; while( n-- ) *p++ = 0;
}
# 81 "C:/esp/esp-idf/components/mbedtls/port/esp_sha256.c"
void mbedtls_sha256_init( mbedtls_sha256_context *ctx )
{
...
{
    if( ctx == 
# 88 "C:/esp/esp-idf/components/mbedtls/port/esp_sha256.c" 3 4
              ((void *)0) 
# 88 "C:/esp/esp-idf/components/mbedtls/port/esp_sha256.c"
                   )
        return;
...
# 197 "C:/esp/esp-idf/components/mbedtls/port/esp_sha256.c"
static void mbedtls_sha256_software_process( mbedtls_sha256_context *ctx, const unsigned char data[64] );

void mbedtls_sha256_process( mbedtls_sha256_context *ctx, const unsigned char data[64] )
{
    
# 201 "C:/esp/esp-idf/components/mbedtls/port/esp_sha256.c" 3 4
   _Bool 
# 201 "C:/esp/esp-idf/components/mbedtls/port/esp_sha256.c"
        first_block = 
# 201 "C:/esp/esp-idf/components/mbedtls/port/esp_sha256.c" 3 4
                      0
# 201 "C:/esp/esp-idf/components/mbedtls/port/esp_sha256.c"
    ...
    if (ctx->mode == ESP_MBEDTLS_SHA256_UNUSED) {
        ...
        if (!ctx->is224 && esp_sha_try_lock_engine(SHA2_256)) {
            ...
            first_block = 
# 207 "C:/esp/esp-idf/components/mbedtls/port/esp_sha256.c" 3 4
                         1
# 207 "C:/esp/esp-idf/components/mbedtls/port/esp_sha256.c"
                             ;
        } else {
...
static void mbedtls_sha256_software_process( mbedtls_sha256_context *ctx, const unsigned char data[64] )
{
    ...
    for( i = 0; i < 8; i++ )
        A[i] = ctx->state[i];
# 244 "C:/esp/esp-idf/components/mbedtls/port/esp_sha256.c"
    for( i = 0; i < 16; i++ )
