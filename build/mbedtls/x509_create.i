# 1 "C:/esp/esp-idf/components/mbedtls/library/x509_create.c"
# 1 "C:\\esp\\ArkPOS2-esp\\build\\mbedtls//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/mbedtls/library/x509_create.c"
# 25 "C:/esp/esp-idf/components/mbedtls/library/x509_create.c"
...
# 26 "C:/esp/esp-idf/components/mbedtls/library/x509_create.c" 2
...
# 31 "C:/esp/esp-idf/components/mbedtls/library/x509_create.c" 2
...
mbedtls_asn1_named_data *mbedtls_asn1_store_named_data( mbedtls_asn1_named_data **list,
                                        ...
                                        size_t val_len );
# 32 "C:/esp/esp-idf/components/mbedtls/library/x509_create.c" 2
...
# 33 "C:/esp/esp-idf/components/mbedtls/library/x509_create.c" 2
...
# 35 "C:/esp/esp-idf/components/mbedtls/library/x509_create.c" 2
...
static const x509_attr_descriptor_t x509_attrs[] =
{
    ...
    { 
# 74 "C:/esp/esp-idf/components/mbedtls/library/x509_create.c" 3 4
     ((void *)0)
# 74 "C:/esp/esp-idf/components/mbedtls/library/x509_create.c"
         , 0, 
# 74 "C:/esp/esp-idf/components/mbedtls/library/x509_create.c" 3 4
              ((void *)0) 
# 74 "C:/esp/esp-idf/components/mbedtls/library/x509_create.c"
...
# 81 "C:/esp/esp-idf/components/mbedtls/library/x509_create.c" 3 4
                                       ((void *)0)
# 81 "C:/esp/esp-idf/components/mbedtls/library/x509_create.c"
                                           ; cur++ )
...
int mbedtls_x509_string_to_names( mbedtls_asn1_named_data **head, const char *name )
{
    ...
    const char *oid = 
# 94 "C:/esp/esp-idf/components/mbedtls/library/x509_create.c" 3 4
                     ((void *)0)
# 94 "C:/esp/esp-idf/components/mbedtls/library/x509_create.c"
                         ;
    int in_tag = 1;
    char data[256];
    char *d = data;
...
# 106 "C:/esp/esp-idf/components/mbedtls/library/x509_create.c" 3 4
                                                              ((void *)0) 
# 106 "C:/esp/esp-idf/components/mbedtls/library/x509_create.c"
                                                                   )
            {
                ret = -0x2100;
                goto exit;
        ...
        else if( !in_tag && ( *c == ',' || c == end ) )
        {
            if( mbedtls_asn1_store_named_data( head, oid, strlen( oid ),
                                       (unsigned char *) data,
                                       d - data ) == 
# 132 "C:/esp/esp-idf/components/mbedtls/library/x509_create.c" 3 4
                                                    ((void *)0) 
# 132 "C:/esp/esp-idf/components/mbedtls/library/x509_create.c"
                                                         )
            {
                return( -0x2880 );
            }
...
# 172 "C:/esp/esp-idf/components/mbedtls/library/x509_create.c" 3 4
                                      ((void *)0)
# 172 "C:/esp/esp-idf/components/mbedtls/library/x509_create.c"
                                          , val_len + 1 ) ) == 
# 172 "C:/esp/esp-idf/components/mbedtls/library/x509_create.c" 3 4
                                                               ((void *)0) 
# 172 "C:/esp/esp-idf/components/mbedtls/library/x509_create.c"
...
# 195 "C:/esp/esp-idf/components/mbedtls/library/x509_create.c"
                      ...
                      mbedtls_asn1_named_data *first )
{
    ...
    while( cur != 
# 240 "C:/esp/esp-idf/components/mbedtls/library/x509_create.c" 3 4
                 ((void *)0) 
# 240 "C:/esp/esp-idf/components/mbedtls/library/x509_create.c"
                      )
    {
...
# 324 "C:/esp/esp-idf/components/mbedtls/library/x509_create.c"
int mbedtls_x509_write_extensions( unsigned char **p, unsigned char *start,
                           mbedtls_asn1_named_data *first )
{
    int ret;
    ...
    while( cur_ext != 
# 331 "C:/esp/esp-idf/components/mbedtls/library/x509_create.c" 3 4
                     ((void *)0) 
# 331 "C:/esp/esp-idf/components/mbedtls/library/x509_create.c"
                          )
    {
