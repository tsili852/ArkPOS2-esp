# 1 "C:/esp/esp-idf/components/mbedtls/library/entropy.c"
# 1 "C:\\esp\\ArkPOS2-esp\\build\\mbedtls//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/mbedtls/library/entropy.c"
# 25 "C:/esp/esp-idf/components/mbedtls/library/entropy.c"
...
# 26 "C:/esp/esp-idf/components/mbedtls/library/entropy.c" 2
# 36 "C:/esp/esp-idf/components/mbedtls/library/entropy.c"
...
# 34 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/sha512.h" 2
...
# 37 "C:/esp/esp-idf/components/mbedtls/library/entropy.c" 2
# 1 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/entropy_poll.h" 1
# 32 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/entropy_poll.h"
# 1 "c:\\msys32\\opt\\xtensa-esp32-elf\\lib\\gcc\\xtensa-esp32-elf\\5.2.0\\include\\stddef.h" 1 3 4
# 33 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/entropy_poll.h" 2
# 91 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/entropy_poll.h"
int mbedtls_hardware_poll( void *data,
                           unsigned char *output, size_t len, size_t *olen );
# 38 "C:/esp/esp-idf/components/mbedtls/library/entropy.c" 2
...
# 40 "C:/esp/esp-idf/components/mbedtls/library/entropy.c" 2
...
# 43 "C:/esp/esp-idf/components/mbedtls/library/entropy.c" 2
# 51 "C:/esp/esp-idf/components/mbedtls/library/entropy.c"
...
# 52 "C:/esp/esp-idf/components/mbedtls/library/entropy.c" 2
# 63 "C:/esp/esp-idf/components/mbedtls/library/entropy.c"
...
# 108 "C:/esp/esp-idf/components/mbedtls/library/entropy.c"
    mbedtls_entropy_add_source( ctx, mbedtls_hardware_poll, 
# 108 "C:/esp/esp-idf/components/mbedtls/library/entropy.c" 3 4
                                                           ((void *)0)
# 108 "C:/esp/esp-idf/components/mbedtls/library/entropy.c"
                                                               ,
                                32,
...
int mbedtls_entropy_func( void *data, unsigned char *output, size_t len )
{
    ...
    if( len > 64 )
        return( -0x003C );
# 315 "C:/esp/esp-idf/components/mbedtls/library/entropy.c"
    do
    {
        if( count++ > 256 )
        {
...
# 365 "C:/esp/esp-idf/components/mbedtls/library/entropy.c"
    for( i = 0; i < ctx->source_count; i++ )
        ctx->source[i].size = 0;
...
# 403 "C:/esp/esp-idf/components/mbedtls/library/entropy.c"
int mbedtls_entropy_write_seed_file( mbedtls_entropy_context *ctx, const char *path )
{
    int ret = -0x003F;
    FILE *f;
    ...
    if( ( f = fopen( path, "wb" ) ) == 
# 409 "C:/esp/esp-idf/components/mbedtls/library/entropy.c" 3 4
                                      ((void *)0) 
# 409 "C:/esp/esp-idf/components/mbedtls/library/entropy.c"
                                           )
        return( -0x003F );
...
int mbedtls_entropy_update_seed_file( mbedtls_entropy_context *ctx, const char *path )
{
    ...
    if( ( f = fopen( path, "rb" ) ) == 
# 434 "C:/esp/esp-idf/components/mbedtls/library/entropy.c" 3 4
                                      ((void *)0) 
# 434 "C:/esp/esp-idf/components/mbedtls/library/entropy.c"
                                           )
        return( -0x003F );
...
# 486 "C:/esp/esp-idf/components/mbedtls/library/entropy.c" 3 4
                                          ((void *)0)
# 486 "C:/esp/esp-idf/components/mbedtls/library/entropy.c"
                                              , buf + entropy_len,
...
# 530 "C:/esp/esp-idf/components/mbedtls/library/entropy.c"
int mbedtls_entropy_source_self_test( int verbose )
{
    int ret = 0;
...
# 578 "C:/esp/esp-idf/components/mbedtls/library/entropy.c"
int mbedtls_entropy_self_test( int verbose )
{
    int ret = 1;
...
# 598 "C:/esp/esp-idf/components/mbedtls/library/entropy.c" 3 4
                                                                 ((void *)0)
# 598 "C:/esp/esp-idf/components/mbedtls/library/entropy.c"
                                                                     , 16,
                                      0 );
    if( ret != 0 )
        goto cleanup;
    ...
    if( ( ret = mbedtls_entropy_update_manual( &ctx, buf, sizeof buf ) ) != 0 )
        goto cleanup;
# 614 "C:/esp/esp-idf/components/mbedtls/library/entropy.c"
    for( i = 0; i < 8; i++ )
    {
