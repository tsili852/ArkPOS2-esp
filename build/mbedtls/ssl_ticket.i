# 1 "C:/esp/esp-idf/components/mbedtls/library/ssl_ticket.c"
# 1 "C:\\esp\\ArkPOS2-esp\\build\\mbedtls//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/mbedtls/library/ssl_ticket.c"
# 25 "C:/esp/esp-idf/components/mbedtls/library/ssl_ticket.c"
...
# 26 "C:/esp/esp-idf/components/mbedtls/library/ssl_ticket.c" 2
...
# 32 "C:/esp/esp-idf/components/mbedtls/library/ssl_ticket.c" 2
...
# 1 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/ssl_ticket.h" 1
# 32 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/ssl_ticket.h"
...
# 33 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/ssl_ticket.h" 2
# 46 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/ssl_ticket.h"
typedef struct
{
...
# 81 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/ssl_ticket.h"
void mbedtls_ssl_ticket_init( mbedtls_ssl_ticket_context *ctx );
# 105 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/ssl_ticket.h"
...
# 39 "C:/esp/esp-idf/components/mbedtls/library/ssl_ticket.c" 2
...
# 41 "C:/esp/esp-idf/components/mbedtls/library/ssl_ticket.c" 2
...
# 72 "C:/esp/esp-idf/components/mbedtls/library/ssl_ticket.c" 3 4
                                                   ((void *)0) 
# 72 "C:/esp/esp-idf/components/mbedtls/library/ssl_ticket.c"
                                                        );
...
# 101 "C:/esp/esp-idf/components/mbedtls/library/ssl_ticket.c" 3 4
                                                        ((void *)0) 
# 101 "C:/esp/esp-idf/components/mbedtls/library/ssl_ticket.c"
                                                             );
    ...
    uint32_t lifetime )
{
    ...
    if( cipher_info == 
# 136 "C:/esp/esp-idf/components/mbedtls/library/ssl_ticket.c" 3 4
                      ((void *)0) 
# 136 "C:/esp/esp-idf/components/mbedtls/library/ssl_ticket.c"
                           )
        return( -0x7100 );
...
# 187 "C:/esp/esp-idf/components/mbedtls/library/ssl_ticket.c" 3 4
                             ((void *)0) 
# 187 "C:/esp/esp-idf/components/mbedtls/library/ssl_ticket.c"
                                  )
        cert_len = 0;
    else
    ...
    *p++ = (unsigned char)( cert_len & 0xFF );
    ...
    if( session->peer_cert != 
# 199 "C:/esp/esp-idf/components/mbedtls/library/ssl_ticket.c" 3 4
                             ((void *)0) 
# 199 "C:/esp/esp-idf/components/mbedtls/library/ssl_ticket.c"
                                  )
                             ...
                             const unsigned char *buf, size_t len )
{
    ...
    {
        session->peer_cert = 
# 237 "C:/esp/esp-idf/components/mbedtls/library/ssl_ticket.c" 3 4
                            ((void *)0)
# 237 "C:/esp/esp-idf/components/mbedtls/library/ssl_ticket.c"
                                ;
    }
    else
    {
        ...
        if( session->peer_cert == 
# 248 "C:/esp/esp-idf/components/mbedtls/library/ssl_ticket.c" 3 4
                                 ((void *)0) 
# 248 "C:/esp/esp-idf/components/mbedtls/library/ssl_ticket.c"
                                      )
            return( -0x7F00 );
                                        ...
                                        p, cert_len ) ) != 0 )
        {
            ...
            session->peer_cert = 
# 258 "C:/esp/esp-idf/components/mbedtls/library/ssl_ticket.c" 3 4
                                ((void *)0)
# 258 "C:/esp/esp-idf/components/mbedtls/library/ssl_ticket.c"
                                    ;
            return( ret );
        }
...
# 285 "C:/esp/esp-idf/components/mbedtls/library/ssl_ticket.c"
                              ...
                              uint32_t *ticket_lifetime )
{
    ...
    *tlen = 0;
    ...
    if( ctx == 
# 304 "C:/esp/esp-idf/components/mbedtls/library/ssl_ticket.c" 3 4
              ((void *)0) 
# 304 "C:/esp/esp-idf/components/mbedtls/library/ssl_ticket.c"
                   || ctx->f_rng == 
# 304 "C:/esp/esp-idf/components/mbedtls/library/ssl_ticket.c" 3 4
                                    ((void *)0) 
# 304 "C:/esp/esp-idf/components/mbedtls/library/ssl_ticket.c"
        ...
        const unsigned char name[4] )
{
    ...
    return( 
# 377 "C:/esp/esp-idf/components/mbedtls/library/ssl_ticket.c" 3 4
           ((void *)0) 
# 377 "C:/esp/esp-idf/components/mbedtls/library/ssl_ticket.c"
                );
}
                              ...
                              size_t len )
{
    ...
    if( ctx == 
# 398 "C:/esp/esp-idf/components/mbedtls/library/ssl_ticket.c" 3 4
              ((void *)0) 
# 398 "C:/esp/esp-idf/components/mbedtls/library/ssl_ticket.c"
                   || ctx->f_rng == 
# 398 "C:/esp/esp-idf/components/mbedtls/library/ssl_ticket.c" 3 4
                                    ((void *)0) 
# 398 "C:/esp/esp-idf/components/mbedtls/library/ssl_ticket.c"
...
# 423 "C:/esp/esp-idf/components/mbedtls/library/ssl_ticket.c" 3 4
                                                           ((void *)0) 
# 423 "C:/esp/esp-idf/components/mbedtls/library/ssl_ticket.c"
                                                                )
    {
...
# 454 "C:/esp/esp-idf/components/mbedtls/library/ssl_ticket.c" 3 4
                                                   ((void *)0) 
# 454 "C:/esp/esp-idf/components/mbedtls/library/ssl_ticket.c"
                                                        );
