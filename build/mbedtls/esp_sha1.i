# 1 "C:/esp/esp-idf/components/mbedtls/port/esp_sha1.c"
# 1 "C:\\esp\\ArkPOS2-esp\\build\\mbedtls//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/mbedtls/port/esp_sha1.c"
# 32 "C:/esp/esp-idf/components/mbedtls/port/esp_sha1.c"
...
# 33 "C:/esp/esp-idf/components/mbedtls/port/esp_sha1.c" 2
...
# 34 "C:/esp/esp-idf/components/mbedtls/include/mbedtls/sha1.h" 2
...
# 38 "C:/esp/esp-idf/components/mbedtls/port/esp_sha1.c" 2
...
# 40 "C:/esp/esp-idf/components/mbedtls/port/esp_sha1.c" 2
...
# 44 "C:/esp/esp-idf/components/mbedtls/port/esp_sha1.c" 2
...
# 51 "C:/esp/esp-idf/components/mbedtls/port/esp_sha1.c" 2


static void mbedtls_zeroize( void *v, size_t n ) {
    volatile unsigned char *p = (unsigned char*)v; while( n-- ) *p++ = 0;
}
# 80 "C:/esp/esp-idf/components/mbedtls/port/esp_sha1.c"
void mbedtls_sha1_init( mbedtls_sha1_context *ctx )
{
...
{
    if( ctx == 
# 87 "C:/esp/esp-idf/components/mbedtls/port/esp_sha1.c" 3 4
              ((void *)0) 
# 87 "C:/esp/esp-idf/components/mbedtls/port/esp_sha1.c"
                   )
        return;
...
# 135 "C:/esp/esp-idf/components/mbedtls/port/esp_sha1.c" 3 4
   _Bool 
# 135 "C:/esp/esp-idf/components/mbedtls/port/esp_sha1.c"
        first_block = 
# 135 "C:/esp/esp-idf/components/mbedtls/port/esp_sha1.c" 3 4
                      0
# 135 "C:/esp/esp-idf/components/mbedtls/port/esp_sha1.c"
    ...
    if (ctx->mode == ESP_MBEDTLS_SHA1_UNUSED) {
        ...
        if (esp_sha_try_lock_engine(SHA1)) {
            ...
            first_block = 
# 140 "C:/esp/esp-idf/components/mbedtls/port/esp_sha1.c" 3 4
                         1
# 140 "C:/esp/esp-idf/components/mbedtls/port/esp_sha1.c"
                             ;
        } else {
...
# 189 "C:/esp/esp-idf/components/mbedtls/port/esp_sha1.c"
    A = ctx->state[0];
    B = ctx->state[1];
    C = ctx->state[2];
    D = ctx->state[3];
