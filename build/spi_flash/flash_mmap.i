# 1 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c"
# 1 "C:\\esp\\ArkPOS2-esp\\build\\spi_flash//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c"
# 15 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c"
...
# 16 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 2
...
# 17 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 2
...
# 18 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 2
...
# 19 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 2
...
# 21 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 2
...
# 22 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 2
...
# 23 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 2
...
# 24 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 2
...
# 25 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 2
...
# 27 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 2
# 1 "C:/esp/ArkPOS2-esp/build/include/sdkconfig.h" 1
# 28 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 2
...
# 29 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 2
...
# 31 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 2
# 1 "C:/esp/esp-idf/components/bootloader_support/include/esp_flash_encrypt.h" 1
# 21 "C:/esp/esp-idf/components/bootloader_support/include/esp_flash_encrypt.h"
...
# 32 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 2
...
# 33 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 2
# 1 "C:/esp/esp-idf/components/spi_flash/cache_utils.h" 1
# 26 "C:/esp/esp-idf/components/spi_flash/cache_utils.h"
...
# 34 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 2
...
# 35 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 2
...
# 41 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 2
# 60 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c"
static 
# 60 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 3 4
      _Bool 
# 60 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c"
...
static struct mmap_entries_head { struct mmap_entry_ *lh_first; } s_mmap_entries_head =
        { 
# 71 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 3 4
       ((void *)0) 
# 71 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c"
       };
                         ...
                         const void** out_ptr, spi_flash_mmap_handle_t* out_handle)
{
    ...
    if (pages==
# 114 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 3 4
              ((void *)0)
# 114 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c"
                  ) {
        return 0x101;
    }
...
# 129 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 3 4
   _Bool 
# 129 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c"
...
# 129 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c"
    ...
    if (start == end) {
        *out_handle = 0;
        *out_ptr = 
# 193 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 3 4
                  ((void *)0)
# 193 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c"
                      ;
        ret = 0x101;
    } else {
...
# 200 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c"
            ,
...
# 200 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c"
            ...
            if (s_mmap_page_refcnt[i] == 0) {
                if (((volatile uint32_t*) 0x3FF10000)[i] != pages[pageno] || ((volatile uint32_t*) 0x3FF12000)[i] != pages[pageno]) {
                    ...
                    need_flush = 
# 207 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 3 4
                                1
# 207 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c"
                                    ;
                }
            }
...
# 213 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 3 4
       ((void *)0)
# 213 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c"
    ...
    if (*out_ptr == 
# 237 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 3 4
                   ((void *)0)
# 237 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c"
                       ) {
        free(new_entry);
    }
    return ret;
...
# 248 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 3 4
                                                     ((void *)0)
# 248 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c"
        ...
        if (it->handle == handle) {
            ...
            for (int i = it->page; i < it->page + it->count; ++i) {
                ((s_mmap_page_refcnt[i] > 0) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/spi_flash/flash_mmap.c", 254, __func__, "s_mmap_page_refcnt[i] > 0"));
                if (--s_mmap_page_refcnt[i] == 0) {
                    ((volatile uint32_t*) 0x3FF10000)[i] = 0x100;
                    ((volatile uint32_t*) 0x3FF12000)[i] = 0x100;
                }
...
# 260 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 3 4
           ((void *)0)
# 260 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c"
    ...
    spi_flash_enable_interrupts_caches_and_other_cpu();
    if (it == 
# 265 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 3 4
             ((void *)0)
# 265 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c"
                 ) {
        ((0 && "invalid handle, or handle already unmapped") ? (void)0 : __assert_func ("C:/esp/esp-idf/components/spi_flash/flash_mmap.c", 266, __func__, "0 && \"invalid handle, or handle already unmapped\""));
    }
    free(it);
}
...
void spi_flash_mmap_dump()
{
    ...
    mmap_entry_t* it;
    for (it = ((&s_mmap_entries_head)->lh_first); it != 
# 275 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 3 4
                                                     ((void *)0)
# 275 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c"
                                                         ; it = ((it)->entries.le_next)) {
...
# 299 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c"
static uint32_t written_pages[256/32];

static 
# 301 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 3 4
      _Bool 
# 301 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c"
...
# 305 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 3 4
                                            1
# 305 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c"
                                                );
}

static __attribute__((section(".iram1"))) 
# 308 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 3 4
                _Bool 
# 308 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c"
                     spi_flash_ensure_unmodified_region(size_t start_addr, size_t length)
{
    return update_written_pages(start_addr, length, 
# 310 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 3 4
                                                   0
# 310 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c"
                                                        );
}


static inline __attribute__((section(".iram1"))) 
# 314 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 3 4
                       _Bool 
# 314 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c"
                            update_written_pages(size_t start_addr, size_t length, 
# 314 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 3 4
                                                                                   _Bool 
# 314 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c"
                                                                                        mark)
{
    ...
    for (uint32_t addr = page_start_addr; addr < page_start_addr + length; addr += 0x10000) {
        ...
        if (page >= 256) {
            return 
# 323 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 3 4
                  0
# 323 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c"
                       ;
        }
...
# 340 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c"
            Cache_Flush(0);
            ...
            return 
# 345 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 3 4
                  1
# 345 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c"
                      ;
        }
    }
    return 
# 348 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 3 4
          0
# 348 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c"
               ;
}
...
const void *spi_flash_phys2cache(uint32_t phys_offs, spi_flash_mmap_memory_t memory)
{
    ...
    return 
# 407 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c" 3 4
          ((void *)0)
# 407 "C:/esp/esp-idf/components/spi_flash/flash_mmap.c"
              ;
}
