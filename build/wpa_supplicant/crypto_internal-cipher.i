# 1 "C:/esp/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
# 1 "C:\\esp\\ArkPOS2-esp\\build\\wpa_supplicant//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
# 12 "C:/esp/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
...
# 13 "C:/esp/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c" 2
...
# 14 "C:/esp/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c" 2
# 1 "C:/esp/esp-idf/components/wpa_supplicant/include/crypto/aes.h" 1
# 20 "C:/esp/esp-idf/components/wpa_supplicant/include/crypto/aes.h"
void * aes_encrypt_init(const u8 *key, size_t len);
void aes_encrypt(void *ctx, const u8 *plain, u8 *crypt);
void aes_encrypt_deinit(void *ctx);
void * aes_decrypt_init(const u8 *key, size_t len);
void aes_decrypt(void *ctx, const u8 *crypt, u8 *plain);
void aes_decrypt_deinit(void *ctx);
# 15 "C:/esp/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c" 2
# 24 "C:/esp/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
struct crypto_cipher {
...
# 50 "C:/esp/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
 } u;
};
       ...
       size_t key_len)
{
 ...
 if (ctx == 
# 61 "C:/esp/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c" 3 4
           ((void *)0)
# 61 "C:/esp/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
               )
  return 
# 62 "C:/esp/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c" 3 4
        ((void *)0)
# 62 "C:/esp/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
            ;
 ...
 case CRYPTO_CIPHER_ALG_RC4:
  if (key_len > sizeof(ctx->u.rc4.key)) {
   free((ctx));
   return 
# 70 "C:/esp/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c" 3 4
         ((void *)0)
# 70 "C:/esp/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
             ;
  }
...
# 77 "C:/esp/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c" 3 4
                           ((void *)0)
# 77 "C:/esp/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
                               ) {
   free((ctx));
   return 
# 79 "C:/esp/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c" 3 4
         ((void *)0)
# 79 "C:/esp/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
             ;
  }
  ctx->u.aes.ctx_dec = aes_decrypt_init(key, key_len);
  if (ctx->u.aes.ctx_dec == 
# 82 "C:/esp/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c" 3 4
                           ((void *)0)
# 82 "C:/esp/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
                               ) {
   aes_encrypt_deinit(ctx->u.aes.ctx_enc);
   free((ctx));
   return 
# 85 "C:/esp/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c" 3 4
         ((void *)0)
# 85 "C:/esp/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
             ;
  }
  memcpy((ctx->u.aes.cbc), (iv), (16));
  break;
# 109 "C:/esp/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
 default:
  free((ctx));
  return 
# 111 "C:/esp/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c" 3 4
        ((void *)0)
# 111 "C:/esp/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
            ;
 }
     ...
     u8 *crypt, size_t len)
{
 ...
 case CRYPTO_CIPHER_ALG_AES:
  ...
  break;
# 177 "C:/esp/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
 default:
  return -1;
 }
     ...
     u8 *plain, size_t len)
{
 ...
 case CRYPTO_CIPHER_ALG_AES:
  ...
  break;
# 245 "C:/esp/esp-idf/components/wpa_supplicant/src/crypto/crypto_internal-cipher.c"
 default:
  return -1;
 }
