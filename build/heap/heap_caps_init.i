# 1 "C:/esp/esp-idf/components/heap/heap_caps_init.c"
# 1 "C:\\esp\\ArkPOS2-esp\\build\\heap//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/heap/heap_caps_init.c"
# 14 "C:/esp/esp-idf/components/heap/heap_caps_init.c"
...
# 17 "C:/esp/esp-idf/components/heap/heap_private.h" 2
...
# 18 "C:/esp/esp-idf/components/heap/heap_private.h" 2
...
# 21 "C:/esp/esp-idf/components/heap/heap_private.h" 2
...
# 15 "C:/esp/esp-idf/components/heap/heap_caps_init.c" 2
...
# 17 "C:/esp/esp-idf/components/heap/heap_caps_init.c" 2
...
# 20 "C:/esp/esp-idf/components/heap/heap_caps_init.c" 2
...
# 22 "C:/esp/esp-idf/components/heap/heap_caps_init.c" 2
...
# 26 "C:/esp/esp-idf/components/heap/heap_caps_init.c" 2
...
static void register_heap(heap_t *region)
{
    ...
    if (region->heap != 
# 35 "C:/esp/esp-idf/components/heap/heap_caps_init.c" 3 4
                       ((void *)0)
# 35 "C:/esp/esp-idf/components/heap/heap_caps_init.c"
                           ) {
...
void heap_caps_enable_nonos_stack_heaps()
{
    ...
    for ((heap) = (((&registered_heaps))->slh_first); (heap); (heap) = (((heap))->next.sle_next)) {
        ...
        if (heap->heap == 
# 46 "C:/esp/esp-idf/components/heap/heap_caps_init.c" 3 4
                         ((void *)0)
# 46 "C:/esp/esp-idf/components/heap/heap_caps_init.c"
                             ) {
            register_heap(heap);
            if (heap->heap != 
# 48 "C:/esp/esp-idf/components/heap/heap_caps_init.c" 3 4
                             ((void *)0)
# 48 "C:/esp/esp-idf/components/heap/heap_caps_init.c"
                                 ) {
...
void heap_caps_init()
{
    ...
    for (int i = 0; i < soc_memory_region_count; i++) {
        ...
        heap_idx++;
        ((heap_idx <= num_heaps) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/heap/heap_caps_init.c", 156, __func__, "heap_idx <= num_heaps"));
        ...
        if (type->startup_stack) {
            ...
            heap->heap = 
# 164 "C:/esp/esp-idf/components/heap/heap_caps_init.c" 3 4
                        ((void *)0)
# 164 "C:/esp/esp-idf/components/heap/heap_caps_init.c"
                            ;
        } else {
            register_heap(heap);
        }
        ((heap)->next.sle_next) = 
# 168 "C:/esp/esp-idf/components/heap/heap_caps_init.c" 3 4
                                ((void *)0)
# 168 "C:/esp/esp-idf/components/heap/heap_caps_init.c"
                                    ;
    ...
    ((heap_idx == num_heaps) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/heap/heap_caps_init.c", 174, __func__, "heap_idx == num_heaps"));




    ((((&registered_heaps)->slh_first == 
# 179 "C:/esp/esp-idf/components/heap/heap_caps_init.c" 3 4
   ((void *)0)
# 179 "C:/esp/esp-idf/components/heap/heap_caps_init.c"
   )) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/heap/heap_caps_init.c", 179, __func__, "SLIST_EMPTY(&registered_heaps)"));

    heap_t *heaps_array = 
# 181 "C:/esp/esp-idf/components/heap/heap_caps_init.c" 3 4
                         ((void *)0)
# 181 "C:/esp/esp-idf/components/heap/heap_caps_init.c"
                             ;
    for (int i = 0; i < num_heaps; i++) {
        if (heap_caps_match(&temp_heaps[i], (1<<2)|(1<<11))) {
            ...
            if (heaps_array != 
# 186 "C:/esp/esp-idf/components/heap/heap_caps_init.c" 3 4
                              ((void *)0)
# 186 "C:/esp/esp-idf/components/heap/heap_caps_init.c"
                                  ) {
                break;
            }
        }
    ...
    ((heaps_array != 
# 191 "C:/esp/esp-idf/components/heap/heap_caps_init.c" 3 4
   ((void *)0)
# 191 "C:/esp/esp-idf/components/heap/heap_caps_init.c"
   ) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/heap/heap_caps_init.c", 191, __func__, "heaps_array != NULL"));
...
# 197 "C:/esp/esp-idf/components/heap/heap_caps_init.c" 3 4
                                  ((void *)0)
# 197 "C:/esp/esp-idf/components/heap/heap_caps_init.c"
                                      ) {
...
esp_err_t heap_caps_add_region_with_caps(const uint32_t caps[], intptr_t start, intptr_t end)
{
    esp_err_t err = -1;
    if (caps == 
# 229 "C:/esp/esp-idf/components/heap/heap_caps_init.c" 3 4
               ((void *)0) 
# 229 "C:/esp/esp-idf/components/heap/heap_caps_init.c"
    ...
    if (p_new == 
# 234 "C:/esp/esp-idf/components/heap/heap_caps_init.c" 3 4
                ((void *)0)
# 234 "C:/esp/esp-idf/components/heap/heap_caps_init.c"
                    ) {
        err = 0x101;
        goto done;
    }
    ...
    ((p_new)->next.sle_next) = 
# 243 "C:/esp/esp-idf/components/heap/heap_caps_init.c" 3 4
                             ((void *)0)
# 243 "C:/esp/esp-idf/components/heap/heap_caps_init.c"
                                 ;
    if (p_new->heap == 
# 244 "C:/esp/esp-idf/components/heap/heap_caps_init.c" 3 4
                      ((void *)0)
# 244 "C:/esp/esp-idf/components/heap/heap_caps_init.c"
                          ) {
        err = -1;
        goto done;
    }
