...
# 229 "C:/esp/esp-idf/components/heap/heap_caps_init.c"
    ...
    heap_t *heap;
    for ((heap) = (((&registered_heaps))->slh_first); (heap); (heap) = (((heap))->next.sle_next)) {
        if ( start <= heap->start && heap->start <=end ) return -1;
        if ( start <= heap->end && heap->end <=end ) return -1;
    }

    heap_t *p_new = malloc(sizeof(heap_t));
    if (p_new == 
# 242 "C:/esp/esp-idf/components/heap/heap_caps_init.c" 3 4
                ((void *)0)
# 242 "C:/esp/esp-idf/components/heap/heap_caps_init.c"
                    ) {
        err = 0x101;
        goto done;
    }
    ...
    ((p_new)->next.sle_next) = 
# 251 "C:/esp/esp-idf/components/heap/heap_caps_init.c" 3 4
                             ((void *)0)
# 251 "C:/esp/esp-idf/components/heap/heap_caps_init.c"
                                 ;
    if (p_new->heap == 
# 252 "C:/esp/esp-idf/components/heap/heap_caps_init.c" 3 4
                      ((void *)0)
# 252 "C:/esp/esp-idf/components/heap/heap_caps_init.c"
                          ) {
        err = -1;
        goto done;
    }
