...
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/heap/heap_caps.c"
# 14 "C:/esp/esp-idf/components/heap/heap_caps.c"
# 1 "c:\\msys32\\opt\\xtensa-esp32-elf\\lib\\gcc\\xtensa-esp32-elf\\5.2.0\\include\\stdbool.h" 1 3 4
# 15 "C:/esp/esp-idf/components/heap/heap_caps.c" 2
...
# 16 "C:/esp/esp-idf/components/heap/heap_caps.c" 2
...
# 17 "C:/esp/esp-idf/components/heap/heap_caps.c" 2
...
# 18 "C:/esp/esp-idf/components/heap/heap_caps.c" 2
...
# 19 "C:/esp/esp-idf/components/heap/heap_caps.c" 2
# 1 "C:/esp/esp-idf/components/esp32/include/esp_attr.h" 1
# 20 "C:/esp/esp-idf/components/heap/heap_caps.c" 2
...
# 17 "C:/esp/esp-idf/components/heap/include/esp_heap_caps.h" 2
...
# 23 "C:/esp/esp-idf/components/heap/heap_caps.c" 2
...
# 24 "C:/esp/esp-idf/components/heap/heap_caps.c" 2
# 44 "C:/esp/esp-idf/components/heap/heap_caps.c"
__attribute__((section(".iram1"))) static void *dram_alloc_to_iram_addr(void *addr, size_t len)
{
    ...
    ((dstart >= 0x3FFE0000) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/heap/heap_caps.c", 48, __func__, "dstart >= SOC_DIRAM_DRAM_LOW"));
    ((dend <= 0x3FFFFFFC) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/heap/heap_caps.c", 49, __func__, "dend <= SOC_DIRAM_DRAM_HIGH"));
    (((dstart & 3) == 0) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/heap/heap_caps.c", 50, __func__, "(dstart & 3) == 0"));
    (((dend & 3) == 0) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/heap/heap_caps.c", 51, __func__, "(dend & 3) == 0"));
...
{
    if (heap->heap == 
# 61 "C:/esp/esp-idf/components/heap/heap_caps.c" 3 4
                     ((void *)0)
# 61 "C:/esp/esp-idf/components/heap/heap_caps.c"
                         ) {
        return 0;
    }
    uint32_t all_caps = 0;
...
# 71 "C:/esp/esp-idf/components/heap/heap_caps.c" 3 4
_Bool 
# 71 "C:/esp/esp-idf/components/heap/heap_caps.c"
    heap_caps_match(const heap_t *heap, uint32_t caps)
{
    return heap->heap != 
# 73 "C:/esp/esp-idf/components/heap/heap_caps.c" 3 4
                        ((void *)0) 
# 73 "C:/esp/esp-idf/components/heap/heap_caps.c"
...
{
    void *ret = 
# 81 "C:/esp/esp-idf/components/heap/heap_caps.c" 3 4
               ((void *)0)
# 81 "C:/esp/esp-idf/components/heap/heap_caps.c"
                   ;
    uint32_t remCaps;
    ...
    if (caps & (1<<0)) {
        ...
        if ((caps & (1<<2)) || (caps & (1<<3))) {
            return 
# 90 "C:/esp/esp-idf/components/heap/heap_caps.c" 3 4
                  ((void *)0)
# 90 "C:/esp/esp-idf/components/heap/heap_caps.c"
                      ;
        }
    ...
    for (int prio = 0; prio < 3; prio++) {
        ...
        for ((heap) = (((&registered_heaps))->slh_first); (heap); (heap) = (((heap))->next.sle_next)) {
            if (heap->heap == 
# 99 "C:/esp/esp-idf/components/heap/heap_caps.c" 3 4
                             ((void *)0)
# 99 "C:/esp/esp-idf/components/heap/heap_caps.c"
                                 ) {
                continue;
            }
            if ((heap->caps[prio] & caps) != 0) {
                ...
                if (remCaps == 0) {
                    ...
                    if ((caps & (1<<0)) && heap->start >= 0x3FFE0000 && heap->start < 0x3FFFFFFC) {
                        ...
                        if (ret != 
# 118 "C:/esp/esp-idf/components/heap/heap_caps.c" 3 4
                                  ((void *)0)
# 118 "C:/esp/esp-idf/components/heap/heap_caps.c"
                                      ) {
                        ...
                        if (ret != 
# 124 "C:/esp/esp-idf/components/heap/heap_caps.c" 3 4
                                  ((void *)0)
# 124 "C:/esp/esp-idf/components/heap/heap_caps.c"
                                      ) {
                            return ret;
                        }
                    }
    ...
    return 
# 133 "C:/esp/esp-idf/components/heap/heap_caps.c" 3 4
          ((void *)0)
# 133 "C:/esp/esp-idf/components/heap/heap_caps.c"
              ;
}
