# 1 "C:/esp/esp-idf/components/heap/heap_trace.c"
# 1 "C:\\esp\\ArkPOS2-esp\\build\\heap//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/heap/heap_trace.c"
# 14 "C:/esp/esp-idf/components/heap/heap_trace.c"
...
# 15 "C:/esp/esp-idf/components/heap/heap_trace.c" 2
...
# 16 "C:/esp/esp-idf/components/heap/heap_trace.c" 2
# 1 "C:/esp/ArkPOS2-esp/build/include/sdkconfig.h" 1
# 17 "C:/esp/esp-idf/components/heap/heap_trace.c" 2


# 1 "C:/esp/esp-idf/components/heap/include/esp_heap_trace.h" 1
# 14 "C:/esp/esp-idf/components/heap/include/esp_heap_trace.h"
       

# 1 "C:/esp/ArkPOS2-esp/build/include/sdkconfig.h" 1
# 17 "C:/esp/esp-idf/components/heap/include/esp_heap_trace.h" 2
...
# 18 "C:/esp/esp-idf/components/heap/include/esp_heap_trace.h" 2
...
# 19 "C:/esp/esp-idf/components/heap/include/esp_heap_trace.h" 2
# 28 "C:/esp/esp-idf/components/heap/include/esp_heap_trace.h"
typedef enum {
    HEAP_TRACE_ALL,
    HEAP_TRACE_LEAKS,
} heap_trace_mode_t;
...
# 60 "C:/esp/esp-idf/components/heap/include/esp_heap_trace.h"
esp_err_t heap_trace_init_standalone(heap_trace_record_t *record_buffer, size_t num_records);
# 77 "C:/esp/esp-idf/components/heap/include/esp_heap_trace.h"
esp_err_t heap_trace_start(heap_trace_mode_t mode);
# 87 "C:/esp/esp-idf/components/heap/include/esp_heap_trace.h"
esp_err_t heap_trace_stop(void);
# 103 "C:/esp/esp-idf/components/heap/include/esp_heap_trace.h"
...
# 126 "C:/esp/esp-idf/components/heap/include/esp_heap_trace.h"
esp_err_t heap_trace_get(size_t index, heap_trace_record_t *record);
# 136 "C:/esp/esp-idf/components/heap/include/esp_heap_trace.h"
void heap_trace_dump(void);
# 20 "C:/esp/esp-idf/components/heap/heap_trace.c" 2
...
# 18 "C:/esp/esp-idf/components/heap/include/multi_heap.h" 2
...
# 174 "C:/esp/esp-idf/components/heap/include/esp_heap_caps.h"
                                                  print_errors);
# 23 "C:/esp/esp-idf/components/heap/heap_trace.c" 2
# 1 "C:/esp/esp-idf/components/esp32/include/esp_attr.h" 1
# 24 "C:/esp/esp-idf/components/heap/heap_trace.c" 2
...
# 25 "C:/esp/esp-idf/components/heap/heap_trace.c" 2
...
# 26 "C:/esp/esp-idf/components/heap/heap_trace.c" 2
...
# 27 "C:/esp/esp-idf/components/heap/heap_trace.c" 2

# 1 "C:/esp/esp-idf/components/heap/heap_private.h" 1
# 14 "C:/esp/esp-idf/components/heap/heap_private.h"
...
# 32 "C:/esp/esp-idf/components/heap/heap_private.h"
...
# 49 "C:/esp/esp-idf/components/heap/heap_private.h" 3 4
_Bool 
# 49 "C:/esp/esp-idf/components/heap/heap_private.h"
...
# 29 "C:/esp/esp-idf/components/heap/heap_trace.c" 2



static portMUX_TYPE trace_mux = { .owner = 0xB33FFFFF, .count = 0, };
static 
# 33 "C:/esp/esp-idf/components/heap/heap_trace.c" 3 4
      _Bool 
# 33 "C:/esp/esp-idf/components/heap/heap_trace.c"
           tracing;
...
static 
# 54 "C:/esp/esp-idf/components/heap/heap_trace.c" 3 4
      _Bool 
# 54 "C:/esp/esp-idf/components/heap/heap_trace.c"
           has_overflowed = 
# 54 "C:/esp/esp-idf/components/heap/heap_trace.c" 3 4
                            0
# 54 "C:/esp/esp-idf/components/heap/heap_trace.c"
...
esp_err_t heap_trace_start(heap_trace_mode_t mode_param)
{
    ...
    if (buffer == 
# 77 "C:/esp/esp-idf/components/heap/heap_trace.c" 3 4
                 ((void *)0) 
# 77 "C:/esp/esp-idf/components/heap/heap_trace.c"
                      || total_records == 0) {
        return 0x103;
    }
    ...
    tracing = 
# 82 "C:/esp/esp-idf/components/heap/heap_trace.c" 3 4
             0
# 82 "C:/esp/esp-idf/components/heap/heap_trace.c"
                  ;
    mode = mode_param;
    count = 0;
    total_allocations = 0;
    total_frees = 0;
    has_overflowed = 
# 87 "C:/esp/esp-idf/components/heap/heap_trace.c" 3 4
                    0
# 87 "C:/esp/esp-idf/components/heap/heap_trace.c"
                         ;
    heap_trace_resume();
...
# 94 "C:/esp/esp-idf/components/heap/heap_trace.c" 3 4
                            _Bool 
# 94 "C:/esp/esp-idf/components/heap/heap_trace.c"
                                 enable)
{
...
{
    return set_tracing(
# 108 "C:/esp/esp-idf/components/heap/heap_trace.c" 3 4
                      0
# 108 "C:/esp/esp-idf/components/heap/heap_trace.c"
                           );
}
...
{
    return set_tracing(
# 113 "C:/esp/esp-idf/components/heap/heap_trace.c" 3 4
                      1
# 113 "C:/esp/esp-idf/components/heap/heap_trace.c"
                          );
}
...
esp_err_t heap_trace_get(size_t index, heap_trace_record_t *record)
{
    ...
    if (record == 
# 126 "C:/esp/esp-idf/components/heap/heap_trace.c" 3 4
                 ((void *)0)
# 126 "C:/esp/esp-idf/components/heap/heap_trace.c"
                     ) {
        return 0x103;
    }
    esp_err_t result = 0;
...
void heap_trace_dump(void)
{
    ...
    for (int i = 0; i < count; i++) {
        ...
        if (rec->address != 
# 156 "C:/esp/esp-idf/components/heap/heap_trace.c" 3 4
                           ((void *)0)
# 156 "C:/esp/esp-idf/components/heap/heap_trace.c"
                               ) {
...
# 164 "C:/esp/esp-idf/components/heap/heap_trace.c" 3 4
                                                                                 ((void *)0)
# 164 "C:/esp/esp-idf/components/heap/heap_trace.c"
                                                                                     ) {
                delta_size += rec->size;
                delta_allocs++;
                printf("\n");
...
static __attribute__((section(".iram1"))) void record_allocation(const heap_trace_record_t *record)
{
    ...
    if (tracing) {
        if (count == total_records) {
            has_overflowed = 
# 198 "C:/esp/esp-idf/components/heap/heap_trace.c" 3 4
                            1
# 198 "C:/esp/esp-idf/components/heap/heap_trace.c"
                                ;
...
# 289 "C:/esp/esp-idf/components/heap/heap_trace.c"
...
static __attribute__((section(".iram1"))) __attribute__((noinline)) void *trace_malloc(size_t size, uint32_t caps, trace_malloc_mode_t mode)
{
    ...
    if (tracing && p != 
# 327 "C:/esp/esp-idf/components/heap/heap_trace.c" 3 4
                       ((void *)0)
# 327 "C:/esp/esp-idf/components/heap/heap_trace.c"
                           ) {
...
{
    if (tracing && p != 
# 344 "C:/esp/esp-idf/components/heap/heap_trace.c" 3 4
                       ((void *)0)
# 344 "C:/esp/esp-idf/components/heap/heap_trace.c"
                           ) {
        void *callers[0];
...
static __attribute__((section(".iram1"))) __attribute__((noinline)) void *trace_realloc(void *p, size_t size, uint32_t caps, trace_malloc_mode_t mode)
{
    ...
    uint32_t ccount = get_ccount();
    if (tracing && p != 
# 359 "C:/esp/esp-idf/components/heap/heap_trace.c" 3 4
                       ((void *)0) 
# 359 "C:/esp/esp-idf/components/heap/heap_trace.c"
                            && size == 0) {
        get_call_stack(callers);
        record_free(p, callers);
    }
    ...
    if (tracing && r != 
# 369 "C:/esp/esp-idf/components/heap/heap_trace.c" 3 4
                       ((void *)0)
# 369 "C:/esp/esp-idf/components/heap/heap_trace.c"
                           ) {
        get_call_stack(callers);
        if (p != 
# 371 "C:/esp/esp-idf/components/heap/heap_trace.c" 3 4
                ((void *)0)
# 371 "C:/esp/esp-idf/components/heap/heap_trace.c"
                    ) {
...
__attribute__((section(".iram1"))) void *__wrap_calloc(size_t nmemb, size_t size)
{
    ...
    if (result != 
# 409 "C:/esp/esp-idf/components/heap/heap_trace.c" 3 4
                 ((void *)0)
# 409 "C:/esp/esp-idf/components/heap/heap_trace.c"
                     ) {
