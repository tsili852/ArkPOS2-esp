# 1 "C:/esp/esp-idf/components/esp32/ipc.c"
# 1 "C:\\esp\\esp32-ArkPOS2\\ArkPOS2-esp\\build\\esp32//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/esp32/ipc.c"
# 15 "C:/esp/esp-idf/components/esp32/ipc.c"
...
# 16 "C:/esp/esp-idf/components/esp32/ipc.c" 2
...
# 17 "C:/esp/esp-idf/components/esp32/ipc.c" 2
...
# 18 "C:/esp/esp-idf/components/esp32/ipc.c" 2
...
# 19 "C:/esp/esp-idf/components/esp32/ipc.c" 2
...
# 20 "C:/esp/esp-idf/components/esp32/ipc.c" 2
...
# 21 "C:/esp/esp-idf/components/esp32/ipc.c" 2
# 1 "C:/esp/esp-idf/components/esp32/include/esp_attr.h" 1
# 22 "C:/esp/esp-idf/components/esp32/ipc.c" 2
...
# 24 "C:/esp/esp-idf/components/esp32/ipc.c" 2
...
# 25 "C:/esp/esp-idf/components/esp32/ipc.c" 2
...
# 26 "C:/esp/esp-idf/components/esp32/ipc.c" 2


static TaskHandle_t s_ipc_tasks[1];
static SemaphoreHandle_t s_ipc_mutex;
static SemaphoreHandle_t s_ipc_sem[1];
...
static void __attribute__((section(".iram1"))) ipc_task(void* arg)
{
    ...
    ((cpuid == xPortGetCoreID()) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/esp32/ipc.c", 47, __func__, "cpuid == xPortGetCoreID()"));
    while (
# 48 "C:/esp/esp-idf/components/esp32/ipc.c" 3 4
          1
# 48 "C:/esp/esp-idf/components/esp32/ipc.c"
              ) {



        if (xQueueGenericReceive( ( QueueHandle_t ) ( s_ipc_sem[cpuid] ), 
# 52 "C:/esp/esp-idf/components/esp32/ipc.c" 3 4
           ((void *)0)
# 52 "C:/esp/esp-idf/components/esp32/ipc.c"
...
# 61 "C:/esp/esp-idf/components/esp32/ipc.c" 3 4
           ((void *)0)
# 61 "C:/esp/esp-idf/components/esp32/ipc.c"
           , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
        }
        (*func)(arg);
        if (s_ipc_wait == IPC_WAIT_FOR_END) {
            xQueueGenericSend( ( QueueHandle_t ) ( s_ipc_ack ), 
# 65 "C:/esp/esp-idf/components/esp32/ipc.c" 3 4
           ((void *)0)
# 65 "C:/esp/esp-idf/components/esp32/ipc.c"
           , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
        }
    }
    ...
    vTaskDelete(
# 73 "C:/esp/esp-idf/components/esp32/ipc.c" 3 4
               ((void *)0)
# 73 "C:/esp/esp-idf/components/esp32/ipc.c"
                   );
}
...
void esp_ipc_init()
{
    ...
    for (int i = 0; i < 1; ++i) {
        ...
        ((res == ( ( BaseType_t ) 1 )) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/esp32/ipc.c", 85, __func__, "res == pdTRUE"));
    }
}
...
# 98 "C:/esp/esp-idf/components/esp32/ipc.c" 3 4
   ((void *)0)
# 98 "C:/esp/esp-idf/components/esp32/ipc.c"
...
# 103 "C:/esp/esp-idf/components/esp32/ipc.c" 3 4
   ((void *)0)
# 103 "C:/esp/esp-idf/components/esp32/ipc.c"
   , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
    xQueueGenericReceive( ( QueueHandle_t ) ( s_ipc_ack ), 
# 104 "C:/esp/esp-idf/components/esp32/ipc.c" 3 4
   ((void *)0)
# 104 "C:/esp/esp-idf/components/esp32/ipc.c"
   , ( ( TickType_t ) 0xffffffffUL ), ( ( BaseType_t ) 0 ) );
    xQueueGenericSend( ( QueueHandle_t ) ( s_ipc_mutex ), 
# 105 "C:/esp/esp-idf/components/esp32/ipc.c" 3 4
   ((void *)0)
# 105 "C:/esp/esp-idf/components/esp32/ipc.c"
   , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
    return 0;
}
