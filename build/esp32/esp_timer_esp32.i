# 1 "C:/esp/esp-idf/components/esp32/esp_timer_esp32.c"
# 1 "C:\\esp\\esp32-ArkPOS2\\ArkPOS2-esp\\build\\esp32//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/esp32/esp_timer_esp32.c"
# 15 "C:/esp/esp-idf/components/esp32/esp_timer_esp32.c"
...
# 16 "C:/esp/esp-idf/components/esp32/esp_timer_esp32.c" 2
...
# 17 "C:/esp/esp-idf/components/esp32/esp_timer_esp32.c" 2
# 1 "C:/esp/esp-idf/components/esp32/include/esp_system.h" 1
# 19 "C:/esp/esp-idf/components/esp32/include/esp_system.h"
...
# 18 "C:/esp/esp-idf/components/esp32/esp_timer_esp32.c" 2
...
# 19 "C:/esp/esp-idf/components/esp32/esp_timer_esp32.c" 2
...
# 22 "C:/esp/esp-idf/components/esp32/esp_timer_esp32.c" 2
...
# 23 "C:/esp/esp-idf/components/esp32/esp_timer_esp32.c" 2
# 1 "C:/esp/esp-idf/components/soc/esp32/include/soc/frc_timer_reg.h" 1
# 24 "C:/esp/esp-idf/components/esp32/esp_timer_esp32.c" 2
...
# 25 "C:/esp/esp-idf/components/esp32/esp_timer_esp32.c" 2
...
# 26 "C:/esp/esp-idf/components/esp32/esp_timer_esp32.c" 2
...
# 27 "C:/esp/esp-idf/components/esp32/esp_timer_esp32.c" 2
...
# 28 "C:/esp/esp-idf/components/esp32/esp_timer_esp32.c" 2
# 83 "C:/esp/esp-idf/components/esp32/esp_timer_esp32.c"
...
# 113 "C:/esp/esp-idf/components/esp32/esp_timer_esp32.c"
static 
# 113 "C:/esp/esp-idf/components/esp32/esp_timer_esp32.c" 3 4
      _Bool 
# 113 "C:/esp/esp-idf/components/esp32/esp_timer_esp32.c"
           s_mask_overflow;
...
static inline 
# 120 "C:/esp/esp-idf/components/esp32/esp_timer_esp32.c" 3 4
             _Bool 
# 120 "C:/esp/esp-idf/components/esp32/esp_timer_esp32.c"
                  __attribute__((section(".iram1"))) timer_overflow_happened()
{
    return (({ ; (*(volatile uint32_t *)(((0x3ff47000 + 1*0x20) + 0x8))); }) & ((1UL << (8)))) != 0 &&
            ({ ; (*(volatile uint32_t *)(((0x3ff47000 + 1*0x20) + 0x10))); }) == 0xffffffffUL &&
            !s_mask_overflow;
}
...
# 132 "C:/esp/esp-idf/components/esp32/esp_timer_esp32.c" 3 4
   _Bool 
# 132 "C:/esp/esp-idf/components/esp32/esp_timer_esp32.c"
        overflow;
...
# 152 "C:/esp/esp-idf/components/esp32/esp_timer_esp32.c" 3 4
           1
# 152 "C:/esp/esp-idf/components/esp32/esp_timer_esp32.c"
               );
...
# 166 "C:/esp/esp-idf/components/esp32/esp_timer_esp32.c" 3 4
   _Bool 
# 166 "C:/esp/esp-idf/components/esp32/esp_timer_esp32.c"
        overflow = timer_overflow_happened();
    if (overflow) {
        ((time_after_timebase_us > s_timer_us_per_overflow) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/esp32/esp_timer_esp32.c", 168, __func__, "time_after_timebase_us > s_timer_us_per_overflow"));
...
static void __attribute__((section(".iram1"))) timer_alarm_isr(void *arg)
{
    ...
    s_mask_overflow = 
# 200 "C:/esp/esp-idf/components/esp32/esp_timer_esp32.c" 3 4
                     0
# 200 "C:/esp/esp-idf/components/esp32/esp_timer_esp32.c"
                          ;
...
esp_err_t esp_timer_impl_init(intr_handler_t alarm_handler)
{
    ...
    esp_err_t err = esp_intr_alloc(57,
            (1<<11) | (1<<10),
            &timer_alarm_isr, 
# 218 "C:/esp/esp-idf/components/esp32/esp_timer_esp32.c" 3 4
                             ((void *)0)
# 218 "C:/esp/esp-idf/components/esp32/esp_timer_esp32.c"
...
# 227 "C:/esp/esp-idf/components/esp32/esp_timer_esp32.c"
    ,
...
# 227 "C:/esp/esp-idf/components/esp32/esp_timer_esp32.c"
    ...
    ({ ; (*(volatile uint32_t *)(((0x3ff47000 + 1*0x20) + 0x8))) = ((0 << 1) | ((1UL << (7))) | ((1UL << (0)))); })
                                                                   ;
    ({ ; (*(volatile uint32_t *)(((0x3ff47000 + 1*0x20) + 0xC))) = (((1UL << (0)))); });
    do { esp_err_t rc = (esp_intr_enable(s_timer_interrupt_handle)); if (rc != 0) { _esp_error_check_failed(rc, "C:/esp/esp-idf/components/esp32/esp_timer_esp32.c", 238, __func__, "esp_intr_enable(s_timer_interrupt_handle)"); } } while(0);;
...
void esp_timer_impl_deinit()
{
    ...
    s_timer_interrupt_handle = 
# 252 "C:/esp/esp-idf/components/esp32/esp_timer_esp32.c" 3 4
                              ((void *)0)
# 252 "C:/esp/esp-idf/components/esp32/esp_timer_esp32.c"
                                  ;
}
