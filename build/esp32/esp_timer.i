# 1 "C:/esp/esp-idf/components/esp32/esp_timer.c"
# 1 "C:\\esp\\esp32-ArkPOS2\\ArkPOS2-esp\\build\\esp32//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/esp32/esp_timer.c"
# 15 "C:/esp/esp-idf/components/esp32/esp_timer.c"
...
# 9 "C:/esp/esp-idf/components/newlib/include/sys/param.h" 2
...
# 16 "C:/esp/esp-idf/components/esp32/esp_timer.c" 2
...
# 17 "C:/esp/esp-idf/components/esp32/esp_timer.c" 2
# 1 "C:/esp/esp-idf/components/esp32/include/esp_attr.h" 1
# 18 "C:/esp/esp-idf/components/esp32/esp_timer.c" 2
...
# 19 "C:/esp/esp-idf/components/esp32/esp_timer.c" 2
...
# 20 "C:/esp/esp-idf/components/esp32/esp_timer.c" 2
...
# 21 "C:/esp/esp-idf/components/esp32/esp_timer.c" 2
...
# 22 "C:/esp/esp-idf/components/esp32/esp_timer.c" 2
...
# 23 "C:/esp/esp-idf/components/esp32/esp_timer.c" 2
...
# 24 "C:/esp/esp-idf/components/esp32/esp_timer.c" 2
...
# 25 "C:/esp/esp-idf/components/esp32/esp_timer.c" 2

# 1 "C:/esp/esp32-ArkPOS2/ArkPOS2-esp/build/include/sdkconfig.h" 1
# 27 "C:/esp/esp-idf/components/esp32/esp_timer.c" 2

# 1 "C:/esp/esp-idf/components/esp32/esp_timer_impl.h" 1
# 15 "C:/esp/esp-idf/components/esp32/esp_timer_impl.h"
       
# 36 "C:/esp/esp-idf/components/esp32/esp_timer_impl.h"
...
# 52 "C:/esp/esp-idf/components/esp32/esp_timer_impl.h"
...
# 68 "C:/esp/esp-idf/components/esp32/esp_timer_impl.h"
uint64_t esp_timer_impl_get_min_period_us();
# 29 "C:/esp/esp-idf/components/esp32/esp_timer.c" 2
# 38 "C:/esp/esp-idf/components/esp32/esp_timer.c"
# 1 "C:/esp/esp-idf/components/esp32/include/rom/queue.h" 1
# 39 "C:/esp/esp-idf/components/esp32/esp_timer.c" 2
...
static 
# 56 "C:/esp/esp-idf/components/esp32/esp_timer.c" 3 4
      _Bool 
# 56 "C:/esp/esp-idf/components/esp32/esp_timer.c"
           is_initialized();
static esp_err_t timer_insert(esp_timer_handle_t timer);
static esp_err_t timer_remove(esp_timer_handle_t timer);
static 
# 59 "C:/esp/esp-idf/components/esp32/esp_timer.c" 3 4
      _Bool 
# 59 "C:/esp/esp-idf/components/esp32/esp_timer.c"
...
static struct esp_timer_list { struct esp_timer *lh_first; } s_timers =
        { 
# 72 "C:/esp/esp-idf/components/esp32/esp_timer.c" 3 4
       ((void *)0) 
# 72 "C:/esp/esp-idf/components/esp32/esp_timer.c"
       };
                           ...
                           esp_timer_handle_t* out_handle)
{
    ...
    if (args->callback == 
# 94 "C:/esp/esp-idf/components/esp32/esp_timer.c" 3 4
                         ((void *)0)
# 94 "C:/esp/esp-idf/components/esp32/esp_timer.c"
                             ) {
        return 0x102;
    }
    esp_timer_handle_t result = (esp_timer_handle_t) calloc(1, sizeof(*result));
    if (result == 
# 98 "C:/esp/esp-idf/components/esp32/esp_timer.c" 3 4
                 ((void *)0)
# 98 "C:/esp/esp-idf/components/esp32/esp_timer.c"
                     ) {
        return 0x101;
    }
...
esp_err_t esp_timer_delete(esp_timer_handle_t timer)
{
    ...
    if (timer == 
# 154 "C:/esp/esp-idf/components/esp32/esp_timer.c" 3 4
                ((void *)0)
# 154 "C:/esp/esp-idf/components/esp32/esp_timer.c"
                    ) {
        return 0x102;
    }
    free(timer);
...
# 167 "C:/esp/esp-idf/components/esp32/esp_timer.c" 3 4
                                 ((void *)0)
# 167 "C:/esp/esp-idf/components/esp32/esp_timer.c"
                                     ;
    if (((&s_timers)->lh_first) == 
# 168 "C:/esp/esp-idf/components/esp32/esp_timer.c" 3 4
                                ((void *)0)
# 168 "C:/esp/esp-idf/components/esp32/esp_timer.c"
                                    ) {
        do { ; if (((((timer))->list_entry.le_next) = (((&s_timers))->lh_first)) != 
# 169 "C:/esp/esp-idf/components/esp32/esp_timer.c" 3 4
       ((void *)0)
# 169 "C:/esp/esp-idf/components/esp32/esp_timer.c"
        ...
        if (it == 
# 178 "C:/esp/esp-idf/components/esp32/esp_timer.c" 3 4
                 ((void *)0)
# 178 "C:/esp/esp-idf/components/esp32/esp_timer.c"
                     ) {
            ((last) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/esp32/esp_timer.c", 179, __func__, "last"));
            do { ; if (((((timer))->list_entry.le_next) = (((last))->list_entry.le_next)) != 
# 180 "C:/esp/esp-idf/components/esp32/esp_timer.c" 3 4
           ((void *)0)
# 180 "C:/esp/esp-idf/components/esp32/esp_timer.c"
...
# 193 "C:/esp/esp-idf/components/esp32/esp_timer.c" 3 4
   ((void *)0)
# 193 "C:/esp/esp-idf/components/esp32/esp_timer.c"
...
# 232 "C:/esp/esp-idf/components/esp32/esp_timer.c"
static 
# 232 "C:/esp/esp-idf/components/esp32/esp_timer.c" 3 4
      _Bool 
# 232 "C:/esp/esp-idf/components/esp32/esp_timer.c"
           timer_armed(esp_timer_handle_t timer)
{
...
static void timer_process_alarm(esp_timer_dispatch_t dispatch_method)
{
    ...
    while (it != 
# 255 "C:/esp/esp-idf/components/esp32/esp_timer.c" 3 4
                ((void *)0) 
# 255 "C:/esp/esp-idf/components/esp32/esp_timer.c"
                     &&
            it->alarm < now) {
        do { ; ; ; ; if ((((it))->list_entry.le_next) != 
# 257 "C:/esp/esp-idf/components/esp32/esp_timer.c" 3 4
       ((void *)0)
# 257 "C:/esp/esp-idf/components/esp32/esp_timer.c"
...
{
    while (
# 289 "C:/esp/esp-idf/components/esp32/esp_timer.c" 3 4
          1
# 289 "C:/esp/esp-idf/components/esp32/esp_timer.c"
              ){
        int res = xQueueGenericReceive( ( QueueHandle_t ) ( s_timer_semaphore ), 
# 290 "C:/esp/esp-idf/components/esp32/esp_timer.c" 3 4
                 ((void *)0)
# 290 "C:/esp/esp-idf/components/esp32/esp_timer.c"
                 , ( ( TickType_t ) 0xffffffffUL ), ( ( BaseType_t ) 0 ) );
        ((res == ( ( BaseType_t ) 1 )) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/esp32/esp_timer.c", 291, __func__, "res == pdTRUE"));
...
static 
# 308 "C:/esp/esp-idf/components/esp32/esp_timer.c" 3 4
      _Bool 
# 308 "C:/esp/esp-idf/components/esp32/esp_timer.c"
           is_initialized()
{
    return s_timer_task != 
# 310 "C:/esp/esp-idf/components/esp32/esp_timer.c" 3 4
                          ((void *)0)
# 310 "C:/esp/esp-idf/components/esp32/esp_timer.c"
                              ;
}
...
esp_err_t esp_timer_init(void)
{
    ...
    int ret = xTaskCreatePinnedToCore(&timer_task, "esp_timer",
            4096, 
# 326 "C:/esp/esp-idf/components/esp32/esp_timer.c" 3 4
                                 ((void *)0)
# 326 "C:/esp/esp-idf/components/esp32/esp_timer.c"
                                     , ((( 25 )) - 3), &s_timer_task, (0));
    if (ret != ( ( ( BaseType_t ) 1 ) )) {
        vQueueDelete( ( QueueHandle_t ) ( s_timer_semaphore ) );
        s_timer_semaphore = 
# 329 "C:/esp/esp-idf/components/esp32/esp_timer.c" 3 4
                           ((void *)0)
# 329 "C:/esp/esp-idf/components/esp32/esp_timer.c"
                               ;
        return 0x101;
    }
    ...
    if (err != 0) {
        ...
        s_timer_task = 
# 336 "C:/esp/esp-idf/components/esp32/esp_timer.c" 3 4
                      ((void *)0)
# 336 "C:/esp/esp-idf/components/esp32/esp_timer.c"
                          ;
        vQueueDelete( ( QueueHandle_t ) ( s_timer_semaphore ) );
        s_timer_semaphore = 
# 338 "C:/esp/esp-idf/components/esp32/esp_timer.c" 3 4
                           ((void *)0)
# 338 "C:/esp/esp-idf/components/esp32/esp_timer.c"
                               ;
        return err;
    }
...
esp_err_t esp_timer_deinit(void)
{
    ...
    if (!((&s_timers)->lh_first == 
# 352 "C:/esp/esp-idf/components/esp32/esp_timer.c" 3 4
        ((void *)0)
# 352 "C:/esp/esp-idf/components/esp32/esp_timer.c"
        )) {
        return 0x103;
    }
# 365 "C:/esp/esp-idf/components/esp32/esp_timer.c"
    esp_timer_impl_deinit();

    vTaskDelete(s_timer_task);
    s_timer_task = 
# 368 "C:/esp/esp-idf/components/esp32/esp_timer.c" 3 4
                  ((void *)0)
# 368 "C:/esp/esp-idf/components/esp32/esp_timer.c"
                      ;
    vQueueDelete( ( QueueHandle_t ) ( s_timer_semaphore ) );
    s_timer_semaphore = 
# 370 "C:/esp/esp-idf/components/esp32/esp_timer.c" 3 4
                       ((void *)0)
# 370 "C:/esp/esp-idf/components/esp32/esp_timer.c"
                           ;
    return 0;
}
...
esp_err_t esp_timer_dump(FILE* stream)
{
    ...
    if (print_buf == 
# 422 "C:/esp/esp-idf/components/esp32/esp_timer.c" 3 4
                    ((void *)0)
# 422 "C:/esp/esp-idf/components/esp32/esp_timer.c"
                        ) {
        return 0x101;
    }
