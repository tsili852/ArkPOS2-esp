# 1 "C:/esp/esp-idf/components/esp32/ets_timer_legacy.c"
# 1 "C:\\esp\\ArkPOS2-esp\\build\\esp32//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/esp32/ets_timer_legacy.c"
# 22 "C:/esp/esp-idf/components/esp32/ets_timer_legacy.c"
...
# 23 "C:/esp/esp-idf/components/esp32/ets_timer_legacy.c" 2
...
# 24 "C:/esp/esp-idf/components/esp32/ets_timer_legacy.c" 2
...
# 25 "C:/esp/esp-idf/components/esp32/ets_timer_legacy.c" 2
# 1 "C:/esp/esp-idf/components/esp32/include/esp_attr.h" 1
# 26 "C:/esp/esp-idf/components/esp32/ets_timer_legacy.c" 2
...
# 27 "C:/esp/esp-idf/components/esp32/ets_timer_legacy.c" 2

# 1 "C:/esp/esp-idf/components/soc/esp32/include/soc/frc_timer_reg.h" 1
# 18 "C:/esp/esp-idf/components/soc/esp32/include/soc/frc_timer_reg.h"
# 1 "C:/esp/esp-idf/components/soc/esp32/include/soc/soc.h" 1
# 19 "C:/esp/esp-idf/components/soc/esp32/include/soc/frc_timer_reg.h" 2
# 29 "C:/esp/esp-idf/components/esp32/ets_timer_legacy.c" 2
...
# 30 "C:/esp/esp-idf/components/esp32/ets_timer_legacy.c" 2
...
# 31 "C:/esp/esp-idf/components/esp32/ets_timer_legacy.c" 2
...
# 32 "C:/esp/esp-idf/components/esp32/ets_timer_legacy.c" 2

# 1 "C:/esp/ArkPOS2-esp/build/include/sdkconfig.h" 1
# 34 "C:/esp/esp-idf/components/esp32/ets_timer_legacy.c" 2
...
# 35 "C:/esp/esp-idf/components/esp32/ets_timer_legacy.c" 2
...
# 36 "C:/esp/esp-idf/components/esp32/ets_timer_legacy.c" 2
# 46 "C:/esp/esp-idf/components/esp32/ets_timer_legacy.c"
static 
# 46 "C:/esp/esp-idf/components/esp32/ets_timer_legacy.c" 3 4
      _Bool 
# 46 "C:/esp/esp-idf/components/esp32/ets_timer_legacy.c"
...
# 58 "C:/esp/esp-idf/components/esp32/ets_timer_legacy.c" 3 4
                            ((void *)0)
# 58 "C:/esp/esp-idf/components/esp32/ets_timer_legacy.c"
                                ) {
        ...
        do { esp_err_t rc = (esp_timer_create(&create_args, (esp_timer_handle_t*)&(ptimer->timer_arg))); if (rc != 0) { _esp_error_check_failed(rc, "C:/esp/esp-idf/components/esp32/ets_timer_legacy.c", 66, __func__, "esp_timer_create(&create_args, (esp_timer_handle_t*)&(ptimer->timer_arg))"); } } while(0);;
    }
}


void ets_timer_arm_us(ETSTimer *ptimer, uint32_t time_us, 
# 71 "C:/esp/esp-idf/components/esp32/ets_timer_legacy.c" 3 4
                                                         _Bool 
# 71 "C:/esp/esp-idf/components/esp32/ets_timer_legacy.c"
                                                              repeat_flag)
{
    ((timer_initialized(ptimer)) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/esp32/ets_timer_legacy.c", 73, __func__, "timer_initialized(ptimer)"));
    esp_timer_stop(((esp_timer_handle_t) (ptimer)->timer_arg));
    if (!repeat_flag) {
        do { esp_err_t rc = (esp_timer_start_once(((esp_timer_handle_t) (ptimer)->timer_arg), time_us)); if (rc != 0) { _esp_error_check_failed(rc, "C:/esp/esp-idf/components/esp32/ets_timer_legacy.c", 76, __func__, "esp_timer_start_once(ESP_TIMER(ptimer), time_us)"); } } while(0);;
    } else {
        do { esp_err_t rc = (esp_timer_start_periodic(((esp_timer_handle_t) (ptimer)->timer_arg), time_us)); if (rc != 0) { _esp_error_check_failed(rc, "C:/esp/esp-idf/components/esp32/ets_timer_legacy.c", 78, __func__, "esp_timer_start_periodic(ESP_TIMER(ptimer), time_us)"); } } while(0);;
    }
}

void ets_timer_arm(ETSTimer *ptimer, uint32_t time_ms, 
# 82 "C:/esp/esp-idf/components/esp32/ets_timer_legacy.c" 3 4
                                                      _Bool 
# 82 "C:/esp/esp-idf/components/esp32/ets_timer_legacy.c"
                                                           repeat_flag)
{
    uint64_t time_us = 1000LL * (uint64_t) time_ms;
    ((timer_initialized(ptimer)) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/esp32/ets_timer_legacy.c", 85, __func__, "timer_initialized(ptimer)"));
    esp_timer_stop(((esp_timer_handle_t) (ptimer)->timer_arg));
    if (!repeat_flag) {
        do { esp_err_t rc = (esp_timer_start_once(((esp_timer_handle_t) (ptimer)->timer_arg), time_us)); if (rc != 0) { _esp_error_check_failed(rc, "C:/esp/esp-idf/components/esp32/ets_timer_legacy.c", 88, __func__, "esp_timer_start_once(ESP_TIMER(ptimer), time_us)"); } } while(0);;
    } else {
        do { esp_err_t rc = (esp_timer_start_periodic(((esp_timer_handle_t) (ptimer)->timer_arg), time_us)); if (rc != 0) { _esp_error_check_failed(rc, "C:/esp/esp-idf/components/esp32/ets_timer_legacy.c", 90, __func__, "esp_timer_start_periodic(ESP_TIMER(ptimer), time_us)"); } } while(0);;
    }
}
...
void ets_timer_done(ETSTimer *ptimer)
{
    if (timer_initialized(ptimer)) {
        ...
        ptimer->timer_arg = 
# 98 "C:/esp/esp-idf/components/esp32/ets_timer_legacy.c" 3 4
                           ((void *)0)
# 98 "C:/esp/esp-idf/components/esp32/ets_timer_legacy.c"
                               ;
...
# 123 "C:/esp/esp-idf/components/esp32/ets_timer_legacy.c" 3 4
                                                        _Bool 
# 123 "C:/esp/esp-idf/components/esp32/ets_timer_legacy.c"
                                                             repeat_flag) __attribute__((alias("ets_timer_arm_us")));
void os_timer_arm(ETSTimer *ptimer,uint32_t milliseconds,
# 124 "C:/esp/esp-idf/components/esp32/ets_timer_legacy.c" 3 4
                                                        _Bool 
# 124 "C:/esp/esp-idf/components/esp32/ets_timer_legacy.c"
