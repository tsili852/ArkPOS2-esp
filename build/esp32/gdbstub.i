# 1 "C:/esp/esp-idf/components/esp32/gdbstub.c"
# 1 "C:\\esp\\ArkPOS2-esp\\build\\esp32//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/esp32/gdbstub.c"
# 21 "C:/esp/esp-idf/components/esp32/gdbstub.c"
...
# 22 "C:/esp/esp-idf/components/esp32/gdbstub.c" 2
...
# 23 "C:/esp/esp-idf/components/esp32/gdbstub.c" 2
...
# 24 "C:/esp/esp-idf/components/esp32/gdbstub.c" 2
# 1 "C:/esp/esp-idf/components/esp32/include/esp_gdbstub.h" 1
# 17 "C:/esp/esp-idf/components/esp32/include/esp_gdbstub.h"
...
# 18 "C:/esp/esp-idf/components/esp32/include/esp_gdbstub.h" 2
# 1 "C:/esp/esp-idf/components/freertos/include/freertos/xtensa_api.h" 1
# 33 "C:/esp/esp-idf/components/freertos/include/freertos/xtensa_api.h"
...
# 19 "C:/esp/esp-idf/components/esp32/include/esp_gdbstub.h" 2

void esp_gdbstub_panic_handler(XtExcFrame *frame) __attribute__((noreturn));
# 25 "C:/esp/esp-idf/components/esp32/gdbstub.c" 2
...
# 26 "C:/esp/esp-idf/components/esp32/gdbstub.c" 2
...
static int gdbRecvChar() {
 int i;
 while (((({ ; (*((volatile uint32_t *)(((0x3ff40000 + (0) * 0x10000 + ( (0) > 1 ? 0xe000 : 0 ) ) + 0x1C)))); })>>0)&0x000000FF)==0) ;
 i=({ ; (*((volatile uint32_t *)(((0x3ff40000 + (0) * 0x10000 + ( (0) > 1 ? 0xe000 : 0 ) ) + 0x0)))); });
 return i;
}
...
# 101 "C:/esp/esp-idf/components/esp32/gdbstub.c"
...
# 215 "C:/esp/esp-idf/components/esp32/gdbstub.c"
...
void esp_gdbstub_panic_handler(XtExcFrame *frame) {
 ...
 gpio_pullup_dis(1);
 ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff49000 +0x84)))) = (((({ ; (*(volatile uint32_t *)((0x3ff49000 +0x84))); }) & ~((0x7) << (12)))|(((0) & (0x7))<<(12)))); })); });
 ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff49000 +0x88)))) = (((({ ; (*(volatile uint32_t *)((0x3ff49000 +0x88))); }) & ~((0x7) << (12)))|(((0) & (0x7))<<(12)))); })); });
