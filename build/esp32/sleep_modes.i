# 1 "C:/esp/esp-idf/components/esp32/sleep_modes.c"
# 1 "C:\\esp\\esp32-ArkPOS2\\ArkPOS2-esp\\build\\esp32//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/esp32/sleep_modes.c"
# 15 "C:/esp/esp-idf/components/esp32/sleep_modes.c"
...
# 16 "C:/esp/esp-idf/components/esp32/sleep_modes.c" 2
...
# 16 "C:/esp/esp-idf/components/newlib/include/sys/lock.h" 2
...
# 17 "C:/esp/esp-idf/components/esp32/sleep_modes.c" 2
...
# 18 "C:/esp/esp-idf/components/esp32/sleep_modes.c" 2
# 1 "C:/esp/esp-idf/components/esp32/include/esp_attr.h" 1
# 19 "C:/esp/esp-idf/components/esp32/sleep_modes.c" 2
...
# 18 "C:/esp/esp-idf/components/esp32/include/esp_sleep.h" 2
...
# 16 "C:/esp/esp-idf/components/newlib/include/sys/_types.h"
typedef long _off_t;
...
# 19 "C:/esp/esp-idf/components/esp32/include/esp_sleep.h" 2
...
# 20 "C:/esp/esp-idf/components/esp32/sleep_modes.c" 2
...
# 21 "C:/esp/esp-idf/components/esp32/sleep_modes.c" 2
...
# 22 "C:/esp/esp-idf/components/esp32/sleep_modes.c" 2
...
# 23 "C:/esp/esp-idf/components/esp32/sleep_modes.c" 2
...
# 24 "C:/esp/esp-idf/components/esp32/sleep_modes.c" 2
...
# 25 "C:/esp/esp-idf/components/esp32/sleep_modes.c" 2
...
# 26 "C:/esp/esp-idf/components/esp32/sleep_modes.c" 2
# 1 "C:/esp/esp-idf/components/esp32/include/rom/uart.h" 1
# 22 "C:/esp/esp-idf/components/esp32/include/rom/uart.h"
...
# 27 "C:/esp/esp-idf/components/esp32/sleep_modes.c" 2
...
# 28 "C:/esp/esp-idf/components/esp32/sleep_modes.c" 2
...
# 29 "C:/esp/esp-idf/components/esp32/sleep_modes.c" 2
# 1 "C:/esp/esp-idf/components/soc/esp32/include/soc/rtc_cntl_reg.h" 1
# 30 "C:/esp/esp-idf/components/esp32/sleep_modes.c" 2

# 1 "C:/esp/esp-idf/components/soc/esp32/include/soc/spi_reg.h" 1
# 32 "C:/esp/esp-idf/components/esp32/sleep_modes.c" 2
# 1 "C:/esp/esp-idf/components/soc/esp32/include/soc/sens_reg.h" 1
# 33 "C:/esp/esp-idf/components/esp32/sleep_modes.c" 2
...
# 34 "C:/esp/esp-idf/components/esp32/sleep_modes.c" 2
...
# 35 "C:/esp/esp-idf/components/esp32/sleep_modes.c" 2
...
# 27 "C:/esp/esp-idf/components/esp32/include/esp_system.h"
typedef enum {
    ESP_MAC_WIFI_STA,
    ESP_MAC_WIFI_SOFTAP,
    ESP_MAC_BT,
...
# 36 "C:/esp/esp-idf/components/esp32/sleep_modes.c" 2
...
# 37 "C:/esp/esp-idf/components/esp32/sleep_modes.c" 2
# 1 "C:/esp/esp32-ArkPOS2/ArkPOS2-esp/build/include/sdkconfig.h" 1
# 38 "C:/esp/esp-idf/components/esp32/sleep_modes.c" 2
# 48 "C:/esp/esp-idf/components/esp32/sleep_modes.c"
typedef struct {
...
esp_deep_sleep_wake_stub_fn_t esp_get_deep_sleep_wake_stub(void)
{
    ...
    if(stored_crc == calc_crc) {
        ...
        return 
# 89 "C:/esp/esp-idf/components/esp32/sleep_modes.c" 3 4
              ((void *)0)
# 89 "C:/esp/esp-idf/components/esp32/sleep_modes.c"
                  ;
    }
}
...
void __attribute__((section(".rtc.text"))) esp_default_wake_deep_sleep(void) {
    ...
    (*(volatile uint32_t *)((0x3ff00000 + 0x044))) = ((*(volatile uint32_t *)((0x3ff00000 + 0x044))) & (~((1UL << (13)))))
                                                                                       ;
# 115 "C:/esp/esp-idf/components/esp32/sleep_modes.c"
}
...
# 158 "C:/esp/esp-idf/components/esp32/sleep_modes.c" 3 4
                                         ((void *)0)
# 158 "C:/esp/esp-idf/components/esp32/sleep_modes.c"
                                             ) {
...
static void rtc_wdt_enable(int time_ms)
{
    ...
    ({ ; (({ ; (*(volatile uint32_t *)(((0x3ff48000 + 0x8c)))) = (((({ ; (*(volatile uint32_t *)((0x3ff48000 + 0x8c))); }) & ~((0x7) << (28)))|(((4) & (0x7))<<(28)))); })); });
    ({ ; (*((volatile uint32_t *)((0x3ff48000 + 0x90)))) = (uint32_t)(rtc_clk_slow_freq_get_hz() * time_ms / 1000); });
...
static esp_err_t esp_light_sleep_inner(uint32_t pd_flags,
        rtc_cpu_freq_t cpu_freq, uint32_t flash_enable_time_us) __attribute__((section(".iram1"))) __attribute__((noinline));
...
esp_err_t esp_sleep_enable_ulp_wakeup()
{
# 282 "C:/esp/esp-idf/components/esp32/sleep_modes.c"
    return 0x103;
...
touch_pad_t esp_sleep_get_touchpad_wakeup_status()
{
    ...
    ((touch_mask != 0 && "wakeup reason is RTC_TOUCH_TRIG_EN but SENS_TOUCH_MEAS_EN is zero") ? (void)0 : __assert_func ("C:/esp/esp-idf/components/esp32/sleep_modes.c", 317, __func__, "touch_mask != 0 && \"wakeup reason is RTC_TOUCH_TRIG_EN but SENS_TOUCH_MEAS_EN is zero\""));
...
static uint32_t get_power_down_flags()
{
# 485 "C:/esp/esp-idf/components/esp32/sleep_modes.c"
