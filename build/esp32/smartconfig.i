# 1 "C:/esp/esp-idf/components/esp32/smartconfig.c"
# 1 "C:\\esp\\esp32-ArkPOS2\\ArkPOS2-esp\\build\\esp32//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/esp32/smartconfig.c"
# 20 "C:/esp/esp-idf/components/esp32/smartconfig.c"
...
# 21 "C:/esp/esp-idf/components/esp32/smartconfig.c" 2
...
# 22 "C:/esp/esp-idf/components/esp32/smartconfig.c" 2
...
# 23 "C:/esp/esp-idf/components/esp32/smartconfig.c" 2
...
# 38 "C:/esp/esp-idf/components/lwip/include/lwip/port/arch/sys_arch.h"
...
# 24 "C:/esp/esp-idf/components/esp32/smartconfig.c" 2
...
# 25 "C:/esp/esp-idf/components/esp32/smartconfig.c" 2
...
# 26 "C:/esp/esp-idf/components/esp32/smartconfig.c" 2
...
# 27 "C:/esp/esp-idf/components/esp32/smartconfig.c" 2
# 1 "C:/esp/esp-idf/components/esp32/include/esp_smartconfig.h" 1
# 26 "C:/esp/esp-idf/components/esp32/include/esp_smartconfig.h"
typedef enum {
    SC_STATUS_WAIT = 0,
...
# 51 "C:/esp/esp-idf/components/esp32/include/esp_smartconfig.h"
...
# 76 "C:/esp/esp-idf/components/esp32/include/esp_smartconfig.h"
esp_err_t esp_smartconfig_start(sc_callback_t cb, ...);
# 88 "C:/esp/esp-idf/components/esp32/include/esp_smartconfig.h"
esp_err_t esp_smartconfig_stop(void);
# 101 "C:/esp/esp-idf/components/esp32/include/esp_smartconfig.h"
esp_err_t esp_esptouch_set_timeout(uint8_t time_s);
# 115 "C:/esp/esp-idf/components/esp32/include/esp_smartconfig.h"
esp_err_t esp_smartconfig_set_type(smartconfig_type_t type);
# 130 "C:/esp/esp-idf/components/esp32/include/esp_smartconfig.h"
esp_err_t esp_smartconfig_fast_mode(
# 130 "C:/esp/esp-idf/components/esp32/include/esp_smartconfig.h" 3 4
                                   _Bool 
# 130 "C:/esp/esp-idf/components/esp32/include/esp_smartconfig.h"
                                        enable);
# 28 "C:/esp/esp-idf/components/esp32/smartconfig.c" 2
# 1 "C:/esp/esp-idf/components/esp32/smartconfig.h" 1
# 36 "C:/esp/esp-idf/components/esp32/smartconfig.h"
typedef enum {
...
# 62 "C:/esp/esp-idf/components/esp32/smartconfig.h"
...
# 29 "C:/esp/esp-idf/components/esp32/smartconfig.c" 2

static const char *TAG = "smartconfig";


static 
# 33 "C:/esp/esp-idf/components/esp32/smartconfig.c" 3 4
      _Bool 
# 33 "C:/esp/esp-idf/components/esp32/smartconfig.c"
           s_sc_ack_send = 
# 33 "C:/esp/esp-idf/components/esp32/smartconfig.c" 3 4
                           0
# 33 "C:/esp/esp-idf/components/esp32/smartconfig.c"
...
static void sc_ack_send_task(void *pvParameters)
{
    ...
    while (s_sc_ack_send) {
        ...
        if ((0 == ret) && (local_ip.ip.addr != ((u32_t)0x00000000UL))) {
            ...
            send_sock = lwip_socket(2,2,0);
            if (send_sock < 0) {
                if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Creat udp socket failed" "\033[0m" "\n", esp_log_timestamp(), TAG); };
                free(ack);
                vTaskDelete(
# 84 "C:/esp/esp-idf/components/esp32/smartconfig.c" 3 4
                           ((void *)0)
# 84 "C:/esp/esp-idf/components/esp32/smartconfig.c"
                               );
            }

            lwip_setsockopt_r(send_sock,0xfff,0x0020 | 0x0004,&optval,sizeof(int));

            while (s_sc_ack_send) {

                vTaskDelay(100 / ( ( TickType_t ) 1000 / ( 100 ) ));

                sendlen = lwip_sendto_r(send_sock,&ack->ctx,ack_len,0,(struct sockaddr*) &server_addr,sin_size);
                if (sendlen > 0) {
                    ...
                    if (packet_count++ >= 30) {
                        ...
                        lwip_close_r(send_sock);
                        free(ack);
                        vTaskDelete(
# 105 "C:/esp/esp-idf/components/esp32/smartconfig.c" 3 4
                                   ((void *)0)
# 105 "C:/esp/esp-idf/components/esp32/smartconfig.c"
                                       );
                    }
                }
                else {
                    ...
                    if (err == 12 || err == 11) {
                        if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "send failed, errno %d" "\033[0m" "\n", esp_log_timestamp(), TAG, err); };
                        continue;
                    }
                    if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "send failed, errno %d" "\033[0m" "\n", esp_log_timestamp(), TAG, err); };
                    lwip_close_r(send_sock);
                    free(ack);
                    vTaskDelete(
# 117 "C:/esp/esp-idf/components/esp32/smartconfig.c" 3 4
                               ((void *)0)
# 117 "C:/esp/esp-idf/components/esp32/smartconfig.c"
                                   );
                }
            }
        }
    ...
    free(ack);
    vTaskDelete(
# 127 "C:/esp/esp-idf/components/esp32/smartconfig.c" 3 4
               ((void *)0)
# 127 "C:/esp/esp-idf/components/esp32/smartconfig.c"
                   );
}
...
{
    sc_ack_t *ack = 
# 132 "C:/esp/esp-idf/components/esp32/smartconfig.c" 3 4
                   ((void *)0)
# 132 "C:/esp/esp-idf/components/esp32/smartconfig.c"
                       ;

    if (param == 
# 134 "C:/esp/esp-idf/components/esp32/smartconfig.c" 3 4
                ((void *)0)
# 134 "C:/esp/esp-idf/components/esp32/smartconfig.c"
                    ) {
        if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Smart config ack parameter error" "\033[0m" "\n", esp_log_timestamp(), TAG); };
        return;
    }

    ack = malloc(sizeof(sc_ack_t));
    if (ack == 
# 140 "C:/esp/esp-idf/components/esp32/smartconfig.c" 3 4
              ((void *)0)
# 140 "C:/esp/esp-idf/components/esp32/smartconfig.c"
                  ) {
        if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Smart config ack parameter malloc fail" "\033[0m" "\n", esp_log_timestamp(), TAG); };
        return;
    }
    memcpy(ack, param, sizeof(sc_ack_t));

    s_sc_ack_send = 
# 146 "C:/esp/esp-idf/components/esp32/smartconfig.c" 3 4
                   1
# 146 "C:/esp/esp-idf/components/esp32/smartconfig.c"
                       ;

    xTaskCreatePinnedToCore( ( sc_ack_send_task ), ( "sc_ack_send_task" ), ( 2048 ), ( ack ), ( 2 ), ( 
# 148 "C:/esp/esp-idf/components/esp32/smartconfig.c" 3 4
   ((void *)0) 
# 148 "C:/esp/esp-idf/components/esp32/smartconfig.c"
   ), 0x7fffffff );
}
...
{
    s_sc_ack_send = 
# 153 "C:/esp/esp-idf/components/esp32/smartconfig.c" 3 4
                   0
# 153 "C:/esp/esp-idf/components/esp32/smartconfig.c"
                        ;
}
