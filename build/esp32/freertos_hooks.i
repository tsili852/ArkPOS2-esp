# 1 "C:/esp/esp-idf/components/esp32/freertos_hooks.c"
# 1 "C:\\esp\\ArkPOS2-esp\\build\\esp32//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/esp32/freertos_hooks.c"
# 16 "C:/esp/esp-idf/components/esp32/freertos_hooks.c"
...
# 17 "C:/esp/esp-idf/components/esp32/freertos_hooks.c" 2
...
# 18 "C:/esp/esp-idf/components/esp32/freertos_hooks.c" 2
# 1 "c:\\msys32\\opt\\xtensa-esp32-elf\\lib\\gcc\\xtensa-esp32-elf\\5.2.0\\include\\stdbool.h" 1 3 4
# 19 "C:/esp/esp-idf/components/esp32/freertos_hooks.c" 2
# 1 "C:/esp/esp-idf/components/esp32/include/esp_attr.h" 1
# 20 "C:/esp/esp-idf/components/esp32/freertos_hooks.c" 2
# 1 "C:/esp/esp-idf/components/esp32/include/esp_freertos_hooks.h" 1
# 19 "C:/esp/esp-idf/components/esp32/include/esp_freertos_hooks.h"
...
# 20 "C:/esp/esp-idf/components/esp32/include/esp_freertos_hooks.h" 2
...
# 21 "C:/esp/esp-idf/components/esp32/freertos_hooks.c" 2
...
void __attribute__((section(".iram1"))) esp_vApplicationTickHook()
{
    ...
    for (n=0; n<8; n++) {
        if (tick_cb[n]!=
# 33 "C:/esp/esp-idf/components/esp32/freertos_hooks.c" 3 4
                       ((void *)0)
# 33 "C:/esp/esp-idf/components/esp32/freertos_hooks.c"
                           ) {
            tick_cb[n]();
        }
    }
...
# 41 "C:/esp/esp-idf/components/esp32/freertos_hooks.c" 3 4
   _Bool 
# 41 "C:/esp/esp-idf/components/esp32/freertos_hooks.c"
        doWait=
# 41 "C:/esp/esp-idf/components/esp32/freertos_hooks.c" 3 4
               1
# 41 "C:/esp/esp-idf/components/esp32/freertos_hooks.c"
...
# 42 "C:/esp/esp-idf/components/esp32/freertos_hooks.c" 3 4
   _Bool 
# 42 "C:/esp/esp-idf/components/esp32/freertos_hooks.c"
        r;
    int n;
    for (n=0; n<8; n++) {
        if (idle_cb[n]!=
# 45 "C:/esp/esp-idf/components/esp32/freertos_hooks.c" 3 4
                       ((void *)0)
# 45 "C:/esp/esp-idf/components/esp32/freertos_hooks.c"
                           ) {
            r=idle_cb[n]();
            if (!r) doWait=
# 47 "C:/esp/esp-idf/components/esp32/freertos_hooks.c" 3 4
                          0
# 47 "C:/esp/esp-idf/components/esp32/freertos_hooks.c"
                               ;
        }
    }
    if (doWait) {
...
esp_err_t esp_register_freertos_idle_hook(esp_freertos_idle_cb_t new_idle_cb)
{
    ...
    for (n=0; n<8; n++) {
        if (idle_cb[n]==
# 61 "C:/esp/esp-idf/components/esp32/freertos_hooks.c" 3 4
                       ((void *)0)
# 61 "C:/esp/esp-idf/components/esp32/freertos_hooks.c"
                           ) {
...
esp_err_t esp_register_freertos_tick_hook(esp_freertos_tick_cb_t new_tick_cb)
{
    ...
    for (n=0; n<8; n++) {
        if (tick_cb[n]==
# 73 "C:/esp/esp-idf/components/esp32/freertos_hooks.c" 3 4
                       ((void *)0)
# 73 "C:/esp/esp-idf/components/esp32/freertos_hooks.c"
                           ) {
...
# 85 "C:/esp/esp-idf/components/esp32/freertos_hooks.c" 3 4
                                               ((void *)0)
# 85 "C:/esp/esp-idf/components/esp32/freertos_hooks.c"
                                                   ;
    }
}
...
# 93 "C:/esp/esp-idf/components/esp32/freertos_hooks.c" 3 4
                                               ((void *)0)
# 93 "C:/esp/esp-idf/components/esp32/freertos_hooks.c"
                                                   ;
    }
}
