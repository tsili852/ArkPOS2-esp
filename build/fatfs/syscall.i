# 1 "C:/esp/esp-idf/components/fatfs/src/option/syscall.c"
...
# 8 "C:/esp/esp-idf/components/fatfs/src/option/syscall.c" 2
# 19 "C:/esp/esp-idf/components/fatfs/src/option/syscall.c"
int ff_cre_syncobj (
 BYTE vol,
 SemaphoreHandle_t *sobj
)
 ...
 *sobj = xQueueCreateMutex( ( ( uint8_t ) 1U ) );
 return (*sobj != 
# 25 "C:/esp/esp-idf/components/fatfs/src/option/syscall.c" 3 4
                 ((void *)0)
# 25 "C:/esp/esp-idf/components/fatfs/src/option/syscall.c"
                     ) ? 1 : 0;
}
# 38 "C:/esp/esp-idf/components/fatfs/src/option/syscall.c"
int ff_del_syncobj (
 SemaphoreHandle_t sobj
)
{
...
# 55 "C:/esp/esp-idf/components/fatfs/src/option/syscall.c"
int ff_req_grant (
 SemaphoreHandle_t sobj
)
{
 return (xQueueGenericReceive( ( QueueHandle_t ) ( sobj ), 
# 59 "C:/esp/esp-idf/components/fatfs/src/option/syscall.c" 3 4
        ((void *)0)
# 59 "C:/esp/esp-idf/components/fatfs/src/option/syscall.c"
        , ( 1000 ), ( ( BaseType_t ) 0 ) ) == ( ( BaseType_t ) 1 )) ? 1 : 0;
}
# 70 "C:/esp/esp-idf/components/fatfs/src/option/syscall.c"
void ff_rel_grant (
 SemaphoreHandle_t sobj
)
{
 xQueueGenericSend( ( QueueHandle_t ) ( sobj ), 
# 74 "C:/esp/esp-idf/components/fatfs/src/option/syscall.c" 3 4
((void *)0)
# 74 "C:/esp/esp-idf/components/fatfs/src/option/syscall.c"
