# 1 "C:/esp/esp-idf/components/fatfs/src/diskio_spiflash.c"
# 1 "C:\\esp\\ArkPOS2-esp\\build\\fatfs//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/fatfs/src/diskio_spiflash.c"
# 15 "C:/esp/esp-idf/components/fatfs/src/diskio_spiflash.c"
...
# 16 "C:/esp/esp-idf/components/fatfs/src/diskio_spiflash.c" 2
# 1 "C:/esp/esp-idf/components/fatfs/src/diskio.h" 1
# 12 "C:/esp/esp-idf/components/fatfs/src/diskio.h"
...
# 13 "C:/esp/esp-idf/components/fatfs/src/diskio.h" 2
...
# 18 "C:/esp/esp-idf/components/sdmmc/include/sdmmc_cmd.h" 2
...
# 19 "C:/esp/esp-idf/components/sdmmc/include/sdmmc_cmd.h" 2
...
# 17 "C:/esp/esp-idf/components/fatfs/src/diskio_spiflash.c" 2
...
# 18 "C:/esp/esp-idf/components/fatfs/src/diskio_spiflash.c" 2
# 1 "C:/esp/esp-idf/components/fatfs/src/ff.h" 1
# 29 "C:/esp/esp-idf/components/fatfs/src/ff.h"
# 1 "C:/esp/esp-idf/components/fatfs/src/ffconf.h" 1
# 1 "C:/esp/ArkPOS2-esp/build/include/sdkconfig.h" 1
# 2 "C:/esp/esp-idf/components/fatfs/src/ffconf.h" 2
...
# 19 "C:/esp/esp-idf/components/fatfs/src/diskio_spiflash.c" 2
...
# 20 "C:/esp/esp-idf/components/fatfs/src/diskio_spiflash.c" 2
# 1 "C:/esp/esp-idf/components/fatfs/src/diskio_spiflash.h" 1
# 23 "C:/esp/esp-idf/components/fatfs/src/diskio_spiflash.h"
...
# 24 "C:/esp/esp-idf/components/fatfs/src/diskio_spiflash.h" 2
# 32 "C:/esp/esp-idf/components/fatfs/src/diskio_spiflash.h"
...
# 21 "C:/esp/esp-idf/components/fatfs/src/diskio_spiflash.c" 2
...
DRESULT ff_wl_read (BYTE pdrv, BYTE *buff, DWORD sector, UINT count)
{
    ...
    ((wl_handle + 1) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/fatfs/src/diskio_spiflash.c", 44, __func__, "wl_handle + 1"));
...
DRESULT ff_wl_write (BYTE pdrv, const BYTE *buff, DWORD sector, UINT count)
{
    ...
    wl_handle_t wl_handle = ff_wl_handles[pdrv];
    ((wl_handle + 1) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/fatfs/src/diskio_spiflash.c", 57, __func__, "wl_handle + 1"));
...
DRESULT ff_wl_ioctl (BYTE pdrv, BYTE cmd, void *buff)
{
    ...
    ((wl_handle + 1) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/fatfs/src/diskio_spiflash.c", 75, __func__, "wl_handle + 1"));
    switch (cmd) {
    case 0:
        return RES_OK;
    case 1:
