# 1 "C:/esp/esp-idf/components/fatfs/src/diskio.c"
# 1 "C:\\esp\\ArkPOS2-esp\\build\\fatfs//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/fatfs/src/diskio.c"
# 11 "C:/esp/esp-idf/components/fatfs/src/diskio.c"
...
# 12 "C:/esp/esp-idf/components/fatfs/src/diskio.c" 2
...
# 13 "C:/esp/esp-idf/components/fatfs/src/diskio.c" 2
...
int setitimer (int __which, const struct itimerval *restrict __value, struct itimerval *restrict __ovalue)
                                            ;
# 14 "C:/esp/esp-idf/components/fatfs/src/diskio.c" 2
...
# 15 "C:/esp/esp-idf/components/fatfs/src/diskio.c" 2
...
# 16 "C:/esp/esp-idf/components/fatfs/src/diskio.c" 2
...
# 17 "C:/esp/esp-idf/components/fatfs/src/diskio.c" 2

static ff_diskio_impl_t * s_impls[2] = { 
# 18 "C:/esp/esp-idf/components/fatfs/src/diskio.c" 3 4
                                               ((void *)0) 
# 18 "C:/esp/esp-idf/components/fatfs/src/diskio.c"
                                                    };
...
void ff_diskio_register(BYTE pdrv, const ff_diskio_impl_t* discio_impl)
{
    ((pdrv < 2) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/fatfs/src/diskio.c", 41, __func__, "pdrv < _VOLUMES"));

    if (s_impls[pdrv]) {
        ff_diskio_impl_t* im = s_impls[pdrv];
        s_impls[pdrv] = 
# 45 "C:/esp/esp-idf/components/fatfs/src/diskio.c" 3 4
                       ((void *)0)
# 45 "C:/esp/esp-idf/components/fatfs/src/diskio.c"
                           ;
        free(im);
    }
    ...
    ((impl != 
# 54 "C:/esp/esp-idf/components/fatfs/src/diskio.c" 3 4
   ((void *)0)
# 54 "C:/esp/esp-idf/components/fatfs/src/diskio.c"
   ) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/fatfs/src/diskio.c", 54, __func__, "impl != NULL"));
...
{
    time_t t = time(
# 82 "C:/esp/esp-idf/components/fatfs/src/diskio.c" 3 4
                   ((void *)0)
# 82 "C:/esp/esp-idf/components/fatfs/src/diskio.c"
                       );
