# 1 "C:/esp/esp-idf/components/vfs/vfs_uart.c"
# 1 "C:\\esp\\ArkPOS2-esp\\build\\vfs//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/esp-idf/components/vfs/vfs_uart.c"
# 15 "C:/esp/esp-idf/components/vfs/vfs_uart.c"
...
# 16 "C:/esp/esp-idf/components/vfs/vfs_uart.c" 2
# 1 "c:\\msys32\\opt\\xtensa-esp32-elf\\lib\\gcc\\xtensa-esp32-elf\\5.2.0\\include\\stdbool.h" 1 3 4
# 17 "C:/esp/esp-idf/components/vfs/vfs_uart.c" 2
...
# 18 "C:/esp/esp-idf/components/vfs/vfs_uart.c" 2
...
# 19 "C:/esp/esp-idf/components/vfs/vfs_uart.c" 2
...
# 184 "C:/esp/esp-idf/components/newlib/include/sys/_default_fcntl.h" 2
...
# 21 "C:/esp/esp-idf/components/vfs/vfs_uart.c" 2
...
# 22 "C:/esp/esp-idf/components/vfs/vfs_uart.c" 2
...
# 23 "C:/esp/esp-idf/components/vfs/vfs_uart.c" 2
# 1 "C:/esp/esp-idf/components/esp32/include/esp_attr.h" 1
# 24 "C:/esp/esp-idf/components/vfs/vfs_uart.c" 2
...
# 25 "C:/esp/esp-idf/components/vfs/vfs_uart.c" 2
...
# 27 "C:/esp/esp-idf/components/driver/include/driver/uart.h" 2
# 1 "C:/esp/esp-idf/components/driver/include/driver/periph_ctrl.h" 1
# 18 "C:/esp/esp-idf/components/driver/include/driver/periph_ctrl.h"
# 1 "C:/esp/esp-idf/components/soc/esp32/include/soc/soc.h" 1
# 19 "C:/esp/esp-idf/components/driver/include/driver/periph_ctrl.h" 2
...
# 29 "C:/esp/esp-idf/components/driver/include/driver/uart.h" 2
...
# 30 "C:/esp/esp-idf/components/driver/include/driver/uart.h" 2
...
# 32 "C:/esp/esp-idf/components/driver/include/driver/uart.h" 2
# 1 "C:/esp/esp-idf/components/freertos/include/freertos/queue.h" 1
...
# 34 "C:/esp/esp-idf/components/driver/include/driver/uart.h" 2
...
# 26 "C:/esp/esp-idf/components/vfs/vfs_uart.c" 2
# 1 "C:/esp/ArkPOS2-esp/build/include/sdkconfig.h" 1
# 27 "C:/esp/esp-idf/components/vfs/vfs_uart.c" 2
# 35 "C:/esp/esp-idf/components/vfs/vfs_uart.c"
...
static 
# 57 "C:/esp/esp-idf/components/vfs/vfs_uart.c" 3 4
      _Bool 
# 57 "C:/esp/esp-idf/components/vfs/vfs_uart.c"
           s_non_blocking[3];
...
{
    ((fd >=0 && fd < 3) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/vfs/vfs_uart.c", 142, __func__, "fd >=0 && fd < 3"));
...
{
    ((s_peek_char[fd] == -1) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/vfs/vfs_uart.c", 181, __func__, "s_peek_char[fd] == NONE"));
    s_peek_char[fd] = c;
}

static ssize_t uart_read(int fd, void* data, size_t size)
{
    ((fd >=0 && fd < 3) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/vfs/vfs_uart.c", 187, __func__, "fd >=0 && fd < 3"));
...
{
    ((fd >=0 && fd < 3) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/vfs/vfs_uart.c", 233, __func__, "fd >=0 && fd < 3"));
    st->st_mode = 0020000;
    return 0;
}
...
{
    ((fd >=0 && fd < 3) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/vfs/vfs_uart.c", 240, __func__, "fd >=0 && fd < 3"));
    return 0;
}

static int uart_fcntl(int fd, int cmd, va_list args)
{
    ((fd >=0 && fd < 3) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/vfs/vfs_uart.c", 246, __func__, "fd >=0 && fd < 3"));
    int result = 0;
    if (cmd == 3) {
        ...
        int arg = 
# 253 "C:/esp/esp-idf/components/vfs/vfs_uart.c" 3 4
                 __builtin_va_arg(
# 253 "C:/esp/esp-idf/components/vfs/vfs_uart.c"
                 args
# 253 "C:/esp/esp-idf/components/vfs/vfs_uart.c" 3 4
                 ,
# 253 "C:/esp/esp-idf/components/vfs/vfs_uart.c"
...
# 275 "C:/esp/esp-idf/components/vfs/vfs_uart.c" 3 4
   ((void *)0)
# 275 "C:/esp/esp-idf/components/vfs/vfs_uart.c"
   )); if (rc != 0) { _esp_error_check_failed(rc, "C:/esp/esp-idf/components/vfs/vfs_uart.c", 275, __func__, "esp_vfs_register(\"/dev/uart\", &vfs, NULL)"); } } while(0);;
}
