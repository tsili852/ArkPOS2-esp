# 1 "C:/esp/esp32-ArkPOS2/ArkPOS2-esp/main/wifi_sta.c"
...
# 9 "C:/esp/esp32-ArkPOS2/ArkPOS2-esp/main/wifi_sta.c" 2
...
# 10 "C:/esp/esp32-ArkPOS2/ArkPOS2-esp/main/wifi_sta.c" 2
...
# 11 "C:/esp/esp32-ArkPOS2/ArkPOS2-esp/main/wifi_sta.c" 2
# 1 "C:/esp/esp-idf/components/esp32/include/esp_wifi.h" 1
# 63 "C:/esp/esp-idf/components/esp32/include/esp_wifi.h"
...
# 23 "C:/esp/esp-idf/components/esp32/include/esp_event.h"
...
# 37 "C:/esp/esp-idf/components/lwip/include/lwip/port/arch/sys_arch.h"
# 1 "C:/esp/esp-idf/components/freertos/include/freertos/task.h" 1
...
# 12 "C:/esp/esp32-ArkPOS2/ArkPOS2-esp/main/wifi_sta.c" 2
...
# 14 "C:/esp/esp32-ArkPOS2/ArkPOS2-esp/main/wifi_sta.c" 2

# 1 "C:/esp/esp32-ArkPOS2/ArkPOS2-esp/main/wifi_sta.h" 1
# 33 "C:/esp/esp32-ArkPOS2/ArkPOS2-esp/main/wifi_sta.h"
...
# 16 "C:/esp/esp32-ArkPOS2/ArkPOS2-esp/main/wifi_sta.c" 2
...
static void wifi_sta_set_connected(
# 23 "C:/esp/esp32-ArkPOS2/ArkPOS2-esp/main/wifi_sta.c" 3 4
                                  _Bool 
# 23 "C:/esp/esp32-ArkPOS2/ArkPOS2-esp/main/wifi_sta.c"
                                       c);
...
esp_err_t wifi_sta_init(wifi_sta_init_struct_t *param)
{
    ...
    if (strlen(param->network_ssid) >= sizeof(wifi_sta_config_struct.sta.ssid) / sizeof(char)) {
        if (ESP_LOG_VERBOSE >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "wifi_sta", "\033[0;" "31" "m" "E" " (%d) %s: " "wifi_sta_init: invalid parameter: network_ssid too long" "\033[0m" "\n", esp_log_timestamp(), "wifi_sta"); };
        return 0x102;
    }

    if (strlen(param->network_password) >= sizeof(wifi_sta_config_struct.sta.password) / sizeof(char)) {
        if (ESP_LOG_VERBOSE >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "wifi_sta", "\033[0;" "31" "m" "E" " (%d) %s: " "wifi_sta_init: invalid parameter: network_password too long" "\033[0m" "\n", esp_log_timestamp(), "wifi_sta"); };
        return 0x102;
    }

    if (ESP_LOG_VERBOSE >= ESP_LOG_INFO) { esp_log_write(ESP_LOG_INFO, "wifi_sta", "\033[0;" "32" "m" "I" " (%d) %s: " "wifi_sta_init: network = '%s'" "\033[0m" "\n", esp_log_timestamp(), "wifi_sta", param->network_ssid); };
    ...
    if (ESP_LOG_VERBOSE >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, "wifi_sta", "D" " (%d) %s: " "wifi_sta_init: esp_wifi_init" "\033[0m" "\n", esp_log_timestamp(), "wifi_sta"); };
    wifi_init_config_t init_config_struct = { .event_handler = &esp_event_send, .wpa_crypto_funcs = g_wifi_default_wpa_crypto_funcs, .static_rx_buf_num = 10, .dynamic_rx_buf_num = 32, .tx_buf_type = 1, .static_tx_buf_num = 0, .dynamic_tx_buf_num = 32, .ampdu_enable = 1, .nvs_enable = 1, .nano_enable = 0, .tx_ba_win = 6, .rx_ba_win = 6, .magic = 0x1F2F3F4F};;
    esp_err_t init_result = esp_wifi_init(&init_config_struct);
    if (0 != init_result) {

        if (ESP_LOG_VERBOSE >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "wifi_sta", "\033[0;" "31" "m" "E" " (%d) %s: " "wifi_sta_init: esp_wifi_init failed: %d" "\033[0m" "\n", esp_log_timestamp(), "wifi_sta", init_result); };
        return init_result;
    }


    if (ESP_LOG_VERBOSE >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, "wifi_sta", "D" " (%d) %s: " "wifi_sta_init: esp_wifi_set_storage" "\033[0m" "\n", esp_log_timestamp(), "wifi_sta"); };
    esp_err_t storage_result = esp_wifi_set_storage(WIFI_STORAGE_RAM);
    if (0 != storage_result) {

        if (ESP_LOG_VERBOSE >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "wifi_sta", "\033[0;" "31" "m" "E" " (%d) %s: " "wifi_sta_init: esp_wifi_set_storage failed: %d" "\033[0m" "\n", esp_log_timestamp(), "wifi_sta", storage_result); };
        return storage_result;
    }


    if (ESP_LOG_VERBOSE >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, "wifi_sta", "D" " (%d) %s: " "wifi_sta_init: esp_wifi_set_mode" "\033[0m" "\n", esp_log_timestamp(), "wifi_sta"); };
    esp_err_t set_mode_result = esp_wifi_set_mode(WIFI_MODE_STA);
    if (0 != set_mode_result) {

        if (ESP_LOG_VERBOSE >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "wifi_sta", "\033[0;" "31" "m" "E" " (%d) %s: " "wifi_sta_init: esp_wifi_set_mode failed: %d" "\033[0m" "\n", esp_log_timestamp(), "wifi_sta", set_mode_result); };
        return set_mode_result;
    }


    if (ESP_LOG_VERBOSE >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, "wifi_sta", "D" " (%d) %s: " "wifi_sta_init: esp_wifi_set_config" "\033[0m" "\n", esp_log_timestamp(), "wifi_sta"); };
    strcpy((char*)wifi_sta_config_struct.sta.ssid, param->network_ssid);
    strcpy((char*)wifi_sta_config_struct.sta.password, param->network_password);
    wifi_sta_config_struct.sta.bssid_set = 
# 79 "C:/esp/esp32-ArkPOS2/ArkPOS2-esp/main/wifi_sta.c" 3 4
                                          0
# 79 "C:/esp/esp32-ArkPOS2/ArkPOS2-esp/main/wifi_sta.c"
                                               ;
    esp_err_t set_config_result = esp_wifi_set_config(ESP_IF_WIFI_STA, &wifi_sta_config_struct);
    if (0 != set_config_result) {
        if (ESP_LOG_VERBOSE >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "wifi_sta", "\033[0;" "31" "m" "E" " (%d) %s: " "wifi_sta_init: esp_wifi_set_config failed: %d" "\033[0m" "\n", esp_log_timestamp(), "wifi_sta", set_config_result); };
    ...
    if (ESP_LOG_VERBOSE >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, "wifi_sta", "D" " (%d) %s: " "wifi_sta_init: esp_wifi_start" "\033[0m" "\n", esp_log_timestamp(), "wifi_sta"); };
    esp_err_t start_result = esp_wifi_start();
    printf("%d", start_result);
    if (0 != start_result) {
        if (ESP_LOG_VERBOSE >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "wifi_sta", "\033[0;" "31" "m" "E" " (%d) %s: " "wifi_sta_init: esp_wifi_set_config failed: %d" "\033[0m" "\n", esp_log_timestamp(), "wifi_sta", start_result); };
        return start_result;
    }

    if (ESP_LOG_VERBOSE >= ESP_LOG_INFO) { esp_log_write(ESP_LOG_INFO, "wifi_sta", "\033[0;" "32" "m" "I" " (%d) %s: " "Wifi initialized successfully" "\033[0m" "\n", esp_log_timestamp(), "wifi_sta"); };
    ...
    *handled = 1;
    ...
    switch(event->event_id) {
        ...
        case SYSTEM_EVENT_STA_START:
            if (ESP_LOG_VERBOSE >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, "wifi_sta", "D" " (%d) %s: " "wifi_sta_handle_event: SYSTEM_EVENT_STA_START" "\033[0m" "\n", esp_log_timestamp(), "wifi_sta"); };
            result = esp_wifi_connect();
            break;

        case SYSTEM_EVENT_STA_GOT_IP:
            if (ESP_LOG_VERBOSE >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, "wifi_sta", "D" " (%d) %s: " "wifi_sta_handle_event: SYSTEM_EVENT_STA_GOT_IP" "\033[0m" "\n", esp_log_timestamp(), "wifi_sta"); };
            wifi_sta_set_connected(
# 119 "C:/esp/esp32-ArkPOS2/ArkPOS2-esp/main/wifi_sta.c" 3 4
                                  1
# 119 "C:/esp/esp32-ArkPOS2/ArkPOS2-esp/main/wifi_sta.c"
                                      );
            break;

        case SYSTEM_EVENT_STA_CONNECTED:
            if (ESP_LOG_VERBOSE >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, "wifi_sta", "D" " (%d) %s: " "wifi_sta_handle_event: SYSTEM_EVENT_STA_CONNECTED" "\033[0m" "\n", esp_log_timestamp(), "wifi_sta"); };
            break;

        case SYSTEM_EVENT_STA_DISCONNECTED:
            if (ESP_LOG_VERBOSE >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, "wifi_sta", "D" " (%d) %s: " "wifi_sta_handle_event: SYSTEM_EVENT_STA_DISCONNECTED" "\033[0m" "\n", esp_log_timestamp(), "wifi_sta"); };
            wifi_sta_set_connected(
# 128 "C:/esp/esp32-ArkPOS2/ArkPOS2-esp/main/wifi_sta.c" 3 4
                                  0
# 128 "C:/esp/esp32-ArkPOS2/ArkPOS2-esp/main/wifi_sta.c"
                                       );
        ...
        default:
            if (ESP_LOG_VERBOSE >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, "wifi_sta", "D" " (%d) %s: " "wifi_sta_handle_event: event is not for us: %d" "\033[0m" "\n", esp_log_timestamp(), "wifi_sta", event->event_id); };
            *handled = 0;
            break;
    }
...
int wifi_sta_is_connected()
{
    return (xEventGroupClearBits( wifi_sta_event_group, 0 ) & (1 << 0)) ? 1 : 0;
}


static void wifi_sta_set_connected(
# 153 "C:/esp/esp32-ArkPOS2/ArkPOS2-esp/main/wifi_sta.c" 3 4
                                  _Bool 
# 153 "C:/esp/esp32-ArkPOS2/ArkPOS2-esp/main/wifi_sta.c"
                                       c)
{
    ...
    if (c) {
        xEventGroupSetBits(wifi_sta_event_group, (1 << 0));
    } else {
        xEventGroupClearBits(wifi_sta_event_group, (1 << 0));
    }

    if (ESP_LOG_VERBOSE >= ESP_LOG_INFO) { esp_log_write(ESP_LOG_INFO, "wifi_sta", "\033[0;" "32" "m" "I" " (%d) %s: " "Device is now %s WIFI network" "\033[0m" "\n", esp_log_timestamp(), "wifi_sta", c ? "connected to" : "disconnected from"); }
}
