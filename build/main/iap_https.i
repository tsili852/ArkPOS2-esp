# 1 "C:/esp/ArkPOS2-esp/main/iap_https.c"
# 1 "C:\\esp\\ArkPOS2-esp\\build\\main//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/ArkPOS2-esp/main/iap_https.c"
# 9 "C:/esp/ArkPOS2-esp/main/iap_https.c"
...
# 10 "C:/esp/ArkPOS2-esp/main/iap_https.c" 2
...
# 12 "C:/esp/ArkPOS2-esp/main/iap_https.c" 2
...
# 24 "C:/esp/esp-idf/components/esp32/include/esp_event.h" 2
...
# 23 "C:/esp/esp-idf/components/esp32/include/esp_event_loop.h" 2
# 39 "C:/esp/esp-idf/components/esp32/include/esp_event_loop.h"
typedef esp_err_t (*system_event_cb_t)(void *ctx, system_event_t *event);
# 51 "C:/esp/esp-idf/components/esp32/include/esp_event_loop.h"
esp_err_t esp_event_loop_init(system_event_cb_t cb, void *ctx);
# 64 "C:/esp/esp-idf/components/esp32/include/esp_event_loop.h"
system_event_cb_t esp_event_loop_set_cb(system_event_cb_t cb, void *ctx);
# 74 "C:/esp/esp-idf/components/esp32/include/esp_event_loop.h"
QueueHandle_t esp_event_loop_get_queue(void);
# 13 "C:/esp/ArkPOS2-esp/main/iap_https.c" 2
...
# 15 "C:/esp/ArkPOS2-esp/main/iap_https.c" 2
...
# 78 "C:/esp/esp-idf/components/freertos/include/freertos/event_groups.h" 2
# 122 "C:/esp/esp-idf/components/freertos/include/freertos/event_groups.h"
typedef void * EventGroupHandle_t;
# 132 "C:/esp/esp-idf/components/freertos/include/freertos/event_groups.h"
typedef TickType_t EventBits_t;
# 176 "C:/esp/esp-idf/components/freertos/include/freertos/event_groups.h"
EventGroupHandle_t xEventGroupCreate( void ) ;
# 270 "C:/esp/esp-idf/components/freertos/include/freertos/event_groups.h"
EventBits_t xEventGroupWaitBits( EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToWaitFor, const BaseType_t xClearOnExit, const BaseType_t xWaitForAllBits, TickType_t xTicksToWait ) ;
# 327 "C:/esp/esp-idf/components/freertos/include/freertos/event_groups.h"
EventBits_t xEventGroupClearBits( EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToClear ) ;
# 460 "C:/esp/esp-idf/components/freertos/include/freertos/event_groups.h"
EventBits_t xEventGroupSetBits( EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToSet ) ;
# 664 "C:/esp/esp-idf/components/freertos/include/freertos/event_groups.h"
EventBits_t xEventGroupSync( EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToSet, const EventBits_t uxBitsToWaitFor, TickType_t xTicksToWait ) ;
# 700 "C:/esp/esp-idf/components/freertos/include/freertos/event_groups.h"
EventBits_t xEventGroupGetBitsFromISR( EventGroupHandle_t xEventGroup );
# 714 "C:/esp/esp-idf/components/freertos/include/freertos/event_groups.h"
void vEventGroupDelete( EventGroupHandle_t xEventGroup );


void vEventGroupSetBitsCallback( void *pvEventGroup, const uint32_t ulBitsToSet );
void vEventGroupClearBitsCallback( void *pvEventGroup, const uint32_t ulBitsToClear );
# 17 "C:/esp/ArkPOS2-esp/main/iap_https.c" 2
...
# 19 "C:/esp/ArkPOS2-esp/main/iap_https.c" 2
# 1 "C:/esp/ArkPOS2-esp/main/wifi_tls.h" 1
# 31 "C:/esp/ArkPOS2-esp/main/wifi_tls.h"
...
# 20 "C:/esp/ArkPOS2-esp/main/iap_https.c" 2
# 1 "C:/esp/ArkPOS2-esp/main/https_client.h" 1
# 32 "C:/esp/ArkPOS2-esp/main/https_client.h"
struct wifi_tls_context_;


typedef int32_t http_err_t;
# 49 "C:/esp/ArkPOS2-esp/main/https_client.h"
typedef enum {
    HTTP_GET = 0,
...
# 21 "C:/esp/ArkPOS2-esp/main/iap_https.c" 2
...
iap_err_t iap_abort();
# 22 "C:/esp/ArkPOS2-esp/main/iap_https.c" 2
...
# 23 "C:/esp/ArkPOS2-esp/main/iap_https.c" 2
...
int iap_https_init(iap_https_config_t *config)
{
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, "fwup_wifi", "D" " (%d) %s: " "iap_https_init" "\033[0m" "\n", esp_log_timestamp(), "fwup_wifi"); };
...
int iap_https_check_now()
{
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, "fwup_wifi", "D" " (%d) %s: " "iap_https_check_now" "\033[0m" "\n", esp_log_timestamp(), "fwup_wifi"); };
...
# 160 "C:/esp/ArkPOS2-esp/main/iap_https.c"
}

static void iap_https_task(void *pvParameter)
{
    if (((esp_log_level_t) 3) >= ESP_LOG_INFO) { esp_log_write(ESP_LOG_INFO, "fwup_wifi", "\033[0;" "32" "m" "I" " (%d) %s: " "Firmware updater task started." "\033[0m" "\n", esp_log_timestamp(), "fwup_wifi"); };
    ...
    while (1) {
        ...
        BaseType_t clearOnExit = ( ( BaseType_t ) 0 );
        BaseType_t waitForAllBits = ( ( BaseType_t ) 0 );
        EventBits_t bits = xEventGroupWaitBits(event_group, (1 << 0) | (1 << 1), clearOnExit, waitForAllBits, ( TickType_t ) 0xffffffffUL);
        ...
        if (bits & (1 << 1)) {
            if (((esp_log_level_t) 3) >= ESP_LOG_INFO) { esp_log_write(ESP_LOG_INFO, "fwup_wifi", "\033[0;" "32" "m" "I" " (%d) %s: " "Firmware updater task will now download the new firmware image." "\033[0m" "\n", esp_log_timestamp(), "fwup_wifi"); };
            iap_https_download_image();
            xEventGroupClearBits(event_group, (1 << 1));

        } else if (bits & (1 << 0)) {
            if (((esp_log_level_t) 3) >= ESP_LOG_INFO) { esp_log_write(ESP_LOG_INFO, "fwup_wifi", "\033[0;" "32" "m" "I" " (%d) %s: " "Firmware updater task checking for firmware update." "\033[0m" "\n", esp_log_timestamp(), "fwup_wifi"); };
            iap_https_check_for_update();
...
static void iap_https_prepare_timer()
{
    ...
    if (fwupdater_config->polling_interval_s > 0) {
        if (!check_for_updates_timer) {
            ...
            BaseType_t autoReload = ( ( BaseType_t ) 0 );
            check_for_updates_timer = xTimerCreate("fwup_periodic_check", 1000, autoReload, 
# 214 "C:/esp/ArkPOS2-esp/main/iap_https.c" 3 4
                                                                                           ((void *)0)
# 214 "C:/esp/ArkPOS2-esp/main/iap_https.c"
                                                                                               , iap_https_periodic_check_timer_callback);
            if (!check_for_updates_timer) {
                if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "fwup_wifi", "\033[0;" "31" "m" "E" " (%d) %s: " "iap_https_prepare_timer: failed to create the fwup_periodic_check timer!" "\033[0m" "\n", esp_log_timestamp(), "fwup_wifi"); };
                return;
            }
        }
        ...
        if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, "fwup_wifi", "D" " (%d) %s: " "iap_https_prepare_timer: timer interval = %d ms" "\033[0m" "\n", esp_log_timestamp(), "fwup_wifi", timerMillisec); };
        TickType_t timerPeriod = ( ( ( TickType_t ) ( timerMillisec ) * ( 100 ) ) / ( TickType_t ) 1000 );

        xTimerGenericCommand( ( check_for_updates_timer ), ( ( BaseType_t ) 4 ), ( timerPeriod ), 
# 227 "C:/esp/ArkPOS2-esp/main/iap_https.c" 3 4
       ((void *)0)
# 227 "C:/esp/ArkPOS2-esp/main/iap_https.c"
       , ( ( ( ( TickType_t ) ( 5000 ) * ( 100 ) ) / ( TickType_t ) 1000 ) ) );

        if (( ( ( BaseType_t ) 0 ) ) == xTimerGenericCommand( ( check_for_updates_timer ), ( ( BaseType_t ) 2 ), ( xTaskGetTickCount() ), 
# 229 "C:/esp/ArkPOS2-esp/main/iap_https.c" 3 4
                     ((void *)0)
# 229 "C:/esp/ArkPOS2-esp/main/iap_https.c"
                     , ( ( ( ( TickType_t ) ( 5000 ) * ( 100 ) ) / ( TickType_t ) 1000 ) ) )) {
            if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "fwup_wifi", "\033[0;" "31" "m" "E" " (%d) %s: " "iap_https_prepare_timer: failed to start the fwup_periodic_check timer!" "\033[0m" "\n", esp_log_timestamp(), "fwup_wifi"); };
        }
    ...
    if (check_for_updates_timer) {
        ...
        xTimerGenericCommand( ( check_for_updates_timer ), ( ( BaseType_t ) 5 ), 0U, 
# 240 "C:/esp/ArkPOS2-esp/main/iap_https.c" 3 4
       ((void *)0)
# 240 "C:/esp/ArkPOS2-esp/main/iap_https.c"
       , ( ( ( ( TickType_t ) ( 5000 ) * ( 100 ) ) / ( TickType_t ) 1000 ) ) );
        check_for_updates_timer = 
# 241 "C:/esp/ArkPOS2-esp/main/iap_https.c" 3 4
                                 ((void *)0)
# 241 "C:/esp/ArkPOS2-esp/main/iap_https.c"
                                     ;
    }
}
...
static void iap_https_check_for_update()
{
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, "fwup_wifi", "D" " (%d) %s: " "iap_https_check_for_update" "\033[0m" "\n", esp_log_timestamp(), "fwup_wifi"); };

    int tlsResult = wifi_tls_connect(tls_context);
    if (tlsResult) {
        if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "fwup_wifi", "\033[0;" "31" "m" "E" " (%d) %s: " "iap_https_check_for_update: failed to initiate SSL/TLS connection; wifi_tls_connect returned %d" "\033[0m" "\n", esp_log_timestamp(), "fwup_wifi", tlsResult); };
        return;
    }

    if (((esp_log_level_t) 3) >= ESP_LOG_INFO) { esp_log_write(ESP_LOG_INFO, "fwup_wifi", "\033[0;" "32" "m" "I" " (%d) %s: " "Requesting firmware metadata from server." "\033[0m" "\n", esp_log_timestamp(), "fwup_wifi"); };
    http_err_t httpResult = https_send_request(tls_context, &http_metadata_request);
    if (httpResult != 0) {
        if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "fwup_wifi", "\033[0;" "31" "m" "E" " (%d) %s: " "iap_https_check_for_update: failed to send HTTPS metadata request; https_send_request returned %d" "\033[0m" "\n", esp_log_timestamp(), "fwup_wifi", httpResult); };
    }
}
...
void iap_https_download_image()
{
    int tlsResult = wifi_tls_connect(tls_context);
    if (tlsResult) {
        if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "fwup_wifi", "\033[0;" "31" "m" "E" " (%d) %s: " "iap_https_download_image: failed to initiate SSL/TLS connection; wifi_tls_connect returned %d" "\033[0m" "\n", esp_log_timestamp(), "fwup_wifi", tlsResult); };
    }


    has_iap_session = 0;

    if (((esp_log_level_t) 3) >= ESP_LOG_INFO) { esp_log_write(ESP_LOG_INFO, "fwup_wifi", "\033[0;" "32" "m" "I" " (%d) %s: " "Requesting firmware image '%s' from web server." "\033[0m" "\n", esp_log_timestamp(), "fwup_wifi", fwupdater_config->server_firmware_path); };
    http_err_t httpResult = https_send_request(tls_context, &http_firmware_data_request);
    if (httpResult != 0) {
        if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "fwup_wifi", "\033[0;" "31" "m" "E" " (%d) %s: " "iap_https_download_image: failed to send HTTPS firmware image request; https_send_request returned %d" "\033[0m" "\n", esp_log_timestamp(), "fwup_wifi", httpResult); };
    }
}

http_continue_receiving_t iap_https_metadata_body_callback(struct http_request_ *request, size_t bytesReceived)
{
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, "fwup_wifi", "D" " (%d) %s: " "iap_https_metadata_body_callback" "\033[0m" "\n", esp_log_timestamp(), "fwup_wifi"); };
    ...
    if (!http_parse_key_value_int(request->response_buffer, "INTERVAL=", &intervalSeconds)) {
        if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, "fwup_wifi", "D" " (%d) %s: " "[INTERVAL=] '%d'" "\033[0m" "\n", esp_log_timestamp(), "fwup_wifi", intervalSeconds); };
        if (intervalSeconds != fwupdater_config->polling_interval_s) {
            if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, "fwup_wifi", "D" " (%d) %s: " "iap_https_metadata_body_callback: polling interval changed from %d s to %d s" "\033[0m" "\n", esp_log_timestamp(), "fwup_wifi", fwupdater_config->polling_interval_s, intervalSeconds); }
                                                                           ;
    ...
    if (!http_parse_key_value_int(request->response_buffer, "VERSION=", &version)) {
        if (((esp_log_level_t) 3) >= ESP_LOG_INFO) { esp_log_write(ESP_LOG_INFO, "fwup_wifi", "\033[0;" "32" "m" "I" " (%d) %s: " "[VERSION=] '%d'" "\033[0m" "\n", esp_log_timestamp(), "fwup_wifi", version); };
    } else {
        if (((esp_log_level_t) 3) >= ESP_LOG_INFO) { esp_log_write(ESP_LOG_INFO, "fwup_wifi", "\033[0;" "32" "m" "I" " (%d) %s: " "iap_https_metadata_body_callback: firmware version not provided, skipping firmware update" "\033[0m" "\n", esp_log_timestamp(), "fwup_wifi"); };
    ...
    if (!http_parse_key_value_string(request->response_buffer, "FILE=", fileName, sizeof(fileName) / sizeof(char))) {
        if (((esp_log_level_t) 3) >= ESP_LOG_INFO) { esp_log_write(ESP_LOG_INFO, "fwup_wifi", "\033[0;" "32" "m" "I" " (%d) %s: " "[FILE=] '%s'" "\033[0m" "\n", esp_log_timestamp(), "fwup_wifi", fileName); };
        strncpy(fwupdater_config->server_firmware_path, fileName, sizeof(fwupdater_config->server_firmware_path) / sizeof(char));
    } else {
        if (((esp_log_level_t) 3) >= ESP_LOG_INFO) { esp_log_write(ESP_LOG_INFO, "fwup_wifi", "\033[0;" "32" "m" "I" " (%d) %s: " "iap_https_metadata_body_callback: firmware file name not provided, skipping firmware update" "\033[0m" "\n", esp_log_timestamp(), "fwup_wifi"); };
        return HTTP_STOP_RECEIVING;
    }
    ...
    if (version == fwupdater_config->current_software_version) {
        if (((esp_log_level_t) 3) >= ESP_LOG_INFO) { esp_log_write(ESP_LOG_INFO, "fwup_wifi", "\033[0;" "32" "m" "I" " (%d) %s: " "iap_https_metadata_body_callback: we're up-to-date!" "\033[0m" "\n", esp_log_timestamp(), "fwup_wifi"); };
        return HTTP_STOP_RECEIVING;
    }

    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, "fwup_wifi", "D" " (%d) %s: " "iap_https_metadata_body_callback: our version is %d, the version on the server is %d" "\033[0m" "\n", esp_log_timestamp(), "fwup_wifi", fwupdater_config->current_software_version, version); }
                                                                 ;
...
http_continue_receiving_t iap_https_firmware_body_callback(struct http_request_ *request, size_t bytesReceived)
{
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, "fwup_wifi", "D" " (%d) %s: " "iap_https_firmware_body_callback" "\033[0m" "\n", esp_log_timestamp(), "fwup_wifi"); };


    if (!has_iap_session) {
        if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, "fwup_wifi", "D" " (%d) %s: " "iap_https_firmware_body_callback: starting IPA session." "\033[0m" "\n", esp_log_timestamp(), "fwup_wifi"); };
        ...
        if (result != 0) {
            if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "fwup_wifi", "\033[0;" "31" "m" "E" " (%d) %s: " "iap_https_firmware_body_callback: iap_begin failed (%d)!" "\033[0m" "\n", esp_log_timestamp(), "fwup_wifi", result); };
            return HTTP_STOP_RECEIVING;
        }
    ...
    if (bytesReceived > 0) {
        ...
        if (result != 0) {
            if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "fwup_wifi", "\033[0;" "31" "m" "E" " (%d) %s: " "iap_https_firmware_body_callback: write failed (%d), aborting firmware update!" "\033[0m" "\n", esp_log_timestamp(), "fwup_wifi", result); };
            iap_abort();
            return HTTP_STOP_RECEIVING;
        }
    ...
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, "fwup_wifi", "D" " (%d) %s: " "iap_https_firmware_body_callback: all data received (%d bytes), closing session" "\033[0m" "\n", esp_log_timestamp(), "fwup_wifi", total_nof_bytes_received); };
    has_iap_session = 0;

    if (total_nof_bytes_received > 0) {
        iap_err_t result = iap_commit();
        if (result != 0) {
            if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "fwup_wifi", "\033[0;" "31" "m" "E" " (%d) %s: " "iap_https_firmware_body_callback: closing the session has failed (%d)!" "\033[0m" "\n", esp_log_timestamp(), "fwup_wifi", result); };
        }

        has_new_firmware = 1;

        if (fwupdater_config->auto_reboot) {
            if (((esp_log_level_t) 3) >= ESP_LOG_INFO) { esp_log_write(ESP_LOG_INFO, "fwup_wifi", "\033[0;" "32" "m" "I" " (%d) %s: " "Automatic re-boot in 2 seconds - goodbye!..." "\033[0m" "\n", esp_log_timestamp(), "fwup_wifi"); };
            vTaskDelay(2000 / ( ( TickType_t ) 1000 / ( 100 ) ));
            esp_restart();
        }

    } else {
        if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "fwup_wifi", "\033[0;" "31" "m" "E" " (%d) %s: " "iap_https_firmware_body_callback: something's not OK - the new firmware image is empty!" "\033[0m" "\n", esp_log_timestamp(), "fwup_wifi"); };
        iap_abort();
    }
...
http_continue_receiving_t iap_https_metadata_headers_callback(struct http_request_ *request, int statusCode, int contentLength)
{
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, "fwup_wifi", "D" " (%d) %s: " "iap_https_metadata_headers_callback" "\033[0m" "\n", esp_log_timestamp(), "fwup_wifi"); };
    return HTTP_CONTINUE_RECEIVING;
}

http_continue_receiving_t iap_https_firmware_headers_callback(struct http_request_ *request, int statusCode, int contentLength)
{
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, "fwup_wifi", "D" " (%d) %s: " "iap_https_firmware_headers_callback" "\033[0m" "\n", esp_log_timestamp(), "fwup_wifi"); };
    return HTTP_CONTINUE_RECEIVING;
}

void iap_https_error_callback(struct http_request_ *request, http_err_t error, int additionalInfo)
{
    if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "fwup_wifi", "\033[0;" "31" "m" "E" " (%d) %s: " "iap_https_error_callback: error=%d additionalInfo=%d" "\033[0m" "\n", esp_log_timestamp(), "fwup_wifi", error, additionalInfo); };

    if (error == 0x108) {
        switch (additionalInfo) {
            case 401:
                if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "fwup_wifi", "\033[0;" "31" "m" "E" " (%d) %s: " "HTTP status code 401: Unauthorized." "\033[0m" "\n", esp_log_timestamp(), "fwup_wifi"); };
                break;
            case 403:
                if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "fwup_wifi", "\033[0;" "31" "m" "E" " (%d) %s: " "HTTP status code 403: The server is refusing to provide the resource." "\033[0m" "\n", esp_log_timestamp(), "fwup_wifi"); };
                break;
            case 404:
                if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "fwup_wifi", "\033[0;" "31" "m" "E" " (%d) %s: " "HTTP status code 404: Resource not found on the server." "\033[0m" "\n", esp_log_timestamp(), "fwup_wifi"); };
                break;
            default:
                if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "fwup_wifi", "\033[0;" "31" "m" "E" " (%d) %s: " "Non-200 status code received: %d" "\033[0m" "\n", esp_log_timestamp(), "fwup_wifi", additionalInfo); };
                break;
        }
    }
}
