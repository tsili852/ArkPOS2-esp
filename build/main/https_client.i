# 1 "C:/esp/ArkPOS2-esp/main/https_client.c"
# 1 "C:\\esp\\ArkPOS2-esp\\build\\main//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/esp/ArkPOS2-esp/main/https_client.c"
# 9 "C:/esp/ArkPOS2-esp/main/https_client.c"
...
# 10 "C:/esp/ArkPOS2-esp/main/https_client.c" 2
...
# 11 "C:/esp/ArkPOS2-esp/main/https_client.c" 2
...
# 12 "C:/esp/ArkPOS2-esp/main/https_client.c" 2
...
# 13 "C:/esp/ArkPOS2-esp/main/https_client.c" 2
...
# 15 "C:/esp/ArkPOS2-esp/main/https_client.c" 2
...
# 16 "C:/esp/ArkPOS2-esp/main/https_client.c" 2
...
http_err_t https_send_request(struct wifi_tls_context_ *tlsContext, http_request_t *httpRequest)
{
    ...
    if (!tlsContext) {
        if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "httpscl", "\033[0;" "31" "m" "E" " (%d) %s: " "https_send_request: tlsContext missing" "\033[0m" "\n", esp_log_timestamp(), "httpscl"); };
        return 0x101;
    }
    ...
    if (tlsResult == 0) {
        if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, "httpscl", "D" " (%d) %s: " "https_send_request: successfully completed HTTP request %d to the server: %s" "\033[0m" "\n", esp_log_timestamp(), "httpscl", httpContext->request_id, tlsRequest.request_buffer); }
                                                                    ;
    ...
    if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "httpscl", "\033[0;" "31" "m" "E" " (%d) %s: " "https_send_request: failed to complete HTTP request %d (wifi_tls_send_request returned %d)" "\033[0m" "\n", esp_log_timestamp(), "httpscl", httpContext->request_id, tlsResult); }
                                                ;
...
static int https_tls_callback(struct wifi_tls_context_ *context, struct wifi_tls_request_ *request, int index, size_t len)
{
    ...
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, "httpscl", "D" " (%d) %s: " "https_tls_callback: request_id = %d" "\033[0m" "\n", esp_log_timestamp(), "httpscl", httpContext->request_id); };
    ...
    if (httpContext->response_buffer_count + len > httpRequest->response_buffer_len) {
        if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "httpscl", "\033[0;" "31" "m" "E" " (%d) %s: " "https_tls_callback: packet buffer overflow (%d bytes), dropping the packet." "\033[0m" "\n", esp_log_timestamp(), "httpscl", httpRequest->response_buffer_len + len); };
        httpRequest->error_callback(httpRequest, 0x104, 0);
        return 0;
    }
    ...
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, "httpscl", "D" " (%d) %s: " "https_tls_callback: packet index=%d length=%d inHeaders=%d" "\033[0m" "\n", esp_log_timestamp(), "httpscl", index, httpContext->response_buffer_count, httpContext->is_processing_headers); }
                                                                                           ;
    ...
    if (httpContext->is_processing_headers) {
        ...
        if (!endOfHeader) {
            if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, "httpscl", "D" " (%d) %s: " "https_tls_callback: headers not yet complete, waiting for remaining header data." "\033[0m" "\n", esp_log_timestamp(), "httpscl"); };
            return 1;
        }
        ...
        *endOfHeader = 0x00;
        ...
        if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, "httpscl", "D" " (%d) %s: " "https_tls_callback: HTTP headers (%d bytes) successfully received. %d bytes of message body data received." "\033[0m" "\n", esp_log_timestamp(), "httpscl", nofHeaderBytes, httpContext->response_buffer_count - nofHeaderBytes); }
                                                                                     ;
        ...
        if (3 != sscanf(httpRequest->response_buffer, "HTTP/%d.%d %d ", &httpVersionMajor, &httpVersionMinor, &httpStatusCode)) {
            if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "httpscl", "\033[0;" "31" "m" "E" " (%d) %s: " "https_tls_callback: invalid HTTP status line, dropping packet. '%s'" "\033[0m" "\n", esp_log_timestamp(), "httpscl", httpRequest->response_buffer); };
            httpRequest->error_callback(httpRequest, 0x106, 0);
            return 0;
        }
        if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, "httpscl", "D" " (%d) %s: " "https_tls_callback: HTTP status line: version = %d.%d, status code = %d" "\033[0m" "\n", esp_log_timestamp(), "httpscl", httpVersionMajor, httpVersionMinor, httpStatusCode); };
        if (httpVersionMajor != 1) {
            if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "httpscl", "\033[0;" "31" "m" "E" " (%d) %s: " "https_tls_callback: HTTP version not supported, dropping packet. '%s'" "\033[0m" "\n", esp_log_timestamp(), "httpscl", httpRequest->response_buffer); };
            httpRequest->error_callback(httpRequest, 0x107, 0);
            return 0;
        }
        if (httpStatusCode != 200) {
            if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "httpscl", "\033[0;" "31" "m" "E" " (%d) %s: " "https_tls_callback: non-200 HTTP status code received, dropping packet. '%s'" "\033[0m" "\n", esp_log_timestamp(), "httpscl", httpRequest->response_buffer); };
            httpRequest->error_callback(httpRequest, 0x108, httpStatusCode);
            return 0;
        }
        ...
        if (!http_parse_key_value_int(httpRequest->response_buffer, "Content-Length:", &contentLength)) {
            if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, "httpscl", "D" " (%d) %s: " "Content-Length: %d" "\033[0m" "\n", esp_log_timestamp(), "httpscl", contentLength); };
            httpContext->content_length = contentLength;
        } else {
            if (((esp_log_level_t) 3) >= ESP_LOG_WARN) { esp_log_write(ESP_LOG_WARN, "httpscl", "\033[0;" "33" "m" "W" " (%d) %s: " "Content length header missing, dropping the packet. '%s'" "\033[0m" "\n", esp_log_timestamp(), "httpscl", httpRequest->response_buffer); };
        ...
        httpContext->response_body_total_count = httpContext->response_buffer_count;
        if (httpContext->response_buffer_count > 0) {
            if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, "httpscl", "D" " (%d) %s: " "https_tls_callback: last packet contains data of the message body; copying to the beginning, new length = %d" "\033[0m" "\n", esp_log_timestamp(), "httpscl", httpContext->response_buffer_count); };
    ...
    if (httpRequest->response_mode == HTTP_WAIT_FOR_COMPLETE_BODY) {
        ...
        if (httpContext->response_buffer_count < httpContext->content_length) {
            if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, "httpscl", "D" " (%d) %s: " "https_tls_callback: message body is not yet complete, waiting for remaining data (total = %d, received = %d)." "\033[0m" "\n", esp_log_timestamp(), "httpscl", httpContext->content_length, httpContext->response_buffer_count); }
                                                                                     ;
            return 1;
        }

        if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, "httpscl", "D" " (%d) %s: " "https_tls_callback: message body has been completely received, starting processing" "\033[0m" "\n", esp_log_timestamp(), "httpscl"); };
    ...
    if (httpContext->response_buffer_count > 0) {
        if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, "httpscl", "D" " (%d) %s: " "https_tls_callback: message body fragment received (%d bytes, total %d of %d bytes), forwarding to callback" "\033[0m" "\n", esp_log_timestamp(), "httpscl", httpContext->response_buffer_count, httpContext->response_body_total_count, httpContext->content_length); }
                                                                                                                         ;
...
{
    if (!httpRequest) {
        if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "httpscl", "\033[0;" "31" "m" "E" " (%d) %s: " "https_validate_request: httpRequest missing" "\033[0m" "\n", esp_log_timestamp(), "httpscl"); };
        return 0x101;
    }

    if (!httpRequest->host) {
        if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "httpscl", "\033[0;" "31" "m" "E" " (%d) %s: " "https_validate_request: host name missing" "\033[0m" "\n", esp_log_timestamp(), "httpscl"); };
        return 0x101;
    }

    if (!httpRequest->path || !httpRequest->path[0]) {
        if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "httpscl", "\033[0;" "31" "m" "E" " (%d) %s: " "https_send_request: resource path missing" "\033[0m" "\n", esp_log_timestamp(), "httpscl"); };
        return 0x101;
    }

    if (!httpRequest->response_buffer) {
        if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "httpscl", "\033[0;" "31" "m" "E" " (%d) %s: " "https_send_request: no response buffer provided" "\033[0m" "\n", esp_log_timestamp(), "httpscl"); };
        return 0x101;
    }

    if (!httpRequest->error_callback) {
        if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "httpscl", "\033[0;" "31" "m" "E" " (%d) %s: " "https_send_request: error callback missing" "\033[0m" "\n", esp_log_timestamp(), "httpscl"); };
        return 0x101;
    }

    if (!httpRequest->body_callback) {
        if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "httpscl", "\033[0;" "31" "m" "E" " (%d) %s: " "https_send_request: body callback missing" "\033[0m" "\n", esp_log_timestamp(), "httpscl"); };
        return 0x101;
    }
    ...
    if (httpRequest->verb != HTTP_GET) {
        if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "httpscl", "\033[0;" "31" "m" "E" " (%d) %s: " "https_send_request: only GET is currently supported" "\033[0m" "\n", esp_log_timestamp(), "httpscl"); };
        return 0x103;
    }
...
static http_err_t https_create_context_for_request(http_request_context_t **httpContext, http_request_t *httpRequest)
{
    ...
    *httpContext = ctx;
    ...
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, "httpscl", "D" " (%d) %s: " "https_create_context_for_request: request_id = %d" "\033[0m" "\n", esp_log_timestamp(), "httpscl", ctx->request_id); };

    if (!ctx) {
        if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "httpscl", "\033[0;" "31" "m" "E" " (%d) %s: " "https_create_context_for_request: failed to allocate HTTP context object" "\033[0m" "\n", esp_log_timestamp(), "httpscl"); };
        return 0x102;
    }
    ...
    if (!ctx->tls_request_buffer) {
        if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "httpscl", "\033[0;" "31" "m" "E" " (%d) %s: " "https_create_context_for_request: failed to allocate TLS request buffer" "\033[0m" "\n", esp_log_timestamp(), "httpscl"); };
        https_destroy_context(ctx);
        *httpContext = 
# 381 "C:/esp/ArkPOS2-esp/main/https_client.c" 3 4
                      ((void *)0)
# 381 "C:/esp/ArkPOS2-esp/main/https_client.c"
                          ;
        return 0x102;
    }

    sprintf(ctx->tls_request_buffer, http_get_request_format_string, httpRequest->path, httpRequest->host);
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, "httpscl", "D" " (%d) %s: " "https_create_context_for_request: request string = '%s'" "\033[0m" "\n", esp_log_timestamp(), "httpscl", ctx->tls_request_buffer); };
    ...
    if (!ctx->tls_response_buffer) {
        if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "httpscl", "\033[0;" "31" "m" "E" " (%d) %s: " "https_create_context_for_request: failed to allocate TLS response buffer" "\033[0m" "\n", esp_log_timestamp(), "httpscl"); };
        https_destroy_context(ctx);
        *httpContext = 
# 395 "C:/esp/ArkPOS2-esp/main/https_client.c" 3 4
                      ((void *)0)
# 395 "C:/esp/ArkPOS2-esp/main/https_client.c"
                          ;
        return 0x102;
    }
...
static void https_destroy_context(http_request_context_t *httpContext)
{
    ...
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, "httpscl", "D" " (%d) %s: " "https_destroy_context: request_id = %d" "\033[0m" "\n", esp_log_timestamp(), "httpscl", httpContext->request_id); };
