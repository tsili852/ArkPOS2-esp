# 1 "C:/esp/esp-idf/components/libsodium/libsodium/src/libsodium/crypto_generichash/blake2b/ref/generichash_blake2b.c"
...
# 3 "C:/esp/esp-idf/components/libsodium/libsodium/src/libsodium/crypto_generichash/blake2b/ref/generichash_blake2b.c" 2
...
# 4 "C:/esp/esp-idf/components/libsodium/libsodium/src/libsodium/crypto_generichash/blake2b/ref/generichash_blake2b.c" 2
...
# 5 "C:/esp/esp-idf/components/libsodium/libsodium/src/libsodium/crypto_generichash/blake2b/ref/generichash_blake2b.c" 2
...
int blake2b_compress_avx2(blake2b_state *S,
                          const uint8_t block[BLAKE2B_BLOCKBYTES]);
# 7 "C:/esp/esp-idf/components/libsodium/libsodium/src/libsodium/crypto_generichash/blake2b/ref/generichash_blake2b.c" 2
                           ...
                           const unsigned char *key, size_t keylen)
{
    ...
    ((outlen <= 0xff) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/libsodium/libsodium/src/libsodium/crypto_generichash/blake2b/ref/generichash_blake2b.c", 18, __func__, "outlen <= UINT8_MAX"));
    ((keylen <= 0xff) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/libsodium/libsodium/src/libsodium/crypto_generichash/blake2b/ref/generichash_blake2b.c", 19, __func__, "keylen <= UINT8_MAX"));
    ...
    const unsigned char *salt, const unsigned char *personal)
{
    ...
    ((outlen <= 0xff) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/libsodium/libsodium/src/libsodium/crypto_generichash/blake2b/ref/generichash_blake2b.c", 35, __func__, "outlen <= UINT8_MAX"));
    ((keylen <= 0xff) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/libsodium/libsodium/src/libsodium/crypto_generichash/blake2b/ref/generichash_blake2b.c", 36, __func__, "keylen <= UINT8_MAX"));
                                ...
                                const size_t outlen)
{
    ...
    ((outlen <= 0xff) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/libsodium/libsodium/src/libsodium/crypto_generichash/blake2b/ref/generichash_blake2b.c", 52, __func__, "outlen <= UINT8_MAX"));
    ((keylen <= 0xff) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/libsodium/libsodium/src/libsodium/crypto_generichash/blake2b/ref/generichash_blake2b.c", 53, __func__, "keylen <= UINT8_MAX"));
    if (key == 
# 54 "C:/esp/esp-idf/components/libsodium/libsodium/src/libsodium/crypto_generichash/blake2b/ref/generichash_blake2b.c" 3 4
              ((void *)0) 
# 54 "C:/esp/esp-idf/components/libsodium/libsodium/src/libsodium/crypto_generichash/blake2b/ref/generichash_blake2b.c"
                   || keylen <= 0U) {
    ...
    const unsigned char *personal)
{
    ...
    ((outlen <= 0xff) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/libsodium/libsodium/src/libsodium/crypto_generichash/blake2b/ref/generichash_blake2b.c", 75, __func__, "outlen <= UINT8_MAX"));
    ((keylen <= 0xff) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/libsodium/libsodium/src/libsodium/crypto_generichash/blake2b/ref/generichash_blake2b.c", 76, __func__, "keylen <= UINT8_MAX"));
    if (key == 
# 77 "C:/esp/esp-idf/components/libsodium/libsodium/src/libsodium/crypto_generichash/blake2b/ref/generichash_blake2b.c" 3 4
              ((void *)0) 
# 77 "C:/esp/esp-idf/components/libsodium/libsodium/src/libsodium/crypto_generichash/blake2b/ref/generichash_blake2b.c"
                   || keylen <= 0U) {
...
{
    ((outlen <= 0xff) ? (void)0 : __assert_func ("C:/esp/esp-idf/components/libsodium/libsodium/src/libsodium/crypto_generichash/blake2b/ref/generichash_blake2b.c", 102, __func__, "outlen <= UINT8_MAX"));
